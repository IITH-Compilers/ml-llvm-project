...
// repeated bytes payload = 1;
inline int GraphList::_internal_payload_size() const {
  return payload_.size();
}
inline int GraphList::payload_size() const {
  return _internal_payload_size();
}
inline void GraphList::clear_payload() {
  payload_.Clear();
}
inline std::string* GraphList::add_payload() {
  // @@protoc_insertion_point(field_add_mutable:registerallocation.GraphList.payload)
  return _internal_add_payload();
}
inline const std::string& GraphList::_internal_payload(int index) const {
  return payload_.Get(index);
}
inline const std::string& GraphList::payload(int index) const {
  // @@protoc_insertion_point(field_get:registerallocation.GraphList.payload)
  return _internal_payload(index);
}
inline std::string* GraphList::mutable_payload(int index) {
  // @@protoc_insertion_point(field_mutable:registerallocation.GraphList.payload)
  return payload_.Mutable(index);
}
inline void GraphList::set_payload(int index, const std::string& value) {
  // @@protoc_insertion_point(field_set:registerallocation.GraphList.payload)
  payload_.Mutable(index)->assign(value);
}
inline void GraphList::set_payload(int index, std::string&& value) {
  // @@protoc_insertion_point(field_set:registerallocation.GraphList.payload)
  payload_.Mutable(index)->assign(std::move(value));
}
inline void GraphList::set_payload(int index, const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  payload_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:registerallocation.GraphList.payload)
}
inline void GraphList::set_payload(int index, const void* value, size_t size) {
  payload_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:registerallocation.GraphList.payload)
}
inline std::string* GraphList::_internal_add_payload() {
  return payload_.Add();
}
inline void GraphList::add_payload(const std::string& value) {
  payload_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:registerallocation.GraphList.payload)
}
inline void GraphList::add_payload(std::string&& value) {
  payload_.Add(std::move(value));
  // @@protoc_insertion_point(field_add:registerallocation.GraphList.payload)
}
inline void GraphList::add_payload(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  payload_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:registerallocation.GraphList.payload)
}
inline void GraphList::add_payload(const void* value, size_t size) {
  payload_.Add()->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:registerallocation.GraphList.payload)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>&
GraphList::payload() const {
  // @@protoc_insertion_point(field_list:registerallocation.GraphList.payload)
  return payload_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>*
GraphList::mutable_payload() {
  // @@protoc_insertion_point(field_mutable_list:registerallocation.GraphList.payload)
  return &payload_;
}
