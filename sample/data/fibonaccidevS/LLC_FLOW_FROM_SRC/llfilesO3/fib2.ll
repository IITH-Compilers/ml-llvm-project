; ModuleID = '/home/venkat/IF-DV/Rohit/regAlloc/ML-Register-Allocation/sample/data/fibonaccidevS/source/fib2.c'
source_filename = "/home/venkat/IF-DV/Rohit/regAlloc/ML-Register-Allocation/sample/data/fibonaccidevS/source/fib2.c"
...
fib.exit:                                         ; preds = %for.body.for.body_crit_edge.i
  ...
  %call.i = tail call i32 @getc(%struct._IO_FILE* %4) #1
  ret i32 0
}
...
; Function Attrs: nofree nounwind
declare dso_local i32 @getc(%struct._IO_FILE* nocapture) local_unnamed_addr #3
...
!1 = !{!"clang version 10.0.1 (https://github.com/rohitaggarwal007/ML-Register-Allocation.git 27f63e986fcf334ea1b67499c47b262bb15f7590)"}
!2 = !{!3, !3, i64 0}
!3 = !{!"int", !4, i64 0}
