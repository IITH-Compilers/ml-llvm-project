...
@_ZTVN11xercesc_2_714BinInputStreamE = dso_local unnamed_addr constant { [6 x i8*] } { [6 x i8*] [i8* null, i8* bitcast ({ i8*, i8*, i8* }* @_ZTIN11xercesc_2_714BinInputStreamE to i8*), i8* bitcast (void (%"class.xercesc_2_7::BinInputStream"*)* @_ZN11xercesc_2_714BinInputStreamD1Ev to i8*), i8* bitcast (void (%"class.xercesc_2_7::BinInputStream"*)* @_ZN11xercesc_2_714BinInputStreamD0Ev to i8*), i8* bitcast (void ()* @__cxa_pure_virtual to i8*), i8* bitcast (void ()* @__cxa_pure_virtual to i8*)] }, align 8
@_ZTVN10__cxxabiv120__si_class_type_infoE = external dso_local global i8*
@_ZTSN11xercesc_2_714BinInputStreamE = dso_local constant [32 x i8] c"N11xercesc_2_714BinInputStreamE\00", align 1
@_ZTVN10__cxxabiv117__class_type_infoE = external dso_local global i8*
@_ZTSN11xercesc_2_77XMemoryE = linkonce_odr dso_local constant [24 x i8] c"N11xercesc_2_77XMemoryE\00", comdat, align 1
@_ZTIN11xercesc_2_77XMemoryE = linkonce_odr dso_local constant { i8*, i8* } { i8* bitcast (i8** getelementptr inbounds (i8*, i8** @_ZTVN10__cxxabiv117__class_type_infoE, i64 2) to i8*), i8* getelementptr inbounds ([24 x i8], [24 x i8]* @_ZTSN11xercesc_2_77XMemoryE, i32 0, i32 0) }, comdat, align 8
@_ZTIN11xercesc_2_714BinInputStreamE = dso_local constant { i8*, i8*, i8* } { i8* bitcast (i8** getelementptr inbounds (i8*, i8** @_ZTVN10__cxxabiv120__si_class_type_infoE, i64 2) to i8*), i8* getelementptr inbounds ([32 x i8], [32 x i8]* @_ZTSN11xercesc_2_714BinInputStreamE, i32 0, i32 0), i8* bitcast ({ i8*, i8* }* @_ZTIN11xercesc_2_77XMemoryE to i8*) }, align 8

@_ZN11xercesc_2_714BinInputStreamD1Ev = dso_local unnamed_addr alias void (%"class.xercesc_2_7::BinInputStream"*), void (%"class.xercesc_2_7::BinInputStream"*)* @_ZN11xercesc_2_714BinInputStreamD2Ev

; Function Attrs: noinline nounwind uwtable
define dso_local void @_ZN11xercesc_2_714BinInputStreamD2Ev(%"class.xercesc_2_7::BinInputStream"* %this) unnamed_addr #0 align 2 !dbg !256 {
entry:
  %this.addr = alloca %"class.xercesc_2_7::BinInputStream"*, align 8
  store %"class.xercesc_2_7::BinInputStream"* %this, %"class.xercesc_2_7::BinInputStream"** %this.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.xercesc_2_7::BinInputStream"** %this.addr, metadata !313, metadata !DIExpression()), !dbg !315
  %this1 = load %"class.xercesc_2_7::BinInputStream"*, %"class.xercesc_2_7::BinInputStream"** %this.addr, align 8
  ret void, !dbg !316
}
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_ZN11xercesc_2_714BinInputStreamD0Ev(%"class.xercesc_2_7::BinInputStream"* %this) unnamed_addr #0 align 2 !dbg !317 {
entry:
  %this.addr = alloca %"class.xercesc_2_7::BinInputStream"*, align 8
  store %"class.xercesc_2_7::BinInputStream"* %this, %"class.xercesc_2_7::BinInputStream"** %this.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.xercesc_2_7::BinInputStream"** %this.addr, metadata !318, metadata !DIExpression()), !dbg !319
  %this1 = load %"class.xercesc_2_7::BinInputStream"*, %"class.xercesc_2_7::BinInputStream"** %this.addr, align 8
  call void @llvm.trap() #4, !dbg !320
  unreachable, !dbg !320
}
...
define dso_local void @_ZN11xercesc_2_714BinInputStreamC2Ev(%"class.xercesc_2_7::BinInputStream"* %this) unnamed_addr #3 align 2 !dbg !321 {
entry:
  %this.addr = alloca %"class.xercesc_2_7::BinInputStream"*, align 8
  store %"class.xercesc_2_7::BinInputStream"* %this, %"class.xercesc_2_7::BinInputStream"** %this.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.xercesc_2_7::BinInputStream"** %this.addr, metadata !322, metadata !DIExpression()), !dbg !323
  %this1 = load %"class.xercesc_2_7::BinInputStream"*, %"class.xercesc_2_7::BinInputStream"** %this.addr, align 8
  %0 = bitcast %"class.xercesc_2_7::BinInputStream"* %this1 to %"class.xercesc_2_7::XMemory"*, !dbg !324
  call void @_ZN11xercesc_2_77XMemoryC2Ev(%"class.xercesc_2_7::XMemory"* %0), !dbg !325
  %1 = bitcast %"class.xercesc_2_7::BinInputStream"* %this1 to i32 (...)***, !dbg !324
  store i32 (...)** bitcast (i8** getelementptr inbounds ({ [6 x i8*] }, { [6 x i8*] }* @_ZTVN11xercesc_2_714BinInputStreamE, i32 0, inrange i32 0, i32 2) to i32 (...)**), i32 (...)*** %1, align 8, !dbg !324
  ret void, !dbg !326
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN11xercesc_2_77XMemoryC2Ev(%"class.xercesc_2_7::XMemory"* %this) unnamed_addr #0 comdat align 2 !dbg !327 {
entry:
  %this.addr = alloca %"class.xercesc_2_7::XMemory"*, align 8
  store %"class.xercesc_2_7::XMemory"* %this, %"class.xercesc_2_7::XMemory"** %this.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.xercesc_2_7::XMemory"** %this.addr, metadata !328, metadata !DIExpression()), !dbg !330
...
!1 = !DIFile(filename: "BinInputStream.cpp", directory: "/home/venkat/IF-DV/spec_build_release/CPU_2017/benchspec/CPU/523.xalancbmk_r/build/build_base_ld-loop-ext-m64.0000")
!2 = !{}
...
!256 = distinct !DISubprogram(name: "~BinInputStream", linkageName: "_ZN11xercesc_2_714BinInputStreamD2Ev", scope: !257, file: !1, line: 32, type: !288, scopeLine: 33, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, declaration: !287, retainedNodes: !2)
!257 = distinct !DICompositeType(tag: DW_TAG_class_type, name: "BinInputStream", scope: !5, file: !258, line: 28, size: 64, flags: DIFlagTypePassByReference | DIFlagNonTrivial, elements: !259, vtableHolder: !257)
!258 = !DIFile(filename: "./xercesc/util/BinInputStream.hpp", directory: "/home/venkat/IF-DV/spec_build_release/CPU_2017/benchspec/CPU/523.xalancbmk_r/build/build_base_ld-loop-ext-m64.0000")
!259 = !{!260, !284, !287, !291, !296, !304, !305, !309}
...
!284 = !DIDerivedType(tag: DW_TAG_member, name: "_vptr$BinInputStream", scope: !258, file: !258, baseType: !285, size: 64, flags: DIFlagArtificial)
!285 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !286, size: 64)
!286 = !DIDerivedType(tag: DW_TAG_pointer_type, name: "__vtbl_ptr_type", baseType: !124, size: 64)
!287 = !DISubprogram(name: "~BinInputStream", scope: !257, file: !258, line: 34, type: !288, scopeLine: 34, containingType: !257, virtualIndex: 0, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagVirtual)
!288 = !DISubroutineType(types: !289)
!289 = !{null, !290}
!290 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !257, size: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!291 = !DISubprogram(name: "curPos", linkageName: "_ZNK11xercesc_2_714BinInputStream6curPosEv", scope: !257, file: !258, line: 40, type: !292, scopeLine: 40, containingType: !257, virtualIndex: 2, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagPureVirtual)
...
!296 = !DISubprogram(name: "readBytes", linkageName: "_ZN11xercesc_2_714BinInputStream9readBytesEPhj", scope: !257, file: !258, line: 42, type: !297, scopeLine: 42, containingType: !257, virtualIndex: 3, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagPureVirtual)
!297 = !DISubroutineType(types: !298)
!298 = !{!134, !290, !299, !303}
!299 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !300)
!300 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !301, size: 64)
!301 = !DIDerivedType(tag: DW_TAG_typedef, name: "XMLByte", file: !6, line: 384, baseType: !302)
!302 = !DIBasicType(name: "unsigned char", size: 8, encoding: DW_ATE_unsigned_char)
!303 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !134)
!304 = !DISubprogram(name: "BinInputStream", scope: !257, file: !258, line: 53, type: !288, scopeLine: 53, flags: DIFlagProtected | DIFlagPrototyped, spFlags: 0)
!305 = !DISubprogram(name: "BinInputStream", scope: !257, file: !258, line: 60, type: !306, scopeLine: 60, flags: DIFlagPrototyped, spFlags: 0)
!306 = !DISubroutineType(types: !307)
!307 = !{null, !290, !308}
!308 = !DIDerivedType(tag: DW_TAG_reference_type, baseType: !295, size: 64)
!309 = !DISubprogram(name: "operator=", linkageName: "_ZN11xercesc_2_714BinInputStreamaSERKS0_", scope: !257, file: !258, line: 61, type: !310, scopeLine: 61, flags: DIFlagPrototyped, spFlags: 0)
!310 = !DISubroutineType(types: !311)
!311 = !{!312, !290, !308}
!312 = !DIDerivedType(tag: DW_TAG_reference_type, baseType: !257, size: 64)
!313 = !DILocalVariable(name: "this", arg: 1, scope: !256, type: !314, flags: DIFlagArtificial | DIFlagObjectPointer)
!314 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !257, size: 64)
!315 = !DILocation(line: 0, scope: !256)
!316 = !DILocation(line: 34, column: 1, scope: !256)
!317 = distinct !DISubprogram(name: "~BinInputStream", linkageName: "_ZN11xercesc_2_714BinInputStreamD0Ev", scope: !257, file: !1, line: 32, type: !288, scopeLine: 33, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, declaration: !287, retainedNodes: !2)
!318 = !DILocalVariable(name: "this", arg: 1, scope: !317, type: !314, flags: DIFlagArtificial | DIFlagObjectPointer)
!319 = !DILocation(line: 0, scope: !317)
!320 = !DILocation(line: 33, column: 1, scope: !317)
!321 = distinct !DISubprogram(name: "BinInputStream", linkageName: "_ZN11xercesc_2_714BinInputStreamC2Ev", scope: !257, file: !1, line: 40, type: !288, scopeLine: 41, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, declaration: !304, retainedNodes: !2)
!322 = !DILocalVariable(name: "this", arg: 1, scope: !321, type: !314, flags: DIFlagArtificial | DIFlagObjectPointer)
!323 = !DILocation(line: 0, scope: !321)
!324 = !DILocation(line: 41, column: 1, scope: !321)
!325 = !DILocation(line: 40, column: 17, scope: !321)
!326 = !DILocation(line: 42, column: 1, scope: !321)
!327 = distinct !DISubprogram(name: "XMemory", linkageName: "_ZN11xercesc_2_77XMemoryC2Ev", scope: !261, file: !262, line: 130, type: !281, scopeLine: 131, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, declaration: !280, retainedNodes: !2)
!328 = !DILocalVariable(name: "this", arg: 1, scope: !327, type: !329, flags: DIFlagArtificial | DIFlagObjectPointer)
!329 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !261, size: 64)
!330 = !DILocation(line: 0, scope: !327)
!331 = !DILocation(line: 132, column: 5, scope: !327)
