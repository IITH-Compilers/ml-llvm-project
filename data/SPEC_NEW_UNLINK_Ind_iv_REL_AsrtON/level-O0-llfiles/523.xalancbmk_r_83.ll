...
@_ZTVN11xercesc_2_715BinOutputStreamE = dso_local unnamed_addr constant { [6 x i8*] } { [6 x i8*] [i8* null, i8* bitcast ({ i8*, i8*, i8* }* @_ZTIN11xercesc_2_715BinOutputStreamE to i8*), i8* bitcast (void (%"class.xercesc_2_7::BinOutputStream"*)* @_ZN11xercesc_2_715BinOutputStreamD1Ev to i8*), i8* bitcast (void (%"class.xercesc_2_7::BinOutputStream"*)* @_ZN11xercesc_2_715BinOutputStreamD0Ev to i8*), i8* bitcast (void ()* @__cxa_pure_virtual to i8*), i8* bitcast (void ()* @__cxa_pure_virtual to i8*)] }, align 8
@_ZTVN10__cxxabiv120__si_class_type_infoE = external dso_local global i8*
@_ZTSN11xercesc_2_715BinOutputStreamE = dso_local constant [33 x i8] c"N11xercesc_2_715BinOutputStreamE\00", align 1
@_ZTVN10__cxxabiv117__class_type_infoE = external dso_local global i8*
@_ZTSN11xercesc_2_77XMemoryE = linkonce_odr dso_local constant [24 x i8] c"N11xercesc_2_77XMemoryE\00", comdat, align 1
@_ZTIN11xercesc_2_77XMemoryE = linkonce_odr dso_local constant { i8*, i8* } { i8* bitcast (i8** getelementptr inbounds (i8*, i8** @_ZTVN10__cxxabiv117__class_type_infoE, i64 2) to i8*), i8* getelementptr inbounds ([24 x i8], [24 x i8]* @_ZTSN11xercesc_2_77XMemoryE, i32 0, i32 0) }, comdat, align 8
@_ZTIN11xercesc_2_715BinOutputStreamE = dso_local constant { i8*, i8*, i8* } { i8* bitcast (i8** getelementptr inbounds (i8*, i8** @_ZTVN10__cxxabiv120__si_class_type_infoE, i64 2) to i8*), i8* getelementptr inbounds ([33 x i8], [33 x i8]* @_ZTSN11xercesc_2_715BinOutputStreamE, i32 0, i32 0), i8* bitcast ({ i8*, i8* }* @_ZTIN11xercesc_2_77XMemoryE to i8*) }, align 8

@_ZN11xercesc_2_715BinOutputStreamD1Ev = dso_local unnamed_addr alias void (%"class.xercesc_2_7::BinOutputStream"*), void (%"class.xercesc_2_7::BinOutputStream"*)* @_ZN11xercesc_2_715BinOutputStreamD2Ev

; Function Attrs: noinline nounwind uwtable
define dso_local void @_ZN11xercesc_2_715BinOutputStreamD2Ev(%"class.xercesc_2_7::BinOutputStream"* %this) unnamed_addr #0 align 2 !dbg !256 {
entry:
  %this.addr = alloca %"class.xercesc_2_7::BinOutputStream"*, align 8
  store %"class.xercesc_2_7::BinOutputStream"* %this, %"class.xercesc_2_7::BinOutputStream"** %this.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.xercesc_2_7::BinOutputStream"** %this.addr, metadata !314, metadata !DIExpression()), !dbg !316
  %this1 = load %"class.xercesc_2_7::BinOutputStream"*, %"class.xercesc_2_7::BinOutputStream"** %this.addr, align 8
  ret void, !dbg !317
}
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_ZN11xercesc_2_715BinOutputStreamD0Ev(%"class.xercesc_2_7::BinOutputStream"* %this) unnamed_addr #0 align 2 !dbg !318 {
entry:
  %this.addr = alloca %"class.xercesc_2_7::BinOutputStream"*, align 8
  store %"class.xercesc_2_7::BinOutputStream"* %this, %"class.xercesc_2_7::BinOutputStream"** %this.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.xercesc_2_7::BinOutputStream"** %this.addr, metadata !319, metadata !DIExpression()), !dbg !320
  %this1 = load %"class.xercesc_2_7::BinOutputStream"*, %"class.xercesc_2_7::BinOutputStream"** %this.addr, align 8
  call void @llvm.trap() #4, !dbg !321
  unreachable, !dbg !321
}
...
define dso_local void @_ZN11xercesc_2_715BinOutputStreamC2Ev(%"class.xercesc_2_7::BinOutputStream"* %this) unnamed_addr #3 align 2 !dbg !322 {
entry:
  %this.addr = alloca %"class.xercesc_2_7::BinOutputStream"*, align 8
  store %"class.xercesc_2_7::BinOutputStream"* %this, %"class.xercesc_2_7::BinOutputStream"** %this.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.xercesc_2_7::BinOutputStream"** %this.addr, metadata !323, metadata !DIExpression()), !dbg !324
  %this1 = load %"class.xercesc_2_7::BinOutputStream"*, %"class.xercesc_2_7::BinOutputStream"** %this.addr, align 8
  %0 = bitcast %"class.xercesc_2_7::BinOutputStream"* %this1 to %"class.xercesc_2_7::XMemory"*, !dbg !325
  call void @_ZN11xercesc_2_77XMemoryC2Ev(%"class.xercesc_2_7::XMemory"* %0), !dbg !326
  %1 = bitcast %"class.xercesc_2_7::BinOutputStream"* %this1 to i32 (...)***, !dbg !325
  store i32 (...)** bitcast (i8** getelementptr inbounds ({ [6 x i8*] }, { [6 x i8*] }* @_ZTVN11xercesc_2_715BinOutputStreamE, i32 0, inrange i32 0, i32 2) to i32 (...)**), i32 (...)*** %1, align 8, !dbg !325
  ret void, !dbg !327
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN11xercesc_2_77XMemoryC2Ev(%"class.xercesc_2_7::XMemory"* %this) unnamed_addr #0 comdat align 2 !dbg !328 {
entry:
  %this.addr = alloca %"class.xercesc_2_7::XMemory"*, align 8
  store %"class.xercesc_2_7::XMemory"* %this, %"class.xercesc_2_7::XMemory"** %this.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.xercesc_2_7::XMemory"** %this.addr, metadata !329, metadata !DIExpression()), !dbg !331
...
!1 = !DIFile(filename: "BinOutputStream.cpp", directory: "/home/venkat/IF-DV/spec_build_release/CPU_2017/benchspec/CPU/523.xalancbmk_r/build/build_base_ld-loop-ext-m64.0000")
!2 = !{}
...
!256 = distinct !DISubprogram(name: "~BinOutputStream", linkageName: "_ZN11xercesc_2_715BinOutputStreamD2Ev", scope: !257, file: !1, line: 32, type: !288, scopeLine: 33, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, declaration: !287, retainedNodes: !2)
!257 = distinct !DICompositeType(tag: DW_TAG_class_type, name: "BinOutputStream", scope: !5, file: !258, line: 28, size: 64, flags: DIFlagTypePassByReference | DIFlagNonTrivial, elements: !259, vtableHolder: !257)
!258 = !DIFile(filename: "./xercesc/framework/BinOutputStream.hpp", directory: "/home/venkat/IF-DV/spec_build_release/CPU_2017/benchspec/CPU/523.xalancbmk_r/build/build_base_ld-loop-ext-m64.0000")
!259 = !{!260, !284, !287, !291, !296, !305, !306, !310}
...
!284 = !DIDerivedType(tag: DW_TAG_member, name: "_vptr$BinOutputStream", scope: !258, file: !258, baseType: !285, size: 64, flags: DIFlagArtificial)
!285 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !286, size: 64)
!286 = !DIDerivedType(tag: DW_TAG_pointer_type, name: "__vtbl_ptr_type", baseType: !124, size: 64)
!287 = !DISubprogram(name: "~BinOutputStream", scope: !257, file: !258, line: 34, type: !288, scopeLine: 34, containingType: !257, virtualIndex: 0, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagVirtual)
!288 = !DISubroutineType(types: !289)
!289 = !{null, !290}
!290 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !257, size: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!291 = !DISubprogram(name: "curPos", linkageName: "_ZNK11xercesc_2_715BinOutputStream6curPosEv", scope: !257, file: !258, line: 39, type: !292, scopeLine: 39, containingType: !257, virtualIndex: 2, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagPureVirtual)
!292 = !DISubroutineType(types: !293)
!293 = !{!134, !294}
!294 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !295, size: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!295 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !257)
!296 = !DISubprogram(name: "writeBytes", linkageName: "_ZN11xercesc_2_715BinOutputStream10writeBytesEPKhj", scope: !257, file: !258, line: 41, type: !297, scopeLine: 41, containingType: !257, virtualIndex: 3, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagPureVirtual)
!297 = !DISubroutineType(types: !298)
!298 = !{null, !290, !299, !304}
!299 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !300)
!300 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !301, size: 64)
!301 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !302)
!302 = !DIDerivedType(tag: DW_TAG_typedef, name: "XMLByte", file: !6, line: 384, baseType: !303)
...
!305 = !DISubprogram(name: "BinOutputStream", scope: !257, file: !258, line: 51, type: !288, scopeLine: 51, flags: DIFlagProtected | DIFlagPrototyped, spFlags: 0)
!306 = !DISubprogram(name: "BinOutputStream", scope: !257, file: !258, line: 58, type: !307, scopeLine: 58, flags: DIFlagPrototyped, spFlags: 0)
!307 = !DISubroutineType(types: !308)
!308 = !{null, !290, !309}
!309 = !DIDerivedType(tag: DW_TAG_reference_type, baseType: !295, size: 64)
!310 = !DISubprogram(name: "operator=", linkageName: "_ZN11xercesc_2_715BinOutputStreamaSERKS0_", scope: !257, file: !258, line: 59, type: !311, scopeLine: 59, flags: DIFlagPrototyped, spFlags: 0)
!311 = !DISubroutineType(types: !312)
!312 = !{!313, !290, !309}
!313 = !DIDerivedType(tag: DW_TAG_reference_type, baseType: !257, size: 64)
!314 = !DILocalVariable(name: "this", arg: 1, scope: !256, type: !315, flags: DIFlagArtificial | DIFlagObjectPointer)
!315 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !257, size: 64)
!316 = !DILocation(line: 0, scope: !256)
!317 = !DILocation(line: 34, column: 1, scope: !256)
!318 = distinct !DISubprogram(name: "~BinOutputStream", linkageName: "_ZN11xercesc_2_715BinOutputStreamD0Ev", scope: !257, file: !1, line: 32, type: !288, scopeLine: 33, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, declaration: !287, retainedNodes: !2)
!319 = !DILocalVariable(name: "this", arg: 1, scope: !318, type: !315, flags: DIFlagArtificial | DIFlagObjectPointer)
!320 = !DILocation(line: 0, scope: !318)
!321 = !DILocation(line: 33, column: 1, scope: !318)
!322 = distinct !DISubprogram(name: "BinOutputStream", linkageName: "_ZN11xercesc_2_715BinOutputStreamC2Ev", scope: !257, file: !1, line: 40, type: !288, scopeLine: 41, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, declaration: !305, retainedNodes: !2)
!323 = !DILocalVariable(name: "this", arg: 1, scope: !322, type: !315, flags: DIFlagArtificial | DIFlagObjectPointer)
!324 = !DILocation(line: 0, scope: !322)
!325 = !DILocation(line: 41, column: 1, scope: !322)
!326 = !DILocation(line: 40, column: 18, scope: !322)
!327 = !DILocation(line: 42, column: 1, scope: !322)
!328 = distinct !DISubprogram(name: "XMemory", linkageName: "_ZN11xercesc_2_77XMemoryC2Ev", scope: !261, file: !262, line: 130, type: !281, scopeLine: 131, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, declaration: !280, retainedNodes: !2)
!329 = !DILocalVariable(name: "this", arg: 1, scope: !328, type: !330, flags: DIFlagArtificial | DIFlagObjectPointer)
!330 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !261, size: 64)
!331 = !DILocation(line: 0, scope: !328)
!332 = !DILocation(line: 132, column: 5, scope: !328)
