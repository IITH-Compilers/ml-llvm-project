...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_petsc_parallel_block_sparse_matrix.cc, i8* null }]
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_petsc_parallel_block_sparse_matrix.cc() #0 section ".text.startup" !dbg !1618 {
entry:
...
!123 = !DIFile(filename: "source/lac/petsc_parallel_block_sparse_matrix.cc", directory: "/home/venkat/IF-DV/spec_build_release/CPU_2017/benchspec/CPU/510.parest_r/build/build_base_ld-loop-ext-m64.0000")
!124 = !{!125}
...
!1618 = distinct !DISubprogram(linkageName: "_GLOBAL__sub_I_petsc_parallel_block_sparse_matrix.cc", scope: !123, file: !123, type: !1619, flags: DIFlagArtificial, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !122, retainedNodes: !1553)
