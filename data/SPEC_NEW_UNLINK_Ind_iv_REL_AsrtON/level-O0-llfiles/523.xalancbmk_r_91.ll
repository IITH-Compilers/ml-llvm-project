...
@_ZTSN11xercesc_2_716CDATASectionImplE = dso_local constant [34 x i8] c"N11xercesc_2_716CDATASectionImplE\00", align 1
@_ZTIN11xercesc_2_78TextImplE = external dso_local constant i8*
@_ZTIN11xercesc_2_716CDATASectionImplE = dso_local constant { i8*, i8*, i8* } { i8* bitcast (i8** getelementptr inbounds (i8*, i8** @_ZTVN10__cxxabiv120__si_class_type_infoE, i64 2) to i8*), i8* getelementptr inbounds ([34 x i8], [34 x i8]* @_ZTSN11xercesc_2_716CDATASectionImplE, i32 0, i32 0), i8* bitcast (i8** @_ZTIN11xercesc_2_78TextImplE to i8*) }, align 8
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_CDATASectionImpl.cpp, i8* null }]

@_ZN11xercesc_2_716CDATASectionImplC1EPNS_12DocumentImplERKNS_9DOMStringE = dso_local unnamed_addr alias void (%"class.xercesc_2_7::CDATASectionImpl"*, %"class.xercesc_2_7::DocumentImpl"*, %"class.xercesc_2_7::DOMString"*), void (%"class.xercesc_2_7::CDATASectionImpl"*, %"class.xercesc_2_7::DocumentImpl"*, %"class.xercesc_2_7::DOMString"*)* @_ZN11xercesc_2_716CDATASectionImplC2EPNS_12DocumentImplERKNS_9DOMStringE
@_ZN11xercesc_2_716CDATASectionImplC1ERKS0_b = dso_local unnamed_addr alias void (%"class.xercesc_2_7::CDATASectionImpl"*, %"class.xercesc_2_7::CDATASectionImpl"*, i1), void (%"class.xercesc_2_7::CDATASectionImpl"*, %"class.xercesc_2_7::CDATASectionImpl"*, i1)* @_ZN11xercesc_2_716CDATASectionImplC2ERKS0_b
@_ZN11xercesc_2_716CDATASectionImplD1Ev = dso_local unnamed_addr alias void (%"class.xercesc_2_7::CDATASectionImpl"*), void (%"class.xercesc_2_7::CDATASectionImpl"*)* @_ZN11xercesc_2_716CDATASectionImplD2Ev
...
entry:
  call void @_ZN11xercesc_2_718XMLRegisterCleanupC1Ev(%"class.xercesc_2_7::XMLRegisterCleanup"* @_ZN11xercesc_2_7L21gcdata_sectionCleanupE), !dbg !714
  ret void, !dbg !714
}
...
; Function Attrs: noinline uwtable
define dso_local void @_ZN11xercesc_2_716CDATASectionImplC2EPNS_12DocumentImplERKNS_9DOMStringE(%"class.xercesc_2_7::CDATASectionImpl"* %this, %"class.xercesc_2_7::DocumentImpl"* %ownerDoc, %"class.xercesc_2_7::DOMString"* dereferenceable(8) %dat) unnamed_addr #3 align 2 !dbg !715 {
entry:
  %this.addr = alloca %"class.xercesc_2_7::CDATASectionImpl"*, align 8
  %ownerDoc.addr = alloca %"class.xercesc_2_7::DocumentImpl"*, align 8
  %dat.addr = alloca %"class.xercesc_2_7::DOMString"*, align 8
  store %"class.xercesc_2_7::CDATASectionImpl"* %this, %"class.xercesc_2_7::CDATASectionImpl"** %this.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.xercesc_2_7::CDATASectionImpl"** %this.addr, metadata !752, metadata !DIExpression()), !dbg !754
  store %"class.xercesc_2_7::DocumentImpl"* %ownerDoc, %"class.xercesc_2_7::DocumentImpl"** %ownerDoc.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.xercesc_2_7::DocumentImpl"** %ownerDoc.addr, metadata !755, metadata !DIExpression()), !dbg !756
  store %"class.xercesc_2_7::DOMString"* %dat, %"class.xercesc_2_7::DOMString"** %dat.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.xercesc_2_7::DOMString"** %dat.addr, metadata !757, metadata !DIExpression()), !dbg !758
  %this1 = load %"class.xercesc_2_7::CDATASectionImpl"*, %"class.xercesc_2_7::CDATASectionImpl"** %this.addr, align 8
  %0 = bitcast %"class.xercesc_2_7::CDATASectionImpl"* %this1 to %"class.xercesc_2_7::TextImpl"*, !dbg !759
  %1 = load %"class.xercesc_2_7::DocumentImpl"*, %"class.xercesc_2_7::DocumentImpl"** %ownerDoc.addr, align 8, !dbg !760
  %2 = load %"class.xercesc_2_7::DOMString"*, %"class.xercesc_2_7::DOMString"** %dat.addr, align 8, !dbg !761
  call void @_ZN11xercesc_2_78TextImplC2EPNS_12DocumentImplERKNS_9DOMStringE(%"class.xercesc_2_7::TextImpl"* %0, %"class.xercesc_2_7::DocumentImpl"* %1, %"class.xercesc_2_7::DOMString"* dereferenceable(8) %2), !dbg !762
  %3 = bitcast %"class.xercesc_2_7::CDATASectionImpl"* %this1 to i32 (...)***, !dbg !759
  store i32 (...)** bitcast (i8** getelementptr inbounds ({ [60 x i8*] }, { [60 x i8*] }* @_ZTVN11xercesc_2_716CDATASectionImplE, i32 0, inrange i32 0, i32 2) to i32 (...)**), i32 (...)*** %3, align 8, !dbg !759
  ret void, !dbg !763
}

declare dso_local void @_ZN11xercesc_2_78TextImplC2EPNS_12DocumentImplERKNS_9DOMStringE(%"class.xercesc_2_7::TextImpl"*, %"class.xercesc_2_7::DocumentImpl"*, %"class.xercesc_2_7::DOMString"* dereferenceable(8)) unnamed_addr #4

; Function Attrs: noinline uwtable
define dso_local void @_ZN11xercesc_2_716CDATASectionImplC2ERKS0_b(%"class.xercesc_2_7::CDATASectionImpl"* %this, %"class.xercesc_2_7::CDATASectionImpl"* dereferenceable(56) %other, i1 zeroext %deep) unnamed_addr #3 align 2 !dbg !764 {
entry:
  %this.addr = alloca %"class.xercesc_2_7::CDATASectionImpl"*, align 8
  %other.addr = alloca %"class.xercesc_2_7::CDATASectionImpl"*, align 8
  %deep.addr = alloca i8, align 1
  store %"class.xercesc_2_7::CDATASectionImpl"* %this, %"class.xercesc_2_7::CDATASectionImpl"** %this.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.xercesc_2_7::CDATASectionImpl"** %this.addr, metadata !765, metadata !DIExpression()), !dbg !766
  store %"class.xercesc_2_7::CDATASectionImpl"* %other, %"class.xercesc_2_7::CDATASectionImpl"** %other.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.xercesc_2_7::CDATASectionImpl"** %other.addr, metadata !767, metadata !DIExpression()), !dbg !768
  %frombool = zext i1 %deep to i8
  store i8 %frombool, i8* %deep.addr, align 1
  call void @llvm.dbg.declare(metadata i8* %deep.addr, metadata !769, metadata !DIExpression()), !dbg !770
  %this1 = load %"class.xercesc_2_7::CDATASectionImpl"*, %"class.xercesc_2_7::CDATASectionImpl"** %this.addr, align 8
  %0 = bitcast %"class.xercesc_2_7::CDATASectionImpl"* %this1 to %"class.xercesc_2_7::TextImpl"*, !dbg !771
  %1 = load %"class.xercesc_2_7::CDATASectionImpl"*, %"class.xercesc_2_7::CDATASectionImpl"** %other.addr, align 8, !dbg !772
  %2 = bitcast %"class.xercesc_2_7::CDATASectionImpl"* %1 to %"class.xercesc_2_7::TextImpl"*, !dbg !772
  %3 = load i8, i8* %deep.addr, align 1, !dbg !773
  %tobool = trunc i8 %3 to i1, !dbg !773
  call void @_ZN11xercesc_2_78TextImplC2ERKS0_b(%"class.xercesc_2_7::TextImpl"* %0, %"class.xercesc_2_7::TextImpl"* dereferenceable(56) %2, i1 zeroext %tobool), !dbg !774
  %4 = bitcast %"class.xercesc_2_7::CDATASectionImpl"* %this1 to i32 (...)***, !dbg !771
  store i32 (...)** bitcast (i8** getelementptr inbounds ({ [60 x i8*] }, { [60 x i8*] }* @_ZTVN11xercesc_2_716CDATASectionImplE, i32 0, inrange i32 0, i32 2) to i32 (...)**), i32 (...)*** %4, align 8, !dbg !771
  ret void, !dbg !775
}

declare dso_local void @_ZN11xercesc_2_78TextImplC2ERKS0_b(%"class.xercesc_2_7::TextImpl"*, %"class.xercesc_2_7::TextImpl"* dereferenceable(56), i1 zeroext) unnamed_addr #4

; Function Attrs: noinline nounwind uwtable
define dso_local void @_ZN11xercesc_2_716CDATASectionImplD2Ev(%"class.xercesc_2_7::CDATASectionImpl"* %this) unnamed_addr #1 align 2 !dbg !776 {
entry:
  %this.addr = alloca %"class.xercesc_2_7::CDATASectionImpl"*, align 8
  store %"class.xercesc_2_7::CDATASectionImpl"* %this, %"class.xercesc_2_7::CDATASectionImpl"** %this.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.xercesc_2_7::CDATASectionImpl"** %this.addr, metadata !777, metadata !DIExpression()), !dbg !778
  %this1 = load %"class.xercesc_2_7::CDATASectionImpl"*, %"class.xercesc_2_7::CDATASectionImpl"** %this.addr, align 8
  %0 = bitcast %"class.xercesc_2_7::CDATASectionImpl"* %this1 to %"class.xercesc_2_7::TextImpl"*, !dbg !779
  call void @_ZN11xercesc_2_78TextImplD2Ev(%"class.xercesc_2_7::TextImpl"* %0) #6, !dbg !779
  ret void, !dbg !781
}

; Function Attrs: nounwind
declare dso_local void @_ZN11xercesc_2_78TextImplD2Ev(%"class.xercesc_2_7::TextImpl"*) unnamed_addr #5

; Function Attrs: noinline nounwind uwtable
define dso_local void @_ZN11xercesc_2_716CDATASectionImplD0Ev(%"class.xercesc_2_7::CDATASectionImpl"* %this) unnamed_addr #1 align 2 !dbg !782 {
entry:
  %this.addr = alloca %"class.xercesc_2_7::CDATASectionImpl"*, align 8
  store %"class.xercesc_2_7::CDATASectionImpl"* %this, %"class.xercesc_2_7::CDATASectionImpl"** %this.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.xercesc_2_7::CDATASectionImpl"** %this.addr, metadata !783, metadata !DIExpression()), !dbg !784
  %this1 = load %"class.xercesc_2_7::CDATASectionImpl"*, %"class.xercesc_2_7::CDATASectionImpl"** %this.addr, align 8
  call void @_ZN11xercesc_2_716CDATASectionImplD1Ev(%"class.xercesc_2_7::CDATASectionImpl"* %this1) #6, !dbg !785
  %0 = bitcast %"class.xercesc_2_7::CDATASectionImpl"* %this1 to i8*, !dbg !785
  call void @_ZN11xercesc_2_77XMemorydlEPv(i8* %0) #6, !dbg !785
  ret void, !dbg !786
}
...
; Function Attrs: noinline uwtable
define dso_local %"class.xercesc_2_7::NodeImpl"* @_ZN11xercesc_2_716CDATASectionImpl9cloneNodeEb(%"class.xercesc_2_7::CDATASectionImpl"* %this, i1 zeroext %deep) unnamed_addr #3 align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) !dbg !787 {
entry:
  %this.addr = alloca %"class.xercesc_2_7::CDATASectionImpl"*, align 8
  %deep.addr = alloca i8, align 1
  %exn.slot = alloca i8*
  ...
  store %"class.xercesc_2_7::CDATASectionImpl"* %this, %"class.xercesc_2_7::CDATASectionImpl"** %this.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.xercesc_2_7::CDATASectionImpl"** %this.addr, metadata !788, metadata !DIExpression()), !dbg !789
  %frombool = zext i1 %deep to i8
  store i8 %frombool, i8* %deep.addr, align 1
  call void @llvm.dbg.declare(metadata i8* %deep.addr, metadata !790, metadata !DIExpression()), !dbg !791
  %this1 = load %"class.xercesc_2_7::CDATASectionImpl"*, %"class.xercesc_2_7::CDATASectionImpl"** %this.addr, align 8
  %0 = bitcast %"class.xercesc_2_7::CDATASectionImpl"* %this1 to %"class.xercesc_2_7::NodeImpl"*, !dbg !792
  %1 = bitcast %"class.xercesc_2_7::NodeImpl"* %0 to %"class.xercesc_2_7::DocumentImpl"* (%"class.xercesc_2_7::NodeImpl"*)***, !dbg !792
  %vtable = load %"class.xercesc_2_7::DocumentImpl"* (%"class.xercesc_2_7::NodeImpl"*)**, %"class.xercesc_2_7::DocumentImpl"* (%"class.xercesc_2_7::NodeImpl"*)*** %1, align 8, !dbg !792
  %vfn = getelementptr inbounds %"class.xercesc_2_7::DocumentImpl"* (%"class.xercesc_2_7::NodeImpl"*)*, %"class.xercesc_2_7::DocumentImpl"* (%"class.xercesc_2_7::NodeImpl"*)** %vtable, i64 26, !dbg !792
  %2 = load %"class.xercesc_2_7::DocumentImpl"* (%"class.xercesc_2_7::NodeImpl"*)*, %"class.xercesc_2_7::DocumentImpl"* (%"class.xercesc_2_7::NodeImpl"*)** %vfn, align 8, !dbg !792
  %call = call %"class.xercesc_2_7::DocumentImpl"* %2(%"class.xercesc_2_7::NodeImpl"* %0), !dbg !792
  %call2 = call %"class.xercesc_2_7::MemoryManager"* @_ZNK11xercesc_2_712DocumentImpl16getMemoryManagerEv(%"class.xercesc_2_7::DocumentImpl"* %call), !dbg !793
  %call3 = call i8* @_ZN11xercesc_2_77XMemorynwEmPNS_13MemoryManagerE(i64 56, %"class.xercesc_2_7::MemoryManager"* %call2), !dbg !794
  %3 = bitcast i8* %call3 to %"class.xercesc_2_7::CDATASectionImpl"*, !dbg !794
  %4 = load i8, i8* %deep.addr, align 1, !dbg !795
  %tobool = trunc i8 %4 to i1, !dbg !795
  invoke void @_ZN11xercesc_2_716CDATASectionImplC1ERKS0_b(%"class.xercesc_2_7::CDATASectionImpl"* %3, %"class.xercesc_2_7::CDATASectionImpl"* dereferenceable(56) %this1, i1 zeroext %tobool)
          to label %invoke.cont unwind label %lpad, !dbg !796

invoke.cont:                                      ; preds = %entry
  %5 = bitcast %"class.xercesc_2_7::CDATASectionImpl"* %3 to %"class.xercesc_2_7::NodeImpl"*, !dbg !794
  ret %"class.xercesc_2_7::NodeImpl"* %5, !dbg !797

lpad:                                             ; preds = %entry
  %6 = landingpad { i8*, i32 }
          cleanup, !dbg !798
  %7 = extractvalue { i8*, i32 } %6, 0, !dbg !798
  store i8* %7, i8** %exn.slot, align 8, !dbg !798
  %8 = extractvalue { i8*, i32 } %6, 1, !dbg !798
  store i32 %8, i32* %ehselector.slot, align 4, !dbg !798
  call void @_ZN11xercesc_2_77XMemorydlEPvPNS_13MemoryManagerE(i8* %call3, %"class.xercesc_2_7::MemoryManager"* %call2) #6, !dbg !794
...
eh.resume:                                        ; preds = %lpad
  ...
  %lpad.val4 = insertvalue { i8*, i32 } %lpad.val, i32 %sel, 1, !dbg !794
  resume { i8*, i32 } %lpad.val4, !dbg !794
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local %"class.xercesc_2_7::MemoryManager"* @_ZNK11xercesc_2_712DocumentImpl16getMemoryManagerEv(%"class.xercesc_2_7::DocumentImpl"* %this) #1 comdat align 2 !dbg !799 {
entry:
  ...
  call void @llvm.dbg.declare(metadata %"class.xercesc_2_7::DocumentImpl"** %this.addr, metadata !805, metadata !DIExpression()), !dbg !807
  %this1 = load %"class.xercesc_2_7::DocumentImpl"*, %"class.xercesc_2_7::DocumentImpl"** %this.addr, align 8
  %fMemoryManager = getelementptr inbounds %"class.xercesc_2_7::DocumentImpl", %"class.xercesc_2_7::DocumentImpl"* %this1, i32 0, i32 11, !dbg !808
  %0 = load %"class.xercesc_2_7::MemoryManager"*, %"class.xercesc_2_7::MemoryManager"** %fMemoryManager, align 8, !dbg !808
  ret %"class.xercesc_2_7::MemoryManager"* %0, !dbg !809
}
...
; Function Attrs: noinline uwtable
define dso_local void @_ZN11xercesc_2_716CDATASectionImpl11getNodeNameEv(%"class.xercesc_2_7::DOMString"* noalias sret %agg.result, %"class.xercesc_2_7::CDATASectionImpl"* %this) unnamed_addr #3 align 2 !dbg !810 {
entry:
  ...
  store %"class.xercesc_2_7::CDATASectionImpl"* %this, %"class.xercesc_2_7::CDATASectionImpl"** %this.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.xercesc_2_7::CDATASectionImpl"** %this.addr, metadata !811, metadata !DIExpression()), !dbg !812
  %this1 = load %"class.xercesc_2_7::CDATASectionImpl"*, %"class.xercesc_2_7::CDATASectionImpl"** %this.addr, align 8
  %call = call dereferenceable(8) %"class.xercesc_2_7::DOMString"* @_ZN11xercesc_2_711DStringPool15getStaticStringEPKcPPNS_9DOMStringEPFvvERNS_18XMLRegisterCleanupE(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str, i64 0, i64 0), %"class.xercesc_2_7::DOMString"** @_ZN11xercesc_2_7L14gcdata_sectionE, void ()* @_ZN11xercesc_2_716CDATASectionImpl22reinitCDATASectionImplEv, %"class.xercesc_2_7::XMLRegisterCleanup"* dereferenceable(24) @_ZN11xercesc_2_7L21gcdata_sectionCleanupE), !dbg !813
  call void @_ZN11xercesc_2_79DOMStringC1ERKS0_(%"class.xercesc_2_7::DOMString"* %agg.result, %"class.xercesc_2_7::DOMString"* dereferenceable(8) %call), !dbg !813
  ret void, !dbg !814
}
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_ZN11xercesc_2_716CDATASectionImpl22reinitCDATASectionImplEv() #1 align 2 !dbg !815 {
entry:
  %0 = load %"class.xercesc_2_7::DOMString"*, %"class.xercesc_2_7::DOMString"** @_ZN11xercesc_2_7L14gcdata_sectionE, align 8, !dbg !816
  %isnull = icmp eq %"class.xercesc_2_7::DOMString"* %0, null, !dbg !817
  br i1 %isnull, label %delete.end, label %delete.notnull, !dbg !817

delete.notnull:                                   ; preds = %entry
  call void @_ZN11xercesc_2_79DOMStringD1Ev(%"class.xercesc_2_7::DOMString"* %0) #6, !dbg !817
  %1 = bitcast %"class.xercesc_2_7::DOMString"* %0 to i8*, !dbg !817
  call void @_ZN11xercesc_2_77XMemorydlEPv(i8* %1) #6, !dbg !817
  br label %delete.end, !dbg !817

delete.end:                                       ; preds = %delete.notnull, %entry
  store %"class.xercesc_2_7::DOMString"* null, %"class.xercesc_2_7::DOMString"** @_ZN11xercesc_2_7L14gcdata_sectionE, align 8, !dbg !818
  ret void, !dbg !819
}
...
; Function Attrs: noinline nounwind uwtable
define dso_local signext i16 @_ZN11xercesc_2_716CDATASectionImpl11getNodeTypeEv(%"class.xercesc_2_7::CDATASectionImpl"* %this) unnamed_addr #1 align 2 !dbg !820 {
entry:
  %this.addr = alloca %"class.xercesc_2_7::CDATASectionImpl"*, align 8
  store %"class.xercesc_2_7::CDATASectionImpl"* %this, %"class.xercesc_2_7::CDATASectionImpl"** %this.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.xercesc_2_7::CDATASectionImpl"** %this.addr, metadata !821, metadata !DIExpression()), !dbg !822
  %this1 = load %"class.xercesc_2_7::CDATASectionImpl"*, %"class.xercesc_2_7::CDATASectionImpl"** %this.addr, align 8
  ret i16 4, !dbg !823
}

; Function Attrs: noinline nounwind uwtable
define dso_local zeroext i1 @_ZN11xercesc_2_716CDATASectionImpl18isCDATASectionImplEv(%"class.xercesc_2_7::CDATASectionImpl"* %this) unnamed_addr #1 align 2 !dbg !824 {
entry:
  %this.addr = alloca %"class.xercesc_2_7::CDATASectionImpl"*, align 8
  store %"class.xercesc_2_7::CDATASectionImpl"* %this, %"class.xercesc_2_7::CDATASectionImpl"** %this.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.xercesc_2_7::CDATASectionImpl"** %this.addr, metadata !825, metadata !DIExpression()), !dbg !826
  %this1 = load %"class.xercesc_2_7::CDATASectionImpl"*, %"class.xercesc_2_7::CDATASectionImpl"** %this.addr, align 8
  ret i1 true, !dbg !827
}
...
declare dso_local zeroext i1 @_ZN11xercesc_2_78TextImpl10isTextImplEv(%"class.xercesc_2_7::TextImpl"*) unnamed_addr #4
...
declare dso_local %"class.xercesc_2_7::TextImpl"* @_ZN11xercesc_2_78TextImpl9splitTextEj(%"class.xercesc_2_7::TextImpl"*, i32) unnamed_addr #4

declare dso_local zeroext i1 @_ZN11xercesc_2_78TextImpl21isIgnorableWhitespaceEv(%"class.xercesc_2_7::TextImpl"*) unnamed_addr #4

declare dso_local void @_ZN11xercesc_2_78TextImpl22setIgnorableWhitespaceEb(%"class.xercesc_2_7::TextImpl"*, i1 zeroext) unnamed_addr #4

; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_CDATASectionImpl.cpp() #3 section ".text.startup" !dbg !828 {
entry:
  call void @__cxx_global_var_init(), !dbg !830
  ret void
}
...
!1 = distinct !DIGlobalVariable(name: "gcdata_sectionCleanup", linkageName: "_ZN11xercesc_2_7L21gcdata_sectionCleanupE", scope: !2, file: !3, line: 30, type: !4, isLocal: true, isDefinition: true)
!2 = !DINamespace(name: "xercesc_2_7", scope: null)
!3 = !DIFile(filename: "CDATASectionImpl.cpp", directory: "/home/venkat/IF-DV/spec_build_release/CPU_2017/benchspec/CPU/523.xalancbmk_r/build/build_base_ld-loop-ext-m64.0000")
...
!35 = distinct !DIGlobalVariable(name: "gcdata_section", linkageName: "_ZN11xercesc_2_7L14gcdata_sectionE", scope: !2, file: !3, line: 29, type: !36, isLocal: true, isDefinition: true)
...
!713 = distinct !DISubprogram(name: "__cxx_global_var_init", scope: !3, file: !3, line: 30, type: !10, scopeLine: 30, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !192, retainedNodes: !703)
!714 = !DILocation(line: 30, column: 27, scope: !713)
!715 = distinct !DISubprogram(name: "CDATASectionImpl", linkageName: "_ZN11xercesc_2_716CDATASectionImplC2EPNS_12DocumentImplERKNS_9DOMStringE", scope: !716, file: !3, line: 32, type: !723, scopeLine: 35, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !192, declaration: !722, retainedNodes: !703)
!716 = distinct !DICompositeType(tag: DW_TAG_class_type, name: "CDATASectionImpl", scope: !2, file: !717, line: 39, size: 448, flags: DIFlagTypePassByReference | DIFlagNonTrivial, elements: !718, vtableHolder: !750)
!717 = !DIFile(filename: "./xercesc/dom/deprecated/CDATASectionImpl.hpp", directory: "/home/venkat/IF-DV/spec_build_release/CPU_2017/benchspec/CPU/523.xalancbmk_r/build/build_base_ld-loop-ext-m64.0000")
...
!720 = !DICompositeType(tag: DW_TAG_class_type, name: "TextImpl", scope: !2, file: !721, line: 41, flags: DIFlagFwdDecl)
!721 = !DIFile(filename: "./xercesc/dom/deprecated/TextImpl.hpp", directory: "/home/venkat/IF-DV/spec_build_release/CPU_2017/benchspec/CPU/523.xalancbmk_r/build/build_base_ld-loop-ext-m64.0000")
!722 = !DISubprogram(name: "CDATASectionImpl", scope: !716, file: !717, line: 41, type: !723, scopeLine: 41, flags: DIFlagPublic | DIFlagPrototyped, spFlags: 0)
...
!729 = !DISubprogram(name: "CDATASectionImpl", scope: !716, file: !717, line: 42, type: !730, scopeLine: 42, flags: DIFlagPublic | DIFlagPrototyped, spFlags: 0)
...
!734 = !DISubprogram(name: "~CDATASectionImpl", scope: !716, file: !717, line: 44, type: !735, scopeLine: 44, containingType: !716, virtualIndex: 0, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagVirtual)
!735 = !DISubroutineType(types: !736)
!736 = !{null, !725}
!737 = !DISubprogram(name: "cloneNode", linkageName: "_ZN11xercesc_2_716CDATASectionImpl9cloneNodeEb", scope: !716, file: !717, line: 45, type: !738, scopeLine: 45, containingType: !716, virtualIndex: 17, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagVirtual)
!738 = !DISubroutineType(types: !739)
!739 = !{!199, !725, !124}
!740 = !DISubprogram(name: "getNodeName", linkageName: "_ZN11xercesc_2_716CDATASectionImpl11getNodeNameEv", scope: !716, file: !717, line: 46, type: !741, scopeLine: 46, containingType: !716, virtualIndex: 23, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagVirtual)
!741 = !DISubroutineType(types: !742)
!742 = !{!37, !725}
!743 = !DISubprogram(name: "getNodeType", linkageName: "_ZN11xercesc_2_716CDATASectionImpl11getNodeTypeEv", scope: !716, file: !717, line: 47, type: !744, scopeLine: 47, containingType: !716, virtualIndex: 24, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagVirtual)
!744 = !DISubroutineType(types: !745)
!745 = !{!235, !725}
!746 = !DISubprogram(name: "isCDATASectionImpl", linkageName: "_ZN11xercesc_2_716CDATASectionImpl18isCDATASectionImplEv", scope: !716, file: !717, line: 48, type: !747, scopeLine: 48, containingType: !716, virtualIndex: 7, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagVirtual)
!747 = !DISubroutineType(types: !748)
!748 = !{!124, !725}
!749 = !DISubprogram(name: "reinitCDATASectionImpl", linkageName: "_ZN11xercesc_2_716CDATASectionImpl22reinitCDATASectionImplEv", scope: !716, file: !717, line: 53, type: !10, scopeLine: 53, flags: DIFlagPublic | DIFlagPrototyped | DIFlagStaticMember, spFlags: 0)
...
!755 = !DILocalVariable(name: "ownerDoc", arg: 2, scope: !715, file: !3, line: 32, type: !726)
!756 = !DILocation(line: 32, column: 50, scope: !715)
!757 = !DILocalVariable(name: "dat", arg: 3, scope: !715, file: !3, line: 33, type: !88)
!758 = !DILocation(line: 33, column: 53, scope: !715)
!759 = !DILocation(line: 35, column: 1, scope: !715)
!760 = !DILocation(line: 34, column: 16, scope: !715)
!761 = !DILocation(line: 34, column: 26, scope: !715)
!762 = !DILocation(line: 34, column: 7, scope: !715)
!763 = !DILocation(line: 36, column: 1, scope: !715)
!764 = distinct !DISubprogram(name: "CDATASectionImpl", linkageName: "_ZN11xercesc_2_716CDATASectionImplC2ERKS0_b", scope: !716, file: !3, line: 39, type: !730, scopeLine: 41, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !192, declaration: !729, retainedNodes: !703)
!765 = !DILocalVariable(name: "this", arg: 1, scope: !764, type: !753, flags: DIFlagArtificial | DIFlagObjectPointer)
!766 = !DILocation(line: 0, scope: !764)
!767 = !DILocalVariable(name: "other", arg: 2, scope: !764, file: !3, line: 39, type: !732)
!768 = !DILocation(line: 39, column: 60, scope: !764)
!769 = !DILocalVariable(name: "deep", arg: 3, scope: !764, file: !3, line: 39, type: !124)
!770 = !DILocation(line: 39, column: 72, scope: !764)
!771 = !DILocation(line: 41, column: 1, scope: !764)
!772 = !DILocation(line: 40, column: 16, scope: !764)
!773 = !DILocation(line: 40, column: 23, scope: !764)
!774 = !DILocation(line: 40, column: 7, scope: !764)
!775 = !DILocation(line: 42, column: 1, scope: !764)
!776 = distinct !DISubprogram(name: "~CDATASectionImpl", linkageName: "_ZN11xercesc_2_716CDATASectionImplD2Ev", scope: !716, file: !3, line: 45, type: !735, scopeLine: 46, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !192, declaration: !734, retainedNodes: !703)
!777 = !DILocalVariable(name: "this", arg: 1, scope: !776, type: !753, flags: DIFlagArtificial | DIFlagObjectPointer)
!778 = !DILocation(line: 0, scope: !776)
!779 = !DILocation(line: 47, column: 1, scope: !780)
!780 = distinct !DILexicalBlock(scope: !776, file: !3, line: 46, column: 1)
!781 = !DILocation(line: 47, column: 1, scope: !776)
!782 = distinct !DISubprogram(name: "~CDATASectionImpl", linkageName: "_ZN11xercesc_2_716CDATASectionImplD0Ev", scope: !716, file: !3, line: 45, type: !735, scopeLine: 46, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !192, declaration: !734, retainedNodes: !703)
!783 = !DILocalVariable(name: "this", arg: 1, scope: !782, type: !753, flags: DIFlagArtificial | DIFlagObjectPointer)
!784 = !DILocation(line: 0, scope: !782)
!785 = !DILocation(line: 46, column: 1, scope: !782)
!786 = !DILocation(line: 47, column: 1, scope: !782)
!787 = distinct !DISubprogram(name: "cloneNode", linkageName: "_ZN11xercesc_2_716CDATASectionImpl9cloneNodeEb", scope: !716, file: !3, line: 50, type: !738, scopeLine: 51, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !192, declaration: !737, retainedNodes: !703)
!788 = !DILocalVariable(name: "this", arg: 1, scope: !787, type: !753, flags: DIFlagArtificial | DIFlagObjectPointer)
!789 = !DILocation(line: 0, scope: !787)
!790 = !DILocalVariable(name: "deep", arg: 2, scope: !787, file: !3, line: 50, type: !124)
!791 = !DILocation(line: 50, column: 45, scope: !787)
!792 = !DILocation(line: 52, column: 17, scope: !787)
!793 = !DILocation(line: 52, column: 37, scope: !787)
!794 = !DILocation(line: 52, column: 12, scope: !787)
!795 = !DILocation(line: 52, column: 81, scope: !787)
!796 = !DILocation(line: 52, column: 57, scope: !787)
!797 = !DILocation(line: 52, column: 5, scope: !787)
!798 = !DILocation(line: 53, column: 1, scope: !787)
!799 = distinct !DISubprogram(name: "getMemoryManager", linkageName: "_ZNK11xercesc_2_712DocumentImpl16getMemoryManagerEv", scope: !727, file: !728, line: 237, type: !800, scopeLine: 237, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !192, declaration: !804, retainedNodes: !703)
!800 = !DISubroutineType(types: !801)
!801 = !{!54, !802}
!802 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !803, size: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!803 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !727)
!804 = !DISubprogram(name: "getMemoryManager", linkageName: "_ZNK11xercesc_2_712DocumentImpl16getMemoryManagerEv", scope: !727, file: !728, line: 237, type: !800, scopeLine: 237, flags: DIFlagPublic | DIFlagPrototyped, spFlags: 0)
...
!808 = !DILocation(line: 238, column: 16, scope: !799)
!809 = !DILocation(line: 238, column: 9, scope: !799)
!810 = distinct !DISubprogram(name: "getNodeName", linkageName: "_ZN11xercesc_2_716CDATASectionImpl11getNodeNameEv", scope: !716, file: !3, line: 56, type: !741, scopeLine: 56, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !192, declaration: !740, retainedNodes: !703)
!811 = !DILocalVariable(name: "this", arg: 1, scope: !810, type: !753, flags: DIFlagArtificial | DIFlagObjectPointer)
!812 = !DILocation(line: 0, scope: !810)
!813 = !DILocation(line: 58, column: 12, scope: !810)
!814 = !DILocation(line: 58, column: 5, scope: !810)
!815 = distinct !DISubprogram(name: "reinitCDATASectionImpl", linkageName: "_ZN11xercesc_2_716CDATASectionImpl22reinitCDATASectionImplEv", scope: !716, file: !3, line: 78, type: !10, scopeLine: 78, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !192, declaration: !749, retainedNodes: !703)
!816 = !DILocation(line: 79, column: 9, scope: !815)
!817 = !DILocation(line: 79, column: 2, scope: !815)
!818 = !DILocation(line: 80, column: 17, scope: !815)
!819 = !DILocation(line: 81, column: 1, scope: !815)
!820 = distinct !DISubprogram(name: "getNodeType", linkageName: "_ZN11xercesc_2_716CDATASectionImpl11getNodeTypeEv", scope: !716, file: !3, line: 65, type: !744, scopeLine: 65, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !192, declaration: !743, retainedNodes: !703)
!821 = !DILocalVariable(name: "this", arg: 1, scope: !820, type: !753, flags: DIFlagArtificial | DIFlagObjectPointer)
!822 = !DILocation(line: 0, scope: !820)
!823 = !DILocation(line: 66, column: 5, scope: !820)
!824 = distinct !DISubprogram(name: "isCDATASectionImpl", linkageName: "_ZN11xercesc_2_716CDATASectionImpl18isCDATASectionImplEv", scope: !716, file: !3, line: 70, type: !747, scopeLine: 71, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !192, declaration: !746, retainedNodes: !703)
!825 = !DILocalVariable(name: "this", arg: 1, scope: !824, type: !753, flags: DIFlagArtificial | DIFlagObjectPointer)
!826 = !DILocation(line: 0, scope: !824)
!827 = !DILocation(line: 72, column: 5, scope: !824)
!828 = distinct !DISubprogram(linkageName: "_GLOBAL__sub_I_CDATASectionImpl.cpp", scope: !3, file: !3, type: !829, flags: DIFlagArtificial, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !192, retainedNodes: !703)
!829 = !DISubroutineType(types: !703)
