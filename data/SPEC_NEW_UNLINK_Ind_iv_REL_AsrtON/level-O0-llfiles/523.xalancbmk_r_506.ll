...
@_ZTSN11xercesc_2_78XSObjectE = dso_local constant [25 x i8] c"N11xercesc_2_78XSObjectE\00", align 1
@_ZTIN11xercesc_2_78XSObjectE = dso_local constant { i8*, i8*, i8* } { i8* bitcast (i8** getelementptr inbounds (i8*, i8** @_ZTVN10__cxxabiv120__si_class_type_infoE, i64 2) to i8*), i8* getelementptr inbounds ([25 x i8], [25 x i8]* @_ZTSN11xercesc_2_78XSObjectE, i32 0, i32 0), i8* bitcast ({ i8*, i8* }* @_ZTIN11xercesc_2_77XMemoryE to i8*) }, align 8

@_ZN11xercesc_2_78XSObjectC1ENS_11XSConstants14COMPONENT_TYPEEPNS_7XSModelEPNS_13MemoryManagerE = dso_local unnamed_addr alias void (%"class.xercesc_2_7::XSObject"*, i32, %"class.xercesc_2_7::XSModel"*, %"class.xercesc_2_7::MemoryManager"*), void (%"class.xercesc_2_7::XSObject"*, i32, %"class.xercesc_2_7::XSModel"*, %"class.xercesc_2_7::MemoryManager"*)* @_ZN11xercesc_2_78XSObjectC2ENS_11XSConstants14COMPONENT_TYPEEPNS_7XSModelEPNS_13MemoryManagerE
@_ZN11xercesc_2_78XSObjectD1Ev = dso_local unnamed_addr alias void (%"class.xercesc_2_7::XSObject"*), void (%"class.xercesc_2_7::XSObject"*)* @_ZN11xercesc_2_78XSObjectD2Ev
...
define dso_local void @_ZN11xercesc_2_78XSObjectC2ENS_11XSConstants14COMPONENT_TYPEEPNS_7XSModelEPNS_13MemoryManagerE(%"class.xercesc_2_7::XSObject"* %this, i32 %compType, %"class.xercesc_2_7::XSModel"* %xsModel, %"class.xercesc_2_7::MemoryManager"* %manager) unnamed_addr #4 align 2 !dbg !1273 {
entry:
  %this.addr = alloca %"class.xercesc_2_7::XSObject"*, align 8
  %compType.addr = alloca i32, align 4
  %xsModel.addr = alloca %"class.xercesc_2_7::XSModel"*, align 8
  %manager.addr = alloca %"class.xercesc_2_7::MemoryManager"*, align 8
  store %"class.xercesc_2_7::XSObject"* %this, %"class.xercesc_2_7::XSObject"** %this.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.xercesc_2_7::XSObject"** %this.addr, metadata !1461, metadata !DIExpression()), !dbg !1462
  store i32 %compType, i32* %compType.addr, align 4
  call void @llvm.dbg.declare(metadata i32* %compType.addr, metadata !1463, metadata !DIExpression()), !dbg !1464
  store %"class.xercesc_2_7::XSModel"* %xsModel, %"class.xercesc_2_7::XSModel"** %xsModel.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.xercesc_2_7::XSModel"** %xsModel.addr, metadata !1465, metadata !DIExpression()), !dbg !1466
  ...
  %this1 = load %"class.xercesc_2_7::XSObject"*, %"class.xercesc_2_7::XSObject"** %this.addr, align 8
  %0 = bitcast %"class.xercesc_2_7::XSObject"* %this1 to %"class.xercesc_2_7::XMemory"*, !dbg !1469
  call void @_ZN11xercesc_2_77XMemoryC2Ev(%"class.xercesc_2_7::XMemory"* %0), !dbg !1470
  %1 = bitcast %"class.xercesc_2_7::XSObject"* %this1 to i32 (...)***, !dbg !1469
  store i32 (...)** bitcast (i8** getelementptr inbounds ({ [8 x i8*] }, { [8 x i8*] }* @_ZTVN11xercesc_2_78XSObjectE, i32 0, inrange i32 0, i32 2) to i32 (...)**), i32 (...)*** %1, align 8, !dbg !1469
  %fComponentType = getelementptr inbounds %"class.xercesc_2_7::XSObject", %"class.xercesc_2_7::XSObject"* %this1, i32 0, i32 1, !dbg !1471
  %2 = load i32, i32* %compType.addr, align 4, !dbg !1472
  store i32 %2, i32* %fComponentType, align 8, !dbg !1471
  %fXSModel = getelementptr inbounds %"class.xercesc_2_7::XSObject", %"class.xercesc_2_7::XSObject"* %this1, i32 0, i32 3, !dbg !1473
  %3 = load %"class.xercesc_2_7::XSModel"*, %"class.xercesc_2_7::XSModel"** %xsModel.addr, align 8, !dbg !1474
  store %"class.xercesc_2_7::XSModel"* %3, %"class.xercesc_2_7::XSModel"** %fXSModel, align 8, !dbg !1473
  %fMemoryManager = getelementptr inbounds %"class.xercesc_2_7::XSObject", %"class.xercesc_2_7::XSObject"* %this1, i32 0, i32 4, !dbg !1475
  %4 = load %"class.xercesc_2_7::MemoryManager"*, %"class.xercesc_2_7::MemoryManager"** %manager.addr, align 8, !dbg !1476
  store %"class.xercesc_2_7::MemoryManager"* %4, %"class.xercesc_2_7::MemoryManager"** %fMemoryManager, align 8, !dbg !1475
  %fId = getelementptr inbounds %"class.xercesc_2_7::XSObject", %"class.xercesc_2_7::XSObject"* %this1, i32 0, i32 5, !dbg !1477
  store i32 0, i32* %fId, align 8, !dbg !1477
  %5 = load %"class.xercesc_2_7::XSModel"*, %"class.xercesc_2_7::XSModel"** %xsModel.addr, align 8, !dbg !1478
  %tobool = icmp ne %"class.xercesc_2_7::XSModel"* %5, null, !dbg !1478
  br i1 %tobool, label %if.then, label %if.end, !dbg !1481

if.then:                                          ; preds = %entry
  %6 = load %"class.xercesc_2_7::XSModel"*, %"class.xercesc_2_7::XSModel"** %xsModel.addr, align 8, !dbg !1482
  %7 = load i32, i32* %compType.addr, align 4, !dbg !1484
  %sub = sub nsw i32 %7, 1, !dbg !1485
  call void @_ZN11xercesc_2_77XSModel22addComponentToIdVectorEPNS_8XSObjectEi(%"class.xercesc_2_7::XSModel"* %6, %"class.xercesc_2_7::XSObject"* %this1, i32 %sub), !dbg !1486
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN11xercesc_2_77XMemoryC2Ev(%"class.xercesc_2_7::XMemory"* %this) unnamed_addr #1 comdat align 2 !dbg !1489 {
entry:
  %this.addr = alloca %"class.xercesc_2_7::XMemory"*, align 8
  store %"class.xercesc_2_7::XMemory"* %this, %"class.xercesc_2_7::XMemory"** %this.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.xercesc_2_7::XMemory"** %this.addr, metadata !1490, metadata !DIExpression()), !dbg !1492
  %this1 = load %"class.xercesc_2_7::XMemory"*, %"class.xercesc_2_7::XMemory"** %this.addr, align 8
  ret void, !dbg !1493
}

declare dso_local void @_ZN11xercesc_2_77XSModel22addComponentToIdVectorEPNS_8XSObjectEi(%"class.xercesc_2_7::XSModel"*, %"class.xercesc_2_7::XSObject"*, i32) #5

; Function Attrs: noinline nounwind uwtable
define dso_local void @_ZN11xercesc_2_78XSObjectD2Ev(%"class.xercesc_2_7::XSObject"* %this) unnamed_addr #1 align 2 !dbg !1494 {
entry:
  %this.addr = alloca %"class.xercesc_2_7::XSObject"*, align 8
  store %"class.xercesc_2_7::XSObject"* %this, %"class.xercesc_2_7::XSObject"** %this.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.xercesc_2_7::XSObject"** %this.addr, metadata !1495, metadata !DIExpression()), !dbg !1496
  %this1 = load %"class.xercesc_2_7::XSObject"*, %"class.xercesc_2_7::XSObject"** %this.addr, align 8
  ret void, !dbg !1497
}

; Function Attrs: noinline nounwind uwtable
define dso_local void @_ZN11xercesc_2_78XSObjectD0Ev(%"class.xercesc_2_7::XSObject"* %this) unnamed_addr #1 align 2 !dbg !1498 {
entry:
  %this.addr = alloca %"class.xercesc_2_7::XSObject"*, align 8
  store %"class.xercesc_2_7::XSObject"* %this, %"class.xercesc_2_7::XSObject"** %this.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.xercesc_2_7::XSObject"** %this.addr, metadata !1499, metadata !DIExpression()), !dbg !1500
  %this1 = load %"class.xercesc_2_7::XSObject"*, %"class.xercesc_2_7::XSObject"** %this.addr, align 8
  call void @_ZN11xercesc_2_78XSObjectD1Ev(%"class.xercesc_2_7::XSObject"* %this1) #7, !dbg !1501
  %0 = bitcast %"class.xercesc_2_7::XSObject"* %this1 to i8*, !dbg !1501
  call void @_ZN11xercesc_2_77XMemorydlEPv(i8* %0) #7, !dbg !1501
  ret void, !dbg !1502
}
...
; Function Attrs: noinline nounwind uwtable
define dso_local i16* @_ZN11xercesc_2_78XSObject7getNameEv(%"class.xercesc_2_7::XSObject"* %this) unnamed_addr #1 align 2 !dbg !1503 {
entry:
  %this.addr = alloca %"class.xercesc_2_7::XSObject"*, align 8
  store %"class.xercesc_2_7::XSObject"* %this, %"class.xercesc_2_7::XSObject"** %this.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.xercesc_2_7::XSObject"** %this.addr, metadata !1504, metadata !DIExpression()), !dbg !1505
  %this1 = load %"class.xercesc_2_7::XSObject"*, %"class.xercesc_2_7::XSObject"** %this.addr, align 8
  ret i16* null, !dbg !1506
}

; Function Attrs: noinline nounwind uwtable
define dso_local i16* @_ZN11xercesc_2_78XSObject12getNamespaceEv(%"class.xercesc_2_7::XSObject"* %this) unnamed_addr #1 align 2 !dbg !1507 {
entry:
  %this.addr = alloca %"class.xercesc_2_7::XSObject"*, align 8
  store %"class.xercesc_2_7::XSObject"* %this, %"class.xercesc_2_7::XSObject"** %this.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.xercesc_2_7::XSObject"** %this.addr, metadata !1508, metadata !DIExpression()), !dbg !1509
  %this1 = load %"class.xercesc_2_7::XSObject"*, %"class.xercesc_2_7::XSObject"** %this.addr, align 8
  ret i16* null, !dbg !1510
}

; Function Attrs: noinline nounwind uwtable
define dso_local %"class.xercesc_2_7::XSNamespaceItem"* @_ZN11xercesc_2_78XSObject16getNamespaceItemEv(%"class.xercesc_2_7::XSObject"* %this) unnamed_addr #1 align 2 !dbg !1511 {
entry:
  %this.addr = alloca %"class.xercesc_2_7::XSObject"*, align 8
  store %"class.xercesc_2_7::XSObject"* %this, %"class.xercesc_2_7::XSObject"** %this.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.xercesc_2_7::XSObject"** %this.addr, metadata !1512, metadata !DIExpression()), !dbg !1513
  %this1 = load %"class.xercesc_2_7::XSObject"*, %"class.xercesc_2_7::XSObject"** %this.addr, align 8
  ret %"class.xercesc_2_7::XSNamespaceItem"* null, !dbg !1514
}

; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_ZNK11xercesc_2_78XSObject5getIdEv(%"class.xercesc_2_7::XSObject"* %this) unnamed_addr #1 align 2 !dbg !1515 {
entry:
  %this.addr = alloca %"class.xercesc_2_7::XSObject"*, align 8
  store %"class.xercesc_2_7::XSObject"* %this, %"class.xercesc_2_7::XSObject"** %this.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.xercesc_2_7::XSObject"** %this.addr, metadata !1516, metadata !DIExpression()), !dbg !1518
  %this1 = load %"class.xercesc_2_7::XSObject"*, %"class.xercesc_2_7::XSObject"** %this.addr, align 8
  %fId = getelementptr inbounds %"class.xercesc_2_7::XSObject", %"class.xercesc_2_7::XSObject"* %this1, i32 0, i32 5, !dbg !1519
  %0 = load i32, i32* %fId, align 8, !dbg !1519
  ret i32 %0, !dbg !1520
}

; Function Attrs: noinline nounwind uwtable
define dso_local void @_ZN11xercesc_2_78XSObject5setIdEj(%"class.xercesc_2_7::XSObject"* %this, i32 %id) #1 align 2 !dbg !1521 {
entry:
  %this.addr = alloca %"class.xercesc_2_7::XSObject"*, align 8
  %id.addr = alloca i32, align 4
  store %"class.xercesc_2_7::XSObject"* %this, %"class.xercesc_2_7::XSObject"** %this.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.xercesc_2_7::XSObject"** %this.addr, metadata !1522, metadata !DIExpression()), !dbg !1523
  store i32 %id, i32* %id.addr, align 4
  call void @llvm.dbg.declare(metadata i32* %id.addr, metadata !1524, metadata !DIExpression()), !dbg !1525
  %this1 = load %"class.xercesc_2_7::XSObject"*, %"class.xercesc_2_7::XSObject"** %this.addr, align 8
  %0 = load i32, i32* %id.addr, align 4, !dbg !1526
  %fId = getelementptr inbounds %"class.xercesc_2_7::XSObject", %"class.xercesc_2_7::XSObject"* %this1, i32 0, i32 5, !dbg !1527
  store i32 %0, i32* %fId, align 8, !dbg !1528
  ret void, !dbg !1529
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN11xercesc_2_713XMLAttDefListD2Ev(%"class.xercesc_2_7::XMLAttDefList"* %this) unnamed_addr #1 comdat align 2 !dbg !1530 {
entry:
  %this.addr = alloca %"class.xercesc_2_7::XMLAttDefList"*, align 8
  store %"class.xercesc_2_7::XMLAttDefList"* %this, %"class.xercesc_2_7::XMLAttDefList"** %this.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.xercesc_2_7::XMLAttDefList"** %this.addr, metadata !1531, metadata !DIExpression()), !dbg !1532
  %this1 = load %"class.xercesc_2_7::XMLAttDefList"*, %"class.xercesc_2_7::XMLAttDefList"** %this.addr, align 8
  %0 = bitcast %"class.xercesc_2_7::XMLAttDefList"* %this1 to %"class.xercesc_2_7::XSerializable"*, !dbg !1533
  call void @_ZN11xercesc_2_713XSerializableD2Ev(%"class.xercesc_2_7::XSerializable"* %0) #7, !dbg !1533
  ret void, !dbg !1535
}
...
!1 = !DIFile(filename: "XSObject.cpp", directory: "/home/venkat/IF-DV/spec_build_release/CPU_2017/benchspec/CPU/523.xalancbmk_r/build/build_base_ld-loop-ext-m64.0000")
!2 = !{!3, !28}
...
!1273 = distinct !DISubprogram(name: "XSObject", linkageName: "_ZN11xercesc_2_78XSObjectC2ENS_11XSConstants14COMPONENT_TYPEEPNS_7XSModelEPNS_13MemoryManagerE", scope: !1274, file: !1, line: 29, type: !1428, scopeLine: 36, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, declaration: !1427, retainedNodes: !855)
!1274 = distinct !DICompositeType(tag: DW_TAG_class_type, name: "XSObject", scope: !6, file: !1275, line: 41, size: 320, flags: DIFlagTypePassByReference | DIFlagNonTrivial, elements: !1276, vtableHolder: !1274)
!1275 = !DIFile(filename: "./xercesc/framework/psvi/XSObject.hpp", directory: "/home/venkat/IF-DV/spec_build_release/CPU_2017/benchspec/CPU/523.xalancbmk_r/build/build_base_ld-loop-ext-m64.0000")
!1276 = !{!1277, !1278, !1279, !1280, !1425, !1426, !1427, !1432, !1435, !1440, !1443, !1444, !1447, !1450, !1453, !1457}
!1277 = !DIDerivedType(tag: DW_TAG_inheritance, scope: !1274, baseType: !882, flags: DIFlagPublic, extraData: i32 0)
!1278 = !DIDerivedType(tag: DW_TAG_member, name: "_vptr$XSObject", scope: !1275, file: !1275, baseType: !839, size: 64, flags: DIFlagArtificial)
!1279 = !DIDerivedType(tag: DW_TAG_member, name: "fComponentType", scope: !1274, file: !1275, line: 138, baseType: !3, size: 32, offset: 64, flags: DIFlagProtected)
!1280 = !DIDerivedType(tag: DW_TAG_member, name: "fXSModel", scope: !1274, file: !1275, line: 139, baseType: !1281, size: 64, offset: 128, flags: DIFlagProtected)
!1281 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1282, size: 64)
!1282 = distinct !DICompositeType(tag: DW_TAG_class_type, name: "XSModel", scope: !6, file: !1283, line: 58, size: 2432, flags: DIFlagTypePassByReference | DIFlagNonTrivial, elements: !1284, identifier: "_ZTSN11xercesc_2_77XSModelE")
!1283 = !DIFile(filename: "./xercesc/framework/psvi/XSModel.hpp", directory: "/home/venkat/IF-DV/spec_build_release/CPU_2017/benchspec/CPU/523.xalancbmk_r/build/build_base_ld-loop-ext-m64.0000")
!1284 = !{!1285, !1286, !1287, !1292, !1297, !1303, !1308, !1309, !1313, !1316, !1320, !1322, !1323, !1324, !1325, !1329, !1335, !1338, !1341, !1344, !1347, !1350, !1353, !1358, !1363, !1369, !1374, !1379, !1384, !1388, !1391, !1396, !1399, !1402, !1409, !1413, !1416, !1421}
!1285 = !DIDerivedType(tag: DW_TAG_inheritance, scope: !1282, baseType: !882, flags: DIFlagPublic, extraData: i32 0)
!1286 = !DIDerivedType(tag: DW_TAG_member, name: "fMemoryManager", scope: !1282, file: !1283, line: 286, baseType: !1026, size: 64, flags: DIFlagProtected)
!1287 = !DIDerivedType(tag: DW_TAG_member, name: "fNamespaceStringList", scope: !1282, file: !1283, line: 288, baseType: !1288, size: 64, offset: 64, flags: DIFlagProtected)
!1288 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1289, size: 64)
!1289 = !DIDerivedType(tag: DW_TAG_typedef, name: "StringList", scope: !6, file: !4, line: 53, baseType: !1290)
!1290 = !DICompositeType(tag: DW_TAG_class_type, name: "RefArrayVectorOf<unsigned short>", scope: !6, file: !1291, line: 28, flags: DIFlagFwdDecl, identifier: "_ZTSN11xercesc_2_716RefArrayVectorOfItEE")
!1291 = !DIFile(filename: "./xercesc/util/RefArrayVectorOf.hpp", directory: "/home/venkat/IF-DV/spec_build_release/CPU_2017/benchspec/CPU/523.xalancbmk_r/build/build_base_ld-loop-ext-m64.0000")
!1292 = !DIDerivedType(tag: DW_TAG_member, name: "fXSNamespaceItemList", scope: !1282, file: !1283, line: 289, baseType: !1293, size: 64, offset: 128, flags: DIFlagProtected)
!1293 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1294, size: 64)
!1294 = !DIDerivedType(tag: DW_TAG_typedef, name: "XSNamespaceItemList", scope: !6, file: !4, line: 50, baseType: !1295)
!1295 = !DICompositeType(tag: DW_TAG_class_type, name: "RefVectorOf<xercesc_2_7::XSNamespaceItem>", scope: !6, file: !1296, line: 32, flags: DIFlagFwdDecl, identifier: "_ZTSN11xercesc_2_711RefVectorOfINS_15XSNamespaceItemEEE")
!1296 = !DIFile(filename: "./xercesc/util/RefVectorOf.hpp", directory: "/home/venkat/IF-DV/spec_build_release/CPU_2017/benchspec/CPU/523.xalancbmk_r/build/build_base_ld-loop-ext-m64.0000")
!1297 = !DIDerivedType(tag: DW_TAG_member, name: "fIdVector", scope: !1282, file: !1283, line: 291, baseType: !1298, size: 896, offset: 192, flags: DIFlagProtected)
!1298 = !DICompositeType(tag: DW_TAG_array_type, baseType: !1299, size: 896, elements: !1301)
!1299 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1300, size: 64)
!1300 = !DICompositeType(tag: DW_TAG_class_type, name: "RefVectorOf<xercesc_2_7::XSObject>", scope: !6, file: !1296, line: 32, flags: DIFlagFwdDecl, identifier: "_ZTSN11xercesc_2_711RefVectorOfINS_8XSObjectEEE")
!1301 = !{!1302}
!1302 = !DISubrange(count: 14)
!1303 = !DIDerivedType(tag: DW_TAG_member, name: "fComponentMap", scope: !1282, file: !1283, line: 309, baseType: !1304, size: 896, offset: 1088, flags: DIFlagProtected)
!1304 = !DICompositeType(tag: DW_TAG_array_type, baseType: !1305, size: 896, elements: !1301)
!1305 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1306, size: 64)
!1306 = !DICompositeType(tag: DW_TAG_class_type, name: "XSNamedMap<xercesc_2_7::XSObject>", scope: !6, file: !1307, line: 40, flags: DIFlagFwdDecl, identifier: "_ZTSN11xercesc_2_710XSNamedMapINS_8XSObjectEEE")
!1307 = !DIFile(filename: "./xercesc/framework/psvi/XSNamedMap.hpp", directory: "/home/venkat/IF-DV/spec_build_release/CPU_2017/benchspec/CPU/523.xalancbmk_r/build/build_base_ld-loop-ext-m64.0000")
!1308 = !DIDerivedType(tag: DW_TAG_member, name: "fURIStringPool", scope: !1282, file: !1283, line: 310, baseType: !1043, size: 64, offset: 1984, flags: DIFlagProtected)
!1309 = !DIDerivedType(tag: DW_TAG_member, name: "fXSAnnotationList", scope: !1282, file: !1283, line: 311, baseType: !1310, size: 64, offset: 2048, flags: DIFlagProtected)
!1310 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1311, size: 64)
!1311 = !DIDerivedType(tag: DW_TAG_typedef, name: "XSAnnotationList", scope: !6, file: !4, line: 46, baseType: !1312)
!1312 = !DICompositeType(tag: DW_TAG_class_type, name: "RefVectorOf<xercesc_2_7::XSAnnotation>", scope: !6, file: !1296, line: 32, flags: DIFlagFwdDecl, identifier: "_ZTSN11xercesc_2_711RefVectorOfINS_12XSAnnotationEEE")
!1313 = !DIDerivedType(tag: DW_TAG_member, name: "fHashNamespace", scope: !1282, file: !1283, line: 312, baseType: !1314, size: 64, offset: 2112, flags: DIFlagProtected)
!1314 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1315, size: 64)
!1315 = !DICompositeType(tag: DW_TAG_class_type, name: "RefHashTableOf<xercesc_2_7::XSNamespaceItem>", scope: !6, file: !1006, line: 72, flags: DIFlagFwdDecl, identifier: "_ZTSN11xercesc_2_714RefHashTableOfINS_15XSNamespaceItemEEE")
!1316 = !DIDerivedType(tag: DW_TAG_member, name: "fObjFactory", scope: !1282, file: !1283, line: 313, baseType: !1317, size: 64, offset: 2176, flags: DIFlagProtected)
!1317 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1318, size: 64)
!1318 = !DICompositeType(tag: DW_TAG_class_type, name: "XSObjectFactory", scope: !6, file: !1319, line: 368, flags: DIFlagFwdDecl, identifier: "_ZTSN11xercesc_2_715XSObjectFactoryE")
!1319 = !DIFile(filename: "./xercesc/framework/psvi/XSSimpleTypeDefinition.hpp", directory: "/home/venkat/IF-DV/spec_build_release/CPU_2017/benchspec/CPU/523.xalancbmk_r/build/build_base_ld-loop-ext-m64.0000")
!1320 = !DIDerivedType(tag: DW_TAG_member, name: "fDeleteNamespace", scope: !1282, file: !1283, line: 314, baseType: !1321, size: 64, offset: 2240, flags: DIFlagProtected)
!1321 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1295, size: 64)
!1322 = !DIDerivedType(tag: DW_TAG_member, name: "fParent", scope: !1282, file: !1283, line: 315, baseType: !1281, size: 64, offset: 2304, flags: DIFlagProtected)
!1323 = !DIDerivedType(tag: DW_TAG_member, name: "fDeleteParent", scope: !1282, file: !1283, line: 316, baseType: !818, size: 8, offset: 2368, flags: DIFlagProtected)
!1324 = !DIDerivedType(tag: DW_TAG_member, name: "fAddedS4SGrammar", scope: !1282, file: !1283, line: 317, baseType: !818, size: 8, offset: 2376, flags: DIFlagProtected)
!1325 = !DISubprogram(name: "XSModel", scope: !1282, file: !1283, line: 72, type: !1326, scopeLine: 72, flags: DIFlagPublic | DIFlagPrototyped, spFlags: 0)
!1326 = !DISubroutineType(types: !1327)
!1327 = !{null, !1328, !983, !1026}
!1328 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1282, size: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!1329 = !DISubprogram(name: "XSModel", scope: !1282, file: !1283, line: 84, type: !1330, scopeLine: 84, flags: DIFlagPublic | DIFlagPrototyped, spFlags: 0)
!1330 = !DISubroutineType(types: !1331)
!1331 = !{null, !1328, !1281, !1332, !1026}
!1332 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1333, size: 64)
!1333 = !DICompositeType(tag: DW_TAG_class_type, name: "GrammarResolver", scope: !6, file: !1334, line: 31, flags: DIFlagFwdDecl, identifier: "_ZTSN11xercesc_2_715GrammarResolverE")
!1334 = !DIFile(filename: "./xercesc/framework/XMLContentModel.hpp", directory: "/home/venkat/IF-DV/spec_build_release/CPU_2017/benchspec/CPU/523.xalancbmk_r/build/build_base_ld-loop-ext-m64.0000")
!1335 = !DISubprogram(name: "~XSModel", scope: !1282, file: !1283, line: 92, type: !1336, scopeLine: 92, flags: DIFlagPublic | DIFlagPrototyped, spFlags: 0)
!1336 = !DISubroutineType(types: !1337)
!1337 = !{null, !1328}
!1338 = !DISubprogram(name: "getNamespaces", linkageName: "_ZN11xercesc_2_77XSModel13getNamespacesEv", scope: !1282, file: !1283, line: 106, type: !1339, scopeLine: 106, flags: DIFlagPublic | DIFlagPrototyped, spFlags: 0)
!1339 = !DISubroutineType(types: !1340)
!1340 = !{!1288, !1328}
!1341 = !DISubprogram(name: "getNamespaceItems", linkageName: "_ZN11xercesc_2_77XSModel17getNamespaceItemsEv", scope: !1282, file: !1283, line: 116, type: !1342, scopeLine: 116, flags: DIFlagPublic | DIFlagPrototyped, spFlags: 0)
!1342 = !DISubroutineType(types: !1343)
!1343 = !{!1293, !1328}
!1344 = !DISubprogram(name: "getComponents", linkageName: "_ZN11xercesc_2_77XSModel13getComponentsENS_11XSConstants14COMPONENT_TYPEE", scope: !1282, file: !1283, line: 128, type: !1345, scopeLine: 128, flags: DIFlagPublic | DIFlagPrototyped, spFlags: 0)
!1345 = !DISubroutineType(types: !1346)
!1346 = !{!1305, !1328, !3}
!1347 = !DISubprogram(name: "getComponentsByNamespace", linkageName: "_ZN11xercesc_2_77XSModel24getComponentsByNamespaceENS_11XSConstants14COMPONENT_TYPEEPKt", scope: !1282, file: !1283, line: 142, type: !1348, scopeLine: 142, flags: DIFlagPublic | DIFlagPrototyped, spFlags: 0)
!1348 = !DISubroutineType(types: !1349)
!1349 = !{!1305, !1328, !3, !928}
!1350 = !DISubprogram(name: "getAnnotations", linkageName: "_ZN11xercesc_2_77XSModel14getAnnotationsEv", scope: !1282, file: !1283, line: 148, type: !1351, scopeLine: 148, flags: DIFlagPublic | DIFlagPrototyped, spFlags: 0)
!1351 = !DISubroutineType(types: !1352)
!1352 = !{!1310, !1328}
!1353 = !DISubprogram(name: "getElementDeclaration", linkageName: "_ZN11xercesc_2_77XSModel21getElementDeclarationEPKtS2_", scope: !1282, file: !1283, line: 157, type: !1354, scopeLine: 157, flags: DIFlagPublic | DIFlagPrototyped, spFlags: 0)
!1354 = !DISubroutineType(types: !1355)
!1355 = !{!1356, !1328, !928, !928}
!1356 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1357, size: 64)
!1357 = !DICompositeType(tag: DW_TAG_class_type, name: "XSElementDeclaration", scope: !6, file: !1283, line: 51, flags: DIFlagFwdDecl, identifier: "_ZTSN11xercesc_2_720XSElementDeclarationE")
!1358 = !DISubprogram(name: "getAttributeDeclaration", linkageName: "_ZN11xercesc_2_77XSModel23getAttributeDeclarationEPKtS2_", scope: !1282, file: !1283, line: 167, type: !1359, scopeLine: 167, flags: DIFlagPublic | DIFlagPrototyped, spFlags: 0)
!1359 = !DISubroutineType(types: !1360)
!1360 = !{!1361, !1328, !928, !928}
!1361 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1362, size: 64)
!1362 = !DICompositeType(tag: DW_TAG_class_type, name: "XSAttributeDeclaration", scope: !6, file: !1283, line: 49, flags: DIFlagFwdDecl, identifier: "_ZTSN11xercesc_2_722XSAttributeDeclarationE")
!1363 = !DISubprogram(name: "getTypeDefinition", linkageName: "_ZN11xercesc_2_77XSModel17getTypeDefinitionEPKtS2_", scope: !1282, file: !1283, line: 178, type: !1364, scopeLine: 178, flags: DIFlagPublic | DIFlagPrototyped, spFlags: 0)
!1364 = !DISubroutineType(types: !1365)
!1365 = !{!1366, !1328, !928, !928}
!1366 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1367, size: 64)
!1367 = !DICompositeType(tag: DW_TAG_class_type, name: "XSTypeDefinition", scope: !6, file: !1368, line: 38, flags: DIFlagFwdDecl)
!1368 = !DIFile(filename: "./xercesc/framework/psvi/XSTypeDefinition.hpp", directory: "/home/venkat/IF-DV/spec_build_release/CPU_2017/benchspec/CPU/523.xalancbmk_r/build/build_base_ld-loop-ext-m64.0000")
!1369 = !DISubprogram(name: "getAttributeGroup", linkageName: "_ZN11xercesc_2_77XSModel17getAttributeGroupEPKtS2_", scope: !1282, file: !1283, line: 188, type: !1370, scopeLine: 188, flags: DIFlagPublic | DIFlagPrototyped, spFlags: 0)
!1370 = !DISubroutineType(types: !1371)
!1371 = !{!1372, !1328, !928, !928}
!1372 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1373, size: 64)
!1373 = !DICompositeType(tag: DW_TAG_class_type, name: "XSAttributeGroupDefinition", scope: !6, file: !1283, line: 50, flags: DIFlagFwdDecl, identifier: "_ZTSN11xercesc_2_726XSAttributeGroupDefinitionE")
!1374 = !DISubprogram(name: "getModelGroupDefinition", linkageName: "_ZN11xercesc_2_77XSModel23getModelGroupDefinitionEPKtS2_", scope: !1282, file: !1283, line: 198, type: !1375, scopeLine: 198, flags: DIFlagPublic | DIFlagPrototyped, spFlags: 0)
!1375 = !DISubroutineType(types: !1376)
!1376 = !{!1377, !1328, !928, !928}
!1377 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1378, size: 64)
!1378 = !DICompositeType(tag: DW_TAG_class_type, name: "XSModelGroupDefinition", scope: !6, file: !1283, line: 52, flags: DIFlagFwdDecl, identifier: "_ZTSN11xercesc_2_722XSModelGroupDefinitionE")
!1379 = !DISubprogram(name: "getNotationDeclaration", linkageName: "_ZN11xercesc_2_77XSModel22getNotationDeclarationEPKtS2_", scope: !1282, file: !1283, line: 208, type: !1380, scopeLine: 208, flags: DIFlagPublic | DIFlagPrototyped, spFlags: 0)
!1380 = !DISubroutineType(types: !1381)
!1381 = !{!1382, !1328, !928, !928}
!1382 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1383, size: 64)
!1383 = !DICompositeType(tag: DW_TAG_class_type, name: "XSNotationDeclaration", scope: !6, file: !1283, line: 54, flags: DIFlagFwdDecl, identifier: "_ZTSN11xercesc_2_721XSNotationDeclarationE")
!1384 = !DISubprogram(name: "getXSObjectById", linkageName: "_ZN11xercesc_2_77XSModel15getXSObjectByIdEjNS_11XSConstants14COMPONENT_TYPEE", scope: !1282, file: !1283, line: 220, type: !1385, scopeLine: 220, flags: DIFlagPublic | DIFlagPrototyped, spFlags: 0)
!1385 = !DISubroutineType(types: !1386)
!1386 = !{!1387, !1328, !12, !3}
!1387 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1274, size: 64)
!1388 = !DISubprogram(name: "getURIStringPool", linkageName: "_ZN11xercesc_2_77XSModel16getURIStringPoolEv", scope: !1282, file: !1283, line: 229, type: !1389, scopeLine: 229, flags: DIFlagPublic | DIFlagPrototyped, spFlags: 0)
!1389 = !DISubroutineType(types: !1390)
!1390 = !{!1043, !1328}
!1391 = !DISubprogram(name: "getNamespaceItem", linkageName: "_ZN11xercesc_2_77XSModel16getNamespaceItemEPKt", scope: !1282, file: !1283, line: 231, type: !1392, scopeLine: 231, flags: DIFlagPublic | DIFlagPrototyped, spFlags: 0)
!1392 = !DISubroutineType(types: !1393)
!1393 = !{!1394, !1328, !927}
!1394 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1395, size: 64)
!1395 = !DICompositeType(tag: DW_TAG_class_type, name: "XSNamespaceItem", scope: !6, file: !4, line: 38, flags: DIFlagFwdDecl, identifier: "_ZTSN11xercesc_2_715XSNamespaceItemE")
!1396 = !DISubprogram(name: "getXSObject", linkageName: "_ZN11xercesc_2_77XSModel11getXSObjectEPv", scope: !1282, file: !1283, line: 240, type: !1397, scopeLine: 240, flags: DIFlagPublic | DIFlagPrototyped, spFlags: 0)
!1397 = !DISubroutineType(types: !1398)
!1398 = !{!1387, !1328, !494}
!1399 = !DISubprogram(name: "addGrammarToXSModel", linkageName: "_ZN11xercesc_2_77XSModel19addGrammarToXSModelEPNS_15XSNamespaceItemE", scope: !1282, file: !1283, line: 248, type: !1400, scopeLine: 248, flags: DIFlagPrototyped, spFlags: 0)
!1400 = !DISubroutineType(types: !1401)
!1401 = !{null, !1328, !1394}
!1402 = !DISubprogram(name: "addS4SToXSModel", linkageName: "_ZN11xercesc_2_77XSModel15addS4SToXSModelEPNS_15XSNamespaceItemEPNS_14RefHashTableOfINS_17DatatypeValidatorEEE", scope: !1282, file: !1283, line: 252, type: !1403, scopeLine: 252, flags: DIFlagPrototyped, spFlags: 0)
!1403 = !DISubroutineType(types: !1404)
!1404 = !{null, !1328, !1405, !1406}
!1405 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !1394)
!1406 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !1407)
!1407 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1408, size: 64)
!1408 = !DICompositeType(tag: DW_TAG_class_type, name: "RefHashTableOf<xercesc_2_7::DatatypeValidator>", scope: !6, file: !1006, line: 72, flags: DIFlagFwdDecl, identifier: "_ZTSN11xercesc_2_714RefHashTableOfINS_17DatatypeValidatorEEE")
!1409 = !DISubprogram(name: "addComponentToNamespace", linkageName: "_ZN11xercesc_2_77XSModel23addComponentToNamespaceEPNS_15XSNamespaceItemEPNS_8XSObjectEib", scope: !1282, file: !1283, line: 257, type: !1410, scopeLine: 257, flags: DIFlagPrototyped, spFlags: 0)
!1410 = !DISubroutineType(types: !1411)
!1411 = !{null, !1328, !1405, !1412, !450, !818}
!1412 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !1387)
!1413 = !DISubprogram(name: "addComponentToIdVector", linkageName: "_ZN11xercesc_2_77XSModel22addComponentToIdVectorEPNS_8XSObjectEi", scope: !1282, file: !1283, line: 265, type: !1414, scopeLine: 265, flags: DIFlagPrototyped, spFlags: 0)
!1414 = !DISubroutineType(types: !1415)
!1415 = !{null, !1328, !1412, !450}
!1416 = !DISubprogram(name: "XSModel", scope: !1282, file: !1283, line: 274, type: !1417, scopeLine: 274, flags: DIFlagPrototyped, spFlags: 0)
!1417 = !DISubroutineType(types: !1418)
!1418 = !{null, !1328, !1419}
!1419 = !DIDerivedType(tag: DW_TAG_reference_type, baseType: !1420, size: 64)
!1420 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !1282)
!1421 = !DISubprogram(name: "operator=", linkageName: "_ZN11xercesc_2_77XSModelaSERKS0_", scope: !1282, file: !1283, line: 275, type: !1422, scopeLine: 275, flags: DIFlagPrototyped, spFlags: 0)
!1422 = !DISubroutineType(types: !1423)
!1423 = !{!1424, !1328, !1419}
!1424 = !DIDerivedType(tag: DW_TAG_reference_type, baseType: !1282, size: 64)
!1425 = !DIDerivedType(tag: DW_TAG_member, name: "fMemoryManager", scope: !1274, file: !1275, line: 140, baseType: !889, size: 64, offset: 192, flags: DIFlagProtected)
!1426 = !DIDerivedType(tag: DW_TAG_member, name: "fId", scope: !1274, file: !1275, line: 141, baseType: !12, size: 32, offset: 256, flags: DIFlagProtected)
!1427 = !DISubprogram(name: "XSObject", scope: !1274, file: !1275, line: 57, type: !1428, scopeLine: 57, flags: DIFlagPublic | DIFlagPrototyped, spFlags: 0)
!1428 = !DISubroutineType(types: !1429)
!1429 = !{null, !1430, !3, !1431, !1026}
!1430 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1274, size: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!1431 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !1281)
!1432 = !DISubprogram(name: "~XSObject", scope: !1274, file: !1275, line: 68, type: !1433, scopeLine: 68, containingType: !1274, virtualIndex: 0, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagVirtual)
!1433 = !DISubroutineType(types: !1434)
!1434 = !{null, !1430}
!1435 = !DISubprogram(name: "getType", linkageName: "_ZNK11xercesc_2_78XSObject7getTypeEv", scope: !1274, file: !1275, line: 80, type: !1436, scopeLine: 80, flags: DIFlagPublic | DIFlagPrototyped, spFlags: 0)
!1436 = !DISubroutineType(types: !1437)
!1437 = !{!3, !1438}
!1438 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1439, size: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!1439 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !1274)
!1440 = !DISubprogram(name: "getName", linkageName: "_ZN11xercesc_2_78XSObject7getNameEv", scope: !1274, file: !1275, line: 86, type: !1441, scopeLine: 86, containingType: !1274, virtualIndex: 2, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagVirtual)
!1441 = !DISubroutineType(types: !1442)
!1442 = !{!928, !1430}
!1443 = !DISubprogram(name: "getNamespace", linkageName: "_ZN11xercesc_2_78XSObject12getNamespaceEv", scope: !1274, file: !1275, line: 92, type: !1441, scopeLine: 92, containingType: !1274, virtualIndex: 3, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagVirtual)
!1444 = !DISubprogram(name: "getNamespaceItem", linkageName: "_ZN11xercesc_2_78XSObject16getNamespaceItemEv", scope: !1274, file: !1275, line: 99, type: !1445, scopeLine: 99, containingType: !1274, virtualIndex: 4, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagVirtual)
!1445 = !DISubroutineType(types: !1446)
!1446 = !{!1394, !1430}
!1447 = !DISubprogram(name: "getId", linkageName: "_ZNK11xercesc_2_78XSObject5getIdEv", scope: !1274, file: !1275, line: 107, type: !1448, scopeLine: 107, containingType: !1274, virtualIndex: 5, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagVirtual)
!1448 = !DISubroutineType(types: !1449)
!1449 = !{!12, !1438}
!1450 = !DISubprogram(name: "setId", linkageName: "_ZN11xercesc_2_78XSObject5setIdEj", scope: !1274, file: !1275, line: 118, type: !1451, scopeLine: 118, flags: DIFlagPublic | DIFlagPrototyped, spFlags: 0)
!1451 = !DISubroutineType(types: !1452)
!1452 = !{null, !1430, !12}
!1453 = !DISubprogram(name: "XSObject", scope: !1274, file: !1275, line: 126, type: !1454, scopeLine: 126, flags: DIFlagPrototyped, spFlags: 0)
!1454 = !DISubroutineType(types: !1455)
!1455 = !{null, !1430, !1456}
!1456 = !DIDerivedType(tag: DW_TAG_reference_type, baseType: !1439, size: 64)
!1457 = !DISubprogram(name: "operator=", linkageName: "_ZN11xercesc_2_78XSObjectaSERKS0_", scope: !1274, file: !1275, line: 127, type: !1458, scopeLine: 127, flags: DIFlagPrototyped, spFlags: 0)
!1458 = !DISubroutineType(types: !1459)
!1459 = !{!1460, !1430, !1456}
!1460 = !DIDerivedType(tag: DW_TAG_reference_type, baseType: !1274, size: 64)
!1461 = !DILocalVariable(name: "this", arg: 1, scope: !1273, type: !1387, flags: DIFlagArtificial | DIFlagObjectPointer)
!1462 = !DILocation(line: 0, scope: !1273)
!1463 = !DILocalVariable(name: "compType", arg: 2, scope: !1273, file: !1, line: 29, type: !3)
!1464 = !DILocation(line: 29, column: 48, scope: !1273)
!1465 = !DILocalVariable(name: "xsModel", arg: 3, scope: !1273, file: !1, line: 30, type: !1431)
!1466 = !DILocation(line: 30, column: 35, scope: !1273)
!1467 = !DILocalVariable(name: "manager", arg: 4, scope: !1273, file: !1, line: 31, type: !1026)
!1468 = !DILocation(line: 31, column: 41, scope: !1273)
!1469 = !DILocation(line: 36, column: 1, scope: !1273)
!1470 = !DILocation(line: 29, column: 11, scope: !1273)
!1471 = !DILocation(line: 32, column: 7, scope: !1273)
!1472 = !DILocation(line: 32, column: 22, scope: !1273)
!1473 = !DILocation(line: 33, column: 7, scope: !1273)
!1474 = !DILocation(line: 33, column: 16, scope: !1273)
!1475 = !DILocation(line: 34, column: 7, scope: !1273)
!1476 = !DILocation(line: 34, column: 22, scope: !1273)
!1477 = !DILocation(line: 35, column: 7, scope: !1273)
!1478 = !DILocation(line: 37, column: 9, scope: !1479)
!1479 = distinct !DILexicalBlock(scope: !1480, file: !1, line: 37, column: 9)
!1480 = distinct !DILexicalBlock(scope: !1273, file: !1, line: 36, column: 1)
!1481 = !DILocation(line: 37, column: 9, scope: !1480)
!1482 = !DILocation(line: 39, column: 9, scope: !1483)
!1483 = distinct !DILexicalBlock(scope: !1479, file: !1, line: 38, column: 5)
!1484 = !DILocation(line: 39, column: 47, scope: !1483)
!1485 = !DILocation(line: 39, column: 55, scope: !1483)
!1486 = !DILocation(line: 39, column: 18, scope: !1483)
!1487 = !DILocation(line: 40, column: 5, scope: !1483)
!1488 = !DILocation(line: 41, column: 1, scope: !1273)
!1489 = distinct !DISubprogram(name: "XMemory", linkageName: "_ZN11xercesc_2_77XMemoryC2Ev", scope: !882, file: !883, line: 130, type: !903, scopeLine: 131, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, declaration: !902, retainedNodes: !855)
!1490 = !DILocalVariable(name: "this", arg: 1, scope: !1489, type: !1491, flags: DIFlagArtificial | DIFlagObjectPointer)
!1491 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !882, size: 64)
!1492 = !DILocation(line: 0, scope: !1489)
!1493 = !DILocation(line: 132, column: 5, scope: !1489)
!1494 = distinct !DISubprogram(name: "~XSObject", linkageName: "_ZN11xercesc_2_78XSObjectD2Ev", scope: !1274, file: !1, line: 43, type: !1433, scopeLine: 44, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, declaration: !1432, retainedNodes: !855)
!1495 = !DILocalVariable(name: "this", arg: 1, scope: !1494, type: !1387, flags: DIFlagArtificial | DIFlagObjectPointer)
!1496 = !DILocation(line: 0, scope: !1494)
!1497 = !DILocation(line: 45, column: 1, scope: !1494)
!1498 = distinct !DISubprogram(name: "~XSObject", linkageName: "_ZN11xercesc_2_78XSObjectD0Ev", scope: !1274, file: !1, line: 43, type: !1433, scopeLine: 44, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, declaration: !1432, retainedNodes: !855)
!1499 = !DILocalVariable(name: "this", arg: 1, scope: !1498, type: !1387, flags: DIFlagArtificial | DIFlagObjectPointer)
!1500 = !DILocation(line: 0, scope: !1498)
!1501 = !DILocation(line: 44, column: 1, scope: !1498)
!1502 = !DILocation(line: 45, column: 1, scope: !1498)
!1503 = distinct !DISubprogram(name: "getName", linkageName: "_ZN11xercesc_2_78XSObject7getNameEv", scope: !1274, file: !1, line: 50, type: !1441, scopeLine: 51, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, declaration: !1440, retainedNodes: !855)
!1504 = !DILocalVariable(name: "this", arg: 1, scope: !1503, type: !1387, flags: DIFlagArtificial | DIFlagObjectPointer)
!1505 = !DILocation(line: 0, scope: !1503)
!1506 = !DILocation(line: 52, column: 5, scope: !1503)
!1507 = distinct !DISubprogram(name: "getNamespace", linkageName: "_ZN11xercesc_2_78XSObject12getNamespaceEv", scope: !1274, file: !1, line: 55, type: !1441, scopeLine: 56, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, declaration: !1443, retainedNodes: !855)
!1508 = !DILocalVariable(name: "this", arg: 1, scope: !1507, type: !1387, flags: DIFlagArtificial | DIFlagObjectPointer)
!1509 = !DILocation(line: 0, scope: !1507)
!1510 = !DILocation(line: 57, column: 5, scope: !1507)
!1511 = distinct !DISubprogram(name: "getNamespaceItem", linkageName: "_ZN11xercesc_2_78XSObject16getNamespaceItemEv", scope: !1274, file: !1, line: 60, type: !1445, scopeLine: 61, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, declaration: !1444, retainedNodes: !855)
!1512 = !DILocalVariable(name: "this", arg: 1, scope: !1511, type: !1387, flags: DIFlagArtificial | DIFlagObjectPointer)
!1513 = !DILocation(line: 0, scope: !1511)
!1514 = !DILocation(line: 62, column: 5, scope: !1511)
!1515 = distinct !DISubprogram(name: "getId", linkageName: "_ZNK11xercesc_2_78XSObject5getIdEv", scope: !1274, file: !1, line: 65, type: !1448, scopeLine: 66, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, declaration: !1447, retainedNodes: !855)
!1516 = !DILocalVariable(name: "this", arg: 1, scope: !1515, type: !1517, flags: DIFlagArtificial | DIFlagObjectPointer)
!1517 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1439, size: 64)
!1518 = !DILocation(line: 0, scope: !1515)
!1519 = !DILocation(line: 67, column: 12, scope: !1515)
!1520 = !DILocation(line: 67, column: 5, scope: !1515)
!1521 = distinct !DISubprogram(name: "setId", linkageName: "_ZN11xercesc_2_78XSObject5setIdEj", scope: !1274, file: !1, line: 70, type: !1451, scopeLine: 71, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, declaration: !1450, retainedNodes: !855)
!1522 = !DILocalVariable(name: "this", arg: 1, scope: !1521, type: !1387, flags: DIFlagArtificial | DIFlagObjectPointer)
!1523 = !DILocation(line: 0, scope: !1521)
!1524 = !DILocalVariable(name: "id", arg: 2, scope: !1521, file: !1, line: 70, type: !12)
!1525 = !DILocation(line: 70, column: 35, scope: !1521)
!1526 = !DILocation(line: 72, column: 11, scope: !1521)
!1527 = !DILocation(line: 72, column: 5, scope: !1521)
!1528 = !DILocation(line: 72, column: 9, scope: !1521)
!1529 = !DILocation(line: 73, column: 1, scope: !1521)
!1530 = distinct !DISubprogram(name: "~XMLAttDefList", linkageName: "_ZN11xercesc_2_713XMLAttDefListD2Ev", scope: !878, file: !877, line: 169, type: !911, scopeLine: 170, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, declaration: !910, retainedNodes: !855)
!1531 = !DILocalVariable(name: "this", arg: 1, scope: !1530, type: !1270, flags: DIFlagArtificial | DIFlagObjectPointer)
!1532 = !DILocation(line: 0, scope: !1530)
!1533 = !DILocation(line: 171, column: 1, scope: !1534)
!1534 = distinct !DILexicalBlock(scope: !1530, file: !877, line: 170, column: 1)
!1535 = !DILocation(line: 171, column: 1, scope: !1530)
