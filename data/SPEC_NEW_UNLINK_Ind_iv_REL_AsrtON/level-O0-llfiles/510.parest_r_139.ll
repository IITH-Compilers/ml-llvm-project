...
%"class.dealii::internal::DoFHandler::DoFObjects.16" = type { %"class.std::vector" }
%"class.dealii::internal::DoFHandler::DoFObjects.17" = type { %"class.std::vector" }
...
; Function Attrs: noinline uwtable
define weak_odr dso_local i32 @_ZNK6dealii8internal10DoFHandler10DoFObjectsILi1EE18memory_consumptionEv(%"class.dealii::internal::DoFHandler::DoFObjects"* %this) #0 comdat align 2 !dbg !1622 {
entry:
  ...
  call void @llvm.dbg.declare(metadata %"class.dealii::internal::DoFHandler::DoFObjects"** %this.addr, metadata !2109, metadata !DIExpression()), !dbg !2111
  %this1 = load %"class.dealii::internal::DoFHandler::DoFObjects"*, %"class.dealii::internal::DoFHandler::DoFObjects"** %this.addr, align 8
  %dofs = getelementptr inbounds %"class.dealii::internal::DoFHandler::DoFObjects", %"class.dealii::internal::DoFHandler::DoFObjects"* %this1, i32 0, i32 0, !dbg !2112
  %call = call i32 @_ZN6dealii17MemoryConsumption18memory_consumptionIjEEjRKSt6vectorIT_SaIS3_EE(%"class.std::vector"* dereferenceable(24) %dofs), !dbg !2113
...
; Function Attrs: noinline uwtable
define linkonce_odr dso_local i32 @_ZN6dealii17MemoryConsumption18memory_consumptionIjEEjRKSt6vectorIT_SaIS3_EE(%"class.std::vector"* dereferenceable(24) %v) #0 comdat !dbg !2115 {
entry:
  ...
  call void @llvm.dbg.declare(metadata %"class.std::vector"** %v.addr, metadata !2122, metadata !DIExpression()), !dbg !2123
  call void @llvm.dbg.declare(metadata i32* %mem, metadata !2124, metadata !DIExpression()), !dbg !2125
  store i32 24, i32* %mem, align 4, !dbg !2125
  call void @llvm.dbg.declare(metadata i32* %n, metadata !2126, metadata !DIExpression()), !dbg !2127
  %0 = load %"class.std::vector"*, %"class.std::vector"** %v.addr, align 8, !dbg !2128
  %call = call i64 @_ZNKSt6vectorIjSaIjEE4sizeEv(%"class.std::vector"* %0) #4, !dbg !2129
  %conv = trunc i64 %call to i32, !dbg !2128
  store i32 %conv, i32* %n, align 4, !dbg !2127
  call void @llvm.dbg.declare(metadata i32* %i, metadata !2130, metadata !DIExpression()), !dbg !2132
  store i32 0, i32* %i, align 4, !dbg !2132
  br label %for.cond, !dbg !2133

for.cond:                                         ; preds = %for.inc, %entry
  %1 = load i32, i32* %i, align 4, !dbg !2134
  %2 = load i32, i32* %n, align 4, !dbg !2136
  %cmp = icmp ult i32 %1, %2, !dbg !2137
  br i1 %cmp, label %for.body, label %for.end, !dbg !2138

for.body:                                         ; preds = %for.cond
  %3 = load %"class.std::vector"*, %"class.std::vector"** %v.addr, align 8, !dbg !2139
  %4 = load i32, i32* %i, align 4, !dbg !2140
  %conv1 = zext i32 %4 to i64, !dbg !2140
  %call2 = call dereferenceable(4) i32* @_ZNKSt6vectorIjSaIjEEixEm(%"class.std::vector"* %3, i64 %conv1) #4, !dbg !2139
  %5 = load i32, i32* %call2, align 4, !dbg !2139
  %call3 = call i32 @_ZN6dealii17MemoryConsumption18memory_consumptionEj(i32 %5), !dbg !2141
  %6 = load i32, i32* %mem, align 4, !dbg !2142
  %add = add i32 %6, %call3, !dbg !2142
  store i32 %add, i32* %mem, align 4, !dbg !2142
  br label %for.inc, !dbg !2143

for.inc:                                          ; preds = %for.body
  %7 = load i32, i32* %i, align 4, !dbg !2144
  %inc = add i32 %7, 1, !dbg !2144
  store i32 %inc, i32* %i, align 4, !dbg !2144
  br label %for.cond, !dbg !2145, !llvm.loop !2146

for.end:                                          ; preds = %for.cond
  %8 = load %"class.std::vector"*, %"class.std::vector"** %v.addr, align 8, !dbg !2148
  %call4 = call i64 @_ZNKSt6vectorIjSaIjEE8capacityEv(%"class.std::vector"* %8) #4, !dbg !2149
  %9 = load i32, i32* %n, align 4, !dbg !2150
  %conv5 = zext i32 %9 to i64, !dbg !2150
  %sub = sub i64 %call4, %conv5, !dbg !2151
  %mul = mul i64 %sub, 4, !dbg !2152
  %10 = load i32, i32* %mem, align 4, !dbg !2153
  %conv6 = zext i32 %10 to i64, !dbg !2153
  %add7 = add i64 %conv6, %mul, !dbg !2153
  %conv8 = trunc i64 %add7 to i32, !dbg !2153
  store i32 %conv8, i32* %mem, align 4, !dbg !2153
  %11 = load i32, i32* %mem, align 4, !dbg !2154
  ret i32 %11, !dbg !2155
}

; Function Attrs: noinline uwtable
define weak_odr dso_local i32 @_ZNK6dealii8internal10DoFHandler10DoFObjectsILi2EE18memory_consumptionEv(%"class.dealii::internal::DoFHandler::DoFObjects.16"* %this) #0 comdat align 2 !dbg !2156 {
entry:
  %this.addr = alloca %"class.dealii::internal::DoFHandler::DoFObjects.16"*, align 8
  store %"class.dealii::internal::DoFHandler::DoFObjects.16"* %this, %"class.dealii::internal::DoFHandler::DoFObjects.16"** %this.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.dealii::internal::DoFHandler::DoFObjects.16"** %this.addr, metadata !2167, metadata !DIExpression()), !dbg !2169
  %this1 = load %"class.dealii::internal::DoFHandler::DoFObjects.16"*, %"class.dealii::internal::DoFHandler::DoFObjects.16"** %this.addr, align 8
  %dofs = getelementptr inbounds %"class.dealii::internal::DoFHandler::DoFObjects.16", %"class.dealii::internal::DoFHandler::DoFObjects.16"* %this1, i32 0, i32 0, !dbg !2170
  %call = call i32 @_ZN6dealii17MemoryConsumption18memory_consumptionIjEEjRKSt6vectorIT_SaIS3_EE(%"class.std::vector"* dereferenceable(24) %dofs), !dbg !2171
  ret i32 %call, !dbg !2172
}

; Function Attrs: noinline uwtable
define weak_odr dso_local i32 @_ZNK6dealii8internal10DoFHandler10DoFObjectsILi3EE18memory_consumptionEv(%"class.dealii::internal::DoFHandler::DoFObjects.17"* %this) #0 comdat align 2 !dbg !2173 {
entry:
  %this.addr = alloca %"class.dealii::internal::DoFHandler::DoFObjects.17"*, align 8
  store %"class.dealii::internal::DoFHandler::DoFObjects.17"* %this, %"class.dealii::internal::DoFHandler::DoFObjects.17"** %this.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.dealii::internal::DoFHandler::DoFObjects.17"** %this.addr, metadata !2184, metadata !DIExpression()), !dbg !2186
  %this1 = load %"class.dealii::internal::DoFHandler::DoFObjects.17"*, %"class.dealii::internal::DoFHandler::DoFObjects.17"** %this.addr, align 8
  %dofs = getelementptr inbounds %"class.dealii::internal::DoFHandler::DoFObjects.17", %"class.dealii::internal::DoFHandler::DoFObjects.17"* %this1, i32 0, i32 0, !dbg !2187
  %call = call i32 @_ZN6dealii17MemoryConsumption18memory_consumptionIjEEjRKSt6vectorIT_SaIS3_EE(%"class.std::vector"* dereferenceable(24) %dofs), !dbg !2188
  ret i32 %call, !dbg !2189
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local i64 @_ZNKSt6vectorIjSaIjEE4sizeEv(%"class.std::vector"* %this) #1 comdat align 2 !dbg !2190 {
entry:
  %this.addr = alloca %"class.std::vector"*, align 8
  store %"class.std::vector"* %this, %"class.std::vector"** %this.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.std::vector"** %this.addr, metadata !2191, metadata !DIExpression()), !dbg !2193
  %this1 = load %"class.std::vector"*, %"class.std::vector"** %this.addr, align 8
  %0 = bitcast %"class.std::vector"* %this1 to %"struct.std::_Vector_base"*, !dbg !2194
  %_M_impl = getelementptr inbounds %"struct.std::_Vector_base", %"struct.std::_Vector_base"* %0, i32 0, i32 0, !dbg !2194
  %1 = bitcast %"struct.std::_Vector_base<unsigned int, std::allocator<unsigned int> >::_Vector_impl"* %_M_impl to %"struct.std::_Vector_base<unsigned int, std::allocator<unsigned int> >::_Vector_impl_data"*, !dbg !2195
  %_M_finish = getelementptr inbounds %"struct.std::_Vector_base<unsigned int, std::allocator<unsigned int> >::_Vector_impl_data", %"struct.std::_Vector_base<unsigned int, std::allocator<unsigned int> >::_Vector_impl_data"* %1, i32 0, i32 1, !dbg !2196
  %2 = load i32*, i32** %_M_finish, align 8, !dbg !2196
  %3 = bitcast %"class.std::vector"* %this1 to %"struct.std::_Vector_base"*, !dbg !2197
  %_M_impl2 = getelementptr inbounds %"struct.std::_Vector_base", %"struct.std::_Vector_base"* %3, i32 0, i32 0, !dbg !2197
  %4 = bitcast %"struct.std::_Vector_base<unsigned int, std::allocator<unsigned int> >::_Vector_impl"* %_M_impl2 to %"struct.std::_Vector_base<unsigned int, std::allocator<unsigned int> >::_Vector_impl_data"*, !dbg !2198
  %_M_start = getelementptr inbounds %"struct.std::_Vector_base<unsigned int, std::allocator<unsigned int> >::_Vector_impl_data", %"struct.std::_Vector_base<unsigned int, std::allocator<unsigned int> >::_Vector_impl_data"* %4, i32 0, i32 0, !dbg !2199
  %5 = load i32*, i32** %_M_start, align 8, !dbg !2199
  %sub.ptr.lhs.cast = ptrtoint i32* %2 to i64, !dbg !2200
  %sub.ptr.rhs.cast = ptrtoint i32* %5 to i64, !dbg !2200
  %sub.ptr.sub = sub i64 %sub.ptr.lhs.cast, %sub.ptr.rhs.cast, !dbg !2200
  %sub.ptr.div = sdiv exact i64 %sub.ptr.sub, 4, !dbg !2200
  ret i64 %sub.ptr.div, !dbg !2201
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local i32 @_ZN6dealii17MemoryConsumption18memory_consumptionEj(i32 %0) #1 comdat !dbg !2202 {
entry:
  %.addr = alloca i32, align 4
  store i32 %0, i32* %.addr, align 4
  call void @llvm.dbg.declare(metadata i32* %.addr, metadata !2205, metadata !DIExpression()), !dbg !2206
  ret i32 4, !dbg !2207
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local dereferenceable(4) i32* @_ZNKSt6vectorIjSaIjEEixEm(%"class.std::vector"* %this, i64 %__n) #1 comdat align 2 !dbg !2208 {
entry:
  %this.addr = alloca %"class.std::vector"*, align 8
  %__n.addr = alloca i64, align 8
  store %"class.std::vector"* %this, %"class.std::vector"** %this.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.std::vector"** %this.addr, metadata !2209, metadata !DIExpression()), !dbg !2210
  store i64 %__n, i64* %__n.addr, align 8
  call void @llvm.dbg.declare(metadata i64* %__n.addr, metadata !2211, metadata !DIExpression()), !dbg !2212
  %this1 = load %"class.std::vector"*, %"class.std::vector"** %this.addr, align 8
  ...
  %1 = bitcast %"struct.std::_Vector_base<unsigned int, std::allocator<unsigned int> >::_Vector_impl"* %_M_impl to %"struct.std::_Vector_base<unsigned int, std::allocator<unsigned int> >::_Vector_impl_data"*, !dbg !2214
  %_M_start = getelementptr inbounds %"struct.std::_Vector_base<unsigned int, std::allocator<unsigned int> >::_Vector_impl_data", %"struct.std::_Vector_base<unsigned int, std::allocator<unsigned int> >::_Vector_impl_data"* %1, i32 0, i32 0, !dbg !2215
  %2 = load i32*, i32** %_M_start, align 8, !dbg !2215
  %3 = load i64, i64* %__n.addr, align 8, !dbg !2216
  %add.ptr = getelementptr inbounds i32, i32* %2, i64 %3, !dbg !2217
  ret i32* %add.ptr, !dbg !2218
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local i64 @_ZNKSt6vectorIjSaIjEE8capacityEv(%"class.std::vector"* %this) #1 comdat align 2 !dbg !2219 {
entry:
  %this.addr = alloca %"class.std::vector"*, align 8
  store %"class.std::vector"* %this, %"class.std::vector"** %this.addr, align 8
  ...
  %_M_impl = getelementptr inbounds %"struct.std::_Vector_base", %"struct.std::_Vector_base"* %0, i32 0, i32 0, !dbg !2222
  %1 = bitcast %"struct.std::_Vector_base<unsigned int, std::allocator<unsigned int> >::_Vector_impl"* %_M_impl to %"struct.std::_Vector_base<unsigned int, std::allocator<unsigned int> >::_Vector_impl_data"*, !dbg !2223
  %_M_end_of_storage = getelementptr inbounds %"struct.std::_Vector_base<unsigned int, std::allocator<unsigned int> >::_Vector_impl_data", %"struct.std::_Vector_base<unsigned int, std::allocator<unsigned int> >::_Vector_impl_data"* %1, i32 0, i32 2, !dbg !2224
  %2 = load i32*, i32** %_M_end_of_storage, align 8, !dbg !2224
  %3 = bitcast %"class.std::vector"* %this1 to %"struct.std::_Vector_base"*, !dbg !2225
  %_M_impl2 = getelementptr inbounds %"struct.std::_Vector_base", %"struct.std::_Vector_base"* %3, i32 0, i32 0, !dbg !2225
  %4 = bitcast %"struct.std::_Vector_base<unsigned int, std::allocator<unsigned int> >::_Vector_impl"* %_M_impl2 to %"struct.std::_Vector_base<unsigned int, std::allocator<unsigned int> >::_Vector_impl_data"*, !dbg !2226
  %_M_start = getelementptr inbounds %"struct.std::_Vector_base<unsigned int, std::allocator<unsigned int> >::_Vector_impl_data", %"struct.std::_Vector_base<unsigned int, std::allocator<unsigned int> >::_Vector_impl_data"* %4, i32 0, i32 0, !dbg !2227
  %5 = load i32*, i32** %_M_start, align 8, !dbg !2227
  %sub.ptr.lhs.cast = ptrtoint i32* %2 to i64, !dbg !2228
  %sub.ptr.rhs.cast = ptrtoint i32* %5 to i64, !dbg !2228
  %sub.ptr.sub = sub i64 %sub.ptr.lhs.cast, %sub.ptr.rhs.cast, !dbg !2228
  %sub.ptr.div = sdiv exact i64 %sub.ptr.sub, 4, !dbg !2228
  ret i64 %sub.ptr.div, !dbg !2229
}

; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_dof_objects.all_dimensions.cc() #0 section ".text.startup" !dbg !2230 {
entry:
  call void @__cxx_global_var_init(), !dbg !2232
  call void @__cxx_global_var_init.1(), !dbg !2232
  call void @__cxx_global_var_init.2(), !dbg !2232
  call void @__cxx_global_var_init.3(), !dbg !2232
  call void @__cxx_global_var_init.4(), !dbg !2232
  call void @__cxx_global_var_init.5(), !dbg !2232
  call void @__cxx_global_var_init.6(), !dbg !2232
  call void @__cxx_global_var_init.7(), !dbg !2232
  call void @__cxx_global_var_init.8(), !dbg !2232
  call void @__cxx_global_var_init.9(), !dbg !2232
  ret void
}
...
!123 = !DIFile(filename: "source/dofs/dof_objects.all_dimensions.cc", directory: "/home/venkat/IF-DV/spec_build_release/CPU_2017/benchspec/CPU/510.parest_r/build/build_base_ld-loop-ext-m64.0000")
!124 = !{!125}
...
!1373 = !DIImportedEntity(tag: DW_TAG_imported_declaration, scope: !97, entity: !125, file: !1374, line: 89)
!1374 = !DIFile(filename: "/usr/lib/gcc/x86_64-linux-gnu/10/../../../../include/c++/10/bits/shared_ptr_base.h", directory: "")
!1375 = !DIImportedEntity(tag: DW_TAG_imported_declaration, scope: !97, entity: !1376, file: !1374, line: 90)
!1376 = !DIGlobalVariable(name: "__default_lock_policy", linkageName: "_ZN9__gnu_cxxL21__default_lock_policyE", scope: !127, file: !126, line: 53, type: !1377, isLocal: true, isDefinition: false)
!1377 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !125)
!1378 = !DIImportedEntity(tag: DW_TAG_imported_declaration, scope: !97, entity: !1379, file: !1382, line: 58)
...
!1622 = distinct !DISubprogram(name: "memory_consumption", linkageName: "_ZNK6dealii8internal10DoFHandler10DoFObjectsILi1EE18memory_consumptionEv", scope: !1623, file: !123, line: 29, type: !2103, scopeLine: 30, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !122, declaration: !2102, retainedNodes: !1557)
!1623 = distinct !DICompositeType(tag: DW_TAG_class_type, name: "DoFObjects<1>", scope: !1625, file: !1624, line: 60, size: 192, flags: DIFlagTypePassByReference | DIFlagNonTrivial, elements: !1627, templateParams: !2107, identifier: "_ZTSN6dealii8internal10DoFHandler10DoFObjectsILi1EEE")
!1624 = !DIFile(filename: "include/dofs/dof_objects.h", directory: "/home/venkat/IF-DV/spec_build_release/CPU_2017/benchspec/CPU/510.parest_r/build/build_base_ld-loop-ext-m64.0000")
!1625 = !DINamespace(name: "DoFHandler", scope: !1626)
!1626 = !DINamespace(name: "internal", scope: !1367)
!1627 = !{!1628, !2102}
!1628 = !DIDerivedType(tag: DW_TAG_member, name: "dofs", scope: !1623, file: !1624, line: 67, baseType: !1629, size: 192, flags: DIFlagPublic)
...
!2102 = !DISubprogram(name: "memory_consumption", linkageName: "_ZNK6dealii8internal10DoFHandler10DoFObjectsILi1EE18memory_consumptionEv", scope: !1623, file: !1624, line: 167, type: !2103, scopeLine: 167, flags: DIFlagPublic | DIFlagPrototyped, spFlags: 0)
!2103 = !DISubroutineType(types: !2104)
!2104 = !{!128, !2105}
!2105 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !2106, size: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!2106 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !1623)
!2107 = !{!2108}
!2108 = !DITemplateValueParameter(name: "dim", type: !14, value: i32 1)
!2109 = !DILocalVariable(name: "this", arg: 1, scope: !1622, type: !2110, flags: DIFlagArtificial | DIFlagObjectPointer)
!2110 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !2106, size: 64)
!2111 = !DILocation(line: 0, scope: !1622)
!2112 = !DILocation(line: 31, column: 54, scope: !1622)
!2113 = !DILocation(line: 31, column: 15, scope: !1622)
!2114 = !DILocation(line: 31, column: 7, scope: !1622)
!2115 = distinct !DISubprogram(name: "memory_consumption<unsigned int>", linkageName: "_ZN6dealii17MemoryConsumption18memory_consumptionIjEEjRKSt6vectorIT_SaIS3_EE", scope: !2117, file: !2116, line: 479, type: !2118, scopeLine: 480, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !122, templateParams: !2120, retainedNodes: !1557)
!2116 = !DIFile(filename: "include/base/memory_consumption.h", directory: "/home/venkat/IF-DV/spec_build_release/CPU_2017/benchspec/CPU/510.parest_r/build/build_base_ld-loop-ext-m64.0000")
!2117 = !DINamespace(name: "MemoryConsumption", scope: !1367)
!2118 = !DISubroutineType(types: !2119)
!2119 = !{!128, !1915}
!2120 = !{!2121}
!2121 = !DITemplateTypeParameter(name: "T", type: !128)
!2122 = !DILocalVariable(name: "v", arg: 1, scope: !2115, file: !2116, line: 479, type: !1915)
!2123 = !DILocation(line: 479, column: 58, scope: !2115)
!2124 = !DILocalVariable(name: "mem", scope: !2115, file: !2116, line: 481, type: !128)
!2125 = !DILocation(line: 481, column: 18, scope: !2115)
!2126 = !DILocalVariable(name: "n", scope: !2115, file: !2116, line: 482, type: !1686)
!2127 = !DILocation(line: 482, column: 24, scope: !2115)
!2128 = !DILocation(line: 482, column: 28, scope: !2115)
!2129 = !DILocation(line: 482, column: 30, scope: !2115)
!2130 = !DILocalVariable(name: "i", scope: !2131, file: !2116, line: 483, type: !128)
!2131 = distinct !DILexicalBlock(scope: !2115, file: !2116, line: 483, column: 5)
!2132 = !DILocation(line: 483, column: 23, scope: !2131)
!2133 = !DILocation(line: 483, column: 10, scope: !2131)
!2134 = !DILocation(line: 483, column: 28, scope: !2135)
!2135 = distinct !DILexicalBlock(scope: !2131, file: !2116, line: 483, column: 5)
!2136 = !DILocation(line: 483, column: 30, scope: !2135)
!2137 = !DILocation(line: 483, column: 29, scope: !2135)
!2138 = !DILocation(line: 483, column: 5, scope: !2131)
!2139 = !DILocation(line: 484, column: 33, scope: !2135)
!2140 = !DILocation(line: 484, column: 35, scope: !2135)
!2141 = !DILocation(line: 484, column: 14, scope: !2135)
!2142 = !DILocation(line: 484, column: 11, scope: !2135)
!2143 = !DILocation(line: 484, column: 7, scope: !2135)
!2144 = !DILocation(line: 483, column: 33, scope: !2135)
!2145 = !DILocation(line: 483, column: 5, scope: !2135)
!2146 = distinct !{!2146, !2138, !2147}
!2147 = !DILocation(line: 484, column: 37, scope: !2131)
!2148 = !DILocation(line: 485, column: 13, scope: !2115)
!2149 = !DILocation(line: 485, column: 15, scope: !2115)
!2150 = !DILocation(line: 485, column: 28, scope: !2115)
!2151 = !DILocation(line: 485, column: 26, scope: !2115)
!2152 = !DILocation(line: 485, column: 30, scope: !2115)
!2153 = !DILocation(line: 485, column: 9, scope: !2115)
!2154 = !DILocation(line: 486, column: 12, scope: !2115)
!2155 = !DILocation(line: 486, column: 5, scope: !2115)
!2156 = distinct !DISubprogram(name: "memory_consumption", linkageName: "_ZNK6dealii8internal10DoFHandler10DoFObjectsILi2EE18memory_consumptionEv", scope: !2157, file: !123, line: 29, type: !2161, scopeLine: 30, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !122, declaration: !2160, retainedNodes: !1557)
!2157 = distinct !DICompositeType(tag: DW_TAG_class_type, name: "DoFObjects<2>", scope: !1625, file: !1624, line: 60, size: 192, flags: DIFlagTypePassByReference | DIFlagNonTrivial, elements: !2158, templateParams: !2165, identifier: "_ZTSN6dealii8internal10DoFHandler10DoFObjectsILi2EEE")
!2158 = !{!2159, !2160}
!2159 = !DIDerivedType(tag: DW_TAG_member, name: "dofs", scope: !2157, file: !1624, line: 67, baseType: !1629, size: 192, flags: DIFlagPublic)
!2160 = !DISubprogram(name: "memory_consumption", linkageName: "_ZNK6dealii8internal10DoFHandler10DoFObjectsILi2EE18memory_consumptionEv", scope: !2157, file: !1624, line: 167, type: !2161, scopeLine: 167, flags: DIFlagPublic | DIFlagPrototyped, spFlags: 0)
!2161 = !DISubroutineType(types: !2162)
!2162 = !{!128, !2163}
!2163 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !2164, size: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!2164 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !2157)
!2165 = !{!2166}
!2166 = !DITemplateValueParameter(name: "dim", type: !14, value: i32 2)
!2167 = !DILocalVariable(name: "this", arg: 1, scope: !2156, type: !2168, flags: DIFlagArtificial | DIFlagObjectPointer)
!2168 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !2164, size: 64)
!2169 = !DILocation(line: 0, scope: !2156)
!2170 = !DILocation(line: 31, column: 54, scope: !2156)
!2171 = !DILocation(line: 31, column: 15, scope: !2156)
!2172 = !DILocation(line: 31, column: 7, scope: !2156)
!2173 = distinct !DISubprogram(name: "memory_consumption", linkageName: "_ZNK6dealii8internal10DoFHandler10DoFObjectsILi3EE18memory_consumptionEv", scope: !2174, file: !123, line: 29, type: !2178, scopeLine: 30, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !122, declaration: !2177, retainedNodes: !1557)
!2174 = distinct !DICompositeType(tag: DW_TAG_class_type, name: "DoFObjects<3>", scope: !1625, file: !1624, line: 60, size: 192, flags: DIFlagTypePassByReference | DIFlagNonTrivial, elements: !2175, templateParams: !2182, identifier: "_ZTSN6dealii8internal10DoFHandler10DoFObjectsILi3EEE")
!2175 = !{!2176, !2177}
!2176 = !DIDerivedType(tag: DW_TAG_member, name: "dofs", scope: !2174, file: !1624, line: 67, baseType: !1629, size: 192, flags: DIFlagPublic)
!2177 = !DISubprogram(name: "memory_consumption", linkageName: "_ZNK6dealii8internal10DoFHandler10DoFObjectsILi3EE18memory_consumptionEv", scope: !2174, file: !1624, line: 167, type: !2178, scopeLine: 167, flags: DIFlagPublic | DIFlagPrototyped, spFlags: 0)
!2178 = !DISubroutineType(types: !2179)
!2179 = !{!128, !2180}
!2180 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !2181, size: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!2181 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !2174)
!2182 = !{!2183}
!2183 = !DITemplateValueParameter(name: "dim", type: !14, value: i32 3)
!2184 = !DILocalVariable(name: "this", arg: 1, scope: !2173, type: !2185, flags: DIFlagArtificial | DIFlagObjectPointer)
!2185 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !2181, size: 64)
!2186 = !DILocation(line: 0, scope: !2173)
!2187 = !DILocation(line: 31, column: 54, scope: !2173)
!2188 = !DILocation(line: 31, column: 15, scope: !2173)
!2189 = !DILocation(line: 31, column: 7, scope: !2173)
!2190 = distinct !DISubprogram(name: "size", linkageName: "_ZNKSt6vectorIjSaIjEE4sizeEv", scope: !1629, file: !135, line: 918, type: !1986, scopeLine: 919, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !122, declaration: !1985, retainedNodes: !1557)
!2191 = !DILocalVariable(name: "this", arg: 1, scope: !2190, type: !2192, flags: DIFlagArtificial | DIFlagObjectPointer)
!2192 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1916, size: 64)
!2193 = !DILocation(line: 0, scope: !2190)
!2194 = !DILocation(line: 919, column: 32, scope: !2190)
!2195 = !DILocation(line: 919, column: 26, scope: !2190)
!2196 = !DILocation(line: 919, column: 40, scope: !2190)
!2197 = !DILocation(line: 919, column: 58, scope: !2190)
!2198 = !DILocation(line: 919, column: 52, scope: !2190)
!2199 = !DILocation(line: 919, column: 66, scope: !2190)
!2200 = !DILocation(line: 919, column: 50, scope: !2190)
!2201 = !DILocation(line: 919, column: 9, scope: !2190)
!2202 = distinct !DISubprogram(name: "memory_consumption", linkageName: "_ZN6dealii17MemoryConsumption18memory_consumptionEj", scope: !2117, file: !2116, line: 447, type: !2203, scopeLine: 448, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !122, retainedNodes: !1557)
!2203 = !DISubroutineType(types: !2204)
!2204 = !{!128, !1686}
!2205 = !DILocalVariable(arg: 1, scope: !2202, file: !2116, line: 447, type: !1686)
!2206 = !DILocation(line: 447, column: 54, scope: !2202)
!2207 = !DILocation(line: 449, column: 5, scope: !2202)
!2208 = distinct !DISubprogram(name: "operator[]", linkageName: "_ZNKSt6vectorIjSaIjEEixEm", scope: !1629, file: !135, line: 1061, type: !2008, scopeLine: 1062, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !122, declaration: !2007, retainedNodes: !1557)
!2209 = !DILocalVariable(name: "this", arg: 1, scope: !2208, type: !2192, flags: DIFlagArtificial | DIFlagObjectPointer)
!2210 = !DILocation(line: 0, scope: !2208)
!2211 = !DILocalVariable(name: "__n", arg: 2, scope: !2208, file: !135, line: 1061, type: !134)
!2212 = !DILocation(line: 1061, column: 28, scope: !2208)
!2213 = !DILocation(line: 1064, column: 17, scope: !2208)
!2214 = !DILocation(line: 1064, column: 11, scope: !2208)
!2215 = !DILocation(line: 1064, column: 25, scope: !2208)
!2216 = !DILocation(line: 1064, column: 36, scope: !2208)
!2217 = !DILocation(line: 1064, column: 34, scope: !2208)
!2218 = !DILocation(line: 1064, column: 2, scope: !2208)
!2219 = distinct !DISubprogram(name: "capacity", linkageName: "_ZNKSt6vectorIjSaIjEE8capacityEv", scope: !1629, file: !135, line: 998, type: !1986, scopeLine: 999, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !122, declaration: !1994, retainedNodes: !1557)
!2220 = !DILocalVariable(name: "this", arg: 1, scope: !2219, type: !2192, flags: DIFlagArtificial | DIFlagObjectPointer)
!2221 = !DILocation(line: 0, scope: !2219)
!2222 = !DILocation(line: 999, column: 32, scope: !2219)
!2223 = !DILocation(line: 999, column: 26, scope: !2219)
!2224 = !DILocation(line: 999, column: 40, scope: !2219)
!2225 = !DILocation(line: 1000, column: 13, scope: !2219)
!2226 = !DILocation(line: 1000, column: 7, scope: !2219)
!2227 = !DILocation(line: 1000, column: 21, scope: !2219)
!2228 = !DILocation(line: 1000, column: 5, scope: !2219)
!2229 = !DILocation(line: 999, column: 9, scope: !2219)
!2230 = distinct !DISubprogram(linkageName: "_GLOBAL__sub_I_dof_objects.all_dimensions.cc", scope: !123, file: !123, type: !2231, flags: DIFlagArtificial, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !122, retainedNodes: !1557)
!2231 = !DISubroutineType(types: !1557)
