...
define dso_local i64 @lzma_physmem() #0 !dbg !7 {
entry:
  %call = call i64 @tuklib_physmem(), !dbg !15
  ret i64 %call, !dbg !16
}

declare dso_local i64 @tuklib_physmem() #1
...
!1 = !DIFile(filename: "liblzma/common/hardware_physmem.c", directory: "/home/venkat/IF-DV/spec_build_release/CPU_2017/benchspec/CPU/557.xz_r/build/build_base_ld-loop-ext-m64.0000")
!2 = !{}
...
!7 = distinct !DISubprogram(name: "lzma_physmem", scope: !1, file: !1, line: 19, type: !8, scopeLine: 20, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !2)
...
!16 = !DILocation(line: 24, column: 2, scope: !7)
