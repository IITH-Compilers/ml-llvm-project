...
@_ZN11xercesc_2_721YearDatatypeValidator26classYearDatatypeValidatorE = dso_local global %"class.xercesc_2_7::XProtoType" { i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str, i32 0, i32 0), %"class.xercesc_2_7::XSerializable"* (%"class.xercesc_2_7::MemoryManager"*)* @_ZN11xercesc_2_721YearDatatypeValidator12createObjectEPNS_13MemoryManagerE }, align 8, !dbg !0
...
@_ZTSN11xercesc_2_721YearDatatypeValidatorE = dso_local constant [39 x i8] c"N11xercesc_2_721YearDatatypeValidatorE\00", align 1
@_ZTIN11xercesc_2_717DateTimeValidatorE = external dso_local constant i8*
@_ZTIN11xercesc_2_721YearDatatypeValidatorE = dso_local constant { i8*, i8*, i8* } { i8* bitcast (i8** getelementptr inbounds (i8*, i8** @_ZTVN10__cxxabiv120__si_class_type_infoE, i64 2) to i8*), i8* getelementptr inbounds ([39 x i8], [39 x i8]* @_ZTSN11xercesc_2_721YearDatatypeValidatorE, i32 0, i32 0), i8* bitcast (i8** @_ZTIN11xercesc_2_717DateTimeValidatorE to i8*) }, align 8

@_ZN11xercesc_2_721YearDatatypeValidatorC1EPNS_13MemoryManagerE = dso_local unnamed_addr alias void (%"class.xercesc_2_7::YearDatatypeValidator"*, %"class.xercesc_2_7::MemoryManager"*), void (%"class.xercesc_2_7::YearDatatypeValidator"*, %"class.xercesc_2_7::MemoryManager"*)* @_ZN11xercesc_2_721YearDatatypeValidatorC2EPNS_13MemoryManagerE
@_ZN11xercesc_2_721YearDatatypeValidatorC1EPNS_17DatatypeValidatorEPNS_14RefHashTableOfINS_12KVStringPairEEEPNS_16RefArrayVectorOfItEEiPNS_13MemoryManagerE = dso_local unnamed_addr alias void (%"class.xercesc_2_7::YearDatatypeValidator"*, %"class.xercesc_2_7::DatatypeValidator"*, %"class.xercesc_2_7::RefHashTableOf"*, %"class.xercesc_2_7::RefArrayVectorOf"*, i32, %"class.xercesc_2_7::MemoryManager"*), void (%"class.xercesc_2_7::YearDatatypeValidator"*, %"class.xercesc_2_7::DatatypeValidator"*, %"class.xercesc_2_7::RefHashTableOf"*, %"class.xercesc_2_7::RefArrayVectorOf"*, i32, %"class.xercesc_2_7::MemoryManager"*)* @_ZN11xercesc_2_721YearDatatypeValidatorC2EPNS_17DatatypeValidatorEPNS_14RefHashTableOfINS_12KVStringPairEEEPNS_16RefArrayVectorOfItEEiPNS_13MemoryManagerE
@_ZN11xercesc_2_721YearDatatypeValidatorD1Ev = dso_local unnamed_addr alias void (%"class.xercesc_2_7::YearDatatypeValidator"*), void (%"class.xercesc_2_7::YearDatatypeValidator"*)* @_ZN11xercesc_2_721YearDatatypeValidatorD2Ev
...
define dso_local void @_ZN11xercesc_2_721YearDatatypeValidatorC2EPNS_13MemoryManagerE(%"class.xercesc_2_7::YearDatatypeValidator"* %this, %"class.xercesc_2_7::MemoryManager"* %manager) unnamed_addr #3 align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) !dbg !1258 {
entry:
  %this.addr = alloca %"class.xercesc_2_7::YearDatatypeValidator"*, align 8
  %manager.addr = alloca %"class.xercesc_2_7::MemoryManager"*, align 8
  %exn.slot = alloca i8*
  %ehselector.slot = alloca i32
  store %"class.xercesc_2_7::YearDatatypeValidator"* %this, %"class.xercesc_2_7::YearDatatypeValidator"** %this.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.xercesc_2_7::YearDatatypeValidator"** %this.addr, metadata !1259, metadata !DIExpression()), !dbg !1261
  ...
  %this1 = load %"class.xercesc_2_7::YearDatatypeValidator"*, %"class.xercesc_2_7::YearDatatypeValidator"** %this.addr, align 8
  %0 = bitcast %"class.xercesc_2_7::YearDatatypeValidator"* %this1 to %"class.xercesc_2_7::DateTimeValidator"*, !dbg !1264
  %1 = load %"class.xercesc_2_7::MemoryManager"*, %"class.xercesc_2_7::MemoryManager"** %manager.addr, align 8, !dbg !1265
  call void @_ZN11xercesc_2_717DateTimeValidatorC2EPNS_17DatatypeValidatorEPNS_14RefHashTableOfINS_12KVStringPairEEEiNS1_13ValidatorTypeEPNS_13MemoryManagerE(%"class.xercesc_2_7::DateTimeValidator"* %0, %"class.xercesc_2_7::DatatypeValidator"* null, %"class.xercesc_2_7::RefHashTableOf"* null, i32 0, i32 17, %"class.xercesc_2_7::MemoryManager"* %1), !dbg !1266
  %2 = bitcast %"class.xercesc_2_7::YearDatatypeValidator"* %this1 to i32 (...)***, !dbg !1264
  store i32 (...)** bitcast (i8** getelementptr inbounds ({ [28 x i8*] }, { [28 x i8*] }* @_ZTVN11xercesc_2_721YearDatatypeValidatorE, i32 0, inrange i32 0, i32 2) to i32 (...)**), i32 (...)*** %2, align 8, !dbg !1264
  %3 = bitcast %"class.xercesc_2_7::YearDatatypeValidator"* %this1 to %"class.xercesc_2_7::DatatypeValidator"*, !dbg !1267
...
lpad:                                             ; preds = %entry
  ...
  %7 = bitcast %"class.xercesc_2_7::YearDatatypeValidator"* %this1 to %"class.xercesc_2_7::DateTimeValidator"*, !dbg !1270
...
; Function Attrs: noinline uwtable
define dso_local void @_ZN11xercesc_2_721YearDatatypeValidatorC2EPNS_17DatatypeValidatorEPNS_14RefHashTableOfINS_12KVStringPairEEEPNS_16RefArrayVectorOfItEEiPNS_13MemoryManagerE(%"class.xercesc_2_7::YearDatatypeValidator"* %this, %"class.xercesc_2_7::DatatypeValidator"* %baseValidator, %"class.xercesc_2_7::RefHashTableOf"* %facets, %"class.xercesc_2_7::RefArrayVectorOf"* %enums, i32 %finalSet, %"class.xercesc_2_7::MemoryManager"* %manager) unnamed_addr #3 align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) !dbg !1284 {
entry:
  %this.addr = alloca %"class.xercesc_2_7::YearDatatypeValidator"*, align 8
  ...
  %ehselector.slot = alloca i32
  store %"class.xercesc_2_7::YearDatatypeValidator"* %this, %"class.xercesc_2_7::YearDatatypeValidator"** %this.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.xercesc_2_7::YearDatatypeValidator"** %this.addr, metadata !1285, metadata !DIExpression()), !dbg !1286
  ...
  %this1 = load %"class.xercesc_2_7::YearDatatypeValidator"*, %"class.xercesc_2_7::YearDatatypeValidator"** %this.addr, align 8
  %0 = bitcast %"class.xercesc_2_7::YearDatatypeValidator"* %this1 to %"class.xercesc_2_7::DateTimeValidator"*, !dbg !1297
  ...
  call void @_ZN11xercesc_2_717DateTimeValidatorC2EPNS_17DatatypeValidatorEPNS_14RefHashTableOfINS_12KVStringPairEEEiNS1_13ValidatorTypeEPNS_13MemoryManagerE(%"class.xercesc_2_7::DateTimeValidator"* %0, %"class.xercesc_2_7::DatatypeValidator"* %1, %"class.xercesc_2_7::RefHashTableOf"* %2, i32 %3, i32 17, %"class.xercesc_2_7::MemoryManager"* %4), !dbg !1302
  %5 = bitcast %"class.xercesc_2_7::YearDatatypeValidator"* %this1 to i32 (...)***, !dbg !1297
  store i32 (...)** bitcast (i8** getelementptr inbounds ({ [28 x i8*] }, { [28 x i8*] }* @_ZTVN11xercesc_2_721YearDatatypeValidatorE, i32 0, inrange i32 0, i32 2) to i32 (...)**), i32 (...)*** %5, align 8, !dbg !1297
  %6 = bitcast %"class.xercesc_2_7::YearDatatypeValidator"* %this1 to %"class.xercesc_2_7::AbstractNumericFacetValidator"*, !dbg !1303
...
lpad:                                             ; preds = %entry
  ...
  %12 = bitcast %"class.xercesc_2_7::YearDatatypeValidator"* %this1 to %"class.xercesc_2_7::DateTimeValidator"*, !dbg !1308
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_ZN11xercesc_2_721YearDatatypeValidatorD2Ev(%"class.xercesc_2_7::YearDatatypeValidator"* %this) unnamed_addr #1 align 2 !dbg !1309 {
entry:
  %this.addr = alloca %"class.xercesc_2_7::YearDatatypeValidator"*, align 8
  store %"class.xercesc_2_7::YearDatatypeValidator"* %this, %"class.xercesc_2_7::YearDatatypeValidator"** %this.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.xercesc_2_7::YearDatatypeValidator"** %this.addr, metadata !1310, metadata !DIExpression()), !dbg !1311
  %this1 = load %"class.xercesc_2_7::YearDatatypeValidator"*, %"class.xercesc_2_7::YearDatatypeValidator"** %this.addr, align 8
  %0 = bitcast %"class.xercesc_2_7::YearDatatypeValidator"* %this1 to %"class.xercesc_2_7::DateTimeValidator"*, !dbg !1312
  call void @_ZN11xercesc_2_717DateTimeValidatorD2Ev(%"class.xercesc_2_7::DateTimeValidator"* %0) #8, !dbg !1312
  ret void, !dbg !1314
}

; Function Attrs: noinline nounwind uwtable
define dso_local void @_ZN11xercesc_2_721YearDatatypeValidatorD0Ev(%"class.xercesc_2_7::YearDatatypeValidator"* %this) unnamed_addr #1 align 2 !dbg !1315 {
entry:
  %this.addr = alloca %"class.xercesc_2_7::YearDatatypeValidator"*, align 8
  store %"class.xercesc_2_7::YearDatatypeValidator"* %this, %"class.xercesc_2_7::YearDatatypeValidator"** %this.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.xercesc_2_7::YearDatatypeValidator"** %this.addr, metadata !1316, metadata !DIExpression()), !dbg !1317
  %this1 = load %"class.xercesc_2_7::YearDatatypeValidator"*, %"class.xercesc_2_7::YearDatatypeValidator"** %this.addr, align 8
  call void @_ZN11xercesc_2_721YearDatatypeValidatorD1Ev(%"class.xercesc_2_7::YearDatatypeValidator"* %this1) #8, !dbg !1318
  %0 = bitcast %"class.xercesc_2_7::YearDatatypeValidator"* %this1 to i8*, !dbg !1318
...
; Function Attrs: noinline uwtable
define dso_local %"class.xercesc_2_7::DatatypeValidator"* @_ZN11xercesc_2_721YearDatatypeValidator11newInstanceEPNS_14RefHashTableOfINS_12KVStringPairEEEPNS_16RefArrayVectorOfItEEiPNS_13MemoryManagerE(%"class.xercesc_2_7::YearDatatypeValidator"* %this, %"class.xercesc_2_7::RefHashTableOf"* %facets, %"class.xercesc_2_7::RefArrayVectorOf"* %enums, i32 %finalSet, %"class.xercesc_2_7::MemoryManager"* %manager) unnamed_addr #3 align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) !dbg !1320 {
entry:
  %this.addr = alloca %"class.xercesc_2_7::YearDatatypeValidator"*, align 8
  %facets.addr = alloca %"class.xercesc_2_7::RefHashTableOf"*, align 8
  %enums.addr = alloca %"class.xercesc_2_7::RefArrayVectorOf"*, align 8
  ...
  %ehselector.slot = alloca i32
  store %"class.xercesc_2_7::YearDatatypeValidator"* %this, %"class.xercesc_2_7::YearDatatypeValidator"** %this.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.xercesc_2_7::YearDatatypeValidator"** %this.addr, metadata !1321, metadata !DIExpression()), !dbg !1322
  store %"class.xercesc_2_7::RefHashTableOf"* %facets, %"class.xercesc_2_7::RefHashTableOf"** %facets.addr, align 8
  ...
  %1 = bitcast i8* %call to %"class.xercesc_2_7::YearDatatypeValidator"*, !dbg !1332
  %2 = bitcast %"class.xercesc_2_7::YearDatatypeValidator"* %this1 to %"class.xercesc_2_7::DatatypeValidator"*, !dbg !1333
  ...
  invoke void @_ZN11xercesc_2_721YearDatatypeValidatorC1EPNS_17DatatypeValidatorEPNS_14RefHashTableOfINS_12KVStringPairEEEPNS_16RefArrayVectorOfItEEiPNS_13MemoryManagerE(%"class.xercesc_2_7::YearDatatypeValidator"* %1, %"class.xercesc_2_7::DatatypeValidator"* %2, %"class.xercesc_2_7::RefHashTableOf"* %3, %"class.xercesc_2_7::RefArrayVectorOf"* %4, i32 %5, %"class.xercesc_2_7::MemoryManager"* %6)
          to label %invoke.cont unwind label %lpad, !dbg !1338

invoke.cont:                                      ; preds = %entry
  %7 = bitcast %"class.xercesc_2_7::YearDatatypeValidator"* %1 to %"class.xercesc_2_7::DatatypeValidator"*, !dbg !1332
...
; Function Attrs: noinline uwtable
define dso_local %"class.xercesc_2_7::XMLDateTime"* @_ZN11xercesc_2_721YearDatatypeValidator5parseEPKtPNS_13MemoryManagerE(%"class.xercesc_2_7::YearDatatypeValidator"* %this, i16* %content, %"class.xercesc_2_7::MemoryManager"* %manager) unnamed_addr #3 align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) !dbg !1341 {
entry:
  %this.addr = alloca %"class.xercesc_2_7::YearDatatypeValidator"*, align 8
  ...
  store %"class.xercesc_2_7::YearDatatypeValidator"* %this, %"class.xercesc_2_7::YearDatatypeValidator"** %this.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.xercesc_2_7::YearDatatypeValidator"** %this.addr, metadata !1342, metadata !DIExpression()), !dbg !1343
...
invoke.cont:                                      ; preds = %entry
  ...
  invoke void @_ZN11xercesc_2_711XMLDateTime9parseYearEv(%"class.xercesc_2_7::XMLDateTime"* %6)
...
declare dso_local void @_ZN11xercesc_2_711XMLDateTime9parseYearEv(%"class.xercesc_2_7::XMLDateTime"*) #4
...
; Function Attrs: noinline uwtable
define dso_local void @_ZN11xercesc_2_721YearDatatypeValidator5parseEPNS_11XMLDateTimeE(%"class.xercesc_2_7::YearDatatypeValidator"* %this, %"class.xercesc_2_7::XMLDateTime"* %pDate) unnamed_addr #3 align 2 !dbg !1498 {
entry:
  %this.addr = alloca %"class.xercesc_2_7::YearDatatypeValidator"*, align 8
  %pDate.addr = alloca %"class.xercesc_2_7::XMLDateTime"*, align 8
  store %"class.xercesc_2_7::YearDatatypeValidator"* %this, %"class.xercesc_2_7::YearDatatypeValidator"** %this.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.xercesc_2_7::YearDatatypeValidator"** %this.addr, metadata !1499, metadata !DIExpression()), !dbg !1500
  ...
  call void @_ZN11xercesc_2_711XMLDateTime9parseYearEv(%"class.xercesc_2_7::XMLDateTime"* %0), !dbg !1504
  ret void, !dbg !1505
}

; Function Attrs: noinline uwtable
define dso_local %"class.xercesc_2_7::XSerializable"* @_ZN11xercesc_2_721YearDatatypeValidator12createObjectEPNS_13MemoryManagerE(%"class.xercesc_2_7::MemoryManager"* %manager) #3 align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) !dbg !1506 {
entry:
  %manager.addr = alloca %"class.xercesc_2_7::MemoryManager"*, align 8
  %exn.slot = alloca i8*
  %ehselector.slot = alloca i32
  ...
  %1 = bitcast i8* %call to %"class.xercesc_2_7::YearDatatypeValidator"*, !dbg !1508
  %2 = load %"class.xercesc_2_7::MemoryManager"*, %"class.xercesc_2_7::MemoryManager"** %manager.addr, align 8, !dbg !1508
  invoke void @_ZN11xercesc_2_721YearDatatypeValidatorC1EPNS_13MemoryManagerE(%"class.xercesc_2_7::YearDatatypeValidator"* %1, %"class.xercesc_2_7::MemoryManager"* %2)
          to label %invoke.cont unwind label %lpad, !dbg !1508

invoke.cont:                                      ; preds = %entry
  %3 = bitcast %"class.xercesc_2_7::YearDatatypeValidator"* %1 to %"class.xercesc_2_7::XSerializable"*, !dbg !1508
...
; Function Attrs: noinline nounwind uwtable
define dso_local zeroext i1 @_ZNK11xercesc_2_721YearDatatypeValidator14isSerializableEv(%"class.xercesc_2_7::YearDatatypeValidator"* %this) unnamed_addr #1 align 2 !dbg !1509 {
entry:
  %this.addr = alloca %"class.xercesc_2_7::YearDatatypeValidator"*, align 8
  store %"class.xercesc_2_7::YearDatatypeValidator"* %this, %"class.xercesc_2_7::YearDatatypeValidator"** %this.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.xercesc_2_7::YearDatatypeValidator"** %this.addr, metadata !1510, metadata !DIExpression()), !dbg !1512
  %this1 = load %"class.xercesc_2_7::YearDatatypeValidator"*, %"class.xercesc_2_7::YearDatatypeValidator"** %this.addr, align 8
  ret i1 true, !dbg !1513
}

; Function Attrs: noinline nounwind uwtable
define dso_local %"class.xercesc_2_7::XProtoType"* @_ZNK11xercesc_2_721YearDatatypeValidator12getProtoTypeEv(%"class.xercesc_2_7::YearDatatypeValidator"* %this) unnamed_addr #1 align 2 !dbg !1514 {
entry:
  %this.addr = alloca %"class.xercesc_2_7::YearDatatypeValidator"*, align 8
  store %"class.xercesc_2_7::YearDatatypeValidator"* %this, %"class.xercesc_2_7::YearDatatypeValidator"** %this.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.xercesc_2_7::YearDatatypeValidator"** %this.addr, metadata !1515, metadata !DIExpression()), !dbg !1516
  %this1 = load %"class.xercesc_2_7::YearDatatypeValidator"*, %"class.xercesc_2_7::YearDatatypeValidator"** %this.addr, align 8
  ret %"class.xercesc_2_7::XProtoType"* @_ZN11xercesc_2_721YearDatatypeValidator26classYearDatatypeValidatorE, !dbg !1517
}

; Function Attrs: noinline uwtable
define dso_local void @_ZN11xercesc_2_721YearDatatypeValidator9serializeERNS_16XSerializeEngineE(%"class.xercesc_2_7::YearDatatypeValidator"* %this, %"class.xercesc_2_7::XSerializeEngine"* dereferenceable(104) %serEng) unnamed_addr #3 align 2 !dbg !1518 {
entry:
  %this.addr = alloca %"class.xercesc_2_7::YearDatatypeValidator"*, align 8
  %serEng.addr = alloca %"class.xercesc_2_7::XSerializeEngine"*, align 8
  store %"class.xercesc_2_7::YearDatatypeValidator"* %this, %"class.xercesc_2_7::YearDatatypeValidator"** %this.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.xercesc_2_7::YearDatatypeValidator"** %this.addr, metadata !1519, metadata !DIExpression()), !dbg !1520
  ...
  %this1 = load %"class.xercesc_2_7::YearDatatypeValidator"*, %"class.xercesc_2_7::YearDatatypeValidator"** %this.addr, align 8
  %0 = bitcast %"class.xercesc_2_7::YearDatatypeValidator"* %this1 to %"class.xercesc_2_7::DateTimeValidator"*, !dbg !1523
...
!1 = distinct !DIGlobalVariable(name: "classYearDatatypeValidator", linkageName: "_ZN11xercesc_2_721YearDatatypeValidator26classYearDatatypeValidatorE", scope: !2, file: !3, line: 94, type: !4, isLocal: false, isDefinition: true, declaration: !744)
!2 = !DINamespace(name: "xercesc_2_7", scope: null)
!3 = !DIFile(filename: "YearDatatypeValidator.cpp", directory: "/home/venkat/IF-DV/spec_build_release/CPU_2017/benchspec/CPU/523.xalancbmk_r/build/build_base_ld-loop-ext-m64.0000")
...
!743 = !{null, !27, !56, !84}
!744 = !DIDerivedType(tag: DW_TAG_member, name: "classYearDatatypeValidator", scope: !746, file: !745, line: 69, baseType: !4, flags: DIFlagPublic | DIFlagStaticMember)
!745 = !DIFile(filename: "./xercesc/validators/datatype/YearDatatypeValidator.hpp", directory: "/home/venkat/IF-DV/spec_build_release/CPU_2017/benchspec/CPU/523.xalancbmk_r/build/build_base_ld-loop-ext-m64.0000")
!746 = distinct !DICompositeType(tag: DW_TAG_class_type, name: "YearDatatypeValidator", scope: !2, file: !745, line: 28, size: 1280, flags: DIFlagTypePassByReference | DIFlagNonTrivial, elements: !747, vtableHolder: !17)
...
!751 = !DISubprogram(name: "YearDatatypeValidator", scope: !746, file: !745, line: 38, type: !752, scopeLine: 38, flags: DIFlagPublic | DIFlagPrototyped, spFlags: 0)
!752 = !DISubroutineType(types: !753)
!753 = !{null, !754, !84}
!754 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !746, size: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!755 = !DISubprogram(name: "YearDatatypeValidator", scope: !746, file: !745, line: 42, type: !756, scopeLine: 42, flags: DIFlagPublic | DIFlagPrototyped, spFlags: 0)
...
!769 = !DISubprogram(name: "~YearDatatypeValidator", scope: !746, file: !745, line: 50, type: !770, scopeLine: 50, containingType: !746, virtualIndex: 0, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagVirtual)
!770 = !DISubroutineType(types: !771)
!771 = !{null, !754}
!772 = !DISubprogram(name: "newInstance", linkageName: "_ZN11xercesc_2_721YearDatatypeValidator11newInstanceEPNS_14RefHashTableOfINS_12KVStringPairEEEPNS_16RefArrayVectorOfItEEiPNS_13MemoryManagerE", scope: !746, file: !745, line: 58, type: !773, scopeLine: 58, containingType: !746, virtualIndex: 11, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagVirtual)
!773 = !DISubroutineType(types: !774)
!774 = !{!759, !754, !762, !765, !137, !84}
!775 = !DISubprogram(name: "createObject", linkageName: "_ZN11xercesc_2_721YearDatatypeValidator12createObjectEPNS_13MemoryManagerE", scope: !746, file: !745, line: 69, type: !14, scopeLine: 69, flags: DIFlagPublic | DIFlagPrototyped | DIFlagStaticMember, spFlags: 0)
!776 = !DISubprogram(name: "isSerializable", linkageName: "_ZNK11xercesc_2_721YearDatatypeValidator14isSerializableEv", scope: !746, file: !745, line: 69, type: !777, scopeLine: 69, containingType: !746, virtualIndex: 2, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagVirtual)
...
!781 = !DISubprogram(name: "getProtoType", linkageName: "_ZNK11xercesc_2_721YearDatatypeValidator12getProtoTypeEv", scope: !746, file: !745, line: 69, type: !782, scopeLine: 69, containingType: !746, virtualIndex: 4, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagVirtual)
!782 = !DISubroutineType(types: !783)
!783 = !{!118, !779}
!784 = !DISubprogram(name: "serialize", linkageName: "_ZN11xercesc_2_721YearDatatypeValidator9serializeERNS_16XSerializeEngineE", scope: !746, file: !745, line: 69, type: !785, scopeLine: 69, containingType: !746, virtualIndex: 3, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagVirtual)
!785 = !DISubroutineType(types: !786)
!786 = !{null, !754, !27}
!787 = !DISubprogram(name: "parse", linkageName: "_ZN11xercesc_2_721YearDatatypeValidator5parseEPKtPNS_13MemoryManagerE", scope: !746, file: !745, line: 76, type: !788, scopeLine: 76, containingType: !746, virtualIndex: 23, flags: DIFlagProtected | DIFlagPrototyped, spFlags: DISPFlagVirtual)
...
!793 = !DISubprogram(name: "parse", linkageName: "_ZN11xercesc_2_721YearDatatypeValidator5parseEPNS_11XMLDateTimeE", scope: !746, file: !745, line: 77, type: !794, scopeLine: 77, containingType: !746, virtualIndex: 24, flags: DIFlagProtected | DIFlagPrototyped, spFlags: DISPFlagVirtual)
!794 = !DISubroutineType(types: !795)
!795 = !{null, !754, !796}
!796 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !790)
!797 = !DISubprogram(name: "YearDatatypeValidator", scope: !746, file: !745, line: 83, type: !798, scopeLine: 83, flags: DIFlagPrototyped, spFlags: 0)
!798 = !DISubroutineType(types: !799)
!799 = !{null, !754, !800}
!800 = !DIDerivedType(tag: DW_TAG_reference_type, baseType: !780, size: 64)
!801 = !DISubprogram(name: "operator=", linkageName: "_ZN11xercesc_2_721YearDatatypeValidatoraSERKS0_", scope: !746, file: !745, line: 84, type: !802, scopeLine: 84, flags: DIFlagPrototyped, spFlags: 0)
...
!1258 = distinct !DISubprogram(name: "YearDatatypeValidator", linkageName: "_ZN11xercesc_2_721YearDatatypeValidatorC2EPNS_13MemoryManagerE", scope: !746, file: !3, line: 32, type: !752, scopeLine: 34, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !805, declaration: !751, retainedNodes: !1248)
...
!1265 = !DILocation(line: 33, column: 54, scope: !1258)
...
!1284 = distinct !DISubprogram(name: "YearDatatypeValidator", linkageName: "_ZN11xercesc_2_721YearDatatypeValidatorC2EPNS_17DatatypeValidatorEPNS_14RefHashTableOfINS_12KVStringPairEEEPNS_16RefArrayVectorOfItEEiPNS_13MemoryManagerE", scope: !746, file: !3, line: 38, type: !756, scopeLine: 45, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !805, declaration: !755, retainedNodes: !1248)
...
!1301 = !DILocation(line: 44, column: 78, scope: !1284)
...
!1309 = distinct !DISubprogram(name: "~YearDatatypeValidator", linkageName: "_ZN11xercesc_2_721YearDatatypeValidatorD2Ev", scope: !746, file: !3, line: 49, type: !770, scopeLine: 50, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !805, declaration: !769, retainedNodes: !1248)
...
!1315 = distinct !DISubprogram(name: "~YearDatatypeValidator", linkageName: "_ZN11xercesc_2_721YearDatatypeValidatorD0Ev", scope: !746, file: !3, line: 49, type: !770, scopeLine: 50, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !805, declaration: !769, retainedNodes: !1248)
...
!1320 = distinct !DISubprogram(name: "newInstance", linkageName: "_ZN11xercesc_2_721YearDatatypeValidator11newInstanceEPNS_14RefHashTableOfINS_12KVStringPairEEEPNS_16RefArrayVectorOfItEEiPNS_13MemoryManagerE", scope: !746, file: !3, line: 52, type: !773, scopeLine: 59, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !805, declaration: !772, retainedNodes: !1248)
...
!1333 = !DILocation(line: 60, column: 69, scope: !1320)
!1334 = !DILocation(line: 60, column: 75, scope: !1320)
!1335 = !DILocation(line: 60, column: 83, scope: !1320)
!1336 = !DILocation(line: 60, column: 90, scope: !1320)
!1337 = !DILocation(line: 60, column: 100, scope: !1320)
...
!1341 = distinct !DISubprogram(name: "parse", linkageName: "_ZN11xercesc_2_721YearDatatypeValidator5parseEPKtPNS_13MemoryManagerE", scope: !746, file: !3, line: 66, type: !788, scopeLine: 67, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !805, declaration: !787, retainedNodes: !1248)
...
!1345 = !DILocation(line: 66, column: 62, scope: !1341)
!1346 = !DILocalVariable(name: "manager", arg: 3, scope: !1341, file: !3, line: 66, type: !84)
!1347 = !DILocation(line: 66, column: 92, scope: !1341)
...
!1498 = distinct !DISubprogram(name: "parse", linkageName: "_ZN11xercesc_2_721YearDatatypeValidator5parseEPNS_11XMLDateTimeE", scope: !746, file: !3, line: 85, type: !794, scopeLine: 86, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !805, declaration: !793, retainedNodes: !1248)
...
!1502 = !DILocation(line: 85, column: 54, scope: !1498)
...
!1506 = distinct !DISubprogram(name: "createObject", linkageName: "_ZN11xercesc_2_721YearDatatypeValidator12createObjectEPNS_13MemoryManagerE", scope: !746, file: !3, line: 94, type: !14, scopeLine: 94, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !805, declaration: !775, retainedNodes: !1248)
!1507 = !DILocalVariable(name: "manager", arg: 1, scope: !1506, file: !3, line: 94, type: !19)
!1508 = !DILocation(line: 94, column: 1, scope: !1506)
!1509 = distinct !DISubprogram(name: "isSerializable", linkageName: "_ZNK11xercesc_2_721YearDatatypeValidator14isSerializableEv", scope: !746, file: !3, line: 94, type: !777, scopeLine: 94, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !805, declaration: !776, retainedNodes: !1248)
...
!1514 = distinct !DISubprogram(name: "getProtoType", linkageName: "_ZNK11xercesc_2_721YearDatatypeValidator12getProtoTypeEv", scope: !746, file: !3, line: 94, type: !782, scopeLine: 94, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !805, declaration: !781, retainedNodes: !1248)
...
!1518 = distinct !DISubprogram(name: "serialize", linkageName: "_ZN11xercesc_2_721YearDatatypeValidator9serializeERNS_16XSerializeEngineE", scope: !746, file: !3, line: 96, type: !785, scopeLine: 97, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !805, declaration: !784, retainedNodes: !1248)
...
!1522 = !DILocation(line: 96, column: 57, scope: !1518)
