...
@_ZTSN11xercesc_2_720DocumentFragmentImplE = dso_local constant [38 x i8] c"N11xercesc_2_720DocumentFragmentImplE\00", align 1
@_ZTIN11xercesc_2_710ParentNodeE = external dso_local constant i8*
@_ZTIN11xercesc_2_720DocumentFragmentImplE = dso_local constant { i8*, i8*, i8* } { i8* bitcast (i8** getelementptr inbounds (i8*, i8** @_ZTVN10__cxxabiv120__si_class_type_infoE, i64 2) to i8*), i8* getelementptr inbounds ([38 x i8], [38 x i8]* @_ZTSN11xercesc_2_720DocumentFragmentImplE, i32 0, i32 0), i8* bitcast (i8** @_ZTIN11xercesc_2_710ParentNodeE to i8*) }, align 8
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_DocumentFragmentImpl.cpp, i8* null }]

@_ZN11xercesc_2_720DocumentFragmentImplC1EPNS_12DocumentImplE = dso_local unnamed_addr alias void (%"class.xercesc_2_7::DocumentFragmentImpl"*, %"class.xercesc_2_7::DocumentImpl"*), void (%"class.xercesc_2_7::DocumentFragmentImpl"*, %"class.xercesc_2_7::DocumentImpl"*)* @_ZN11xercesc_2_720DocumentFragmentImplC2EPNS_12DocumentImplE
@_ZN11xercesc_2_720DocumentFragmentImplC1ERKS0_b = dso_local unnamed_addr alias void (%"class.xercesc_2_7::DocumentFragmentImpl"*, %"class.xercesc_2_7::DocumentFragmentImpl"*, i1), void (%"class.xercesc_2_7::DocumentFragmentImpl"*, %"class.xercesc_2_7::DocumentFragmentImpl"*, i1)* @_ZN11xercesc_2_720DocumentFragmentImplC2ERKS0_b
@_ZN11xercesc_2_720DocumentFragmentImplD1Ev = dso_local unnamed_addr alias void (%"class.xercesc_2_7::DocumentFragmentImpl"*), void (%"class.xercesc_2_7::DocumentFragmentImpl"*)* @_ZN11xercesc_2_720DocumentFragmentImplD2Ev
...
entry:
  call void @_ZN11xercesc_2_718XMLRegisterCleanupC1Ev(%"class.xercesc_2_7::XMLRegisterCleanup"* @_ZN11xercesc_2_7L10namCleanupE), !dbg !714
  ret void, !dbg !714
}
...
; Function Attrs: noinline uwtable
define dso_local void @_ZN11xercesc_2_720DocumentFragmentImplC2EPNS_12DocumentImplE(%"class.xercesc_2_7::DocumentFragmentImpl"* %this, %"class.xercesc_2_7::DocumentImpl"* %masterDoc) unnamed_addr #3 align 2 !dbg !715 {
entry:
  %this.addr = alloca %"class.xercesc_2_7::DocumentFragmentImpl"*, align 8
  %masterDoc.addr = alloca %"class.xercesc_2_7::DocumentImpl"*, align 8
  store %"class.xercesc_2_7::DocumentFragmentImpl"* %this, %"class.xercesc_2_7::DocumentFragmentImpl"** %this.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.xercesc_2_7::DocumentFragmentImpl"** %this.addr, metadata !752, metadata !DIExpression()), !dbg !754
  store %"class.xercesc_2_7::DocumentImpl"* %masterDoc, %"class.xercesc_2_7::DocumentImpl"** %masterDoc.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.xercesc_2_7::DocumentImpl"** %masterDoc.addr, metadata !755, metadata !DIExpression()), !dbg !756
  %this1 = load %"class.xercesc_2_7::DocumentFragmentImpl"*, %"class.xercesc_2_7::DocumentFragmentImpl"** %this.addr, align 8
  %0 = bitcast %"class.xercesc_2_7::DocumentFragmentImpl"* %this1 to %"class.xercesc_2_7::ParentNode"*, !dbg !757
  %1 = load %"class.xercesc_2_7::DocumentImpl"*, %"class.xercesc_2_7::DocumentImpl"** %masterDoc.addr, align 8, !dbg !758
  call void @_ZN11xercesc_2_710ParentNodeC2EPNS_12DocumentImplE(%"class.xercesc_2_7::ParentNode"* %0, %"class.xercesc_2_7::DocumentImpl"* %1), !dbg !759
  %2 = bitcast %"class.xercesc_2_7::DocumentFragmentImpl"* %this1 to i32 (...)***, !dbg !757
  store i32 (...)** bitcast (i8** getelementptr inbounds ({ [49 x i8*] }, { [49 x i8*] }* @_ZTVN11xercesc_2_720DocumentFragmentImplE, i32 0, inrange i32 0, i32 2) to i32 (...)**), i32 (...)*** %2, align 8, !dbg !757
  ret void, !dbg !760
}
...
; Function Attrs: noinline uwtable
define dso_local void @_ZN11xercesc_2_720DocumentFragmentImplC2ERKS0_b(%"class.xercesc_2_7::DocumentFragmentImpl"* %this, %"class.xercesc_2_7::DocumentFragmentImpl"* dereferenceable(88) %other, i1 zeroext %deep) unnamed_addr #3 align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) !dbg !761 {
entry:
  %this.addr = alloca %"class.xercesc_2_7::DocumentFragmentImpl"*, align 8
  %other.addr = alloca %"class.xercesc_2_7::DocumentFragmentImpl"*, align 8
  %deep.addr = alloca i8, align 1
  %exn.slot = alloca i8*
  %ehselector.slot = alloca i32
  store %"class.xercesc_2_7::DocumentFragmentImpl"* %this, %"class.xercesc_2_7::DocumentFragmentImpl"** %this.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.xercesc_2_7::DocumentFragmentImpl"** %this.addr, metadata !762, metadata !DIExpression()), !dbg !763
  store %"class.xercesc_2_7::DocumentFragmentImpl"* %other, %"class.xercesc_2_7::DocumentFragmentImpl"** %other.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.xercesc_2_7::DocumentFragmentImpl"** %other.addr, metadata !764, metadata !DIExpression()), !dbg !765
  ...
  %this1 = load %"class.xercesc_2_7::DocumentFragmentImpl"*, %"class.xercesc_2_7::DocumentFragmentImpl"** %this.addr, align 8
  %0 = bitcast %"class.xercesc_2_7::DocumentFragmentImpl"* %this1 to %"class.xercesc_2_7::ParentNode"*, !dbg !768
  %1 = load %"class.xercesc_2_7::DocumentFragmentImpl"*, %"class.xercesc_2_7::DocumentFragmentImpl"** %other.addr, align 8, !dbg !769
  %2 = bitcast %"class.xercesc_2_7::DocumentFragmentImpl"* %1 to %"class.xercesc_2_7::ParentNode"*, !dbg !769
  ...
  %3 = bitcast %"class.xercesc_2_7::DocumentFragmentImpl"* %this1 to i32 (...)***, !dbg !768
  store i32 (...)** bitcast (i8** getelementptr inbounds ({ [49 x i8*] }, { [49 x i8*] }* @_ZTVN11xercesc_2_720DocumentFragmentImplE, i32 0, inrange i32 0, i32 2) to i32 (...)**), i32 (...)*** %3, align 8, !dbg !768
  %4 = load i8, i8* %deep.addr, align 1, !dbg !771
  %tobool = trunc i8 %4 to i1, !dbg !771
  br i1 %tobool, label %if.then, label %if.end, !dbg !774

if.then:                                          ; preds = %entry
  %5 = bitcast %"class.xercesc_2_7::DocumentFragmentImpl"* %this1 to %"class.xercesc_2_7::ParentNode"*, !dbg !775
  %6 = load %"class.xercesc_2_7::DocumentFragmentImpl"*, %"class.xercesc_2_7::DocumentFragmentImpl"** %other.addr, align 8, !dbg !776
  %7 = bitcast %"class.xercesc_2_7::DocumentFragmentImpl"* %6 to %"class.xercesc_2_7::NodeImpl"*, !dbg !776
  invoke void @_ZN11xercesc_2_710ParentNode13cloneChildrenERKNS_8NodeImplE(%"class.xercesc_2_7::ParentNode"* %5, %"class.xercesc_2_7::NodeImpl"* dereferenceable(32) %7)
          to label %invoke.cont unwind label %lpad, !dbg !775
...
lpad:                                             ; preds = %if.then
  %8 = landingpad { i8*, i32 }
          cleanup, !dbg !777
  %9 = extractvalue { i8*, i32 } %8, 0, !dbg !777
  store i8* %9, i8** %exn.slot, align 8, !dbg !777
  %10 = extractvalue { i8*, i32 } %8, 1, !dbg !777
  store i32 %10, i32* %ehselector.slot, align 4, !dbg !777
  %11 = bitcast %"class.xercesc_2_7::DocumentFragmentImpl"* %this1 to %"class.xercesc_2_7::ParentNode"*, !dbg !778
  call void @_ZN11xercesc_2_710ParentNodeD2Ev(%"class.xercesc_2_7::ParentNode"* %11) #6, !dbg !778
  br label %eh.resume, !dbg !778

if.end:                                           ; preds = %invoke.cont, %entry
  ret void, !dbg !779

eh.resume:                                        ; preds = %lpad
  %exn = load i8*, i8** %exn.slot, align 8, !dbg !778
  %sel = load i32, i32* %ehselector.slot, align 4, !dbg !778
  %lpad.val = insertvalue { i8*, i32 } undef, i8* %exn, 0, !dbg !778
  %lpad.val2 = insertvalue { i8*, i32 } %lpad.val, i32 %sel, 1, !dbg !778
  resume { i8*, i32 } %lpad.val2, !dbg !778
}
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN11xercesc_2_710ParentNodeD2Ev(%"class.xercesc_2_7::ParentNode"* %this) unnamed_addr #1 comdat align 2 !dbg !780 {
entry:
  ...
  call void @llvm.dbg.declare(metadata %"class.xercesc_2_7::ParentNode"** %this.addr, metadata !785, metadata !DIExpression()), !dbg !787
  %this1 = load %"class.xercesc_2_7::ParentNode"*, %"class.xercesc_2_7::ParentNode"** %this.addr, align 8
  %0 = bitcast %"class.xercesc_2_7::ParentNode"* %this1 to %"class.xercesc_2_7::ChildNode"*, !dbg !788
  call void @_ZN11xercesc_2_79ChildNodeD2Ev(%"class.xercesc_2_7::ChildNode"* %0) #6, !dbg !788
  ret void, !dbg !790
}

; Function Attrs: noinline nounwind uwtable
define dso_local void @_ZN11xercesc_2_720DocumentFragmentImplD2Ev(%"class.xercesc_2_7::DocumentFragmentImpl"* %this) unnamed_addr #1 align 2 !dbg !791 {
entry:
  %this.addr = alloca %"class.xercesc_2_7::DocumentFragmentImpl"*, align 8
  store %"class.xercesc_2_7::DocumentFragmentImpl"* %this, %"class.xercesc_2_7::DocumentFragmentImpl"** %this.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.xercesc_2_7::DocumentFragmentImpl"** %this.addr, metadata !792, metadata !DIExpression()), !dbg !793
  %this1 = load %"class.xercesc_2_7::DocumentFragmentImpl"*, %"class.xercesc_2_7::DocumentFragmentImpl"** %this.addr, align 8
  %0 = bitcast %"class.xercesc_2_7::DocumentFragmentImpl"* %this1 to %"class.xercesc_2_7::ParentNode"*, !dbg !794
  call void @_ZN11xercesc_2_710ParentNodeD2Ev(%"class.xercesc_2_7::ParentNode"* %0) #6, !dbg !794
  ret void, !dbg !796
}

; Function Attrs: noinline nounwind uwtable
define dso_local void @_ZN11xercesc_2_720DocumentFragmentImplD0Ev(%"class.xercesc_2_7::DocumentFragmentImpl"* %this) unnamed_addr #1 align 2 !dbg !797 {
entry:
  %this.addr = alloca %"class.xercesc_2_7::DocumentFragmentImpl"*, align 8
  store %"class.xercesc_2_7::DocumentFragmentImpl"* %this, %"class.xercesc_2_7::DocumentFragmentImpl"** %this.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.xercesc_2_7::DocumentFragmentImpl"** %this.addr, metadata !798, metadata !DIExpression()), !dbg !799
  %this1 = load %"class.xercesc_2_7::DocumentFragmentImpl"*, %"class.xercesc_2_7::DocumentFragmentImpl"** %this.addr, align 8
  call void @_ZN11xercesc_2_720DocumentFragmentImplD1Ev(%"class.xercesc_2_7::DocumentFragmentImpl"* %this1) #6, !dbg !800
  %0 = bitcast %"class.xercesc_2_7::DocumentFragmentImpl"* %this1 to i8*, !dbg !800
  call void @_ZN11xercesc_2_77XMemorydlEPv(i8* %0) #6, !dbg !800
  ret void, !dbg !801
}
...
; Function Attrs: noinline uwtable
define dso_local %"class.xercesc_2_7::NodeImpl"* @_ZN11xercesc_2_720DocumentFragmentImpl9cloneNodeEb(%"class.xercesc_2_7::DocumentFragmentImpl"* %this, i1 zeroext %deep) unnamed_addr #3 align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) !dbg !802 {
entry:
  %this.addr = alloca %"class.xercesc_2_7::DocumentFragmentImpl"*, align 8
  %deep.addr = alloca i8, align 1
  %exn.slot = alloca i8*
  %ehselector.slot = alloca i32
  store %"class.xercesc_2_7::DocumentFragmentImpl"* %this, %"class.xercesc_2_7::DocumentFragmentImpl"** %this.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.xercesc_2_7::DocumentFragmentImpl"** %this.addr, metadata !803, metadata !DIExpression()), !dbg !804
  %frombool = zext i1 %deep to i8
  store i8 %frombool, i8* %deep.addr, align 1
  call void @llvm.dbg.declare(metadata i8* %deep.addr, metadata !805, metadata !DIExpression()), !dbg !806
  %this1 = load %"class.xercesc_2_7::DocumentFragmentImpl"*, %"class.xercesc_2_7::DocumentFragmentImpl"** %this.addr, align 8
  %0 = bitcast %"class.xercesc_2_7::DocumentFragmentImpl"* %this1 to %"class.xercesc_2_7::ParentNode"*, !dbg !807
  %1 = bitcast %"class.xercesc_2_7::ParentNode"* %0 to %"class.xercesc_2_7::DocumentImpl"* (%"class.xercesc_2_7::ParentNode"*)***, !dbg !807
  %vtable = load %"class.xercesc_2_7::DocumentImpl"* (%"class.xercesc_2_7::ParentNode"*)**, %"class.xercesc_2_7::DocumentImpl"* (%"class.xercesc_2_7::ParentNode"*)*** %1, align 8, !dbg !807
  %vfn = getelementptr inbounds %"class.xercesc_2_7::DocumentImpl"* (%"class.xercesc_2_7::ParentNode"*)*, %"class.xercesc_2_7::DocumentImpl"* (%"class.xercesc_2_7::ParentNode"*)** %vtable, i64 26, !dbg !807
  %2 = load %"class.xercesc_2_7::DocumentImpl"* (%"class.xercesc_2_7::ParentNode"*)*, %"class.xercesc_2_7::DocumentImpl"* (%"class.xercesc_2_7::ParentNode"*)** %vfn, align 8, !dbg !807
  %call = call %"class.xercesc_2_7::DocumentImpl"* %2(%"class.xercesc_2_7::ParentNode"* %0), !dbg !807
  %call2 = call %"class.xercesc_2_7::MemoryManager"* @_ZNK11xercesc_2_712DocumentImpl16getMemoryManagerEv(%"class.xercesc_2_7::DocumentImpl"* %call), !dbg !808
  %call3 = call i8* @_ZN11xercesc_2_77XMemorynwEmPNS_13MemoryManagerE(i64 88, %"class.xercesc_2_7::MemoryManager"* %call2), !dbg !809
  %3 = bitcast i8* %call3 to %"class.xercesc_2_7::DocumentFragmentImpl"*, !dbg !809
  %4 = load i8, i8* %deep.addr, align 1, !dbg !810
  %tobool = trunc i8 %4 to i1, !dbg !810
  invoke void @_ZN11xercesc_2_720DocumentFragmentImplC1ERKS0_b(%"class.xercesc_2_7::DocumentFragmentImpl"* %3, %"class.xercesc_2_7::DocumentFragmentImpl"* dereferenceable(88) %this1, i1 zeroext %tobool)
          to label %invoke.cont unwind label %lpad, !dbg !811

invoke.cont:                                      ; preds = %entry
  %5 = bitcast %"class.xercesc_2_7::DocumentFragmentImpl"* %3 to %"class.xercesc_2_7::NodeImpl"*, !dbg !809
  ret %"class.xercesc_2_7::NodeImpl"* %5, !dbg !812

lpad:                                             ; preds = %entry
  %6 = landingpad { i8*, i32 }
          cleanup, !dbg !813
  %7 = extractvalue { i8*, i32 } %6, 0, !dbg !813
  store i8* %7, i8** %exn.slot, align 8, !dbg !813
  %8 = extractvalue { i8*, i32 } %6, 1, !dbg !813
  store i32 %8, i32* %ehselector.slot, align 4, !dbg !813
  call void @_ZN11xercesc_2_77XMemorydlEPvPNS_13MemoryManagerE(i8* %call3, %"class.xercesc_2_7::MemoryManager"* %call2) #6, !dbg !809
  br label %eh.resume, !dbg !809

eh.resume:                                        ; preds = %lpad
  %exn = load i8*, i8** %exn.slot, align 8, !dbg !809
  %sel = load i32, i32* %ehselector.slot, align 4, !dbg !809
  %lpad.val = insertvalue { i8*, i32 } undef, i8* %exn, 0, !dbg !809
  %lpad.val4 = insertvalue { i8*, i32 } %lpad.val, i32 %sel, 1, !dbg !809
  resume { i8*, i32 } %lpad.val4, !dbg !809
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local %"class.xercesc_2_7::MemoryManager"* @_ZNK11xercesc_2_712DocumentImpl16getMemoryManagerEv(%"class.xercesc_2_7::DocumentImpl"* %this) #1 comdat align 2 !dbg !814 {
entry:
  ...
  call void @llvm.dbg.declare(metadata %"class.xercesc_2_7::DocumentImpl"** %this.addr, metadata !820, metadata !DIExpression()), !dbg !822
  %this1 = load %"class.xercesc_2_7::DocumentImpl"*, %"class.xercesc_2_7::DocumentImpl"** %this.addr, align 8
  %fMemoryManager = getelementptr inbounds %"class.xercesc_2_7::DocumentImpl", %"class.xercesc_2_7::DocumentImpl"* %this1, i32 0, i32 11, !dbg !823
  %0 = load %"class.xercesc_2_7::MemoryManager"*, %"class.xercesc_2_7::MemoryManager"** %fMemoryManager, align 8, !dbg !823
  ret %"class.xercesc_2_7::MemoryManager"* %0, !dbg !824
}
...
; Function Attrs: noinline uwtable
define dso_local void @_ZN11xercesc_2_720DocumentFragmentImpl11getNodeNameEv(%"class.xercesc_2_7::DOMString"* noalias sret %agg.result, %"class.xercesc_2_7::DocumentFragmentImpl"* %this) unnamed_addr #3 align 2 !dbg !825 {
entry:
  ...
  store %"class.xercesc_2_7::DocumentFragmentImpl"* %this, %"class.xercesc_2_7::DocumentFragmentImpl"** %this.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.xercesc_2_7::DocumentFragmentImpl"** %this.addr, metadata !826, metadata !DIExpression()), !dbg !827
  %this1 = load %"class.xercesc_2_7::DocumentFragmentImpl"*, %"class.xercesc_2_7::DocumentFragmentImpl"** %this.addr, align 8
  %call = call dereferenceable(8) %"class.xercesc_2_7::DOMString"* @_ZN11xercesc_2_711DStringPool15getStaticStringEPKcPPNS_9DOMStringEPFvvERNS_18XMLRegisterCleanupE(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str, i64 0, i64 0), %"class.xercesc_2_7::DOMString"** @_ZN11xercesc_2_7L3namE, void ()* @_ZN11xercesc_2_720DocumentFragmentImpl26reinitDocumentFragmentImplEv, %"class.xercesc_2_7::XMLRegisterCleanup"* dereferenceable(24) @_ZN11xercesc_2_7L10namCleanupE), !dbg !828
  call void @_ZN11xercesc_2_79DOMStringC1ERKS0_(%"class.xercesc_2_7::DOMString"* %agg.result, %"class.xercesc_2_7::DOMString"* dereferenceable(8) %call), !dbg !828
  ret void, !dbg !829
}
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_ZN11xercesc_2_720DocumentFragmentImpl26reinitDocumentFragmentImplEv() #1 align 2 !dbg !830 {
entry:
  %0 = load %"class.xercesc_2_7::DOMString"*, %"class.xercesc_2_7::DOMString"** @_ZN11xercesc_2_7L3namE, align 8, !dbg !831
  %isnull = icmp eq %"class.xercesc_2_7::DOMString"* %0, null, !dbg !832
  br i1 %isnull, label %delete.end, label %delete.notnull, !dbg !832

delete.notnull:                                   ; preds = %entry
  call void @_ZN11xercesc_2_79DOMStringD1Ev(%"class.xercesc_2_7::DOMString"* %0) #6, !dbg !832
  %1 = bitcast %"class.xercesc_2_7::DOMString"* %0 to i8*, !dbg !832
  call void @_ZN11xercesc_2_77XMemorydlEPv(i8* %1) #6, !dbg !832
  br label %delete.end, !dbg !832

delete.end:                                       ; preds = %delete.notnull, %entry
  store %"class.xercesc_2_7::DOMString"* null, %"class.xercesc_2_7::DOMString"** @_ZN11xercesc_2_7L3namE, align 8, !dbg !833
  ret void, !dbg !834
}
...
; Function Attrs: noinline nounwind uwtable
define dso_local signext i16 @_ZN11xercesc_2_720DocumentFragmentImpl11getNodeTypeEv(%"class.xercesc_2_7::DocumentFragmentImpl"* %this) unnamed_addr #1 align 2 !dbg !835 {
entry:
  %this.addr = alloca %"class.xercesc_2_7::DocumentFragmentImpl"*, align 8
  store %"class.xercesc_2_7::DocumentFragmentImpl"* %this, %"class.xercesc_2_7::DocumentFragmentImpl"** %this.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.xercesc_2_7::DocumentFragmentImpl"** %this.addr, metadata !836, metadata !DIExpression()), !dbg !837
  %this1 = load %"class.xercesc_2_7::DocumentFragmentImpl"*, %"class.xercesc_2_7::DocumentFragmentImpl"** %this.addr, align 8
  ret i16 11, !dbg !838
}

; Function Attrs: noinline nounwind uwtable
define dso_local zeroext i1 @_ZN11xercesc_2_720DocumentFragmentImpl22isDocumentFragmentImplEv(%"class.xercesc_2_7::DocumentFragmentImpl"* %this) unnamed_addr #1 align 2 !dbg !839 {
entry:
  %this.addr = alloca %"class.xercesc_2_7::DocumentFragmentImpl"*, align 8
  store %"class.xercesc_2_7::DocumentFragmentImpl"* %this, %"class.xercesc_2_7::DocumentFragmentImpl"** %this.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.xercesc_2_7::DocumentFragmentImpl"** %this.addr, metadata !840, metadata !DIExpression()), !dbg !841
  %this1 = load %"class.xercesc_2_7::DocumentFragmentImpl"*, %"class.xercesc_2_7::DocumentFragmentImpl"** %this.addr, align 8
  ret i1 true, !dbg !842
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_DocumentFragmentImpl.cpp() #3 section ".text.startup" !dbg !843 {
entry:
  call void @__cxx_global_var_init(), !dbg !845
  ret void
}
...
!1 = distinct !DIGlobalVariable(name: "namCleanup", linkageName: "_ZN11xercesc_2_7L10namCleanupE", scope: !2, file: !3, line: 32, type: !4, isLocal: true, isDefinition: true)
!2 = !DINamespace(name: "xercesc_2_7", scope: null)
!3 = !DIFile(filename: "DocumentFragmentImpl.cpp", directory: "/home/venkat/IF-DV/spec_build_release/CPU_2017/benchspec/CPU/523.xalancbmk_r/build/build_base_ld-loop-ext-m64.0000")
...
!35 = distinct !DIGlobalVariable(name: "nam", linkageName: "_ZN11xercesc_2_7L3namE", scope: !2, file: !3, line: 31, type: !36, isLocal: true, isDefinition: true)
...
!713 = distinct !DISubprogram(name: "__cxx_global_var_init", scope: !3, file: !3, line: 32, type: !10, scopeLine: 32, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !192, retainedNodes: !703)
!714 = !DILocation(line: 32, column: 27, scope: !713)
!715 = distinct !DISubprogram(name: "DocumentFragmentImpl", linkageName: "_ZN11xercesc_2_720DocumentFragmentImplC2EPNS_12DocumentImplE", scope: !716, file: !3, line: 34, type: !723, scopeLine: 36, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !192, declaration: !722, retainedNodes: !703)
!716 = distinct !DICompositeType(tag: DW_TAG_class_type, name: "DocumentFragmentImpl", scope: !2, file: !717, line: 38, size: 704, flags: DIFlagTypePassByReference | DIFlagNonTrivial, elements: !718, vtableHolder: !750)
!717 = !DIFile(filename: "./xercesc/dom/deprecated/DocumentFragmentImpl.hpp", directory: "/home/venkat/IF-DV/spec_build_release/CPU_2017/benchspec/CPU/523.xalancbmk_r/build/build_base_ld-loop-ext-m64.0000")
!718 = !{!719, !722, !729, !734, !737, !740, !743, !746, !749}
!719 = !DIDerivedType(tag: DW_TAG_inheritance, scope: !716, baseType: !720, flags: DIFlagPublic, extraData: i32 0)
!720 = !DICompositeType(tag: DW_TAG_class_type, name: "ParentNode", scope: !2, file: !721, line: 66, flags: DIFlagFwdDecl)
!721 = !DIFile(filename: "./xercesc/dom/deprecated/ParentNode.hpp", directory: "/home/venkat/IF-DV/spec_build_release/CPU_2017/benchspec/CPU/523.xalancbmk_r/build/build_base_ld-loop-ext-m64.0000")
!722 = !DISubprogram(name: "DocumentFragmentImpl", scope: !716, file: !717, line: 40, type: !723, scopeLine: 40, flags: DIFlagProtected | DIFlagPrototyped, spFlags: 0)
...
!729 = !DISubprogram(name: "DocumentFragmentImpl", scope: !716, file: !717, line: 43, type: !730, scopeLine: 43, flags: DIFlagPrototyped, spFlags: 0)
...
!734 = !DISubprogram(name: "~DocumentFragmentImpl", scope: !716, file: !717, line: 47, type: !735, scopeLine: 47, containingType: !716, virtualIndex: 0, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagVirtual)
!735 = !DISubroutineType(types: !736)
!736 = !{null, !725}
!737 = !DISubprogram(name: "cloneNode", linkageName: "_ZN11xercesc_2_720DocumentFragmentImpl9cloneNodeEb", scope: !716, file: !717, line: 48, type: !738, scopeLine: 48, containingType: !716, virtualIndex: 17, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagVirtual)
!738 = !DISubroutineType(types: !739)
!739 = !{!199, !725, !124}
!740 = !DISubprogram(name: "getNodeName", linkageName: "_ZN11xercesc_2_720DocumentFragmentImpl11getNodeNameEv", scope: !716, file: !717, line: 49, type: !741, scopeLine: 49, containingType: !716, virtualIndex: 23, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagVirtual)
!741 = !DISubroutineType(types: !742)
!742 = !{!37, !725}
!743 = !DISubprogram(name: "getNodeType", linkageName: "_ZN11xercesc_2_720DocumentFragmentImpl11getNodeTypeEv", scope: !716, file: !717, line: 50, type: !744, scopeLine: 50, containingType: !716, virtualIndex: 24, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagVirtual)
!744 = !DISubroutineType(types: !745)
!745 = !{!235, !725}
!746 = !DISubprogram(name: "isDocumentFragmentImpl", linkageName: "_ZN11xercesc_2_720DocumentFragmentImpl22isDocumentFragmentImplEv", scope: !716, file: !717, line: 51, type: !747, scopeLine: 51, containingType: !716, virtualIndex: 8, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagVirtual)
!747 = !DISubroutineType(types: !748)
!748 = !{!124, !725}
!749 = !DISubprogram(name: "reinitDocumentFragmentImpl", linkageName: "_ZN11xercesc_2_720DocumentFragmentImpl26reinitDocumentFragmentImplEv", scope: !716, file: !717, line: 56, type: !10, scopeLine: 56, flags: DIFlagPublic | DIFlagPrototyped | DIFlagStaticMember, spFlags: 0)
!750 = !DICompositeType(tag: DW_TAG_class_type, name: "RefCountedImpl", scope: !2, file: !751, line: 39, flags: DIFlagFwdDecl)
!751 = !DIFile(filename: "./xercesc/dom/deprecated/RefCountedImpl.hpp", directory: "/home/venkat/IF-DV/spec_build_release/CPU_2017/benchspec/CPU/523.xalancbmk_r/build/build_base_ld-loop-ext-m64.0000")
!752 = !DILocalVariable(name: "this", arg: 1, scope: !715, type: !753, flags: DIFlagArtificial | DIFlagObjectPointer)
!753 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !716, size: 64)
!754 = !DILocation(line: 0, scope: !715)
!755 = !DILocalVariable(name: "masterDoc", arg: 2, scope: !715, file: !3, line: 34, type: !726)
!756 = !DILocation(line: 34, column: 58, scope: !715)
!757 = !DILocation(line: 36, column: 1, scope: !715)
!758 = !DILocation(line: 35, column: 18, scope: !715)
!759 = !DILocation(line: 35, column: 7, scope: !715)
!760 = !DILocation(line: 37, column: 1, scope: !715)
!761 = distinct !DISubprogram(name: "DocumentFragmentImpl", linkageName: "_ZN11xercesc_2_720DocumentFragmentImplC2ERKS0_b", scope: !716, file: !3, line: 40, type: !730, scopeLine: 43, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !192, declaration: !729, retainedNodes: !703)
!762 = !DILocalVariable(name: "this", arg: 1, scope: !761, type: !753, flags: DIFlagArtificial | DIFlagObjectPointer)
!763 = !DILocation(line: 0, scope: !761)
!764 = !DILocalVariable(name: "other", arg: 2, scope: !761, file: !3, line: 40, type: !732)
!765 = !DILocation(line: 40, column: 72, scope: !761)
!766 = !DILocalVariable(name: "deep", arg: 3, scope: !761, file: !3, line: 41, type: !124)
!767 = !DILocation(line: 41, column: 49, scope: !761)
!768 = !DILocation(line: 43, column: 1, scope: !761)
!769 = !DILocation(line: 42, column: 18, scope: !761)
!770 = !DILocation(line: 42, column: 7, scope: !761)
!771 = !DILocation(line: 44, column: 9, scope: !772)
!772 = distinct !DILexicalBlock(scope: !773, file: !3, line: 44, column: 9)
!773 = distinct !DILexicalBlock(scope: !761, file: !3, line: 43, column: 1)
!774 = !DILocation(line: 44, column: 9, scope: !773)
!775 = !DILocation(line: 45, column: 9, scope: !772)
!776 = !DILocation(line: 45, column: 23, scope: !772)
!777 = !DILocation(line: 46, column: 1, scope: !772)
!778 = !DILocation(line: 46, column: 1, scope: !773)
!779 = !DILocation(line: 46, column: 1, scope: !761)
!780 = distinct !DISubprogram(name: "~ParentNode", linkageName: "_ZN11xercesc_2_710ParentNodeD2Ev", scope: !720, file: !721, line: 66, type: !781, scopeLine: 66, flags: DIFlagArtificial | DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !192, declaration: !784, retainedNodes: !703)
!781 = !DISubroutineType(types: !782)
!782 = !{null, !783}
!783 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !720, size: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!784 = !DISubprogram(name: "~ParentNode", scope: !720, type: !781, containingType: !720, virtualIndex: 0, flags: DIFlagPublic | DIFlagArtificial | DIFlagPrototyped, spFlags: DISPFlagVirtual)
!785 = !DILocalVariable(name: "this", arg: 1, scope: !780, type: !786, flags: DIFlagArtificial | DIFlagObjectPointer)
!786 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !720, size: 64)
!787 = !DILocation(line: 0, scope: !780)
!788 = !DILocation(line: 66, column: 29, scope: !789)
!789 = distinct !DILexicalBlock(scope: !780, file: !721, line: 66, column: 29)
!790 = !DILocation(line: 66, column: 29, scope: !780)
!791 = distinct !DISubprogram(name: "~DocumentFragmentImpl", linkageName: "_ZN11xercesc_2_720DocumentFragmentImplD2Ev", scope: !716, file: !3, line: 49, type: !735, scopeLine: 50, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !192, declaration: !734, retainedNodes: !703)
!792 = !DILocalVariable(name: "this", arg: 1, scope: !791, type: !753, flags: DIFlagArtificial | DIFlagObjectPointer)
!793 = !DILocation(line: 0, scope: !791)
!794 = !DILocation(line: 51, column: 1, scope: !795)
!795 = distinct !DILexicalBlock(scope: !791, file: !3, line: 50, column: 1)
!796 = !DILocation(line: 51, column: 1, scope: !791)
!797 = distinct !DISubprogram(name: "~DocumentFragmentImpl", linkageName: "_ZN11xercesc_2_720DocumentFragmentImplD0Ev", scope: !716, file: !3, line: 49, type: !735, scopeLine: 50, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !192, declaration: !734, retainedNodes: !703)
!798 = !DILocalVariable(name: "this", arg: 1, scope: !797, type: !753, flags: DIFlagArtificial | DIFlagObjectPointer)
!799 = !DILocation(line: 0, scope: !797)
!800 = !DILocation(line: 50, column: 1, scope: !797)
!801 = !DILocation(line: 51, column: 1, scope: !797)
!802 = distinct !DISubprogram(name: "cloneNode", linkageName: "_ZN11xercesc_2_720DocumentFragmentImpl9cloneNodeEb", scope: !716, file: !3, line: 55, type: !738, scopeLine: 56, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !192, declaration: !737, retainedNodes: !703)
!803 = !DILocalVariable(name: "this", arg: 1, scope: !802, type: !753, flags: DIFlagArtificial | DIFlagObjectPointer)
!804 = !DILocation(line: 0, scope: !802)
!805 = !DILocalVariable(name: "deep", arg: 2, scope: !802, file: !3, line: 55, type: !124)
!806 = !DILocation(line: 55, column: 48, scope: !802)
!807 = !DILocation(line: 57, column: 17, scope: !802)
!808 = !DILocation(line: 57, column: 37, scope: !802)
!809 = !DILocation(line: 57, column: 12, scope: !802)
!810 = !DILocation(line: 57, column: 85, scope: !802)
!811 = !DILocation(line: 57, column: 57, scope: !802)
!812 = !DILocation(line: 57, column: 5, scope: !802)
!813 = !DILocation(line: 58, column: 1, scope: !802)
!814 = distinct !DISubprogram(name: "getMemoryManager", linkageName: "_ZNK11xercesc_2_712DocumentImpl16getMemoryManagerEv", scope: !727, file: !728, line: 237, type: !815, scopeLine: 237, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !192, declaration: !819, retainedNodes: !703)
!815 = !DISubroutineType(types: !816)
!816 = !{!54, !817}
!817 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !818, size: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!818 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !727)
!819 = !DISubprogram(name: "getMemoryManager", linkageName: "_ZNK11xercesc_2_712DocumentImpl16getMemoryManagerEv", scope: !727, file: !728, line: 237, type: !815, scopeLine: 237, flags: DIFlagPublic | DIFlagPrototyped, spFlags: 0)
!820 = !DILocalVariable(name: "this", arg: 1, scope: !814, type: !821, flags: DIFlagArtificial | DIFlagObjectPointer)
!821 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !818, size: 64)
!822 = !DILocation(line: 0, scope: !814)
!823 = !DILocation(line: 238, column: 16, scope: !814)
!824 = !DILocation(line: 238, column: 9, scope: !814)
!825 = distinct !DISubprogram(name: "getNodeName", linkageName: "_ZN11xercesc_2_720DocumentFragmentImpl11getNodeNameEv", scope: !716, file: !3, line: 61, type: !741, scopeLine: 61, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !192, declaration: !740, retainedNodes: !703)
!826 = !DILocalVariable(name: "this", arg: 1, scope: !825, type: !753, flags: DIFlagArtificial | DIFlagObjectPointer)
!827 = !DILocation(line: 0, scope: !825)
!828 = !DILocation(line: 62, column: 12, scope: !825)
!829 = !DILocation(line: 62, column: 5, scope: !825)
!830 = distinct !DISubprogram(name: "reinitDocumentFragmentImpl", linkageName: "_ZN11xercesc_2_720DocumentFragmentImpl26reinitDocumentFragmentImplEv", scope: !716, file: !3, line: 83, type: !10, scopeLine: 83, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !192, declaration: !749, retainedNodes: !703)
!831 = !DILocation(line: 84, column: 9, scope: !830)
!832 = !DILocation(line: 84, column: 2, scope: !830)
!833 = !DILocation(line: 85, column: 6, scope: !830)
!834 = !DILocation(line: 86, column: 1, scope: !830)
!835 = distinct !DISubprogram(name: "getNodeType", linkageName: "_ZN11xercesc_2_720DocumentFragmentImpl11getNodeTypeEv", scope: !716, file: !3, line: 69, type: !744, scopeLine: 69, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !192, declaration: !743, retainedNodes: !703)
!836 = !DILocalVariable(name: "this", arg: 1, scope: !835, type: !753, flags: DIFlagArtificial | DIFlagObjectPointer)
!837 = !DILocation(line: 0, scope: !835)
!838 = !DILocation(line: 70, column: 5, scope: !835)
!839 = distinct !DISubprogram(name: "isDocumentFragmentImpl", linkageName: "_ZN11xercesc_2_720DocumentFragmentImpl22isDocumentFragmentImplEv", scope: !716, file: !3, line: 74, type: !747, scopeLine: 75, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !192, declaration: !746, retainedNodes: !703)
!840 = !DILocalVariable(name: "this", arg: 1, scope: !839, type: !753, flags: DIFlagArtificial | DIFlagObjectPointer)
!841 = !DILocation(line: 0, scope: !839)
!842 = !DILocation(line: 76, column: 9, scope: !839)
!843 = distinct !DISubprogram(linkageName: "_GLOBAL__sub_I_DocumentFragmentImpl.cpp", scope: !3, file: !3, type: !844, flags: DIFlagArtificial, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !192, retainedNodes: !703)
!844 = !DISubroutineType(types: !703)
