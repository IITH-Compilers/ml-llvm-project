...
@_ZN11xercesc_2_725DOM_ProcessingInstructionC1Ev = dso_local unnamed_addr alias void (%"class.xercesc_2_7::DOM_ProcessingInstruction"*), void (%"class.xercesc_2_7::DOM_ProcessingInstruction"*)* @_ZN11xercesc_2_725DOM_ProcessingInstructionC2Ev
@_ZN11xercesc_2_725DOM_ProcessingInstructionC1ERKS0_ = dso_local unnamed_addr alias void (%"class.xercesc_2_7::DOM_ProcessingInstruction"*, %"class.xercesc_2_7::DOM_ProcessingInstruction"*), void (%"class.xercesc_2_7::DOM_ProcessingInstruction"*, %"class.xercesc_2_7::DOM_ProcessingInstruction"*)* @_ZN11xercesc_2_725DOM_ProcessingInstructionC2ERKS0_
@_ZN11xercesc_2_725DOM_ProcessingInstructionC1EPNS_25ProcessingInstructionImplE = dso_local unnamed_addr alias void (%"class.xercesc_2_7::DOM_ProcessingInstruction"*, %"class.xercesc_2_7::ProcessingInstructionImpl"*), void (%"class.xercesc_2_7::DOM_ProcessingInstruction"*, %"class.xercesc_2_7::ProcessingInstructionImpl"*)* @_ZN11xercesc_2_725DOM_ProcessingInstructionC2EPNS_25ProcessingInstructionImplE
@_ZN11xercesc_2_725DOM_ProcessingInstructionD1Ev = dso_local unnamed_addr alias void (%"class.xercesc_2_7::DOM_ProcessingInstruction"*), void (%"class.xercesc_2_7::DOM_ProcessingInstruction"*)* @_ZN11xercesc_2_725DOM_ProcessingInstructionD2Ev

; Function Attrs: noinline uwtable
define dso_local void @_ZN11xercesc_2_725DOM_ProcessingInstructionC2Ev(%"class.xercesc_2_7::DOM_ProcessingInstruction"* %this) unnamed_addr #0 align 2 !dbg !260 {
entry:
  %this.addr = alloca %"class.xercesc_2_7::DOM_ProcessingInstruction"*, align 8
  store %"class.xercesc_2_7::DOM_ProcessingInstruction"* %this, %"class.xercesc_2_7::DOM_ProcessingInstruction"** %this.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.xercesc_2_7::DOM_ProcessingInstruction"** %this.addr, metadata !529, metadata !DIExpression()), !dbg !531
  %this1 = load %"class.xercesc_2_7::DOM_ProcessingInstruction"*, %"class.xercesc_2_7::DOM_ProcessingInstruction"** %this.addr, align 8
  %0 = bitcast %"class.xercesc_2_7::DOM_ProcessingInstruction"* %this1 to %"class.xercesc_2_7::DOM_Node"*, !dbg !532
  call void @_ZN11xercesc_2_78DOM_NodeC2EPNS_8NodeImplE(%"class.xercesc_2_7::DOM_Node"* %0, %"class.xercesc_2_7::NodeImpl"* null), !dbg !533
  ret void, !dbg !534
}
...
; Function Attrs: noinline uwtable
define dso_local void @_ZN11xercesc_2_725DOM_ProcessingInstructionC2ERKS0_(%"class.xercesc_2_7::DOM_ProcessingInstruction"* %this, %"class.xercesc_2_7::DOM_ProcessingInstruction"* dereferenceable(8) %other) unnamed_addr #0 align 2 !dbg !535 {
entry:
  %this.addr = alloca %"class.xercesc_2_7::DOM_ProcessingInstruction"*, align 8
  %other.addr = alloca %"class.xercesc_2_7::DOM_ProcessingInstruction"*, align 8
  store %"class.xercesc_2_7::DOM_ProcessingInstruction"* %this, %"class.xercesc_2_7::DOM_ProcessingInstruction"** %this.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.xercesc_2_7::DOM_ProcessingInstruction"** %this.addr, metadata !536, metadata !DIExpression()), !dbg !537
  store %"class.xercesc_2_7::DOM_ProcessingInstruction"* %other, %"class.xercesc_2_7::DOM_ProcessingInstruction"** %other.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.xercesc_2_7::DOM_ProcessingInstruction"** %other.addr, metadata !538, metadata !DIExpression()), !dbg !539
  %this1 = load %"class.xercesc_2_7::DOM_ProcessingInstruction"*, %"class.xercesc_2_7::DOM_ProcessingInstruction"** %this.addr, align 8
  %0 = bitcast %"class.xercesc_2_7::DOM_ProcessingInstruction"* %this1 to %"class.xercesc_2_7::DOM_Node"*, !dbg !540
  %1 = load %"class.xercesc_2_7::DOM_ProcessingInstruction"*, %"class.xercesc_2_7::DOM_ProcessingInstruction"** %other.addr, align 8, !dbg !541
  %2 = bitcast %"class.xercesc_2_7::DOM_ProcessingInstruction"* %1 to %"class.xercesc_2_7::DOM_Node"*, !dbg !541
  call void @_ZN11xercesc_2_78DOM_NodeC2ERKS0_(%"class.xercesc_2_7::DOM_Node"* %0, %"class.xercesc_2_7::DOM_Node"* dereferenceable(8) %2), !dbg !542
  ret void, !dbg !543
}
...
; Function Attrs: noinline uwtable
define dso_local void @_ZN11xercesc_2_725DOM_ProcessingInstructionC2EPNS_25ProcessingInstructionImplE(%"class.xercesc_2_7::DOM_ProcessingInstruction"* %this, %"class.xercesc_2_7::ProcessingInstructionImpl"* %impl) unnamed_addr #0 align 2 !dbg !544 {
entry:
  %this.addr = alloca %"class.xercesc_2_7::DOM_ProcessingInstruction"*, align 8
  %impl.addr = alloca %"class.xercesc_2_7::ProcessingInstructionImpl"*, align 8
  store %"class.xercesc_2_7::DOM_ProcessingInstruction"* %this, %"class.xercesc_2_7::DOM_ProcessingInstruction"** %this.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.xercesc_2_7::DOM_ProcessingInstruction"** %this.addr, metadata !545, metadata !DIExpression()), !dbg !546
  store %"class.xercesc_2_7::ProcessingInstructionImpl"* %impl, %"class.xercesc_2_7::ProcessingInstructionImpl"** %impl.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.xercesc_2_7::ProcessingInstructionImpl"** %impl.addr, metadata !547, metadata !DIExpression()), !dbg !548
  %this1 = load %"class.xercesc_2_7::DOM_ProcessingInstruction"*, %"class.xercesc_2_7::DOM_ProcessingInstruction"** %this.addr, align 8
  %0 = bitcast %"class.xercesc_2_7::DOM_ProcessingInstruction"* %this1 to %"class.xercesc_2_7::DOM_Node"*, !dbg !549
  %1 = load %"class.xercesc_2_7::ProcessingInstructionImpl"*, %"class.xercesc_2_7::ProcessingInstructionImpl"** %impl.addr, align 8, !dbg !550
  %2 = bitcast %"class.xercesc_2_7::ProcessingInstructionImpl"* %1 to %"class.xercesc_2_7::NodeImpl"*, !dbg !550
  call void @_ZN11xercesc_2_78DOM_NodeC2EPNS_8NodeImplE(%"class.xercesc_2_7::DOM_Node"* %0, %"class.xercesc_2_7::NodeImpl"* %2), !dbg !551
  ret void, !dbg !552
}

; Function Attrs: noinline nounwind uwtable
define dso_local void @_ZN11xercesc_2_725DOM_ProcessingInstructionD2Ev(%"class.xercesc_2_7::DOM_ProcessingInstruction"* %this) unnamed_addr #3 align 2 !dbg !553 {
entry:
  %this.addr = alloca %"class.xercesc_2_7::DOM_ProcessingInstruction"*, align 8
  store %"class.xercesc_2_7::DOM_ProcessingInstruction"* %this, %"class.xercesc_2_7::DOM_ProcessingInstruction"** %this.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.xercesc_2_7::DOM_ProcessingInstruction"** %this.addr, metadata !554, metadata !DIExpression()), !dbg !555
  %this1 = load %"class.xercesc_2_7::DOM_ProcessingInstruction"*, %"class.xercesc_2_7::DOM_ProcessingInstruction"** %this.addr, align 8
  %0 = bitcast %"class.xercesc_2_7::DOM_ProcessingInstruction"* %this1 to %"class.xercesc_2_7::DOM_Node"*, !dbg !556
  call void @_ZN11xercesc_2_78DOM_NodeD2Ev(%"class.xercesc_2_7::DOM_Node"* %0) #5, !dbg !556
  ret void, !dbg !558
}
...
; Function Attrs: noinline uwtable
define dso_local dereferenceable(8) %"class.xercesc_2_7::DOM_ProcessingInstruction"* @_ZN11xercesc_2_725DOM_ProcessingInstructionaSERKS0_(%"class.xercesc_2_7::DOM_ProcessingInstruction"* %this, %"class.xercesc_2_7::DOM_ProcessingInstruction"* dereferenceable(8) %other) #0 align 2 !dbg !559 {
entry:
  %this.addr = alloca %"class.xercesc_2_7::DOM_ProcessingInstruction"*, align 8
  %other.addr = alloca %"class.xercesc_2_7::DOM_ProcessingInstruction"*, align 8
  store %"class.xercesc_2_7::DOM_ProcessingInstruction"* %this, %"class.xercesc_2_7::DOM_ProcessingInstruction"** %this.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.xercesc_2_7::DOM_ProcessingInstruction"** %this.addr, metadata !560, metadata !DIExpression()), !dbg !561
  store %"class.xercesc_2_7::DOM_ProcessingInstruction"* %other, %"class.xercesc_2_7::DOM_ProcessingInstruction"** %other.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.xercesc_2_7::DOM_ProcessingInstruction"** %other.addr, metadata !562, metadata !DIExpression()), !dbg !563
  %this1 = load %"class.xercesc_2_7::DOM_ProcessingInstruction"*, %"class.xercesc_2_7::DOM_ProcessingInstruction"** %this.addr, align 8
  %0 = bitcast %"class.xercesc_2_7::DOM_ProcessingInstruction"* %this1 to %"class.xercesc_2_7::DOM_Node"*, !dbg !564
  %1 = load %"class.xercesc_2_7::DOM_ProcessingInstruction"*, %"class.xercesc_2_7::DOM_ProcessingInstruction"** %other.addr, align 8, !dbg !565
  %2 = bitcast %"class.xercesc_2_7::DOM_ProcessingInstruction"* %1 to %"class.xercesc_2_7::DOM_Node"*, !dbg !565
  %call = call dereferenceable(8) %"class.xercesc_2_7::DOM_Node"* @_ZN11xercesc_2_78DOM_NodeaSERKS0_(%"class.xercesc_2_7::DOM_Node"* %0, %"class.xercesc_2_7::DOM_Node"* dereferenceable(8) %2), !dbg !564
  %3 = bitcast %"class.xercesc_2_7::DOM_Node"* %call to %"class.xercesc_2_7::DOM_ProcessingInstruction"*, !dbg !566
  ret %"class.xercesc_2_7::DOM_ProcessingInstruction"* %3, !dbg !567
}
...
; Function Attrs: noinline uwtable
define dso_local dereferenceable(8) %"class.xercesc_2_7::DOM_ProcessingInstruction"* @_ZN11xercesc_2_725DOM_ProcessingInstructionaSEPKNS_11DOM_NullPtrE(%"class.xercesc_2_7::DOM_ProcessingInstruction"* %this, %"class.xercesc_2_7::DOM_NullPtr"* %other) #0 align 2 !dbg !568 {
entry:
  %this.addr = alloca %"class.xercesc_2_7::DOM_ProcessingInstruction"*, align 8
  %other.addr = alloca %"class.xercesc_2_7::DOM_NullPtr"*, align 8
  store %"class.xercesc_2_7::DOM_ProcessingInstruction"* %this, %"class.xercesc_2_7::DOM_ProcessingInstruction"** %this.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.xercesc_2_7::DOM_ProcessingInstruction"** %this.addr, metadata !569, metadata !DIExpression()), !dbg !570
  store %"class.xercesc_2_7::DOM_NullPtr"* %other, %"class.xercesc_2_7::DOM_NullPtr"** %other.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.xercesc_2_7::DOM_NullPtr"** %other.addr, metadata !571, metadata !DIExpression()), !dbg !572
  %this1 = load %"class.xercesc_2_7::DOM_ProcessingInstruction"*, %"class.xercesc_2_7::DOM_ProcessingInstruction"** %this.addr, align 8
  %0 = bitcast %"class.xercesc_2_7::DOM_ProcessingInstruction"* %this1 to %"class.xercesc_2_7::DOM_Node"*, !dbg !573
  %1 = load %"class.xercesc_2_7::DOM_NullPtr"*, %"class.xercesc_2_7::DOM_NullPtr"** %other.addr, align 8, !dbg !574
  %call = call dereferenceable(8) %"class.xercesc_2_7::DOM_Node"* @_ZN11xercesc_2_78DOM_NodeaSEPKNS_11DOM_NullPtrE(%"class.xercesc_2_7::DOM_Node"* %0, %"class.xercesc_2_7::DOM_NullPtr"* %1), !dbg !573
  %2 = bitcast %"class.xercesc_2_7::DOM_Node"* %call to %"class.xercesc_2_7::DOM_ProcessingInstruction"*, !dbg !575
  ret %"class.xercesc_2_7::DOM_ProcessingInstruction"* %2, !dbg !576
}
...
; Function Attrs: noinline uwtable
define dso_local void @_ZNK11xercesc_2_725DOM_ProcessingInstruction9getTargetEv(%"class.xercesc_2_7::DOMString"* noalias sret %agg.result, %"class.xercesc_2_7::DOM_ProcessingInstruction"* %this) #0 align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) !dbg !577 {
entry:
  ...
  store %"class.xercesc_2_7::DOM_ProcessingInstruction"* %this, %"class.xercesc_2_7::DOM_ProcessingInstruction"** %this.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.xercesc_2_7::DOM_ProcessingInstruction"** %this.addr, metadata !578, metadata !DIExpression()), !dbg !580
  %this1 = load %"class.xercesc_2_7::DOM_ProcessingInstruction"*, %"class.xercesc_2_7::DOM_ProcessingInstruction"** %this.addr, align 8
  %1 = bitcast %"class.xercesc_2_7::DOM_ProcessingInstruction"* %this1 to %"class.xercesc_2_7::DOM_Node"*, !dbg !581
  %fImpl = getelementptr inbounds %"class.xercesc_2_7::DOM_Node", %"class.xercesc_2_7::DOM_Node"* %1, i32 0, i32 0, !dbg !581
  %2 = load %"class.xercesc_2_7::NodeImpl"*, %"class.xercesc_2_7::NodeImpl"** %fImpl, align 8, !dbg !581
  %3 = bitcast %"class.xercesc_2_7::NodeImpl"* %2 to %"class.xercesc_2_7::ProcessingInstructionImpl"*, !dbg !582
  %4 = bitcast %"class.xercesc_2_7::ProcessingInstructionImpl"* %3 to void (%"class.xercesc_2_7::DOMString"*, %"class.xercesc_2_7::ProcessingInstructionImpl"*)***, !dbg !583
  %vtable = load void (%"class.xercesc_2_7::DOMString"*, %"class.xercesc_2_7::ProcessingInstructionImpl"*)**, void (%"class.xercesc_2_7::DOMString"*, %"class.xercesc_2_7::ProcessingInstructionImpl"*)*** %4, align 8, !dbg !583
  %vfn = getelementptr inbounds void (%"class.xercesc_2_7::DOMString"*, %"class.xercesc_2_7::ProcessingInstructionImpl"*)*, void (%"class.xercesc_2_7::DOMString"*, %"class.xercesc_2_7::ProcessingInstructionImpl"*)** %vtable, i64 48, !dbg !583
  %5 = load void (%"class.xercesc_2_7::DOMString"*, %"class.xercesc_2_7::ProcessingInstructionImpl"*)*, void (%"class.xercesc_2_7::DOMString"*, %"class.xercesc_2_7::ProcessingInstructionImpl"*)** %vfn, align 8, !dbg !583
  call void %5(%"class.xercesc_2_7::DOMString"* sret %ref.tmp, %"class.xercesc_2_7::ProcessingInstructionImpl"* %3), !dbg !583
  invoke void @_ZNK11xercesc_2_79DOMString5cloneEv(%"class.xercesc_2_7::DOMString"* sret %agg.result, %"class.xercesc_2_7::DOMString"* %ref.tmp)
          to label %invoke.cont unwind label %lpad, !dbg !584

invoke.cont:                                      ; preds = %entry
  call void @_ZN11xercesc_2_79DOMStringD1Ev(%"class.xercesc_2_7::DOMString"* %ref.tmp) #5, !dbg !585
  ret void, !dbg !585

lpad:                                             ; preds = %entry
  %6 = landingpad { i8*, i32 }
          cleanup, !dbg !586
  %7 = extractvalue { i8*, i32 } %6, 0, !dbg !586
  store i8* %7, i8** %exn.slot, align 8, !dbg !586
  %8 = extractvalue { i8*, i32 } %6, 1, !dbg !586
  store i32 %8, i32* %ehselector.slot, align 4, !dbg !586
  call void @_ZN11xercesc_2_79DOMStringD1Ev(%"class.xercesc_2_7::DOMString"* %ref.tmp) #5, !dbg !585
  br label %eh.resume, !dbg !585

eh.resume:                                        ; preds = %lpad
  %exn = load i8*, i8** %exn.slot, align 8, !dbg !585
  %sel = load i32, i32* %ehselector.slot, align 4, !dbg !585
  %lpad.val = insertvalue { i8*, i32 } undef, i8* %exn, 0, !dbg !585
  %lpad.val2 = insertvalue { i8*, i32 } %lpad.val, i32 %sel, 1, !dbg !585
  resume { i8*, i32 } %lpad.val2, !dbg !585
}
...
; Function Attrs: noinline uwtable
define dso_local void @_ZNK11xercesc_2_725DOM_ProcessingInstruction7getDataEv(%"class.xercesc_2_7::DOMString"* noalias sret %agg.result, %"class.xercesc_2_7::DOM_ProcessingInstruction"* %this) #0 align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) !dbg !587 {
entry:
  %result.ptr = alloca i8*, align 8
  %this.addr = alloca %"class.xercesc_2_7::DOM_ProcessingInstruction"*, align 8
  %ref.tmp = alloca %"class.xercesc_2_7::DOMString", align 8
  ...
  store i8* %0, i8** %result.ptr, align 8
  store %"class.xercesc_2_7::DOM_ProcessingInstruction"* %this, %"class.xercesc_2_7::DOM_ProcessingInstruction"** %this.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.xercesc_2_7::DOM_ProcessingInstruction"** %this.addr, metadata !588, metadata !DIExpression()), !dbg !589
  %this1 = load %"class.xercesc_2_7::DOM_ProcessingInstruction"*, %"class.xercesc_2_7::DOM_ProcessingInstruction"** %this.addr, align 8
  %1 = bitcast %"class.xercesc_2_7::DOM_ProcessingInstruction"* %this1 to %"class.xercesc_2_7::DOM_Node"*, !dbg !590
  %fImpl = getelementptr inbounds %"class.xercesc_2_7::DOM_Node", %"class.xercesc_2_7::DOM_Node"* %1, i32 0, i32 0, !dbg !590
  %2 = load %"class.xercesc_2_7::NodeImpl"*, %"class.xercesc_2_7::NodeImpl"** %fImpl, align 8, !dbg !590
  %3 = bitcast %"class.xercesc_2_7::NodeImpl"* %2 to %"class.xercesc_2_7::ProcessingInstructionImpl"*, !dbg !591
  %4 = bitcast %"class.xercesc_2_7::ProcessingInstructionImpl"* %3 to void (%"class.xercesc_2_7::DOMString"*, %"class.xercesc_2_7::ProcessingInstructionImpl"*)***, !dbg !592
  %vtable = load void (%"class.xercesc_2_7::DOMString"*, %"class.xercesc_2_7::ProcessingInstructionImpl"*)**, void (%"class.xercesc_2_7::DOMString"*, %"class.xercesc_2_7::ProcessingInstructionImpl"*)*** %4, align 8, !dbg !592
  %vfn = getelementptr inbounds void (%"class.xercesc_2_7::DOMString"*, %"class.xercesc_2_7::ProcessingInstructionImpl"*)*, void (%"class.xercesc_2_7::DOMString"*, %"class.xercesc_2_7::ProcessingInstructionImpl"*)** %vtable, i64 47, !dbg !592
  %5 = load void (%"class.xercesc_2_7::DOMString"*, %"class.xercesc_2_7::ProcessingInstructionImpl"*)*, void (%"class.xercesc_2_7::DOMString"*, %"class.xercesc_2_7::ProcessingInstructionImpl"*)** %vfn, align 8, !dbg !592
  call void %5(%"class.xercesc_2_7::DOMString"* sret %ref.tmp, %"class.xercesc_2_7::ProcessingInstructionImpl"* %3), !dbg !592
  invoke void @_ZNK11xercesc_2_79DOMString5cloneEv(%"class.xercesc_2_7::DOMString"* sret %agg.result, %"class.xercesc_2_7::DOMString"* %ref.tmp)
          to label %invoke.cont unwind label %lpad, !dbg !593

invoke.cont:                                      ; preds = %entry
  call void @_ZN11xercesc_2_79DOMStringD1Ev(%"class.xercesc_2_7::DOMString"* %ref.tmp) #5, !dbg !594
  ret void, !dbg !594

lpad:                                             ; preds = %entry
  %6 = landingpad { i8*, i32 }
          cleanup, !dbg !595
  %7 = extractvalue { i8*, i32 } %6, 0, !dbg !595
  store i8* %7, i8** %exn.slot, align 8, !dbg !595
  %8 = extractvalue { i8*, i32 } %6, 1, !dbg !595
  store i32 %8, i32* %ehselector.slot, align 4, !dbg !595
  call void @_ZN11xercesc_2_79DOMStringD1Ev(%"class.xercesc_2_7::DOMString"* %ref.tmp) #5, !dbg !594
  br label %eh.resume, !dbg !594

eh.resume:                                        ; preds = %lpad
  %exn = load i8*, i8** %exn.slot, align 8, !dbg !594
  %sel = load i32, i32* %ehselector.slot, align 4, !dbg !594
  %lpad.val = insertvalue { i8*, i32 } undef, i8* %exn, 0, !dbg !594
  %lpad.val2 = insertvalue { i8*, i32 } %lpad.val, i32 %sel, 1, !dbg !594
  resume { i8*, i32 } %lpad.val2, !dbg !594
}

; Function Attrs: noinline uwtable
define dso_local void @_ZN11xercesc_2_725DOM_ProcessingInstruction7setDataERKNS_9DOMStringE(%"class.xercesc_2_7::DOM_ProcessingInstruction"* %this, %"class.xercesc_2_7::DOMString"* dereferenceable(8) %data) #0 align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) !dbg !596 {
entry:
  %this.addr = alloca %"class.xercesc_2_7::DOM_ProcessingInstruction"*, align 8
  ...
  %ehselector.slot = alloca i32
  store %"class.xercesc_2_7::DOM_ProcessingInstruction"* %this, %"class.xercesc_2_7::DOM_ProcessingInstruction"** %this.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.xercesc_2_7::DOM_ProcessingInstruction"** %this.addr, metadata !597, metadata !DIExpression()), !dbg !598
  store %"class.xercesc_2_7::DOMString"* %data, %"class.xercesc_2_7::DOMString"** %data.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.xercesc_2_7::DOMString"** %data.addr, metadata !599, metadata !DIExpression()), !dbg !600
  %this1 = load %"class.xercesc_2_7::DOM_ProcessingInstruction"*, %"class.xercesc_2_7::DOM_ProcessingInstruction"** %this.addr, align 8
  %0 = bitcast %"class.xercesc_2_7::DOM_ProcessingInstruction"* %this1 to %"class.xercesc_2_7::DOM_Node"*, !dbg !601
  %fImpl = getelementptr inbounds %"class.xercesc_2_7::DOM_Node", %"class.xercesc_2_7::DOM_Node"* %0, i32 0, i32 0, !dbg !601
  %1 = load %"class.xercesc_2_7::NodeImpl"*, %"class.xercesc_2_7::NodeImpl"** %fImpl, align 8, !dbg !601
  %2 = bitcast %"class.xercesc_2_7::NodeImpl"* %1 to %"class.xercesc_2_7::ProcessingInstructionImpl"*, !dbg !602
  %3 = load %"class.xercesc_2_7::DOMString"*, %"class.xercesc_2_7::DOMString"** %data.addr, align 8, !dbg !603
  call void @_ZNK11xercesc_2_79DOMString5cloneEv(%"class.xercesc_2_7::DOMString"* sret %ref.tmp, %"class.xercesc_2_7::DOMString"* %3), !dbg !604
  %4 = bitcast %"class.xercesc_2_7::ProcessingInstructionImpl"* %2 to void (%"class.xercesc_2_7::ProcessingInstructionImpl"*, %"class.xercesc_2_7::DOMString"*)***, !dbg !605
  %vtable = load void (%"class.xercesc_2_7::ProcessingInstructionImpl"*, %"class.xercesc_2_7::DOMString"*)**, void (%"class.xercesc_2_7::ProcessingInstructionImpl"*, %"class.xercesc_2_7::DOMString"*)*** %4, align 8, !dbg !605
  %vfn = getelementptr inbounds void (%"class.xercesc_2_7::ProcessingInstructionImpl"*, %"class.xercesc_2_7::DOMString"*)*, void (%"class.xercesc_2_7::ProcessingInstructionImpl"*, %"class.xercesc_2_7::DOMString"*)** %vtable, i64 49, !dbg !605
  %5 = load void (%"class.xercesc_2_7::ProcessingInstructionImpl"*, %"class.xercesc_2_7::DOMString"*)*, void (%"class.xercesc_2_7::ProcessingInstructionImpl"*, %"class.xercesc_2_7::DOMString"*)** %vfn, align 8, !dbg !605
  invoke void %5(%"class.xercesc_2_7::ProcessingInstructionImpl"* %2, %"class.xercesc_2_7::DOMString"* dereferenceable(8) %ref.tmp)
          to label %invoke.cont unwind label %lpad, !dbg !605

invoke.cont:                                      ; preds = %entry
  call void @_ZN11xercesc_2_79DOMStringD1Ev(%"class.xercesc_2_7::DOMString"* %ref.tmp) #5, !dbg !606
  ret void, !dbg !607

lpad:                                             ; preds = %entry
  %6 = landingpad { i8*, i32 }
          cleanup, !dbg !607
  %7 = extractvalue { i8*, i32 } %6, 0, !dbg !607
  store i8* %7, i8** %exn.slot, align 8, !dbg !607
  %8 = extractvalue { i8*, i32 } %6, 1, !dbg !607
  store i32 %8, i32* %ehselector.slot, align 4, !dbg !607
  call void @_ZN11xercesc_2_79DOMStringD1Ev(%"class.xercesc_2_7::DOMString"* %ref.tmp) #5, !dbg !606
  br label %eh.resume, !dbg !606

eh.resume:                                        ; preds = %lpad
  %exn = load i8*, i8** %exn.slot, align 8, !dbg !606
  %sel = load i32, i32* %ehselector.slot, align 4, !dbg !606
  %lpad.val = insertvalue { i8*, i32 } undef, i8* %exn, 0, !dbg !606
  %lpad.val2 = insertvalue { i8*, i32 } %lpad.val, i32 %sel, 1, !dbg !606
  resume { i8*, i32 } %lpad.val2, !dbg !606
}
...
!1 = !DIFile(filename: "DOM_ProcessingInstruction.cpp", directory: "/home/venkat/IF-DV/spec_build_release/CPU_2017/benchspec/CPU/523.xalancbmk_r/build/build_base_ld-loop-ext-m64.0000")
!2 = !{}
!3 = !{!4}
!4 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !5, size: 64)
!5 = !DICompositeType(tag: DW_TAG_class_type, name: "ProcessingInstructionImpl", scope: !7, file: !6, line: 42, flags: DIFlagFwdDecl)
!6 = !DIFile(filename: "./xercesc/dom/deprecated/ProcessingInstructionImpl.hpp", directory: "/home/venkat/IF-DV/spec_build_release/CPU_2017/benchspec/CPU/523.xalancbmk_r/build/build_base_ld-loop-ext-m64.0000")
...
!260 = distinct !DISubprogram(name: "DOM_ProcessingInstruction", linkageName: "_ZN11xercesc_2_725DOM_ProcessingInstructionC2Ev", scope: !261, file: !1, line: 27, type: !502, scopeLine: 29, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, declaration: !501, retainedNodes: !2)
!261 = distinct !DICompositeType(tag: DW_TAG_class_type, name: "DOM_ProcessingInstruction", scope: !7, file: !262, line: 37, size: 64, flags: DIFlagTypePassByReference | DIFlagNonTrivial, elements: !263, identifier: "_ZTSN11xercesc_2_725DOM_ProcessingInstructionE")
!262 = !DIFile(filename: "./xercesc/dom/deprecated/DOM_ProcessingInstruction.hpp", directory: "/home/venkat/IF-DV/spec_build_release/CPU_2017/benchspec/CPU/523.xalancbmk_r/build/build_base_ld-loop-ext-m64.0000")
!263 = !{!264, !501, !505, !510, !514, !517, !518, !522, !523, !526}
...
!500 = !{null, !275, !269}
!501 = !DISubprogram(name: "DOM_ProcessingInstruction", scope: !261, file: !262, line: 51, type: !502, scopeLine: 51, flags: DIFlagPublic | DIFlagPrototyped, spFlags: 0)
!502 = !DISubroutineType(types: !503)
!503 = !{null, !504}
!504 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !261, size: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!505 = !DISubprogram(name: "DOM_ProcessingInstruction", scope: !261, file: !262, line: 61, type: !506, scopeLine: 61, flags: DIFlagPublic | DIFlagPrototyped, spFlags: 0)
...
!510 = !DISubprogram(name: "operator=", linkageName: "_ZN11xercesc_2_725DOM_ProcessingInstructionaSERKS0_", scope: !261, file: !262, line: 68, type: !511, scopeLine: 68, flags: DIFlagPublic | DIFlagPrototyped, spFlags: 0)
!511 = !DISubroutineType(types: !512)
!512 = !{!513, !504, !508}
!513 = !DIDerivedType(tag: DW_TAG_reference_type, baseType: !261, size: 64)
!514 = !DISubprogram(name: "operator=", linkageName: "_ZN11xercesc_2_725DOM_ProcessingInstructionaSEPKNS_11DOM_NullPtrE", scope: !261, file: !262, line: 83, type: !515, scopeLine: 83, flags: DIFlagPublic | DIFlagPrototyped, spFlags: 0)
!515 = !DISubroutineType(types: !516)
!516 = !{!513, !504, !288}
!517 = !DISubprogram(name: "~DOM_ProcessingInstruction", scope: !261, file: !262, line: 93, type: !502, scopeLine: 93, flags: DIFlagPublic | DIFlagPrototyped, spFlags: 0)
!518 = !DISubprogram(name: "getTarget", linkageName: "_ZNK11xercesc_2_725DOM_ProcessingInstruction9getTargetEv", scope: !261, file: !262, line: 104, type: !519, scopeLine: 104, flags: DIFlagPublic | DIFlagPrototyped, spFlags: 0)
!519 = !DISubroutineType(types: !520)
!520 = !{!306, !521}
!521 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !509, size: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!522 = !DISubprogram(name: "getData", linkageName: "_ZNK11xercesc_2_725DOM_ProcessingInstruction7getDataEv", scope: !261, file: !262, line: 115, type: !519, scopeLine: 115, flags: DIFlagPublic | DIFlagPrototyped, spFlags: 0)
!523 = !DISubprogram(name: "setData", linkageName: "_ZN11xercesc_2_725DOM_ProcessingInstruction7setDataERKNS_9DOMStringE", scope: !261, file: !262, line: 128, type: !524, scopeLine: 128, flags: DIFlagPublic | DIFlagPrototyped, spFlags: 0)
!524 = !DISubroutineType(types: !525)
!525 = !{null, !504, !346}
!526 = !DISubprogram(name: "DOM_ProcessingInstruction", scope: !261, file: !262, line: 132, type: !527, scopeLine: 132, flags: DIFlagProtected | DIFlagPrototyped, spFlags: 0)
!527 = !DISubroutineType(types: !528)
!528 = !{null, !504, !4}
!529 = !DILocalVariable(name: "this", arg: 1, scope: !260, type: !530, flags: DIFlagArtificial | DIFlagObjectPointer)
!530 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !261, size: 64)
!531 = !DILocation(line: 0, scope: !260)
!532 = !DILocation(line: 29, column: 1, scope: !260)
!533 = !DILocation(line: 28, column: 3, scope: !260)
!534 = !DILocation(line: 30, column: 1, scope: !260)
!535 = distinct !DISubprogram(name: "DOM_ProcessingInstruction", linkageName: "_ZN11xercesc_2_725DOM_ProcessingInstructionC2ERKS0_", scope: !261, file: !1, line: 33, type: !506, scopeLine: 36, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, declaration: !505, retainedNodes: !2)
!536 = !DILocalVariable(name: "this", arg: 1, scope: !535, type: !530, flags: DIFlagArtificial | DIFlagObjectPointer)
!537 = !DILocation(line: 0, scope: !535)
!538 = !DILocalVariable(name: "other", arg: 2, scope: !535, file: !1, line: 34, type: !508)
!539 = !DILocation(line: 34, column: 82, scope: !535)
!540 = !DILocation(line: 36, column: 1, scope: !535)
!541 = !DILocation(line: 35, column: 12, scope: !535)
!542 = !DILocation(line: 35, column: 3, scope: !535)
!543 = !DILocation(line: 37, column: 1, scope: !535)
!544 = distinct !DISubprogram(name: "DOM_ProcessingInstruction", linkageName: "_ZN11xercesc_2_725DOM_ProcessingInstructionC2EPNS_25ProcessingInstructionImplE", scope: !261, file: !1, line: 40, type: !527, scopeLine: 43, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, declaration: !526, retainedNodes: !2)
!545 = !DILocalVariable(name: "this", arg: 1, scope: !544, type: !530, flags: DIFlagArtificial | DIFlagObjectPointer)
!546 = !DILocation(line: 0, scope: !544)
!547 = !DILocalVariable(name: "impl", arg: 2, scope: !544, file: !1, line: 41, type: !4)
!548 = !DILocation(line: 41, column: 75, scope: !544)
!549 = !DILocation(line: 43, column: 1, scope: !544)
!550 = !DILocation(line: 42, column: 13, scope: !544)
!551 = !DILocation(line: 42, column: 4, scope: !544)
!552 = !DILocation(line: 44, column: 1, scope: !544)
!553 = distinct !DISubprogram(name: "~DOM_ProcessingInstruction", linkageName: "_ZN11xercesc_2_725DOM_ProcessingInstructionD2Ev", scope: !261, file: !1, line: 47, type: !502, scopeLine: 48, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, declaration: !517, retainedNodes: !2)
!554 = !DILocalVariable(name: "this", arg: 1, scope: !553, type: !530, flags: DIFlagArtificial | DIFlagObjectPointer)
!555 = !DILocation(line: 0, scope: !553)
!556 = !DILocation(line: 49, column: 1, scope: !557)
!557 = distinct !DILexicalBlock(scope: !553, file: !1, line: 48, column: 1)
!558 = !DILocation(line: 49, column: 1, scope: !553)
!559 = distinct !DISubprogram(name: "operator=", linkageName: "_ZN11xercesc_2_725DOM_ProcessingInstructionaSERKS0_", scope: !261, file: !1, line: 52, type: !511, scopeLine: 54, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, declaration: !510, retainedNodes: !2)
!560 = !DILocalVariable(name: "this", arg: 1, scope: !559, type: !530, flags: DIFlagArtificial | DIFlagObjectPointer)
!561 = !DILocation(line: 0, scope: !559)
!562 = !DILocalVariable(name: "other", arg: 2, scope: !559, file: !1, line: 53, type: !508)
!563 = !DILocation(line: 53, column: 75, scope: !559)
!564 = !DILocation(line: 55, column: 52, scope: !559)
!565 = !DILocation(line: 55, column: 64, scope: !559)
!566 = !DILocation(line: 55, column: 12, scope: !559)
!567 = !DILocation(line: 55, column: 5, scope: !559)
!568 = distinct !DISubprogram(name: "operator=", linkageName: "_ZN11xercesc_2_725DOM_ProcessingInstructionaSEPKNS_11DOM_NullPtrE", scope: !261, file: !1, line: 59, type: !515, scopeLine: 60, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, declaration: !514, retainedNodes: !2)
!569 = !DILocalVariable(name: "this", arg: 1, scope: !568, type: !530, flags: DIFlagArtificial | DIFlagObjectPointer)
!570 = !DILocation(line: 0, scope: !568)
!571 = !DILocalVariable(name: "other", arg: 2, scope: !568, file: !1, line: 59, type: !288)
!572 = !DILocation(line: 59, column: 87, scope: !568)
!573 = !DILocation(line: 61, column: 52, scope: !568)
!574 = !DILocation(line: 61, column: 64, scope: !568)
!575 = !DILocation(line: 61, column: 12, scope: !568)
!576 = !DILocation(line: 61, column: 5, scope: !568)
!577 = distinct !DISubprogram(name: "getTarget", linkageName: "_ZNK11xercesc_2_725DOM_ProcessingInstruction9getTargetEv", scope: !261, file: !1, line: 66, type: !519, scopeLine: 67, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, declaration: !518, retainedNodes: !2)
!578 = !DILocalVariable(name: "this", arg: 1, scope: !577, type: !579, flags: DIFlagArtificial | DIFlagObjectPointer)
!579 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !509, size: 64)
!580 = !DILocation(line: 0, scope: !577)
!581 = !DILocation(line: 68, column: 42, scope: !577)
!582 = !DILocation(line: 68, column: 13, scope: !577)
!583 = !DILocation(line: 68, column: 50, scope: !577)
!584 = !DILocation(line: 68, column: 62, scope: !577)
!585 = !DILocation(line: 68, column: 5, scope: !577)
!586 = !DILocation(line: 69, column: 1, scope: !577)
!587 = distinct !DISubprogram(name: "getData", linkageName: "_ZNK11xercesc_2_725DOM_ProcessingInstruction7getDataEv", scope: !261, file: !1, line: 72, type: !519, scopeLine: 73, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, declaration: !522, retainedNodes: !2)
!588 = !DILocalVariable(name: "this", arg: 1, scope: !587, type: !579, flags: DIFlagArtificial | DIFlagObjectPointer)
!589 = !DILocation(line: 0, scope: !587)
!590 = !DILocation(line: 74, column: 42, scope: !587)
!591 = !DILocation(line: 74, column: 13, scope: !587)
!592 = !DILocation(line: 74, column: 50, scope: !587)
!593 = !DILocation(line: 74, column: 60, scope: !587)
!594 = !DILocation(line: 74, column: 5, scope: !587)
!595 = !DILocation(line: 75, column: 1, scope: !587)
!596 = distinct !DISubprogram(name: "setData", linkageName: "_ZN11xercesc_2_725DOM_ProcessingInstruction7setDataERKNS_9DOMStringE", scope: !261, file: !1, line: 78, type: !524, scopeLine: 79, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, declaration: !523, retainedNodes: !2)
!597 = !DILocalVariable(name: "this", arg: 1, scope: !596, type: !530, flags: DIFlagArtificial | DIFlagObjectPointer)
!598 = !DILocation(line: 0, scope: !596)
!599 = !DILocalVariable(name: "data", arg: 2, scope: !596, file: !1, line: 78, type: !346)
!600 = !DILocation(line: 78, column: 63, scope: !596)
!601 = !DILocation(line: 80, column: 35, scope: !596)
!602 = !DILocation(line: 80, column: 6, scope: !596)
!603 = !DILocation(line: 80, column: 51, scope: !596)
!604 = !DILocation(line: 80, column: 56, scope: !596)
!605 = !DILocation(line: 80, column: 43, scope: !596)
!606 = !DILocation(line: 80, column: 5, scope: !596)
!607 = !DILocation(line: 81, column: 1, scope: !596)
