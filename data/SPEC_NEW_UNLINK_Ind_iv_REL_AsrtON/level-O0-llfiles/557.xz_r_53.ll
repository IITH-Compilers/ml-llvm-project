...
define dso_local i64 @lzma_easy_decoder_memusage(i32 %preset) #0 !dbg !24 {
entry:
...
if.end:                                           ; preds = %entry
  ...
  %call1 = call i64 @lzma_raw_decoder_memusage(%struct.lzma_filter* %arraydecay), !dbg !99
...
!1 = !DIFile(filename: "liblzma/common/easy_decoder_memusage.c", directory: "/home/venkat/IF-DV/spec_build_release/CPU_2017/benchspec/CPU/557.xz_r/build/build_base_ld-loop-ext-m64.0000")
!2 = !{!3, !9, !16}
...
!24 = distinct !DISubprogram(name: "lzma_easy_decoder_memusage", scope: !1, file: !1, line: 17, type: !25, scopeLine: 18, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !34)
