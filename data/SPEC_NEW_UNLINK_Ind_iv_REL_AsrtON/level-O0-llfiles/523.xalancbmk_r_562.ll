...
@_ZTVN11xalanc_1_1017XalanParsedSourceE = dso_local unnamed_addr constant { [7 x i8*] } { [7 x i8*] [i8* null, i8* bitcast ({ i8*, i8* }* @_ZTIN11xalanc_1_1017XalanParsedSourceE to i8*), i8* bitcast (void (%"class.xalanc_1_10::XalanParsedSource"*)* @_ZN11xalanc_1_1017XalanParsedSourceD1Ev to i8*), i8* bitcast (void (%"class.xalanc_1_10::XalanParsedSource"*)* @_ZN11xalanc_1_1017XalanParsedSourceD0Ev to i8*), i8* bitcast (void ()* @__cxa_pure_virtual to i8*), i8* bitcast (void ()* @__cxa_pure_virtual to i8*), i8* bitcast (void ()* @__cxa_pure_virtual to i8*)] }, align 8
@_ZTVN10__cxxabiv117__class_type_infoE = external dso_local global i8*
@_ZTSN11xalanc_1_1017XalanParsedSourceE = dso_local constant [35 x i8] c"N11xalanc_1_1017XalanParsedSourceE\00", align 1
@_ZTIN11xalanc_1_1017XalanParsedSourceE = dso_local constant { i8*, i8* } { i8* bitcast (i8** getelementptr inbounds (i8*, i8** @_ZTVN10__cxxabiv117__class_type_infoE, i64 2) to i8*), i8* getelementptr inbounds ([35 x i8], [35 x i8]* @_ZTSN11xalanc_1_1017XalanParsedSourceE, i32 0, i32 0) }, align 8

@_ZN11xalanc_1_1017XalanParsedSourceD1Ev = dso_local unnamed_addr alias void (%"class.xalanc_1_10::XalanParsedSource"*), void (%"class.xalanc_1_10::XalanParsedSource"*)* @_ZN11xalanc_1_1017XalanParsedSourceD2Ev

; Function Attrs: noinline nounwind uwtable
define dso_local void @_ZN11xalanc_1_1017XalanParsedSourceC2Ev(%"class.xalanc_1_10::XalanParsedSource"* %this) unnamed_addr #0 align 2 !dbg !328 {
entry:
  %this.addr = alloca %"class.xalanc_1_10::XalanParsedSource"*, align 8
  store %"class.xalanc_1_10::XalanParsedSource"* %this, %"class.xalanc_1_10::XalanParsedSource"** %this.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.xalanc_1_10::XalanParsedSource"** %this.addr, metadata !362, metadata !DIExpression()), !dbg !364
  %this1 = load %"class.xalanc_1_10::XalanParsedSource"*, %"class.xalanc_1_10::XalanParsedSource"** %this.addr, align 8
  %0 = bitcast %"class.xalanc_1_10::XalanParsedSource"* %this1 to i32 (...)***, !dbg !365
  store i32 (...)** bitcast (i8** getelementptr inbounds ({ [7 x i8*] }, { [7 x i8*] }* @_ZTVN11xalanc_1_1017XalanParsedSourceE, i32 0, inrange i32 0, i32 2) to i32 (...)**), i32 (...)*** %0, align 8, !dbg !365
  ret void, !dbg !366
}
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_ZN11xalanc_1_1017XalanParsedSourceD2Ev(%"class.xalanc_1_10::XalanParsedSource"* %this) unnamed_addr #0 align 2 !dbg !367 {
entry:
  %this.addr = alloca %"class.xalanc_1_10::XalanParsedSource"*, align 8
  store %"class.xalanc_1_10::XalanParsedSource"* %this, %"class.xalanc_1_10::XalanParsedSource"** %this.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.xalanc_1_10::XalanParsedSource"** %this.addr, metadata !368, metadata !DIExpression()), !dbg !369
  %this1 = load %"class.xalanc_1_10::XalanParsedSource"*, %"class.xalanc_1_10::XalanParsedSource"** %this.addr, align 8
  ret void, !dbg !370
}

; Function Attrs: noinline nounwind uwtable
define dso_local void @_ZN11xalanc_1_1017XalanParsedSourceD0Ev(%"class.xalanc_1_10::XalanParsedSource"* %this) unnamed_addr #0 align 2 !dbg !371 {
entry:
  %this.addr = alloca %"class.xalanc_1_10::XalanParsedSource"*, align 8
  store %"class.xalanc_1_10::XalanParsedSource"* %this, %"class.xalanc_1_10::XalanParsedSource"** %this.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.xalanc_1_10::XalanParsedSource"** %this.addr, metadata !372, metadata !DIExpression()), !dbg !373
  %this1 = load %"class.xalanc_1_10::XalanParsedSource"*, %"class.xalanc_1_10::XalanParsedSource"** %this.addr, align 8
  call void @llvm.trap() #3, !dbg !374
  unreachable, !dbg !374
}
...
!1 = !DIFile(filename: "XalanParsedSource.cpp", directory: "/home/venkat/IF-DV/spec_build_release/CPU_2017/benchspec/CPU/523.xalancbmk_r/build/build_base_ld-loop-ext-m64.0000")
!2 = !{}
...
!328 = distinct !DISubprogram(name: "XalanParsedSource", linkageName: "_ZN11xalanc_1_1017XalanParsedSourceC2Ev", scope: !329, file: !1, line: 24, type: !336, scopeLine: 25, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, declaration: !335, retainedNodes: !2)
!329 = distinct !DICompositeType(tag: DW_TAG_class_type, name: "XalanParsedSource", scope: !8, file: !330, line: 75, size: 64, flags: DIFlagTypePassByReference | DIFlagNonTrivial, elements: !331, vtableHolder: !329)
!330 = !DIFile(filename: "./xalanc/XalanTransformer/XalanParsedSource.hpp", directory: "/home/venkat/IF-DV/spec_build_release/CPU_2017/benchspec/CPU/523.xalancbmk_r/build/build_base_ld-loop-ext-m64.0000")
!331 = !{!332, !335, !339, !340, !348, !355}
!332 = !DIDerivedType(tag: DW_TAG_member, name: "_vptr$XalanParsedSource", scope: !330, file: !330, baseType: !333, size: 64, flags: DIFlagArtificial)
!333 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !334, size: 64)
!334 = !DIDerivedType(tag: DW_TAG_pointer_type, name: "__vtbl_ptr_type", baseType: !192, size: 64)
!335 = !DISubprogram(name: "XalanParsedSource", scope: !329, file: !330, line: 79, type: !336, scopeLine: 79, flags: DIFlagPublic | DIFlagPrototyped, spFlags: 0)
!336 = !DISubroutineType(types: !337)
!337 = !{null, !338}
!338 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !329, size: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!339 = !DISubprogram(name: "~XalanParsedSource", scope: !329, file: !330, line: 82, type: !336, scopeLine: 82, containingType: !329, virtualIndex: 0, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagVirtual)
!340 = !DISubprogram(name: "getDocument", linkageName: "_ZNK11xalanc_1_1017XalanParsedSource11getDocumentEv", scope: !329, file: !330, line: 91, type: !341, scopeLine: 91, containingType: !329, virtualIndex: 2, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagPureVirtual)
!341 = !DISubroutineType(types: !342)
!342 = !{!343, !346}
!343 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !344, size: 64)
!344 = !DICompositeType(tag: DW_TAG_class_type, name: "XalanDocument", scope: !8, file: !345, line: 51, flags: DIFlagFwdDecl)
!345 = !DIFile(filename: "./xalanc/XalanDOM/XalanDocument.hpp", directory: "/home/venkat/IF-DV/spec_build_release/CPU_2017/benchspec/CPU/523.xalancbmk_r/build/build_base_ld-loop-ext-m64.0000")
!346 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !347, size: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!347 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !329)
!348 = !DISubprogram(name: "createHelper", linkageName: "_ZNK11xalanc_1_1017XalanParsedSource12createHelperERN11xercesc_2_713MemoryManagerE", scope: !329, file: !330, line: 102, type: !349, scopeLine: 102, containingType: !329, virtualIndex: 3, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagPureVirtual)
!349 = !DISubroutineType(types: !350)
!350 = !{!351, !346, !353}
!351 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !352, size: 64)
!352 = !DICompositeType(tag: DW_TAG_class_type, name: "XalanParsedSourceHelper", scope: !8, file: !330, line: 43, flags: DIFlagFwdDecl, identifier: "_ZTSN11xalanc_1_1023XalanParsedSourceHelperE")
!353 = !DIDerivedType(tag: DW_TAG_reference_type, baseType: !354, size: 64)
!354 = !DIDerivedType(tag: DW_TAG_typedef, name: "MemoryManagerType", scope: !8, file: !323, line: 39, baseType: !321)
!355 = !DISubprogram(name: "getURI", linkageName: "_ZNK11xalanc_1_1017XalanParsedSource6getURIEv", scope: !329, file: !330, line: 111, type: !356, scopeLine: 111, containingType: !329, virtualIndex: 4, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagPureVirtual)
...
!360 = !DICompositeType(tag: DW_TAG_class_type, name: "XalanDOMString", scope: !8, file: !361, line: 29, flags: DIFlagFwdDecl, identifier: "_ZTSN11xalanc_1_1014XalanDOMStringE")
!361 = !DIFile(filename: "./xalanc/XalanDOM/XalanNode.hpp", directory: "/home/venkat/IF-DV/spec_build_release/CPU_2017/benchspec/CPU/523.xalancbmk_r/build/build_base_ld-loop-ext-m64.0000")
!362 = !DILocalVariable(name: "this", arg: 1, scope: !328, type: !363, flags: DIFlagArtificial | DIFlagObjectPointer)
!363 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !329, size: 64)
!364 = !DILocation(line: 0, scope: !328)
!365 = !DILocation(line: 25, column: 1, scope: !328)
!366 = !DILocation(line: 26, column: 1, scope: !328)
!367 = distinct !DISubprogram(name: "~XalanParsedSource", linkageName: "_ZN11xalanc_1_1017XalanParsedSourceD2Ev", scope: !329, file: !1, line: 30, type: !336, scopeLine: 31, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, declaration: !339, retainedNodes: !2)
!368 = !DILocalVariable(name: "this", arg: 1, scope: !367, type: !363, flags: DIFlagArtificial | DIFlagObjectPointer)
!369 = !DILocation(line: 0, scope: !367)
!370 = !DILocation(line: 32, column: 1, scope: !367)
!371 = distinct !DISubprogram(name: "~XalanParsedSource", linkageName: "_ZN11xalanc_1_1017XalanParsedSourceD0Ev", scope: !329, file: !1, line: 30, type: !336, scopeLine: 31, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, declaration: !339, retainedNodes: !2)
!372 = !DILocalVariable(name: "this", arg: 1, scope: !371, type: !363, flags: DIFlagArtificial | DIFlagObjectPointer)
!373 = !DILocation(line: 0, scope: !371)
!374 = !DILocation(line: 31, column: 1, scope: !371)
