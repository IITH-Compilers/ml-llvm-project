...
define dso_local void @bmo_split_edges_exec(%struct.BMesh* %bm, %struct.BMOperator* %op) #0 !dbg !62 {
entry:
  ...
  call void @llvm.dbg.declare(metadata i8* %use_verts, metadata !284, metadata !DIExpression()), !dbg !287
  %0 = load %struct.BMOperator*, %struct.BMOperator** %op.addr, align 8, !dbg !288
  %slots_in = getelementptr inbounds %struct.BMOperator, %struct.BMOperator* %0, i32 0, i32 0, !dbg !289
  %arraydecay = getelementptr inbounds [16 x %struct.BMOpSlot], [16 x %struct.BMOpSlot]* %slots_in, i64 0, i64 0, !dbg !288
  %call = call zeroext i8 @BMO_slot_bool_get(%struct.BMOpSlot* %arraydecay, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str, i64 0, i64 0)), !dbg !290
  store i8 %call, i8* %use_verts, align 1, !dbg !287
  %1 = load %struct.BMesh*, %struct.BMesh** %bm.addr, align 8, !dbg !291
  call void @BM_mesh_elem_hflag_disable_all(%struct.BMesh* %1, i8 zeroext 2, i8 zeroext 16, i8 zeroext 0), !dbg !292
  %2 = load %struct.BMesh*, %struct.BMesh** %bm.addr, align 8, !dbg !293
  %3 = load %struct.BMOperator*, %struct.BMOperator** %op.addr, align 8, !dbg !294
  %slots_in1 = getelementptr inbounds %struct.BMOperator, %struct.BMOperator* %3, i32 0, i32 0, !dbg !295
  %arraydecay2 = getelementptr inbounds [16 x %struct.BMOpSlot], [16 x %struct.BMOpSlot]* %slots_in1, i64 0, i64 0, !dbg !294
  call void @BMO_slot_buffer_hflag_enable(%struct.BMesh* %2, %struct.BMOpSlot* %arraydecay2, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i8 zeroext 2, i8 zeroext 16, i8 zeroext 0), !dbg !296
  %4 = load i8, i8* %use_verts, align 1, !dbg !297
  %tobool = icmp ne i8 %4, 0, !dbg !297
  br i1 %tobool, label %if.then, label %if.end, !dbg !299

if.then:                                          ; preds = %entry
  %5 = load %struct.BMesh*, %struct.BMesh** %bm.addr, align 8, !dbg !300
  %6 = load %struct.BMOperator*, %struct.BMOperator** %op.addr, align 8, !dbg !302
  %slots_in3 = getelementptr inbounds %struct.BMOperator, %struct.BMOperator* %6, i32 0, i32 0, !dbg !303
  %arraydecay4 = getelementptr inbounds [16 x %struct.BMOpSlot], [16 x %struct.BMOpSlot]* %slots_in3, i64 0, i64 0, !dbg !302
  call void @BMO_slot_buffer_hflag_enable(%struct.BMesh* %5, %struct.BMOpSlot* %arraydecay4, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.2, i64 0, i64 0), i8 zeroext 1, i8 zeroext 16, i8 zeroext 0), !dbg !304
  br label %if.end, !dbg !305

if.end:                                           ; preds = %if.then, %entry
  %7 = load %struct.BMesh*, %struct.BMesh** %bm.addr, align 8, !dbg !306
  %8 = load i8, i8* %use_verts, align 1, !dbg !307
  call void @BM_mesh_edgesplit(%struct.BMesh* %7, i8 zeroext %8, i8 zeroext 1, i8 zeroext 0), !dbg !308
  %9 = load %struct.BMesh*, %struct.BMesh** %bm.addr, align 8, !dbg !309
  %10 = load %struct.BMOperator*, %struct.BMOperator** %op.addr, align 8, !dbg !310
  %11 = load %struct.BMOperator*, %struct.BMOperator** %op.addr, align 8, !dbg !311
  %slots_out = getelementptr inbounds %struct.BMOperator, %struct.BMOperator* %11, i32 0, i32 1, !dbg !312
  %arraydecay5 = getelementptr inbounds [16 x %struct.BMOpSlot], [16 x %struct.BMOpSlot]* %slots_out, i64 0, i64 0, !dbg !311
  call void @BMO_slot_buffer_from_enabled_hflag(%struct.BMesh* %9, %struct.BMOperator* %10, %struct.BMOpSlot* %arraydecay5, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.3, i64 0, i64 0), i8 zeroext 2, i8 zeroext -128), !dbg !313
  ret void, !dbg !314
}
...
!1 = !DIFile(filename: "blender/source/blender/bmesh/operators/bmo_split_edges.c", directory: "/home/venkat/IF-DV/spec_build_release/CPU_2017/benchspec/CPU/526.blender_r/build/build_base_ld-loop-ext-m64.0000")
...
!62 = distinct !DISubprogram(name: "bmo_split_edges_exec", scope: !1, file: !1, line: 38, type: !63, scopeLine: 39, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !279)
...
!279 = !{}
!280 = !DILocalVariable(name: "bm", arg: 1, scope: !62, file: !1, line: 38, type: !65)
!281 = !DILocation(line: 38, column: 34, scope: !62)
!282 = !DILocalVariable(name: "op", arg: 2, scope: !62, file: !1, line: 38, type: !277)
!283 = !DILocation(line: 38, column: 50, scope: !62)
!284 = !DILocalVariable(name: "use_verts", scope: !62, file: !1, line: 40, type: !285)
...
!287 = !DILocation(line: 40, column: 13, scope: !62)
!288 = !DILocation(line: 40, column: 43, scope: !62)
!289 = !DILocation(line: 40, column: 47, scope: !62)
!290 = !DILocation(line: 40, column: 25, scope: !62)
!291 = !DILocation(line: 42, column: 33, scope: !62)
!292 = !DILocation(line: 42, column: 2, scope: !62)
!293 = !DILocation(line: 43, column: 31, scope: !62)
!294 = !DILocation(line: 43, column: 35, scope: !62)
!295 = !DILocation(line: 43, column: 39, scope: !62)
!296 = !DILocation(line: 43, column: 2, scope: !62)
!297 = !DILocation(line: 45, column: 6, scope: !298)
!298 = distinct !DILexicalBlock(scope: !62, file: !1, line: 45, column: 6)
!299 = !DILocation(line: 45, column: 6, scope: !62)
!300 = !DILocation(line: 47, column: 32, scope: !301)
!301 = distinct !DILexicalBlock(scope: !298, file: !1, line: 45, column: 17)
!302 = !DILocation(line: 47, column: 36, scope: !301)
!303 = !DILocation(line: 47, column: 40, scope: !301)
!304 = !DILocation(line: 47, column: 3, scope: !301)
!305 = !DILocation(line: 48, column: 2, scope: !301)
!306 = !DILocation(line: 51, column: 20, scope: !62)
!307 = !DILocation(line: 51, column: 24, scope: !62)
!308 = !DILocation(line: 51, column: 2, scope: !62)
!309 = !DILocation(line: 53, column: 37, scope: !62)
!310 = !DILocation(line: 53, column: 41, scope: !62)
!311 = !DILocation(line: 53, column: 45, scope: !62)
!312 = !DILocation(line: 53, column: 49, scope: !62)
!313 = !DILocation(line: 53, column: 2, scope: !62)
!314 = !DILocation(line: 54, column: 1, scope: !62)
