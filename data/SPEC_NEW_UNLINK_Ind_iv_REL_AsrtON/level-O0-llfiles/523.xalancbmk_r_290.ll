...
entry:
  ...
  call void @_ZN11xercesc_2_710XMLDeleterD2Ev(%"class.xercesc_2_7::XMLDeleter"* %this1) #3, !dbg !280
  %0 = bitcast %"class.xercesc_2_7::XMLDeleter"* %this1 to i8*, !dbg !280
  call void @_ZdlPv(i8* %0) #4, !dbg !280
  ret void, !dbg !281
}
...
!1 = !DIFile(filename: "HeaderDummy.cpp", directory: "/home/venkat/IF-DV/spec_build_release/CPU_2017/benchspec/CPU/523.xalancbmk_r/build/build_base_ld-loop-ext-m64.0000")
!2 = !{}
