...
@_ZTVN12METomography18ProblemDescriptionE = linkonce_odr dso_local unnamed_addr constant { [4 x i8*] } { [4 x i8*] [i8* null, i8* bitcast ({ i8*, i8*, i8* }* @_ZTIN12METomography18ProblemDescriptionE to i8*), i8* bitcast (void (%"class.METomography::ProblemDescription"*)* @_ZN12METomography18ProblemDescriptionD2Ev to i8*), i8* bitcast (void (%"class.METomography::ProblemDescription"*)* @_ZN12METomography18ProblemDescriptionD0Ev to i8*)] }, comdat, align 8
...
@_ZTIN12METomography18ProblemDescriptionE = linkonce_odr dso_local constant { i8*, i8*, i8* } { i8* bitcast (i8** getelementptr inbounds (i8*, i8** @_ZTVN10__cxxabiv120__si_class_type_infoE, i64 2) to i8*), i8* getelementptr inbounds ([37 x i8], [37 x i8]* @_ZTSN12METomography18ProblemDescriptionE, i32 0, i32 0), i8* bitcast ({ i8*, i8*, i8* }* @_ZTIN9libparest5Slave10Stationary18ProblemDescriptionE to i8*) }, comdat, align 8

@_ZN12METomography18ProblemDescriptionC1Ev = dso_local unnamed_addr alias void (%"class.METomography::ProblemDescription"*), void (%"class.METomography::ProblemDescription"*)* @_ZN12METomography18ProblemDescriptionC2Ev

; Function Attrs: noinline uwtable
define dso_local void @_ZN12METomography18ProblemDescriptionC2Ev(%"class.METomography::ProblemDescription"* %this) unnamed_addr #0 align 2 !dbg !1237 {
entry:
  ...
  call void @llvm.dbg.declare(metadata %"class.METomography::ProblemDescription"** %this.addr, metadata !1252, metadata !DIExpression()), !dbg !1254
  %this1 = load %"class.METomography::ProblemDescription"*, %"class.METomography::ProblemDescription"** %this.addr, align 8
  %0 = bitcast %"class.METomography::ProblemDescription"* %this1 to %"class.libparest::Slave::Stationary::ProblemDescription"*, !dbg !1255
  call void @_ZN9libparest5Slave10Stationary18ProblemDescriptionC2Ejjj(%"class.libparest::Slave::Stationary::ProblemDescription"* %0, i32 4, i32 4, i32 1), !dbg !1256
  %1 = bitcast %"class.METomography::ProblemDescription"* %this1 to i32 (...)***, !dbg !1255
  store i32 (...)** bitcast (i8** getelementptr inbounds ({ [4 x i8*] }, { [4 x i8*] }* @_ZTVN12METomography18ProblemDescriptionE, i32 0, inrange i32 0, i32 2) to i32 (...)**), i32 (...)*** %1, align 8, !dbg !1255
  ret void, !dbg !1257
}
...
declare dso_local void @_ZN9libparest5Slave10Stationary18ProblemDescriptionC2Ejjj(%"class.libparest::Slave::Stationary::ProblemDescription"*, i32, i32, i32) unnamed_addr #2

; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN12METomography18ProblemDescriptionD2Ev(%"class.METomography::ProblemDescription"* %this) unnamed_addr #3 comdat align 2 !dbg !1258 {
entry:
  %this.addr = alloca %"class.METomography::ProblemDescription"*, align 8
  store %"class.METomography::ProblemDescription"* %this, %"class.METomography::ProblemDescription"** %this.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.METomography::ProblemDescription"** %this.addr, metadata !1260, metadata !DIExpression()), !dbg !1261
  %this1 = load %"class.METomography::ProblemDescription"*, %"class.METomography::ProblemDescription"** %this.addr, align 8
  %0 = bitcast %"class.METomography::ProblemDescription"* %this1 to %"class.libparest::Slave::Stationary::ProblemDescription"*, !dbg !1262
  call void @_ZN9libparest5Slave10Stationary18ProblemDescriptionD2Ev(%"class.libparest::Slave::Stationary::ProblemDescription"* %0) #6, !dbg !1262
  ret void, !dbg !1264
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN12METomography18ProblemDescriptionD0Ev(%"class.METomography::ProblemDescription"* %this) unnamed_addr #3 comdat align 2 !dbg !1265 {
entry:
  %this.addr = alloca %"class.METomography::ProblemDescription"*, align 8
  store %"class.METomography::ProblemDescription"* %this, %"class.METomography::ProblemDescription"** %this.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.METomography::ProblemDescription"** %this.addr, metadata !1266, metadata !DIExpression()), !dbg !1267
  %this1 = load %"class.METomography::ProblemDescription"*, %"class.METomography::ProblemDescription"** %this.addr, align 8
  call void @_ZN12METomography18ProblemDescriptionD2Ev(%"class.METomography::ProblemDescription"* %this1) #6, !dbg !1268
  %0 = bitcast %"class.METomography::ProblemDescription"* %this1 to i8*, !dbg !1268
  call void @_ZdlPv(i8* %0) #7, !dbg !1268
  ret void, !dbg !1268
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN9libparest5Slave10Stationary18ProblemDescriptionD2Ev(%"class.libparest::Slave::Stationary::ProblemDescription"* %this) unnamed_addr #3 comdat align 2 !dbg !1269 {
entry:
  ...
  call void @llvm.dbg.declare(metadata %"class.libparest::Slave::Stationary::ProblemDescription"** %this.addr, metadata !1274, metadata !DIExpression()), !dbg !1276
  ...
  %0 = bitcast %"class.libparest::Slave::Stationary::ProblemDescription"* %this1 to %"class.dealii::Subscriptor"*, !dbg !1277
  call void @_ZN6dealii11SubscriptorD2Ev(%"class.dealii::Subscriptor"* %0) #6, !dbg !1277
  ret void, !dbg !1279
}
...
!1230 = !DIImportedEntity(tag: DW_TAG_imported_module, scope: !1231, entity: !1224, file: !1232, line: 19)
!1231 = !DINamespace(name: "libparest", scope: null)
!1232 = !DIFile(filename: "include/libparest/slave/stationary/problem_description.h", directory: "/home/venkat/IF-DV/spec_build_release/CPU_2017/benchspec/CPU/510.parest_r/build/build_base_ld-loop-ext-m64.0000")
!1233 = !{i32 7, !"Dwarf Version", i32 4}
!1234 = !{i32 2, !"Debug Info Version", i32 3}
!1235 = !{i32 1, !"wchar_size", i32 4}
!1236 = !{!"clang version 10.0.1 (https://github.com/svkeerthy/IR2Vec-LoopOptimizationFramework.git 561ac470e63b728263a0ac06ef987886ac648486)"}
!1237 = distinct !DISubprogram(name: "ProblemDescription", linkageName: "_ZN12METomography18ProblemDescriptionC2Ev", scope: !1238, file: !1, line: 8, type: !1247, scopeLine: 11, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, declaration: !1246, retainedNodes: !2)
!1238 = distinct !DICompositeType(tag: DW_TAG_class_type, name: "ProblemDescription", scope: !1240, file: !1239, line: 17, size: 704, flags: DIFlagTypePassByReference | DIFlagNonTrivial, elements: !1241, vtableHolder: !1250, identifier: "_ZTSN12METomography18ProblemDescriptionE")
!1239 = !DIFile(filename: "include/me-tomography/problem_description.h", directory: "/home/venkat/IF-DV/spec_build_release/CPU_2017/benchspec/CPU/510.parest_r/build/build_base_ld-loop-ext-m64.0000")
!1240 = !DINamespace(name: "METomography", scope: null)
!1241 = !{!1242, !1246}
!1242 = !DIDerivedType(tag: DW_TAG_inheritance, scope: !1238, baseType: !1243, flags: DIFlagPublic, extraData: i32 0)
!1243 = !DICompositeType(tag: DW_TAG_class_type, name: "ProblemDescription", scope: !1244, file: !1232, line: 27, flags: DIFlagFwdDecl, identifier: "_ZTSN9libparest5Slave10Stationary18ProblemDescriptionE")
!1244 = !DINamespace(name: "Stationary", scope: !1245)
!1245 = !DINamespace(name: "Slave", scope: !1231)
!1246 = !DISubprogram(name: "ProblemDescription", scope: !1238, file: !1239, line: 20, type: !1247, scopeLine: 20, flags: DIFlagPublic | DIFlagPrototyped, spFlags: 0)
!1247 = !DISubroutineType(types: !1248)
!1248 = !{null, !1249}
!1249 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1238, size: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!1250 = !DICompositeType(tag: DW_TAG_class_type, name: "Subscriptor", scope: !1224, file: !1251, line: 53, flags: DIFlagFwdDecl)
!1251 = !DIFile(filename: "include/base/subscriptor.h", directory: "/home/venkat/IF-DV/spec_build_release/CPU_2017/benchspec/CPU/510.parest_r/build/build_base_ld-loop-ext-m64.0000")
!1252 = !DILocalVariable(name: "this", arg: 1, scope: !1237, type: !1253, flags: DIFlagArtificial | DIFlagObjectPointer)
!1253 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1238, size: 64)
!1254 = !DILocation(line: 0, scope: !1237)
!1255 = !DILocation(line: 11, column: 3, scope: !1237)
!1256 = !DILocation(line: 10, column: 5, scope: !1237)
!1257 = !DILocation(line: 11, column: 4, scope: !1237)
!1258 = distinct !DISubprogram(name: "~ProblemDescription", linkageName: "_ZN12METomography18ProblemDescriptionD2Ev", scope: !1238, file: !1239, line: 17, type: !1247, scopeLine: 17, flags: DIFlagArtificial | DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, declaration: !1259, retainedNodes: !2)
!1259 = !DISubprogram(name: "~ProblemDescription", scope: !1238, type: !1247, containingType: !1238, virtualIndex: 0, flags: DIFlagPublic | DIFlagArtificial | DIFlagPrototyped, spFlags: DISPFlagVirtual)
!1260 = !DILocalVariable(name: "this", arg: 1, scope: !1258, type: !1253, flags: DIFlagArtificial | DIFlagObjectPointer)
!1261 = !DILocation(line: 0, scope: !1258)
!1262 = !DILocation(line: 17, column: 9, scope: !1263)
!1263 = distinct !DILexicalBlock(scope: !1258, file: !1239, line: 17, column: 9)
!1264 = !DILocation(line: 17, column: 9, scope: !1258)
!1265 = distinct !DISubprogram(name: "~ProblemDescription", linkageName: "_ZN12METomography18ProblemDescriptionD0Ev", scope: !1238, file: !1239, line: 17, type: !1247, scopeLine: 17, flags: DIFlagArtificial | DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, declaration: !1259, retainedNodes: !2)
!1266 = !DILocalVariable(name: "this", arg: 1, scope: !1265, type: !1253, flags: DIFlagArtificial | DIFlagObjectPointer)
!1267 = !DILocation(line: 0, scope: !1265)
!1268 = !DILocation(line: 17, column: 9, scope: !1265)
!1269 = distinct !DISubprogram(name: "~ProblemDescription", linkageName: "_ZN9libparest5Slave10Stationary18ProblemDescriptionD2Ev", scope: !1243, file: !1232, line: 27, type: !1270, scopeLine: 27, flags: DIFlagArtificial | DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, declaration: !1273, retainedNodes: !2)
!1270 = !DISubroutineType(types: !1271)
!1271 = !{null, !1272}
!1272 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1243, size: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!1273 = !DISubprogram(name: "~ProblemDescription", scope: !1243, type: !1270, containingType: !1243, virtualIndex: 0, flags: DIFlagPublic | DIFlagArtificial | DIFlagPrototyped, spFlags: DISPFlagVirtual)
!1274 = !DILocalVariable(name: "this", arg: 1, scope: !1269, type: !1275, flags: DIFlagArtificial | DIFlagObjectPointer)
!1275 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1243, size: 64)
!1276 = !DILocation(line: 0, scope: !1269)
!1277 = !DILocation(line: 27, column: 13, scope: !1278)
!1278 = distinct !DILexicalBlock(scope: !1269, file: !1232, line: 27, column: 13)
!1279 = !DILocation(line: 27, column: 13, scope: !1269)
