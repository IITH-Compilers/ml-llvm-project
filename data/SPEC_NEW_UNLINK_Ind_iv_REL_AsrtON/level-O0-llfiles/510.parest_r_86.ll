...
%"class.dealii::internal::hp::DoFLevel" = type { %"class.std::vector" }
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_dof_levels.all_dimensions.cc, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local i32 @_ZNK6dealii8internal2hp8DoFLevelILi0EE18memory_consumptionEv(%"class.dealii::internal::hp::DoFLevel"* %this) #0 align 2 !dbg !1622 {
entry:
  ...
  call void @llvm.dbg.declare(metadata %"class.dealii::internal::hp::DoFLevel"** %this.addr, metadata !2109, metadata !DIExpression()), !dbg !2111
  %this1 = load %"class.dealii::internal::hp::DoFLevel"*, %"class.dealii::internal::hp::DoFLevel"** %this.addr, align 8
  %active_fe_indices = getelementptr inbounds %"class.dealii::internal::hp::DoFLevel", %"class.dealii::internal::hp::DoFLevel"* %this1, i32 0, i32 0, !dbg !2112
  %call = call i32 @_ZN6dealii17MemoryConsumption18memory_consumptionIjEEjRKSt6vectorIT_SaIS3_EE(%"class.std::vector"* dereferenceable(24) %active_fe_indices), !dbg !2113
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local i64 @_ZNKSt6vectorIjSaIjEE4sizeEv(%"class.std::vector"* %this) #1 comdat align 2 !dbg !2156 {
entry:
  %this.addr = alloca %"class.std::vector"*, align 8
  store %"class.std::vector"* %this, %"class.std::vector"** %this.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.std::vector"** %this.addr, metadata !2157, metadata !DIExpression()), !dbg !2159
  %this1 = load %"class.std::vector"*, %"class.std::vector"** %this.addr, align 8
  %0 = bitcast %"class.std::vector"* %this1 to %"struct.std::_Vector_base"*, !dbg !2160
  %_M_impl = getelementptr inbounds %"struct.std::_Vector_base", %"struct.std::_Vector_base"* %0, i32 0, i32 0, !dbg !2160
  %1 = bitcast %"struct.std::_Vector_base<unsigned int, std::allocator<unsigned int> >::_Vector_impl"* %_M_impl to %"struct.std::_Vector_base<unsigned int, std::allocator<unsigned int> >::_Vector_impl_data"*, !dbg !2161
  %_M_finish = getelementptr inbounds %"struct.std::_Vector_base<unsigned int, std::allocator<unsigned int> >::_Vector_impl_data", %"struct.std::_Vector_base<unsigned int, std::allocator<unsigned int> >::_Vector_impl_data"* %1, i32 0, i32 1, !dbg !2162
  %2 = load i32*, i32** %_M_finish, align 8, !dbg !2162
  %3 = bitcast %"class.std::vector"* %this1 to %"struct.std::_Vector_base"*, !dbg !2163
  %_M_impl2 = getelementptr inbounds %"struct.std::_Vector_base", %"struct.std::_Vector_base"* %3, i32 0, i32 0, !dbg !2163
  %4 = bitcast %"struct.std::_Vector_base<unsigned int, std::allocator<unsigned int> >::_Vector_impl"* %_M_impl2 to %"struct.std::_Vector_base<unsigned int, std::allocator<unsigned int> >::_Vector_impl_data"*, !dbg !2164
  %_M_start = getelementptr inbounds %"struct.std::_Vector_base<unsigned int, std::allocator<unsigned int> >::_Vector_impl_data", %"struct.std::_Vector_base<unsigned int, std::allocator<unsigned int> >::_Vector_impl_data"* %4, i32 0, i32 0, !dbg !2165
  %5 = load i32*, i32** %_M_start, align 8, !dbg !2165
  %sub.ptr.lhs.cast = ptrtoint i32* %2 to i64, !dbg !2166
  %sub.ptr.rhs.cast = ptrtoint i32* %5 to i64, !dbg !2166
  %sub.ptr.sub = sub i64 %sub.ptr.lhs.cast, %sub.ptr.rhs.cast, !dbg !2166
  %sub.ptr.div = sdiv exact i64 %sub.ptr.sub, 4, !dbg !2166
  ret i64 %sub.ptr.div, !dbg !2167
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local i32 @_ZN6dealii17MemoryConsumption18memory_consumptionEj(i32 %0) #1 comdat !dbg !2168 {
entry:
  %.addr = alloca i32, align 4
  store i32 %0, i32* %.addr, align 4
  call void @llvm.dbg.declare(metadata i32* %.addr, metadata !2171, metadata !DIExpression()), !dbg !2172
  ret i32 4, !dbg !2173
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local dereferenceable(4) i32* @_ZNKSt6vectorIjSaIjEEixEm(%"class.std::vector"* %this, i64 %__n) #1 comdat align 2 !dbg !2174 {
entry:
  %this.addr = alloca %"class.std::vector"*, align 8
  %__n.addr = alloca i64, align 8
  store %"class.std::vector"* %this, %"class.std::vector"** %this.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.std::vector"** %this.addr, metadata !2175, metadata !DIExpression()), !dbg !2176
  store i64 %__n, i64* %__n.addr, align 8
  call void @llvm.dbg.declare(metadata i64* %__n.addr, metadata !2177, metadata !DIExpression()), !dbg !2178
  %this1 = load %"class.std::vector"*, %"class.std::vector"** %this.addr, align 8
  %0 = bitcast %"class.std::vector"* %this1 to %"struct.std::_Vector_base"*, !dbg !2179
  %_M_impl = getelementptr inbounds %"struct.std::_Vector_base", %"struct.std::_Vector_base"* %0, i32 0, i32 0, !dbg !2179
  %1 = bitcast %"struct.std::_Vector_base<unsigned int, std::allocator<unsigned int> >::_Vector_impl"* %_M_impl to %"struct.std::_Vector_base<unsigned int, std::allocator<unsigned int> >::_Vector_impl_data"*, !dbg !2180
  %_M_start = getelementptr inbounds %"struct.std::_Vector_base<unsigned int, std::allocator<unsigned int> >::_Vector_impl_data", %"struct.std::_Vector_base<unsigned int, std::allocator<unsigned int> >::_Vector_impl_data"* %1, i32 0, i32 0, !dbg !2181
  %2 = load i32*, i32** %_M_start, align 8, !dbg !2181
  %3 = load i64, i64* %__n.addr, align 8, !dbg !2182
  %add.ptr = getelementptr inbounds i32, i32* %2, i64 %3, !dbg !2183
  ret i32* %add.ptr, !dbg !2184
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local i64 @_ZNKSt6vectorIjSaIjEE8capacityEv(%"class.std::vector"* %this) #1 comdat align 2 !dbg !2185 {
entry:
  %this.addr = alloca %"class.std::vector"*, align 8
  store %"class.std::vector"* %this, %"class.std::vector"** %this.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.std::vector"** %this.addr, metadata !2186, metadata !DIExpression()), !dbg !2187
  %this1 = load %"class.std::vector"*, %"class.std::vector"** %this.addr, align 8
  %0 = bitcast %"class.std::vector"* %this1 to %"struct.std::_Vector_base"*, !dbg !2188
  %_M_impl = getelementptr inbounds %"struct.std::_Vector_base", %"struct.std::_Vector_base"* %0, i32 0, i32 0, !dbg !2188
  %1 = bitcast %"struct.std::_Vector_base<unsigned int, std::allocator<unsigned int> >::_Vector_impl"* %_M_impl to %"struct.std::_Vector_base<unsigned int, std::allocator<unsigned int> >::_Vector_impl_data"*, !dbg !2189
  %_M_end_of_storage = getelementptr inbounds %"struct.std::_Vector_base<unsigned int, std::allocator<unsigned int> >::_Vector_impl_data", %"struct.std::_Vector_base<unsigned int, std::allocator<unsigned int> >::_Vector_impl_data"* %1, i32 0, i32 2, !dbg !2190
  %2 = load i32*, i32** %_M_end_of_storage, align 8, !dbg !2190
  %3 = bitcast %"class.std::vector"* %this1 to %"struct.std::_Vector_base"*, !dbg !2191
  %_M_impl2 = getelementptr inbounds %"struct.std::_Vector_base", %"struct.std::_Vector_base"* %3, i32 0, i32 0, !dbg !2191
  %4 = bitcast %"struct.std::_Vector_base<unsigned int, std::allocator<unsigned int> >::_Vector_impl"* %_M_impl2 to %"struct.std::_Vector_base<unsigned int, std::allocator<unsigned int> >::_Vector_impl_data"*, !dbg !2192
  %_M_start = getelementptr inbounds %"struct.std::_Vector_base<unsigned int, std::allocator<unsigned int> >::_Vector_impl_data", %"struct.std::_Vector_base<unsigned int, std::allocator<unsigned int> >::_Vector_impl_data"* %4, i32 0, i32 0, !dbg !2193
  %5 = load i32*, i32** %_M_start, align 8, !dbg !2193
  %sub.ptr.lhs.cast = ptrtoint i32* %2 to i64, !dbg !2194
  %sub.ptr.rhs.cast = ptrtoint i32* %5 to i64, !dbg !2194
  %sub.ptr.sub = sub i64 %sub.ptr.lhs.cast, %sub.ptr.rhs.cast, !dbg !2194
  %sub.ptr.div = sdiv exact i64 %sub.ptr.sub, 4, !dbg !2194
  ret i64 %sub.ptr.div, !dbg !2195
}

; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_dof_levels.all_dimensions.cc() #0 section ".text.startup" !dbg !2196 {
entry:
  call void @__cxx_global_var_init(), !dbg !2198
  call void @__cxx_global_var_init.1(), !dbg !2198
  call void @__cxx_global_var_init.2(), !dbg !2198
  call void @__cxx_global_var_init.3(), !dbg !2198
  call void @__cxx_global_var_init.4(), !dbg !2198
  call void @__cxx_global_var_init.5(), !dbg !2198
  call void @__cxx_global_var_init.6(), !dbg !2198
  call void @__cxx_global_var_init.7(), !dbg !2198
  call void @__cxx_global_var_init.8(), !dbg !2198
  call void @__cxx_global_var_init.9(), !dbg !2198
  ret void
}
...
!123 = !DIFile(filename: "source/hp/dof_levels.all_dimensions.cc", directory: "/home/venkat/IF-DV/spec_build_release/CPU_2017/benchspec/CPU/510.parest_r/build/build_base_ld-loop-ext-m64.0000")
!124 = !{!125}
...
!1622 = distinct !DISubprogram(name: "memory_consumption", linkageName: "_ZNK6dealii8internal2hp8DoFLevelILi0EE18memory_consumptionEv", scope: !1623, file: !123, line: 26, type: !2103, scopeLine: 27, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !122, declaration: !2102, retainedNodes: !1557)
!1623 = distinct !DICompositeType(tag: DW_TAG_class_type, name: "DoFLevel<0>", scope: !1625, file: !1624, line: 126, size: 192, flags: DIFlagTypePassByReference | DIFlagNonTrivial, elements: !1627, templateParams: !2107, identifier: "_ZTSN6dealii8internal2hp8DoFLevelILi0EEE")
!1624 = !DIFile(filename: "include/hp/dof_levels.h", directory: "/home/venkat/IF-DV/spec_build_release/CPU_2017/benchspec/CPU/510.parest_r/build/build_base_ld-loop-ext-m64.0000")
!1625 = !DINamespace(name: "hp", scope: !1626)
!1626 = !DINamespace(name: "internal", scope: !1367)
!1627 = !{!1628, !2102}
!1628 = !DIDerivedType(tag: DW_TAG_member, name: "active_fe_indices", scope: !1623, file: !1624, line: 143, baseType: !1629, size: 192, flags: DIFlagPublic)
...
!2102 = !DISubprogram(name: "memory_consumption", linkageName: "_ZNK6dealii8internal2hp8DoFLevelILi0EE18memory_consumptionEv", scope: !1623, file: !1624, line: 149, type: !2103, scopeLine: 149, flags: DIFlagPublic | DIFlagPrototyped, spFlags: 0)
...
!2107 = !{!2108}
!2108 = !DITemplateValueParameter(name: "N", type: !14, value: i32 0)
...
!2112 = !DILocation(line: 28, column: 53, scope: !1622)
!2113 = !DILocation(line: 28, column: 14, scope: !1622)
!2114 = !DILocation(line: 28, column: 7, scope: !1622)
...
!2156 = distinct !DISubprogram(name: "size", linkageName: "_ZNKSt6vectorIjSaIjEE4sizeEv", scope: !1629, file: !135, line: 918, type: !1986, scopeLine: 919, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !122, declaration: !1985, retainedNodes: !1557)
!2157 = !DILocalVariable(name: "this", arg: 1, scope: !2156, type: !2158, flags: DIFlagArtificial | DIFlagObjectPointer)
!2158 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1916, size: 64)
!2159 = !DILocation(line: 0, scope: !2156)
!2160 = !DILocation(line: 919, column: 32, scope: !2156)
!2161 = !DILocation(line: 919, column: 26, scope: !2156)
!2162 = !DILocation(line: 919, column: 40, scope: !2156)
!2163 = !DILocation(line: 919, column: 58, scope: !2156)
!2164 = !DILocation(line: 919, column: 52, scope: !2156)
!2165 = !DILocation(line: 919, column: 66, scope: !2156)
!2166 = !DILocation(line: 919, column: 50, scope: !2156)
!2167 = !DILocation(line: 919, column: 9, scope: !2156)
!2168 = distinct !DISubprogram(name: "memory_consumption", linkageName: "_ZN6dealii17MemoryConsumption18memory_consumptionEj", scope: !2117, file: !2116, line: 447, type: !2169, scopeLine: 448, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !122, retainedNodes: !1557)
!2169 = !DISubroutineType(types: !2170)
!2170 = !{!128, !1686}
!2171 = !DILocalVariable(arg: 1, scope: !2168, file: !2116, line: 447, type: !1686)
!2172 = !DILocation(line: 447, column: 54, scope: !2168)
!2173 = !DILocation(line: 449, column: 5, scope: !2168)
!2174 = distinct !DISubprogram(name: "operator[]", linkageName: "_ZNKSt6vectorIjSaIjEEixEm", scope: !1629, file: !135, line: 1061, type: !2008, scopeLine: 1062, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !122, declaration: !2007, retainedNodes: !1557)
!2175 = !DILocalVariable(name: "this", arg: 1, scope: !2174, type: !2158, flags: DIFlagArtificial | DIFlagObjectPointer)
!2176 = !DILocation(line: 0, scope: !2174)
!2177 = !DILocalVariable(name: "__n", arg: 2, scope: !2174, file: !135, line: 1061, type: !134)
!2178 = !DILocation(line: 1061, column: 28, scope: !2174)
!2179 = !DILocation(line: 1064, column: 17, scope: !2174)
!2180 = !DILocation(line: 1064, column: 11, scope: !2174)
!2181 = !DILocation(line: 1064, column: 25, scope: !2174)
!2182 = !DILocation(line: 1064, column: 36, scope: !2174)
!2183 = !DILocation(line: 1064, column: 34, scope: !2174)
!2184 = !DILocation(line: 1064, column: 2, scope: !2174)
!2185 = distinct !DISubprogram(name: "capacity", linkageName: "_ZNKSt6vectorIjSaIjEE8capacityEv", scope: !1629, file: !135, line: 998, type: !1986, scopeLine: 999, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !122, declaration: !1994, retainedNodes: !1557)
!2186 = !DILocalVariable(name: "this", arg: 1, scope: !2185, type: !2158, flags: DIFlagArtificial | DIFlagObjectPointer)
!2187 = !DILocation(line: 0, scope: !2185)
!2188 = !DILocation(line: 999, column: 32, scope: !2185)
!2189 = !DILocation(line: 999, column: 26, scope: !2185)
!2190 = !DILocation(line: 999, column: 40, scope: !2185)
!2191 = !DILocation(line: 1000, column: 13, scope: !2185)
!2192 = !DILocation(line: 1000, column: 7, scope: !2185)
!2193 = !DILocation(line: 1000, column: 21, scope: !2185)
!2194 = !DILocation(line: 1000, column: 5, scope: !2185)
!2195 = !DILocation(line: 999, column: 9, scope: !2185)
!2196 = distinct !DISubprogram(linkageName: "_GLOBAL__sub_I_dof_levels.all_dimensions.cc", scope: !123, file: !123, type: !2197, flags: DIFlagArtificial, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !122, retainedNodes: !1557)
!2197 = !DISubroutineType(types: !1557)
