...
; Function Attrs: noinline nounwind uwtable
define dso_local void @spec_init_genrand(i64 %s) #0 {
entry:
  %s.addr = alloca i64, align 8
  store i64 %s, i64* %s.addr, align 8
  %0 = load i64, i64* %s.addr, align 8
  %and = and i64 %0, 4294967295
  store i64 %and, i64* getelementptr inbounds ([624 x i64], [624 x i64]* @mt, i64 0, i64 0), align 16
  store i32 1, i32* @mti, align 4
  br label %for.cond

for.cond:                                         ; preds = %for.inc, %entry
  %1 = load i32, i32* @mti, align 4
  %cmp = icmp slt i32 %1, 624
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds [624 x i64], [624 x i64]* @mt, i64 0, i64 %idxprom
  %3 = load i64, i64* %arrayidx, align 8
  %4 = load i32, i32* @mti, align 4
  %sub1 = sub nsw i32 %4, 1
  %idxprom2 = sext i32 %sub1 to i64
  %arrayidx3 = getelementptr inbounds [624 x i64], [624 x i64]* @mt, i64 0, i64 %idxprom2
  %5 = load i64, i64* %arrayidx3, align 8
  %shr = lshr i64 %5, 30
  %xor = xor i64 %3, %shr
  %mul = mul i64 1812433253, %xor
  %6 = load i32, i32* @mti, align 4
  %conv = sext i32 %6 to i64
  %add = add i64 %mul, %conv
  %7 = load i32, i32* @mti, align 4
  %idxprom4 = sext i32 %7 to i64
  %arrayidx5 = getelementptr inbounds [624 x i64], [624 x i64]* @mt, i64 0, i64 %idxprom4
  store i64 %add, i64* %arrayidx5, align 8
  %8 = load i32, i32* @mti, align 4
  %idxprom6 = sext i32 %8 to i64
  %arrayidx7 = getelementptr inbounds [624 x i64], [624 x i64]* @mt, i64 0, i64 %idxprom6
...
entry:
  %call = call i64 @spec_genrand_int32()
...
; Function Attrs: noinline nounwind uwtable
define dso_local i64 @spec_genrand_int32() #0 {
entry:
  %y = alloca i64, align 8
  %kk = alloca i32, align 4
  %0 = load i32, i32* @mti, align 4
  %cmp = icmp sge i32 %0, 624
  br i1 %cmp, label %if.then, label %if.end47

if.then:                                          ; preds = %entry
  %1 = load i32, i32* @mti, align 4
  %cmp1 = icmp eq i32 %1, 625
...
for.body:                                         ; preds = %for.cond
  ...
  %add7 = add nsw i32 %7, 397
  %idxprom8 = sext i32 %add7 to i64
  %arrayidx9 = getelementptr inbounds [624 x i64], [624 x i64]* @mt, i64 0, i64 %idxprom8
  ...
  %and10 = and i64 %10, 1
  %arrayidx11 = getelementptr inbounds [2 x i64], [2 x i64]* @spec_genrand_int32.mag01, i64 0, i64 %and10
  %11 = load i64, i64* %arrayidx11, align 8
  %xor12 = xor i64 %xor, %11
  %12 = load i32, i32* %kk, align 4
  %idxprom13 = sext i32 %12 to i64
  %arrayidx14 = getelementptr inbounds [624 x i64], [624 x i64]* @mt, i64 0, i64 %idxprom13
...
for.body17:                                       ; preds = %for.cond15
  ...
  %add26 = add nsw i32 %19, -227
  %idxprom27 = sext i32 %add26 to i64
  %arrayidx28 = getelementptr inbounds [624 x i64], [624 x i64]* @mt, i64 0, i64 %idxprom27
  ...
  %and31 = and i64 %22, 1
  %arrayidx32 = getelementptr inbounds [2 x i64], [2 x i64]* @spec_genrand_int32.mag01, i64 0, i64 %and31
  %23 = load i64, i64* %arrayidx32, align 8
  %xor33 = xor i64 %xor30, %23
  %24 = load i32, i32* %kk, align 4
  %idxprom34 = sext i32 %24 to i64
  %arrayidx35 = getelementptr inbounds [624 x i64], [624 x i64]* @mt, i64 0, i64 %idxprom34
...
for.end38:                                        ; preds = %for.cond15
  %26 = load i64, i64* getelementptr inbounds ([624 x i64], [624 x i64]* @mt, i64 0, i64 623), align 8
  %and39 = and i64 %26, 2147483648
  %27 = load i64, i64* getelementptr inbounds ([624 x i64], [624 x i64]* @mt, i64 0, i64 0), align 16
  %and40 = and i64 %27, 2147483647
  %or41 = or i64 %and39, %and40
  store i64 %or41, i64* %y, align 8
  %28 = load i64, i64* getelementptr inbounds ([624 x i64], [624 x i64]* @mt, i64 0, i64 396), align 16
  %29 = load i64, i64* %y, align 8
  %shr42 = lshr i64 %29, 1
  %xor43 = xor i64 %28, %shr42
  %30 = load i64, i64* %y, align 8
  %and44 = and i64 %30, 1
  %arrayidx45 = getelementptr inbounds [2 x i64], [2 x i64]* @spec_genrand_int32.mag01, i64 0, i64 %and44
  %31 = load i64, i64* %arrayidx45, align 8
  %xor46 = xor i64 %xor43, %31
  store i64 %xor46, i64* getelementptr inbounds ([624 x i64], [624 x i64]* @mt, i64 0, i64 623), align 8
...
if.end47:                                         ; preds = %for.end38, %entry
  ...
  %arrayidx50 = getelementptr inbounds [624 x i64], [624 x i64]* @mt, i64 0, i64 %idxprom49
  %33 = load i64, i64* %arrayidx50, align 8
...
; Function Attrs: noinline nounwind uwtable
define dso_local i64 @spec_lrand48() #0 {
entry:
  %call = call i64 @spec_genrand_int32()
  %shr = lshr i64 %call, 1
  ret i64 %shr
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @spec_init_by_array(i64* %init_key, i32 %key_length) #0 {
entry:
  ...
  %0 = load i32, i32* %key_length.addr, align 4
  %cmp = icmp sgt i32 624, %0
...
cond.false:                                       ; preds = %entry
  %1 = load i32, i32* %key_length.addr, align 4
  br label %cond.end

cond.end:                                         ; preds = %cond.false, %cond.true
  %cond = phi i32 [ 624, %cond.true ], [ %1, %cond.false ]
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx2 = getelementptr inbounds [624 x i64], [624 x i64]* @mt, i64 0, i64 %idxprom1
  ...
  %xor6 = xor i64 %4, %mul
  %9 = load i64*, i64** %init_key.addr, align 8
  ...
  %arrayidx11 = getelementptr inbounds [624 x i64], [624 x i64]* @mt, i64 0, i64 %idxprom10
  store i64 %add9, i64* %arrayidx11, align 8
  %14 = load i32, i32* %i, align 4
  %idxprom12 = sext i32 %14 to i64
  %arrayidx13 = getelementptr inbounds [624 x i64], [624 x i64]* @mt, i64 0, i64 %idxprom12
  ...
  %cmp15 = icmp sge i32 %18, 624
  br i1 %cmp15, label %if.then, label %if.end

if.then:                                          ; preds = %for.body
  %19 = load i64, i64* getelementptr inbounds ([624 x i64], [624 x i64]* @mt, i64 0, i64 623), align 8
  store i64 %19, i64* getelementptr inbounds ([624 x i64], [624 x i64]* @mt, i64 0, i64 0), align 16
  store i32 1, i32* %i, align 4
  br label %if.end

if.end:                                           ; preds = %if.then, %for.body
  %20 = load i32, i32* %j, align 4
  %21 = load i32, i32* %key_length.addr, align 4
...
for.body23:                                       ; preds = %for.cond21
  ...
  %arrayidx25 = getelementptr inbounds [624 x i64], [624 x i64]* @mt, i64 0, i64 %idxprom24
  ...
  %arrayidx31 = getelementptr inbounds [624 x i64], [624 x i64]* @mt, i64 0, i64 %idxprom30
  ...
  %arrayidx39 = getelementptr inbounds [624 x i64], [624 x i64]* @mt, i64 0, i64 %idxprom38
  store i64 %sub37, i64* %arrayidx39, align 8
  %32 = load i32, i32* %i, align 4
  %idxprom40 = sext i32 %32 to i64
  %arrayidx41 = getelementptr inbounds [624 x i64], [624 x i64]* @mt, i64 0, i64 %idxprom40
  ...
  %cmp44 = icmp sge i32 %35, 624
  br i1 %cmp44, label %if.then46, label %if.end47

if.then46:                                        ; preds = %for.body23
  %36 = load i64, i64* getelementptr inbounds ([624 x i64], [624 x i64]* @mt, i64 0, i64 623), align 8
  store i64 %36, i64* getelementptr inbounds ([624 x i64], [624 x i64]* @mt, i64 0, i64 0), align 16
  store i32 1, i32* %i, align 4
  br label %if.end47
...
; Function Attrs: noinline nounwind uwtable
define dso_local i64 @spec_genrand_int31() #0 {
entry:
  %call = call i64 @spec_genrand_int32()
  %shr = lshr i64 %call, 1
  ret i64 %shr
...
; Function Attrs: noinline nounwind uwtable
define dso_local double @spec_genrand_real1() #0 {
entry:
  %call = call i64 @spec_genrand_int32()
  %conv = uitofp i64 %call to double
...
; Function Attrs: noinline nounwind uwtable
define dso_local double @spec_genrand_real2() #0 {
entry:
  %call = call i64 @spec_genrand_int32()
  %conv = uitofp i64 %call to double
  %mul = fmul double %conv, 0x3DF0000000000000
...
; Function Attrs: noinline nounwind uwtable
define dso_local double @spec_genrand_real3() #0 {
entry:
  %call = call i64 @spec_genrand_int32()
  %conv = uitofp i64 %call to double
  %add = fadd double %conv, 5.000000e-01
  %mul = fmul double %add, 0x3DF0000000000000
  ret double %mul
}

; Function Attrs: noinline nounwind uwtable
define dso_local double @spec_genrand_res53() #0 {
entry:
  ...
  %call1 = call i64 @spec_genrand_int32()
