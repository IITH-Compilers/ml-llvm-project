...
define dso_local i32 @tuklib_cpucores() #0 !dbg !7 {
entry:
  ...
  %0 = load i32, i32* %ret, align 4, !dbg !17
  ret i32 %0, !dbg !18
}
...
!1 = !DIFile(filename: "common/tuklib_cpucores.c", directory: "/home/venkat/IF-DV/spec_build_release/CPU_2017/benchspec/CPU/557.xz_r/build/build_base_ld-loop-ext-m64.0000")
!2 = !{}
...
!7 = distinct !DISubprogram(name: "tuklib_cpucores", scope: !1, file: !1, line: 34, type: !8, scopeLine: 35, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !2)
...
!15 = !DILocalVariable(name: "ret", scope: !7, file: !1, line: 36, type: !10)
!16 = !DILocation(line: 36, column: 11, scope: !7)
!17 = !DILocation(line: 65, column: 9, scope: !7)
!18 = !DILocation(line: 65, column: 2, scope: !7)
