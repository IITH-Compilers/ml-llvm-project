...
@_ZTVN11xercesc_2_712NodeListImplE = dso_local unnamed_addr constant { [8 x i8*] } { [8 x i8*] [i8* null, i8* bitcast ({ i8*, i8*, i8* }* @_ZTIN11xercesc_2_712NodeListImplE to i8*), i8* bitcast (void (%"class.xercesc_2_7::NodeListImpl"*)* @_ZN11xercesc_2_712NodeListImplD1Ev to i8*), i8* bitcast (void (%"class.xercesc_2_7::NodeListImpl"*)* @_ZN11xercesc_2_712NodeListImplD0Ev to i8*), i8* bitcast (void (%"class.xercesc_2_7::RefCountedImpl"*)* @_ZN11xercesc_2_714RefCountedImpl10referencedEv to i8*), i8* bitcast (void (%"class.xercesc_2_7::RefCountedImpl"*)* @_ZN11xercesc_2_714RefCountedImpl12unreferencedEv to i8*), i8* bitcast (void ()* @__cxa_pure_virtual to i8*), i8* bitcast (void ()* @__cxa_pure_virtual to i8*)] }, align 8
@_ZTVN10__cxxabiv120__si_class_type_infoE = external dso_local global i8*
@_ZTSN11xercesc_2_712NodeListImplE = dso_local constant [30 x i8] c"N11xercesc_2_712NodeListImplE\00", align 1
@_ZTIN11xercesc_2_714RefCountedImplE = external dso_local constant i8*
@_ZTIN11xercesc_2_712NodeListImplE = dso_local constant { i8*, i8*, i8* } { i8* bitcast (i8** getelementptr inbounds (i8*, i8** @_ZTVN10__cxxabiv120__si_class_type_infoE, i64 2) to i8*), i8* getelementptr inbounds ([30 x i8], [30 x i8]* @_ZTSN11xercesc_2_712NodeListImplE, i32 0, i32 0), i8* bitcast (i8** @_ZTIN11xercesc_2_714RefCountedImplE to i8*) }, align 8

@_ZN11xercesc_2_712NodeListImplD1Ev = dso_local unnamed_addr alias void (%"class.xercesc_2_7::NodeListImpl"*), void (%"class.xercesc_2_7::NodeListImpl"*)* @_ZN11xercesc_2_712NodeListImplD2Ev

; Function Attrs: noinline uwtable
define dso_local void @_ZN11xercesc_2_712NodeListImplC2Ev(%"class.xercesc_2_7::NodeListImpl"* %this) unnamed_addr #0 align 2 !dbg !256 {
entry:
  %this.addr = alloca %"class.xercesc_2_7::NodeListImpl"*, align 8
  store %"class.xercesc_2_7::NodeListImpl"* %this, %"class.xercesc_2_7::NodeListImpl"** %this.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.xercesc_2_7::NodeListImpl"** %this.addr, metadata !276, metadata !DIExpression()), !dbg !278
  %this1 = load %"class.xercesc_2_7::NodeListImpl"*, %"class.xercesc_2_7::NodeListImpl"** %this.addr, align 8
  %0 = bitcast %"class.xercesc_2_7::NodeListImpl"* %this1 to %"class.xercesc_2_7::RefCountedImpl"*, !dbg !279
  call void @_ZN11xercesc_2_714RefCountedImplC2Ev(%"class.xercesc_2_7::RefCountedImpl"* %0), !dbg !280
  %1 = bitcast %"class.xercesc_2_7::NodeListImpl"* %this1 to i32 (...)***, !dbg !279
  store i32 (...)** bitcast (i8** getelementptr inbounds ({ [8 x i8*] }, { [8 x i8*] }* @_ZTVN11xercesc_2_712NodeListImplE, i32 0, inrange i32 0, i32 2) to i32 (...)**), i32 (...)*** %1, align 8, !dbg !279
  ret void, !dbg !281
}
...
declare dso_local void @_ZN11xercesc_2_714RefCountedImplC2Ev(%"class.xercesc_2_7::RefCountedImpl"*) unnamed_addr #2

; Function Attrs: noinline nounwind uwtable
define dso_local void @_ZN11xercesc_2_712NodeListImplD2Ev(%"class.xercesc_2_7::NodeListImpl"* %this) unnamed_addr #3 align 2 !dbg !282 {
entry:
  %this.addr = alloca %"class.xercesc_2_7::NodeListImpl"*, align 8
  store %"class.xercesc_2_7::NodeListImpl"* %this, %"class.xercesc_2_7::NodeListImpl"** %this.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.xercesc_2_7::NodeListImpl"** %this.addr, metadata !283, metadata !DIExpression()), !dbg !284
  %this1 = load %"class.xercesc_2_7::NodeListImpl"*, %"class.xercesc_2_7::NodeListImpl"** %this.addr, align 8
  %0 = bitcast %"class.xercesc_2_7::NodeListImpl"* %this1 to %"class.xercesc_2_7::RefCountedImpl"*, !dbg !285
  call void @_ZN11xercesc_2_714RefCountedImplD2Ev(%"class.xercesc_2_7::RefCountedImpl"* %0) #6, !dbg !285
  ret void, !dbg !287
}

; Function Attrs: nounwind
declare dso_local void @_ZN11xercesc_2_714RefCountedImplD2Ev(%"class.xercesc_2_7::RefCountedImpl"*) unnamed_addr #4

; Function Attrs: noinline nounwind uwtable
define dso_local void @_ZN11xercesc_2_712NodeListImplD0Ev(%"class.xercesc_2_7::NodeListImpl"* %this) unnamed_addr #3 align 2 !dbg !288 {
entry:
  %this.addr = alloca %"class.xercesc_2_7::NodeListImpl"*, align 8
  store %"class.xercesc_2_7::NodeListImpl"* %this, %"class.xercesc_2_7::NodeListImpl"** %this.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.xercesc_2_7::NodeListImpl"** %this.addr, metadata !289, metadata !DIExpression()), !dbg !290
  %this1 = load %"class.xercesc_2_7::NodeListImpl"*, %"class.xercesc_2_7::NodeListImpl"** %this.addr, align 8
  call void @llvm.trap() #7, !dbg !291
  unreachable, !dbg !291
}
...
declare dso_local void @_ZN11xercesc_2_714RefCountedImpl10referencedEv(%"class.xercesc_2_7::RefCountedImpl"*) unnamed_addr #2

declare dso_local void @_ZN11xercesc_2_714RefCountedImpl12unreferencedEv(%"class.xercesc_2_7::RefCountedImpl"*) unnamed_addr #2
...
!1 = !DIFile(filename: "NodeListImpl.cpp", directory: "/home/venkat/IF-DV/spec_build_release/CPU_2017/benchspec/CPU/523.xalancbmk_r/build/build_base_ld-loop-ext-m64.0000")
!2 = !{}
...
!256 = distinct !DISubprogram(name: "NodeListImpl", linkageName: "_ZN11xercesc_2_712NodeListImplC2Ev", scope: !257, file: !1, line: 27, type: !264, scopeLine: 27, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, declaration: !263, retainedNodes: !2)
!257 = distinct !DICompositeType(tag: DW_TAG_class_type, name: "NodeListImpl", scope: !5, file: !258, line: 40, size: 128, flags: DIFlagTypePassByReference | DIFlagNonTrivial, elements: !259, vtableHolder: !261)
!258 = !DIFile(filename: "./xercesc/dom/deprecated/NodeListImpl.hpp", directory: "/home/venkat/IF-DV/spec_build_release/CPU_2017/benchspec/CPU/523.xalancbmk_r/build/build_base_ld-loop-ext-m64.0000")
...
!261 = !DICompositeType(tag: DW_TAG_class_type, name: "RefCountedImpl", scope: !5, file: !262, line: 39, flags: DIFlagFwdDecl)
!262 = !DIFile(filename: "./xercesc/dom/deprecated/RefCountedImpl.hpp", directory: "/home/venkat/IF-DV/spec_build_release/CPU_2017/benchspec/CPU/523.xalancbmk_r/build/build_base_ld-loop-ext-m64.0000")
!263 = !DISubprogram(name: "NodeListImpl", scope: !257, file: !258, line: 43, type: !264, scopeLine: 43, flags: DIFlagProtected | DIFlagPrototyped, spFlags: 0)
!264 = !DISubroutineType(types: !265)
!265 = !{null, !266}
!266 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !257, size: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!267 = !DISubprogram(name: "~NodeListImpl", scope: !257, file: !258, line: 45, type: !264, scopeLine: 45, containingType: !257, virtualIndex: 0, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagVirtual)
!268 = !DISubprogram(name: "item", linkageName: "_ZN11xercesc_2_712NodeListImpl4itemEj", scope: !257, file: !258, line: 46, type: !269, scopeLine: 46, containingType: !257, virtualIndex: 4, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagPureVirtual)
!269 = !DISubroutineType(types: !270)
!270 = !{!271, !266, !134}
!271 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !272, size: 64)
!272 = !DICompositeType(tag: DW_TAG_class_type, name: "NodeImpl", scope: !5, file: !258, line: 37, flags: DIFlagFwdDecl, identifier: "_ZTSN11xercesc_2_78NodeImplE")
!273 = !DISubprogram(name: "getLength", linkageName: "_ZN11xercesc_2_712NodeListImpl9getLengthEv", scope: !257, file: !258, line: 47, type: !274, scopeLine: 47, containingType: !257, virtualIndex: 5, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagPureVirtual)
!274 = !DISubroutineType(types: !275)
!275 = !{!134, !266}
!276 = !DILocalVariable(name: "this", arg: 1, scope: !256, type: !277, flags: DIFlagArtificial | DIFlagObjectPointer)
!277 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !257, size: 64)
!278 = !DILocation(line: 0, scope: !256)
!279 = !DILocation(line: 27, column: 30, scope: !256)
!280 = !DILocation(line: 27, column: 15, scope: !256)
!281 = !DILocation(line: 27, column: 31, scope: !256)
!282 = distinct !DISubprogram(name: "~NodeListImpl", linkageName: "_ZN11xercesc_2_712NodeListImplD2Ev", scope: !257, file: !1, line: 29, type: !264, scopeLine: 29, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, declaration: !267, retainedNodes: !2)
!283 = !DILocalVariable(name: "this", arg: 1, scope: !282, type: !277, flags: DIFlagArtificial | DIFlagObjectPointer)
!284 = !DILocation(line: 0, scope: !282)
!285 = !DILocation(line: 29, column: 32, scope: !286)
!286 = distinct !DILexicalBlock(scope: !282, file: !1, line: 29, column: 31)
!287 = !DILocation(line: 29, column: 32, scope: !282)
!288 = distinct !DISubprogram(name: "~NodeListImpl", linkageName: "_ZN11xercesc_2_712NodeListImplD0Ev", scope: !257, file: !1, line: 29, type: !264, scopeLine: 29, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, declaration: !267, retainedNodes: !2)
!289 = !DILocalVariable(name: "this", arg: 1, scope: !288, type: !277, flags: DIFlagArtificial | DIFlagObjectPointer)
!290 = !DILocation(line: 0, scope: !288)
!291 = !DILocation(line: 29, column: 31, scope: !288)
