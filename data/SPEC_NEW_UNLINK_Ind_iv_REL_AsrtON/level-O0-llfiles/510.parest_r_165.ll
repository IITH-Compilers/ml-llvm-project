...
@_ZTVN6dealii12FunctionTimeE = dso_local unnamed_addr constant { [6 x i8*] } { [6 x i8*] [i8* null, i8* bitcast ({ i8*, i8* }* @_ZTIN6dealii12FunctionTimeE to i8*), i8* bitcast (void (%"class.dealii::FunctionTime"*)* @_ZN6dealii12FunctionTimeD1Ev to i8*), i8* bitcast (void (%"class.dealii::FunctionTime"*)* @_ZN6dealii12FunctionTimeD0Ev to i8*), i8* bitcast (void (%"class.dealii::FunctionTime"*, double)* @_ZN6dealii12FunctionTime8set_timeEd to i8*), i8* bitcast (void (%"class.dealii::FunctionTime"*, double)* @_ZN6dealii12FunctionTime12advance_timeEd to i8*)] }, align 8
@_ZTVN10__cxxabiv117__class_type_infoE = external dso_local global i8*
@_ZTSN6dealii12FunctionTimeE = dso_local constant [24 x i8] c"N6dealii12FunctionTimeE\00", align 1
@_ZTIN6dealii12FunctionTimeE = dso_local constant { i8*, i8* } { i8* bitcast (i8** getelementptr inbounds (i8*, i8** @_ZTVN10__cxxabiv117__class_type_infoE, i64 2) to i8*), i8* getelementptr inbounds ([24 x i8], [24 x i8]* @_ZTSN6dealii12FunctionTimeE, i32 0, i32 0) }, align 8

@_ZN6dealii12FunctionTimeC1Ed = dso_local unnamed_addr alias void (%"class.dealii::FunctionTime"*, double), void (%"class.dealii::FunctionTime"*, double)* @_ZN6dealii12FunctionTimeC2Ed
@_ZN6dealii12FunctionTimeD1Ev = dso_local unnamed_addr alias void (%"class.dealii::FunctionTime"*), void (%"class.dealii::FunctionTime"*)* @_ZN6dealii12FunctionTimeD2Ev

; Function Attrs: noinline nounwind uwtable
define dso_local void @_ZN6dealii12FunctionTimeC2Ed(%"class.dealii::FunctionTime"* %this, double %initial_time) unnamed_addr #0 align 2 !dbg !1234 {
entry:
  %this.addr = alloca %"class.dealii::FunctionTime"*, align 8
  %initial_time.addr = alloca double, align 8
  store %"class.dealii::FunctionTime"* %this, %"class.dealii::FunctionTime"** %this.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.dealii::FunctionTime"** %this.addr, metadata !1257, metadata !DIExpression()), !dbg !1259
  store double %initial_time, double* %initial_time.addr, align 8
  call void @llvm.dbg.declare(metadata double* %initial_time.addr, metadata !1260, metadata !DIExpression()), !dbg !1261
  %this1 = load %"class.dealii::FunctionTime"*, %"class.dealii::FunctionTime"** %this.addr, align 8
  %0 = bitcast %"class.dealii::FunctionTime"* %this1 to i32 (...)***, !dbg !1262
  store i32 (...)** bitcast (i8** getelementptr inbounds ({ [6 x i8*] }, { [6 x i8*] }* @_ZTVN6dealii12FunctionTimeE, i32 0, inrange i32 0, i32 2) to i32 (...)**), i32 (...)*** %0, align 8, !dbg !1262
  %time = getelementptr inbounds %"class.dealii::FunctionTime", %"class.dealii::FunctionTime"* %this1, i32 0, i32 1, !dbg !1263
  %1 = load double, double* %initial_time.addr, align 8, !dbg !1264
  store double %1, double* %time, align 8, !dbg !1263
  ret void, !dbg !1265
}
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_ZN6dealii12FunctionTimeD2Ev(%"class.dealii::FunctionTime"* %this) unnamed_addr #0 align 2 !dbg !1266 {
entry:
  %this.addr = alloca %"class.dealii::FunctionTime"*, align 8
  store %"class.dealii::FunctionTime"* %this, %"class.dealii::FunctionTime"** %this.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.dealii::FunctionTime"** %this.addr, metadata !1267, metadata !DIExpression()), !dbg !1268
  %this1 = load %"class.dealii::FunctionTime"*, %"class.dealii::FunctionTime"** %this.addr, align 8
  ret void, !dbg !1269
}

; Function Attrs: noinline nounwind uwtable
define dso_local void @_ZN6dealii12FunctionTimeD0Ev(%"class.dealii::FunctionTime"* %this) unnamed_addr #0 align 2 !dbg !1270 {
entry:
  %this.addr = alloca %"class.dealii::FunctionTime"*, align 8
  store %"class.dealii::FunctionTime"* %this, %"class.dealii::FunctionTime"** %this.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.dealii::FunctionTime"** %this.addr, metadata !1271, metadata !DIExpression()), !dbg !1272
  %this1 = load %"class.dealii::FunctionTime"*, %"class.dealii::FunctionTime"** %this.addr, align 8
  call void @_ZN6dealii12FunctionTimeD1Ev(%"class.dealii::FunctionTime"* %this1) #4, !dbg !1273
  %0 = bitcast %"class.dealii::FunctionTime"* %this1 to i8*, !dbg !1273
  call void @_ZdlPv(i8* %0) #5, !dbg !1273
  ret void, !dbg !1274
}
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_ZN6dealii12FunctionTime8set_timeEd(%"class.dealii::FunctionTime"* %this, double %new_time) unnamed_addr #0 align 2 !dbg !1275 {
entry:
  %this.addr = alloca %"class.dealii::FunctionTime"*, align 8
  %new_time.addr = alloca double, align 8
  store %"class.dealii::FunctionTime"* %this, %"class.dealii::FunctionTime"** %this.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.dealii::FunctionTime"** %this.addr, metadata !1276, metadata !DIExpression()), !dbg !1277
  store double %new_time, double* %new_time.addr, align 8
  call void @llvm.dbg.declare(metadata double* %new_time.addr, metadata !1278, metadata !DIExpression()), !dbg !1279
  %this1 = load %"class.dealii::FunctionTime"*, %"class.dealii::FunctionTime"** %this.addr, align 8
  %0 = load double, double* %new_time.addr, align 8, !dbg !1280
  %time = getelementptr inbounds %"class.dealii::FunctionTime", %"class.dealii::FunctionTime"* %this1, i32 0, i32 1, !dbg !1281
  store double %0, double* %time, align 8, !dbg !1282
  ret void, !dbg !1283
}

; Function Attrs: noinline uwtable
define dso_local void @_ZN6dealii12FunctionTime12advance_timeEd(%"class.dealii::FunctionTime"* %this, double %delta_t) unnamed_addr #3 align 2 !dbg !1284 {
entry:
  %this.addr = alloca %"class.dealii::FunctionTime"*, align 8
  %delta_t.addr = alloca double, align 8
  store %"class.dealii::FunctionTime"* %this, %"class.dealii::FunctionTime"** %this.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.dealii::FunctionTime"** %this.addr, metadata !1285, metadata !DIExpression()), !dbg !1286
  store double %delta_t, double* %delta_t.addr, align 8
  call void @llvm.dbg.declare(metadata double* %delta_t.addr, metadata !1287, metadata !DIExpression()), !dbg !1288
  %this1 = load %"class.dealii::FunctionTime"*, %"class.dealii::FunctionTime"** %this.addr, align 8
  %time = getelementptr inbounds %"class.dealii::FunctionTime", %"class.dealii::FunctionTime"* %this1, i32 0, i32 1, !dbg !1289
  %0 = load double, double* %time, align 8, !dbg !1289
  %1 = load double, double* %delta_t.addr, align 8, !dbg !1290
  %add = fadd double %0, %1, !dbg !1291
  %2 = bitcast %"class.dealii::FunctionTime"* %this1 to void (%"class.dealii::FunctionTime"*, double)***, !dbg !1292
  %vtable = load void (%"class.dealii::FunctionTime"*, double)**, void (%"class.dealii::FunctionTime"*, double)*** %2, align 8, !dbg !1292
  %vfn = getelementptr inbounds void (%"class.dealii::FunctionTime"*, double)*, void (%"class.dealii::FunctionTime"*, double)** %vtable, i64 2, !dbg !1292
  %3 = load void (%"class.dealii::FunctionTime"*, double)*, void (%"class.dealii::FunctionTime"*, double)** %vfn, align 8, !dbg !1292
  call void %3(%"class.dealii::FunctionTime"* %this1, double %add), !dbg !1292
  ret void, !dbg !1293
}
...
!1 = !DIFile(filename: "source/base/function_time.cc", directory: "/home/venkat/IF-DV/spec_build_release/CPU_2017/benchspec/CPU/510.parest_r/build/build_base_ld-loop-ext-m64.0000")
!2 = !{}
...
!1234 = distinct !DISubprogram(name: "FunctionTime", linkageName: "_ZN6dealii12FunctionTimeC2Ed", scope: !1235, file: !1, line: 20, type: !1243, scopeLine: 23, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, declaration: !1242, retainedNodes: !2)
!1235 = distinct !DICompositeType(tag: DW_TAG_class_type, name: "FunctionTime", scope: !1224, file: !1236, line: 63, size: 128, flags: DIFlagTypePassByReference | DIFlagNonTrivial, elements: !1237, vtableHolder: !1235)
!1236 = !DIFile(filename: "include/base/function_time.h", directory: "/home/venkat/IF-DV/spec_build_release/CPU_2017/benchspec/CPU/510.parest_r/build/build_base_ld-loop-ext-m64.0000")
!1237 = !{!1238, !1241, !1242, !1247, !1250, !1255, !1256}
!1238 = !DIDerivedType(tag: DW_TAG_member, name: "_vptr$FunctionTime", scope: !1236, file: !1236, baseType: !1239, size: 64, flags: DIFlagArtificial)
!1239 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1240, size: 64)
!1240 = !DIDerivedType(tag: DW_TAG_pointer_type, name: "__vtbl_ptr_type", baseType: !915, size: 64)
!1241 = !DIDerivedType(tag: DW_TAG_member, name: "time", scope: !1235, file: !1236, line: 99, baseType: !17, size: 64, offset: 64)
!1242 = !DISubprogram(name: "FunctionTime", scope: !1235, file: !1236, line: 71, type: !1243, scopeLine: 71, flags: DIFlagPublic | DIFlagPrototyped, spFlags: 0)
!1243 = !DISubroutineType(types: !1244)
!1244 = !{null, !1245, !1246}
!1245 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1235, size: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!1246 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !17)
!1247 = !DISubprogram(name: "~FunctionTime", scope: !1235, file: !1236, line: 76, type: !1248, scopeLine: 76, containingType: !1235, virtualIndex: 0, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagVirtual)
!1248 = !DISubroutineType(types: !1249)
!1249 = !{null, !1245}
!1250 = !DISubprogram(name: "get_time", linkageName: "_ZNK6dealii12FunctionTime8get_timeEv", scope: !1235, file: !1236, line: 81, type: !1251, scopeLine: 81, flags: DIFlagPublic | DIFlagPrototyped, spFlags: 0)
!1251 = !DISubroutineType(types: !1252)
!1252 = !{!17, !1253}
!1253 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1254, size: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!1254 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !1235)
!1255 = !DISubprogram(name: "set_time", linkageName: "_ZN6dealii12FunctionTime8set_timeEd", scope: !1235, file: !1236, line: 87, type: !1243, scopeLine: 87, containingType: !1235, virtualIndex: 2, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagVirtual)
!1256 = !DISubprogram(name: "advance_time", linkageName: "_ZN6dealii12FunctionTime12advance_timeEd", scope: !1235, file: !1236, line: 93, type: !1243, scopeLine: 93, containingType: !1235, virtualIndex: 3, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagVirtual)
!1257 = !DILocalVariable(name: "this", arg: 1, scope: !1234, type: !1258, flags: DIFlagArtificial | DIFlagObjectPointer)
!1258 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1235, size: 64)
!1259 = !DILocation(line: 0, scope: !1234)
!1260 = !DILocalVariable(name: "initial_time", arg: 2, scope: !1234, file: !1, line: 20, type: !1246)
!1261 = !DILocation(line: 20, column: 41, scope: !1234)
!1262 = !DILocation(line: 23, column: 1, scope: !1234)
!1263 = !DILocation(line: 22, column: 3, scope: !1234)
!1264 = !DILocation(line: 22, column: 8, scope: !1234)
!1265 = !DILocation(line: 23, column: 2, scope: !1234)
!1266 = distinct !DISubprogram(name: "~FunctionTime", linkageName: "_ZN6dealii12FunctionTimeD2Ev", scope: !1235, file: !1, line: 27, type: !1248, scopeLine: 28, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, declaration: !1247, retainedNodes: !2)
!1267 = !DILocalVariable(name: "this", arg: 1, scope: !1266, type: !1258, flags: DIFlagArtificial | DIFlagObjectPointer)
!1268 = !DILocation(line: 0, scope: !1266)
!1269 = !DILocation(line: 28, column: 2, scope: !1266)
!1270 = distinct !DISubprogram(name: "~FunctionTime", linkageName: "_ZN6dealii12FunctionTimeD0Ev", scope: !1235, file: !1, line: 27, type: !1248, scopeLine: 28, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, declaration: !1247, retainedNodes: !2)
!1271 = !DILocalVariable(name: "this", arg: 1, scope: !1270, type: !1258, flags: DIFlagArtificial | DIFlagObjectPointer)
!1272 = !DILocation(line: 0, scope: !1270)
!1273 = !DILocation(line: 28, column: 1, scope: !1270)
!1274 = !DILocation(line: 28, column: 2, scope: !1270)
!1275 = distinct !DISubprogram(name: "set_time", linkageName: "_ZN6dealii12FunctionTime8set_timeEd", scope: !1235, file: !1, line: 33, type: !1243, scopeLine: 34, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, declaration: !1255, retainedNodes: !2)
!1276 = !DILocalVariable(name: "this", arg: 1, scope: !1275, type: !1258, flags: DIFlagArtificial | DIFlagObjectPointer)
!1277 = !DILocation(line: 0, scope: !1275)
!1278 = !DILocalVariable(name: "new_time", arg: 2, scope: !1275, file: !1, line: 33, type: !1246)
!1279 = !DILocation(line: 33, column: 38, scope: !1275)
!1280 = !DILocation(line: 35, column: 10, scope: !1275)
!1281 = !DILocation(line: 35, column: 3, scope: !1275)
!1282 = !DILocation(line: 35, column: 8, scope: !1275)
!1283 = !DILocation(line: 36, column: 1, scope: !1275)
!1284 = distinct !DISubprogram(name: "advance_time", linkageName: "_ZN6dealii12FunctionTime12advance_timeEd", scope: !1235, file: !1, line: 41, type: !1243, scopeLine: 42, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, declaration: !1256, retainedNodes: !2)
!1285 = !DILocalVariable(name: "this", arg: 1, scope: !1284, type: !1258, flags: DIFlagArtificial | DIFlagObjectPointer)
!1286 = !DILocation(line: 0, scope: !1284)
!1287 = !DILocalVariable(name: "delta_t", arg: 2, scope: !1284, file: !1, line: 41, type: !1246)
!1288 = !DILocation(line: 41, column: 42, scope: !1284)
!1289 = !DILocation(line: 43, column: 13, scope: !1284)
!1290 = !DILocation(line: 43, column: 18, scope: !1284)
!1291 = !DILocation(line: 43, column: 17, scope: !1284)
!1292 = !DILocation(line: 43, column: 3, scope: !1284)
!1293 = !DILocation(line: 44, column: 1, scope: !1284)
