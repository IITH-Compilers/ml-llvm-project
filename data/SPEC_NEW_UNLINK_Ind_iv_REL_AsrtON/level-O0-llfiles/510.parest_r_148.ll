...
%"class.dealii::ConditionalOStream" = type <{ %"class.std::basic_ostream"*, i8, [7 x i8] }>
...
@_ZN6dealii18ConditionalOStreamC1ERSob = dso_local unnamed_addr alias void (%"class.dealii::ConditionalOStream"*, %"class.std::basic_ostream"*, i1), void (%"class.dealii::ConditionalOStream"*, %"class.std::basic_ostream"*, i1)* @_ZN6dealii18ConditionalOStreamC2ERSob

; Function Attrs: noinline nounwind uwtable
define dso_local void @_ZN6dealii18ConditionalOStreamC2ERSob(%"class.dealii::ConditionalOStream"* %this, %"class.std::basic_ostream"* dereferenceable(272) %stream, i1 zeroext %active) unnamed_addr #0 align 2 !dbg !1231 {
entry:
  %this.addr = alloca %"class.dealii::ConditionalOStream"*, align 8
  %stream.addr = alloca %"class.std::basic_ostream"*, align 8
  %active.addr = alloca i8, align 1
  store %"class.dealii::ConditionalOStream"* %this, %"class.dealii::ConditionalOStream"** %this.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.dealii::ConditionalOStream"** %this.addr, metadata !1262, metadata !DIExpression()), !dbg !1264
  store %"class.std::basic_ostream"* %stream, %"class.std::basic_ostream"** %stream.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.std::basic_ostream"** %stream.addr, metadata !1265, metadata !DIExpression()), !dbg !1266
  %frombool = zext i1 %active to i8
  store i8 %frombool, i8* %active.addr, align 1
  call void @llvm.dbg.declare(metadata i8* %active.addr, metadata !1267, metadata !DIExpression()), !dbg !1268
  %this1 = load %"class.dealii::ConditionalOStream"*, %"class.dealii::ConditionalOStream"** %this.addr, align 8
  %output_stream = getelementptr inbounds %"class.dealii::ConditionalOStream", %"class.dealii::ConditionalOStream"* %this1, i32 0, i32 0, !dbg !1269
  %0 = load %"class.std::basic_ostream"*, %"class.std::basic_ostream"** %stream.addr, align 8, !dbg !1270
  store %"class.std::basic_ostream"* %0, %"class.std::basic_ostream"** %output_stream, align 8, !dbg !1269
  %active_flag = getelementptr inbounds %"class.dealii::ConditionalOStream", %"class.dealii::ConditionalOStream"* %this1, i32 0, i32 1, !dbg !1271
  %1 = load i8, i8* %active.addr, align 1, !dbg !1272
  %tobool = trunc i8 %1 to i1, !dbg !1272
  %frombool2 = zext i1 %tobool to i8, !dbg !1271
  store i8 %frombool2, i8* %active_flag, align 8, !dbg !1271
  ret void, !dbg !1273
}
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_ZN6dealii18ConditionalOStream13set_conditionEb(%"class.dealii::ConditionalOStream"* %this, i1 zeroext %flag) #0 align 2 !dbg !1274 {
entry:
  %this.addr = alloca %"class.dealii::ConditionalOStream"*, align 8
  %flag.addr = alloca i8, align 1
  store %"class.dealii::ConditionalOStream"* %this, %"class.dealii::ConditionalOStream"** %this.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.dealii::ConditionalOStream"** %this.addr, metadata !1277, metadata !DIExpression()), !dbg !1278
  %frombool = zext i1 %flag to i8
  store i8 %frombool, i8* %flag.addr, align 1
  call void @llvm.dbg.declare(metadata i8* %flag.addr, metadata !1279, metadata !DIExpression()), !dbg !1280
  %this1 = load %"class.dealii::ConditionalOStream"*, %"class.dealii::ConditionalOStream"** %this.addr, align 8
  %0 = load i8, i8* %flag.addr, align 1, !dbg !1281
  %tobool = trunc i8 %0 to i1, !dbg !1281
  %active_flag = getelementptr inbounds %"class.dealii::ConditionalOStream", %"class.dealii::ConditionalOStream"* %this1, i32 0, i32 1, !dbg !1282
  %frombool2 = zext i1 %tobool to i8, !dbg !1283
  store i8 %frombool2, i8* %active_flag, align 8, !dbg !1283
  ret void, !dbg !1284
}

; Function Attrs: noinline nounwind uwtable
define dso_local zeroext i1 @_ZNK6dealii18ConditionalOStream9is_activeEv(%"class.dealii::ConditionalOStream"* %this) #0 align 2 !dbg !1285 {
entry:
  %this.addr = alloca %"class.dealii::ConditionalOStream"*, align 8
  store %"class.dealii::ConditionalOStream"* %this, %"class.dealii::ConditionalOStream"** %this.addr, align 8
  call void @llvm.dbg.declare(metadata %"class.dealii::ConditionalOStream"** %this.addr, metadata !1286, metadata !DIExpression()), !dbg !1288
  %this1 = load %"class.dealii::ConditionalOStream"*, %"class.dealii::ConditionalOStream"** %this.addr, align 8
  %active_flag = getelementptr inbounds %"class.dealii::ConditionalOStream", %"class.dealii::ConditionalOStream"* %this1, i32 0, i32 1, !dbg !1289
  %0 = load i8, i8* %active_flag, align 8, !dbg !1289
  %tobool = trunc i8 %0 to i1, !dbg !1289
...
!1231 = distinct !DISubprogram(name: "ConditionalOStream", linkageName: "_ZN6dealii18ConditionalOStreamC2ERSob", scope: !1232, file: !1, line: 18, type: !1243, scopeLine: 23, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, declaration: !1242, retainedNodes: !2)
!1232 = distinct !DICompositeType(tag: DW_TAG_class_type, name: "ConditionalOStream", scope: !1224, file: !1233, line: 85, size: 128, flags: DIFlagTypePassByValue | DIFlagNonTrivial, elements: !1234, identifier: "_ZTSN6dealii18ConditionalOStreamE")
!1233 = !DIFile(filename: "include/base/conditional_ostream.h", directory: "/home/venkat/IF-DV/spec_build_release/CPU_2017/benchspec/CPU/510.parest_r/build/build_base_ld-loop-ext-m64.0000")
!1234 = !{!1235, !1241, !1242, !1247, !1250, !1255}
!1235 = !DIDerivedType(tag: DW_TAG_member, name: "output_stream", scope: !1232, file: !1233, line: 149, baseType: !1236, size: 64)
!1236 = !DIDerivedType(tag: DW_TAG_reference_type, baseType: !1237, size: 64)
!1237 = !DIDerivedType(tag: DW_TAG_typedef, name: "ostream", scope: !5, file: !1238, line: 141, baseType: !1239)
!1238 = !DIFile(filename: "/usr/lib/gcc/x86_64-linux-gnu/10/../../../../include/c++/10/iosfwd", directory: "")
!1239 = !DICompositeType(tag: DW_TAG_class_type, name: "basic_ostream<char, std::char_traits<char> >", scope: !5, file: !1240, line: 359, flags: DIFlagFwdDecl)
!1240 = !DIFile(filename: "/usr/lib/gcc/x86_64-linux-gnu/10/../../../../include/c++/10/bits/ostream.tcc", directory: "")
!1241 = !DIDerivedType(tag: DW_TAG_member, name: "active_flag", scope: !1232, file: !1233, line: 155, baseType: !680, size: 8, offset: 64)
!1242 = !DISubprogram(name: "ConditionalOStream", scope: !1232, file: !1233, line: 95, type: !1243, scopeLine: 95, flags: DIFlagPublic | DIFlagPrototyped, spFlags: 0)
!1243 = !DISubroutineType(types: !1244)
!1244 = !{null, !1245, !1236, !1246}
!1245 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1232, size: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!1246 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !680)
!1247 = !DISubprogram(name: "set_condition", linkageName: "_ZN6dealii18ConditionalOStream13set_conditionEb", scope: !1232, file: !1233, line: 108, type: !1248, scopeLine: 108, flags: DIFlagPublic | DIFlagPrototyped, spFlags: 0)
!1248 = !DISubroutineType(types: !1249)
!1249 = !{null, !1245, !1246}
!1250 = !DISubprogram(name: "is_active", linkageName: "_ZNK6dealii18ConditionalOStream9is_activeEv", scope: !1232, file: !1233, line: 113, type: !1251, scopeLine: 113, flags: DIFlagPublic | DIFlagPrototyped, spFlags: 0)
!1251 = !DISubroutineType(types: !1252)
!1252 = !{!680, !1253}
!1253 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1254, size: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!1254 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !1232)
!1255 = !DISubprogram(name: "operator<<", linkageName: "_ZNK6dealii18ConditionalOStreamlsEPFRSoS1_E", scope: !1232, file: !1233, line: 142, type: !1256, scopeLine: 142, flags: DIFlagPublic | DIFlagPrototyped, spFlags: 0)
!1256 = !DISubroutineType(types: !1257)
!1257 = !{!1258, !1253, !1259}
!1258 = !DIDerivedType(tag: DW_TAG_reference_type, baseType: !1254, size: 64)
!1259 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1260, size: 64)
!1260 = !DISubroutineType(types: !1261)
!1261 = !{!1236, !1236}
!1262 = !DILocalVariable(name: "this", arg: 1, scope: !1231, type: !1263, flags: DIFlagArtificial | DIFlagObjectPointer)
!1263 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1232, size: 64)
!1264 = !DILocation(line: 0, scope: !1231)
!1265 = !DILocalVariable(name: "stream", arg: 2, scope: !1231, file: !1, line: 18, type: !1236)
!1266 = !DILocation(line: 18, column: 54, scope: !1231)
!1267 = !DILocalVariable(name: "active", arg: 3, scope: !1231, file: !1, line: 19, type: !1246)
!1268 = !DILocation(line: 19, column: 54, scope: !1231)
!1269 = !DILocation(line: 21, column: 3, scope: !1231)
!1270 = !DILocation(line: 21, column: 18, scope: !1231)
!1271 = !DILocation(line: 22, column: 3, scope: !1231)
!1272 = !DILocation(line: 22, column: 15, scope: !1231)
!1273 = !DILocation(line: 23, column: 2, scope: !1231)
!1274 = distinct !DISubprogram(name: "set_condition", linkageName: "_ZN6dealii18ConditionalOStream13set_conditionEb", scope: !1232, file: !1, line: 26, type: !1275, scopeLine: 27, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, declaration: !1247, retainedNodes: !2)
!1275 = !DISubroutineType(types: !1276)
!1276 = !{null, !1245, !680}
!1277 = !DILocalVariable(name: "this", arg: 1, scope: !1274, type: !1263, flags: DIFlagArtificial | DIFlagObjectPointer)
!1278 = !DILocation(line: 0, scope: !1274)
!1279 = !DILocalVariable(name: "flag", arg: 2, scope: !1274, file: !1, line: 26, type: !680)
!1280 = !DILocation(line: 26, column: 45, scope: !1274)
!1281 = !DILocation(line: 28, column: 17, scope: !1274)
!1282 = !DILocation(line: 28, column: 3, scope: !1274)
!1283 = !DILocation(line: 28, column: 15, scope: !1274)
!1284 = !DILocation(line: 29, column: 1, scope: !1274)
!1285 = distinct !DISubprogram(name: "is_active", linkageName: "_ZNK6dealii18ConditionalOStream9is_activeEv", scope: !1232, file: !1, line: 32, type: !1251, scopeLine: 33, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, declaration: !1250, retainedNodes: !2)
!1286 = !DILocalVariable(name: "this", arg: 1, scope: !1285, type: !1287, flags: DIFlagArtificial | DIFlagObjectPointer)
!1287 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1254, size: 64)
!1288 = !DILocation(line: 0, scope: !1285)
!1289 = !DILocation(line: 34, column: 10, scope: !1285)
!1290 = !DILocation(line: 34, column: 3, scope: !1285)
