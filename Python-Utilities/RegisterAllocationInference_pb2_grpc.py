...
class RegisterAllocationInferenceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.getAdvice = channel.unary_unary(
                '/registerallocationinference.RegisterAllocationInference/getAdvice',
...
class RegisterAllocationInference(object):
    ...
    def getAdvice(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/registerallocationinference.RegisterAllocationInference/getAdvice',
