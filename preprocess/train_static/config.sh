...
INP_DIR=${HOME}/data/SPEC_NEW_UNLINK_Ind_iv${BUILD_TYPE}
INP_TYPE=llfiles

WD=${INP_DIR}/generated_with_inline
...
SSA_COMMOM_SEQ="-mem2reg -loop-rotate -loop-simplify"


SSA_PASSES_SEQ="${SSA_COMMOM_SEQ} -inline -enable-loop-inline"
