...
# CPU2017 -- no need to make directories
...
# CPU2017 -- we started a long time ago
#    my $started = time;
...
sub expire_old_tokens_trapped {
  ...
  my $num_lowfreq = 0;
  my $num_hapaxes = 0;
# CPU2017 - started a long time ago
#  my $started = time();
...
# CPU2017 -- just in the interest of validation
...
# CPU2017 -- there will never be pre-existing Bayes DBs that need upgrading
return 0;
#
#  eval {
#    local $SIG{'__DIE__'};	# do not run user die() traps in here
