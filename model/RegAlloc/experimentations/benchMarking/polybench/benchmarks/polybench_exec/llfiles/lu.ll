...
source_filename = "./linear-algebra/solvers/lu/lu.c"
...
entry:
  ...
  call void @kernel_lu(i32 %3, [4000 x double]* %arraydecay1)
...
for.body33:                                       ; preds = %for.cond31
  ...
  %arrayidx35 = getelementptr inbounds [4000 x double], [4000 x double]* %33, i64 %idxprom34
  %35 = load i32, i32* %k, align 4
  %idxprom36 = sext i32 %35 to i64
  %arrayidx37 = getelementptr inbounds [4000 x double], [4000 x double]* %arrayidx35, i64 0, i64 %idxprom36
  %36 = load double, double* %arrayidx37, align 8
  %37 = load [4000 x double]*, [4000 x double]** %A.addr, align 8
  %38 = load i32, i32* %k, align 4
  %idxprom38 = sext i32 %38 to i64
  %arrayidx39 = getelementptr inbounds [4000 x double], [4000 x double]* %37, i64 %idxprom38
  ...
  %mul42 = fmul fast double %36, %40
  %41 = load [4000 x double]*, [4000 x double]** %A.addr, align 8
  %42 = load i32, i32* %i, align 4
  %idxprom43 = sext i32 %42 to i64
  %arrayidx44 = getelementptr inbounds [4000 x double], [4000 x double]* %41, i64 %idxprom43
  ...
  %sub47 = fsub fast double %44, %mul42
