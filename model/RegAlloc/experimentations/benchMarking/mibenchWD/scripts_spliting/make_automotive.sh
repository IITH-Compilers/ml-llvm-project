BENCHMARK="/home/shalini/LOF_test/mibench"
# LLVM_BUILD="/home/shalini/LOF_test/IR2Vec-LoopOptimizationFramework/build_release"
LLVM_BUILD="/usr"

############ automotive: basicmath

cd /home/shalini/LOF_test/mibench/automotive/basicmath
...
${LLVM_BUILD}/bin/llc -filetype=obj automotive_small_final.ll -o automotive_small_final.o
${LLVM_BUILD}/bin/clang -lm  automotive_small_final.o -o automotive_small_final.out
time ./automotive_small_final.out > output_small.txt
...
${LLVM_BUILD}/bin/llc -filetype=obj automotive_large_final.ll -o automotive_large_final.o
${LLVM_BUILD}/bin/clang -lm  automotive_large_final.o -o automotive_large_final.out
time ./automotive_large_final.out > output_large.txt

########### automotive: bitcount

cd /home/shalini/LOF_test/mibench/automotive/bitcount
...
${LLVM_BUILD}/bin/llc -filetype=obj bitcount.ll -o bitcount.o
${LLVM_BUILD}/bin/clang -lm  bitcount.o -o bitcount.out
time ./bitcount.out 75000 > output_small.txt
time ./bitcount.out 1125000 > output_large.txt


// automotive: qsort

cd /home/shalini/LOF_test/mibench/automotive/qsort
...
# ${LLVM_BUILD}/bin/llvm-link basicmath_large.ll  rad2deg.ll  cubic.ll   isqrt.ll -o automotive_large_final.ll
${LLVM_BUILD}/bin/llc -filetype=obj qsort_small.ll -o qsort_small.o
${LLVM_BUILD}/bin/clang -lm  qsort_small.o -o qsort_small.out
time ./qsort_small.out input_small.dat > output_small.txt
...
# ${LLVM_BUILD}/bin/llvm-link basicmath_large.ll  rad2deg.ll  cubic.ll   isqrt.ll -o automotive_large_final.ll
${LLVM_BUILD}/bin/llc -filetype=obj qsort_large.ll -o qsort_large.o
${LLVM_BUILD}/bin/clang -lm  qsort_large.o -o qsort_large.out
time ./qsort_large.out input_large.dat > output_large.txt

// automotive: susan

cd /home/shalini/LOF_test/mibench/automotive/susan

${LLVM_BUILD}/bin/clang  -S -emit-llvm -Xclang -disable-O0-optnone susan.c -lm
${LLVM_BUILD}/bin/opt -O3 susan.ll -o susan.ll
# ${LLVM_BUILD}/bin/llvm-link basicmath_large.ll  rad2deg.ll  cubic.ll   isqrt.ll -o automotive_large_final.ll
${LLVM_BUILD}/bin/llc -filetype=obj susan.ll -o susan.o
