...
def allocate_registers(inter_graph_list : list, trained_model : str):
    ...
    train_agent = SimpleQTrainer(env=HierarchicalGraphColorEnv, config=config)
    # train_agent = DQNTrainer(config=config)
    print('Hi 2')
    checkpoint = trained_model#"/home/cs20mtech12003/ray_results/experiment_2021-06-27_23-29-08/experiment_GraphColorEnv_5efd2_00000_0_2021-06-27_23-29-09/checkpoint_001000/checkpoint-1000"
