...
class MyCallbacks(DefaultCallbacks):
    def  on_episode_start(self, *, worker: RolloutWorker, base_env: BaseEnv,
        ...
        if base_env.get_unwrapped()[0].curr_file_name is not None:
            episode.hist_data["file_name"] = [base_env.get_unwrapped()[0].curr_file_name]
        else:
...
if __name__ == "__main__":
    ...
    print('Coloring agent action space size: ',config["env_config"]["action_space_size"])
