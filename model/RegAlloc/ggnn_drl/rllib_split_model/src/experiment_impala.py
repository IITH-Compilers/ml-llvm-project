...
from impala import Impala, DEFAULT_CONFIG
...
def experiment(config):
    ...
    train_agent = Impala(config=config, env=HierarchicalGraphColorEnv)
...
if __name__ == "__main__":
    ...
    tune.run(
        ...
        resources_per_trial=Impala.default_resource_request(config),
        # fail_fast=True,
        # max_failures=10
        )
