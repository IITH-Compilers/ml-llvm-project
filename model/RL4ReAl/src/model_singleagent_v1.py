...
class SplitNetwork(TorchModelV2, nn.Module):
    """Actor (Policy) Model."""
    ...
    def forward(self, input_dict, state, seq_lens):
        ...
        usepoint_properties = input_dict["obs"]["usepoint_properties"].values
        usepoint_properties = usepoint_properties.reshape(usepoint_properties.shape[0], usepoint_properties.shape[1], usepoint_properties.shape[2]//2, 2)
