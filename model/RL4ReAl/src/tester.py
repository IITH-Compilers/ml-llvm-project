...
from tester_config import PPO, DEFAULT_CONFIG
...
parser.add_argument("--train-iterations", type=int, default=100000)    #because of this it is not running to episodes
...
def experiment(config):
    epochs = config["env_config"]["episode_number"]  #check this
    iterations = config.pop("train-iterations")
    print("Iterations are: ",iterations)
    global checkpoint
    train_results = {}
    #numeric_trial_id = re.search(r'\d+', tune.get_trial_id()).group()
