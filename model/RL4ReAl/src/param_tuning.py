...
def experiment(config):   
    ...
    #numeric_trial_id=0
    #print("num_epsiodes: ",config["env_config"]["episode_number"])
    ...
    for i in range(iterations):
        ...
        if train_results['episode_reward_max'] > max_reward:
            ...
            #passing best params as dictionary
            # li={}
            # li['episode_reward_mean']=train_results['sampler_results']['episode_reward_mean']
            # li['episode_reward_min']=train_results['sampler_results']['episode_reward_min']
            # li['episode_len_mean']=train_results['sampler_results']['episode_len_mean']
            # li['episode_reward_max']=train_results['sampler_results']['episode_reward_max']
            #li['episode_reward']=train_results['episode_reward']
            #best_params=li
...
if __name__ == "__main__":
 ...
 # Print the type of config["multiagent"]
    ...
    metric="episode_reward_mean",
    mode="max",
    #points_to_evaluate=[{"lr":0.00001},{"sgd_minibatch_size":64},{"num_sgd_iter":10},{"clip_param":0.3},{"kl_target":0.03},{"kl_coeff":0.6}]
    )
