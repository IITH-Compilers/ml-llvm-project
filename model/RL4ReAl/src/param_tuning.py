...
if __name__ == "__main__":
    ...
    config.update({
        ...
        "num_sgd_iter":tune.grid_search([1,3,10]),
        "clip_param ":tune.grid_search([0.1,0.2,0.3]),
        "kl_coeff":tune.grid_search([0.3,0.6,1.0]),
        "kl_target":tune.grid_search([0.003,0.016,0.03])
    })
    ...
    #and grace_period indicates that no trials will be eliminated before grace_period iterations.
