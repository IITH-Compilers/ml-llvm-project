    ...
    for sentence in sentences:
        ...
        if s[0] != "":
           ...
           for arg in range(2,l):
                toWrite += ed[opc] + "\t" + ed[s[arg]] + "\t" + rd["Arg" + str(i)] + "\n"
                nol += 1
                i += 1
    op.write(str(nol) + "\n")
    op.write(toWrite)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--tripletFile', dest='tripletFile', metavar='FILE', help='Path of the triplet file generated by collectIR pass.', required=True)
