...
void CollectIR::traverseBasicBlock(BasicBlock &B) {
    ...
    for(Instruction &I : B) {
        ...
        switch(I.getType()->getTypeID())    {
            ...
            case 6 : res += " floatTy ";
                     break;
            case 11: res += " integerTy ";
                     break;
            case 12: res += " functionTy ";
                     break;
            case 13: res += " structTy ";
                     break;
            case 14: res += " arrayTy ";
                     break;
            case 15: res += " pointerTy ";
                     break; 
            case 16: res += " vectorTy ";
                     break;
            default: res += "unknownTy";
        }
...
void CollectIR::getAnalysisUsage(AnalysisUsage &AU) const {
