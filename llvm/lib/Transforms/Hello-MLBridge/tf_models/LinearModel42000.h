...
#ifndef TFCOMPILE_GENERATED__xla_home_cs20btech11018_repos_ml_llvm_project_llvm_lib_Transforms_Hello_MLBridge_tf_models_LinearModel42000_LinearModel42000_H_  // NOLINT(build/header_guard)
#define TFCOMPILE_GENERATED__xla_home_cs20btech11018_repos_ml_llvm_project_llvm_lib_Transforms_Hello_MLBridge_tf_models_LinearModel42000_LinearModel42000_H_  // NOLINT(build/header_guard)
...
extern "C" void _xla_home_cs20btech11018_repos_ml_llvm_project_llvm_lib_Transforms_Hello_MLBridge_tf_models_LinearModel42000_LinearModel42000(
 ...
 public:
  ...
  static const tensorflow::XlaCompiledCpuFunction::StaticData& StaticData() {
    static XlaCompiledCpuFunction::StaticData* kStaticData = [](){
      ...
      set_static_data_raw_function(data, _xla_home_cs20btech11018_repos_ml_llvm_project_llvm_lib_Transforms_Hello_MLBridge_tf_models_LinearModel42000_LinearModel42000);
...
::xla::cpu_function_runtime::BufferInfo({1344002ULL, 0ULL}),
...
::xla::cpu_function_runtime::BufferInfo({35ULL, ~0ULL}),
::xla::cpu_function_runtime::BufferInfo({35ULL, ~0ULL}),
::xla::cpu_function_runtime::BufferInfo({43361ULL, ~0ULL})
      };
    return kBufferInfos;
  }
...
#endif  // TFCOMPILE_GENERATED__xla_home_cs20btech11018_repos_ml_llvm_project_llvm_lib_Transforms_Hello_MLBridge_tf_models_LinearModel42000_LinearModel42000_H_
