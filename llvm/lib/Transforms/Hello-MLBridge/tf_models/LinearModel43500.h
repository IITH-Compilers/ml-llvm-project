...
#ifndef TFCOMPILE_GENERATED__xla_home_cs20btech11018_repos_ml_llvm_project_llvm_lib_Transforms_Hello_MLBridge_tf_models_LinearModel43500_LinearModel43500_H_  // NOLINT(build/header_guard)
#define TFCOMPILE_GENERATED__xla_home_cs20btech11018_repos_ml_llvm_project_llvm_lib_Transforms_Hello_MLBridge_tf_models_LinearModel43500_LinearModel43500_H_  // NOLINT(build/header_guard)
...
extern "C" void _xla_home_cs20btech11018_repos_ml_llvm_project_llvm_lib_Transforms_Hello_MLBridge_tf_models_LinearModel43500_LinearModel43500(
 ...
 public:
  ...
  static const tensorflow::XlaCompiledCpuFunction::StaticData& StaticData() {
    static XlaCompiledCpuFunction::StaticData* kStaticData = [](){
      ...
      set_static_data_raw_function(data, _xla_home_cs20btech11018_repos_ml_llvm_project_llvm_lib_Transforms_Hello_MLBridge_tf_models_LinearModel43500_LinearModel43500);
...
::xla::cpu_function_runtime::BufferInfo({1392002ULL, 0ULL}),
...
::xla::cpu_function_runtime::BufferInfo({35ULL, ~0ULL}),
::xla::cpu_function_runtime::BufferInfo({35ULL, ~0ULL}),
::xla::cpu_function_runtime::BufferInfo({44897ULL, ~0ULL})
      };
    return kBufferInfos;
  }
...
#endif  // TFCOMPILE_GENERATED__xla_home_cs20btech11018_repos_ml_llvm_project_llvm_lib_Transforms_Hello_MLBridge_tf_models_LinearModel43500_LinearModel43500_H_
