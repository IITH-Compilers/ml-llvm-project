...
// void RDGWrapperPass::PrintDotFile_LAI(DataDependenceGraph &G, std::string Filename){
// 	std::error_code EC;
...
void RDGWrapperPass::Print_IR2Vec_File(DataDependenceGraph &G, std::string Filename,
