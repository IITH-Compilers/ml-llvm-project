; ModuleID = '/home/es17btech11025/llvm-test-suite/SingleSource/Benchmarks/Shootout-C++/hash.cpp'
...
30:                                               ; preds = %26
  ...
  %33 = call i32 (i8*, i8*, ...) @sprintf(i8* %31, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32 %32) #3
  %34 = load i32, i32* %9, align 4
  %35 = getelementptr inbounds [16 x i8], [16 x i8]* %7, i64 0, i64 0
  %36 = call noalias i8* @strdup(i8* %35) #3
  store i8* %36, i8** %10, align 8
  %37 = invoke dereferenceable(4) i32* @_ZN9__gnu_cxx8hash_mapIPKciNS_4hashIS2_EE5eqstrSaIiEEixERKS2_(%"class.__gnu_cxx::hash_map"* %8, i8** dereferenceable(8) %10)
...
51:                                               ; preds = %48
  ...
  %54 = call i32 (i8*, i8*, ...) @sprintf(i8* %52, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i32 %53) #3
  %55 = getelementptr inbounds [16 x i8], [16 x i8]* %7, i64 0, i64 0
  %56 = call noalias i8* @strdup(i8* %55) #3
  store i8* %56, i8** %15, align 8
  %57 = invoke dereferenceable(4) i32* @_ZN9__gnu_cxx8hash_mapIPKciNS_4hashIS2_EE5eqstrSaIiEEixERKS2_(%"class.__gnu_cxx::hash_map"* %8, i8** dereferenceable(8) %15)
...
11:                                               ; preds = %2
  call void @_ZSt20__throw_length_errorPKc(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.2, i64 0, i64 0)) #16
  unreachable
...
151:                                              ; preds = %25
  ...
  %153 = call i64 @_ZNKSt6vectorIPN9__gnu_cxx15_Hashtable_nodeISt4pairIKPKciEEESaIS8_EE12_M_check_lenEmS4_(%"class.std::vector"* %22, i64 %152, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.3, i64 0, i64 0))
