...
# %bb.0:
	...
	movsd	four(%rip), %xmm2       # xmm2 = mem[0],zero
	...
	movsd	A1(%rip), %xmm15        # xmm15 = mem[0],zero
	movsd	one(%rip), %xmm4        # xmm4 = mem[0],zero
	movsd	B6(%rip), %xmm5         # xmm5 = mem[0],zero
	movsd	B5(%rip), %xmm6         # xmm6 = mem[0],zero
	movsd	B4(%rip), %xmm7         # xmm7 = mem[0],zero
	movsd	B3(%rip), %xmm3         # xmm3 = mem[0],zero
	movsd	B2(%rip), %xmm1         # xmm1 = mem[0],zero
	xorpd	%xmm2, %xmm2
	movl	$1, %eax
	movsd	B1(%rip), %xmm8         # xmm8 = mem[0],zero
...
.LBB0_2:                                # =>This Inner Loop Header: Depth=1
	...
	mulsd	%xmm0, %xmm10
	movapd	%xmm10, %xmm9
	mulsd	-32(%rbp), %xmm9        # 8-byte Folded Reload
	addsd	%xmm11, %xmm9
	mulsd	%xmm10, %xmm9
	addsd	%xmm12, %xmm9
	mulsd	%xmm10, %xmm9
...
.LBB0_3:
	movsd	-24(%rbp), %xmm5        # 8-byte Reload
                                        # xmm5 = mem[0],zero
	divsd	-16(%rbp), %xmm5        # 8-byte Folded Reload
	movapd	%xmm5, %xmm3
	mulsd	%xmm5, %xmm3
	...
	mulsd	%xmm3, %xmm1
	addsd	A1(%rip), %xmm1
	movsd	B6(%rip), %xmm0         # xmm0 = mem[0],zero
	mulsd	%xmm3, %xmm0
	addsd	B5(%rip), %xmm0
	mulsd	%xmm3, %xmm1
	mulsd	%xmm3, %xmm0
