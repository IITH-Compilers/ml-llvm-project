...
.LCPI0_0:
	...
	.p2align	3
.LCPI0_1:
	.quad	4729518889111650304     # double 1.5625E+8
.LCPI0_2:
...
# %bb.0:
	...
	movl	$.Lstr.2, %edi
	callq	puts
	movsd	A3(%rip), %xmm8         # xmm8 = mem[0],zero
	...
	xorpd	%xmm9, %xmm0
	movlpd	%xmm0, A5(%rip)
	movsd	piref(%rip), %xmm11     # xmm11 = mem[0],zero
	movsd	three(%rip), %xmm10     # xmm10 = mem[0],zero
	movsd	.LCPI0_1(%rip), %xmm1   # xmm1 = mem[0],zero
	mulsd	%xmm10, %xmm1
	movapd	%xmm11, %xmm0
	divsd	%xmm1, %xmm0
	movsd	B6(%rip), %xmm12        # xmm12 = mem[0],zero
	movsd	B5(%rip), %xmm13        # xmm13 = mem[0],zero
	movsd	B4(%rip), %xmm14        # xmm14 = mem[0],zero
	movsd	B3(%rip), %xmm3         # xmm3 = mem[0],zero
	movsd	B2(%rip), %xmm5         # xmm5 = mem[0],zero
	movsd	B1(%rip), %xmm1         # xmm1 = mem[0],zero
	xorpd	%xmm4, %xmm4
	movl	$1, %eax
...
.LBB0_3:
	...
	movapd	%xmm11, %xmm5
	mulsd	%xmm11, %xmm5
	movsd	B6(%rip), %xmm1         # xmm1 = mem[0],zero
	mulsd	%xmm5, %xmm1
	addsd	B5(%rip), %xmm1
	mulsd	%xmm5, %xmm1
	addsd	B4(%rip), %xmm1
	...
	addsd	%xmm2, %xmm1
	addsd	%xmm2, %xmm1
	movsd	two(%rip), %xmm2        # xmm2 = mem[0],zero
	mulsd	%xmm2, %xmm4
	addsd	%xmm1, %xmm4
	mulsd	%xmm4, %xmm0
	divsd	%xmm2, %xmm0
	movsd	%xmm0, sa(%rip)
	movsd	A6(%rip), %xmm1         # xmm1 = mem[0],zero
	mulsd	%xmm5, %xmm1
	subsd	%xmm9, %xmm1
	mulsd	%xmm5, %xmm1
	addsd	A4(%rip), %xmm1
