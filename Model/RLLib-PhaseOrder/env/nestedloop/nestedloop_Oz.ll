; ModuleID = '/home/cs20btech11037/ml-llvm-project/Model/RLLib-PhaseOrder/env/nestedloop/nestedloop.ll'
source_filename = "/home/es17btech11025/llvm-test-suite/SingleSource/Benchmarks/Shootout-C++/nestedloop.cpp"
...
4:                                                ; preds = %2
  ...
  %7 = tail call i32 @atoi(i8* %6) #7
  %8 = mul i32 %7, %7
  %9 = icmp sgt i32 %7, 0
  br i1 %9, label %.thread, label %12

.thread:                                          ; preds = %2, %4
  %10 = phi i32 [ %8, %4 ], [ 2116, %2 ]
  %11 = phi i32 [ %7, %4 ], [ 46, %2 ]
  br label %12

12:                                               ; preds = %4, %.thread
  %13 = phi i32 [ %10, %.thread ], [ %8, %4 ]
  %14 = phi i32 [ %11, %.thread ], [ %7, %4 ]
  %15 = phi i32 [ %11, %.thread ], [ 0, %4 ]
  %16 = mul i32 %13, %13
  %17 = mul i32 %14, %16
  %18 = mul i32 %17, %15
