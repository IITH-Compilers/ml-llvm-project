; ModuleID = '/home/cs20btech11037/ml-llvm-project/Model/RLLib-PhaseOrder/env/random/random.ll'
source_filename = "/home/es17btech11025/llvm-test-suite/SingleSource/Benchmarks/Shootout-C++/random.cpp"
...
4:                                                ; preds = %2
  ...
  %7 = tail call i32 @atoi(i8* %6) #8
  br label %.preheader

.preheader:                                       ; preds = %2, %4
  %.03.ph = phi i32 [ 400000000, %2 ], [ %7, %4 ]
  br label %8

8:                                                ; preds = %.preheader, %10
  %.03 = phi i32 [ %11, %10 ], [ %.03.ph, %.preheader ]
  %.0 = phi double [ %12, %10 ], [ 0.000000e+00, %.preheader ]
  %9 = icmp eq i32 %.03, 0
  br i1 %9, label %13, label %10

10:                                               ; preds = %8
  %11 = add nsw i32 %.03, -1
  %12 = tail call double @_Z10gen_randomd(double 1.000000e+02)
  br label %8
...
13:                                               ; preds = %8
  ...
  %20 = tail call i64 @_ZNSt8ios_base9precisionEl(%"class.std::ios_base"* %19, i64 9)
  ...
  %27 = tail call i32 @_ZNSt8ios_base4setfESt13_Ios_Fmtflags(%"class.std::ios_base"* %26, i32 4)
...
define linkonce_odr dso_local double @_Z10gen_randomd(double %0) local_unnamed_addr #6 comdat {
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local i64 @_ZNSt8ios_base9precisionEl(%"class.std::ios_base"* %0, i64 %1) local_unnamed_addr #6 comdat align 2 {
...
; Function Attrs: noinline uwtable
define linkonce_odr dso_local i32 @_ZNSt8ios_base4setfESt13_Ios_Fmtflags(%"class.std::ios_base"* %0, i32 %1) local_unnamed_addr #0 comdat align 2 {
...
declare dso_local dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEd(%"class.std::basic_ostream"*, double) local_unnamed_addr #1
...
; Function Attrs: noinline uwtable
define linkonce_odr dso_local dereferenceable(4) i32* @_ZStoRRSt13_Ios_FmtflagsS_(i32* dereferenceable(4) %0, i32 %1) local_unnamed_addr #0 comdat {
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local i32 @_ZStorSt13_Ios_FmtflagsS_(i32 %0, i32 %1) local_unnamed_addr #6 comdat {
  %3 = or i32 %1, %0
  ret i32 %3
}
