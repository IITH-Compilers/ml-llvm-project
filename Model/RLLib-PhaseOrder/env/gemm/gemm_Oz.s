...
# %bb.4:                                #   in Loop: Header=BB9_3 Depth=2
	...
	addq	%rdi, %rax
	leaq	(%rax,%r10,8), %r11
	movsd	(%rax,%r10,8), %xmm2    # xmm2 = mem[0],zero
	mulsd	%xmm1, %xmm2
...
.Lfunc_end9:
	...
	.cfi_endproc
                                        # -- End function
	.p2align	4, 0x90         # -- Begin function kernel_gemm_StrictFP
	.type	kernel_gemm_StrictFP,@function
kernel_gemm_StrictFP:                   # @kernel_gemm_StrictFP
	.cfi_startproc
# %bb.0:
	pushq	%rbp
	.cfi_def_cfa_offset 16
...
.LBB10_9:
	...
	retq
.Lfunc_end10:
	.size	kernel_gemm_StrictFP, .Lfunc_end10-kernel_gemm_StrictFP
	.cfi_endproc
                                        # -- End function
