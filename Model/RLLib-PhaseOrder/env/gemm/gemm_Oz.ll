; ModuleID = '/home/cs20btech11037/ml-llvm-project/Model/RLLib-PhaseOrder/env/gemm/gemm.ll'
...
define dso_local i32 @main(i32 %0, i8** nocapture readnone %1) local_unnamed_addr #0 {
  ...
  tail call fastcc void @kernel_gemm(double %13, double %14, [1024 x double]* %9, [1024 x double]* %11, [1024 x double]* %12)
  tail call fastcc void @kernel_gemm_StrictFP(double %13, double %14, [1024 x double]* %10, [1024 x double]* %11, [1024 x double]* %12)
...
7:                                                ; preds = %24, %6
  %indvars.iv17 = phi i64 [ %indvars.iv.next18, %24 ], [ 0, %6 ]
  %exitcond19 = icmp eq i64 %indvars.iv17, 1024
  br i1 %exitcond19, label %.preheader3, label %.preheader4
...
10:                                               ; preds = %11, %.preheader4
  %indvars.iv14 = phi i64 [ 0, %.preheader4 ], [ %indvars.iv.next15.1, %11 ]
  %exitcond16 = icmp eq i64 %indvars.iv14, 1024
  br i1 %exitcond16, label %24, label %11
...
11:                                               ; preds = %10
  ...
  %16 = getelementptr inbounds [1024 x double], [1024 x double]* %2, i64 %indvars.iv17, i64 %indvars.iv14
  store double %15, double* %16, align 8
  %17 = getelementptr inbounds [1024 x double], [1024 x double]* %3, i64 %indvars.iv17, i64 %indvars.iv14
  ...
  %22 = getelementptr inbounds [1024 x double], [1024 x double]* %2, i64 %indvars.iv17, i64 %indvars.iv.next15
  store double %21, double* %22, align 8
  %23 = getelementptr inbounds [1024 x double], [1024 x double]* %3, i64 %indvars.iv17, i64 %indvars.iv.next15
...
.preheader3:                                      ; preds = %7, %39
  %indvars.iv11 = phi i64 [ %indvars.iv.next12, %39 ], [ 0, %7 ]
  %exitcond13 = icmp eq i64 %indvars.iv11, 1024
  br i1 %exitcond13, label %.preheader1, label %.preheader2
...
27:                                               ; preds = %28, %.preheader2
  %indvars.iv8 = phi i64 [ 0, %.preheader2 ], [ %indvars.iv.next9.1, %28 ]
  %exitcond10 = icmp eq i64 %indvars.iv8, 1024
  br i1 %exitcond10, label %39, label %28
...
28:                                               ; preds = %27
  ...
  %33 = getelementptr inbounds [1024 x double], [1024 x double]* %4, i64 %indvars.iv11, i64 %indvars.iv8
  store double %32, double* %33, align 8
  %indvars.iv.next9 = or i64 %indvars.iv8, 1
  %34 = trunc i64 %indvars.iv.next9 to i32
  %35 = sitofp i32 %34 to double
  %36 = fmul double %26, %35
  %37 = fmul double %36, 0x3F50000000000000
  %38 = getelementptr inbounds [1024 x double], [1024 x double]* %4, i64 %indvars.iv11, i64 %indvars.iv.next9
...
.preheader1:                                      ; preds = %.preheader3, %54
  %indvars.iv5 = phi i64 [ %indvars.iv.next6, %54 ], [ 0, %.preheader3 ]
  %exitcond7 = icmp eq i64 %indvars.iv5, 1024
  br i1 %exitcond7, label %55, label %.preheader

.preheader:                                       ; preds = %.preheader1
  %40 = trunc i64 %indvars.iv5 to i32
  %41 = sitofp i32 %40 to double
  br label %42

42:                                               ; preds = %43, %.preheader
  %indvars.iv = phi i64 [ 0, %.preheader ], [ %indvars.iv.next.1, %43 ]
  %exitcond = icmp eq i64 %indvars.iv, 1024
  br i1 %exitcond, label %54, label %43
...
43:                                               ; preds = %42
  ...
  %48 = getelementptr inbounds [1024 x double], [1024 x double]* %5, i64 %indvars.iv5, i64 %indvars.iv
  ...
  %53 = getelementptr inbounds [1024 x double], [1024 x double]* %5, i64 %indvars.iv5, i64 %indvars.iv.next
...
define internal fastcc void @kernel_gemm(double %0, double %1, [1024 x double]* nocapture %2, [1024 x double]* nocapture readonly %3, [1024 x double]* nocapture readonly %4) unnamed_addr #6 {
  br label %6

6:                                                ; preds = %30, %5
  %indvars.iv4 = phi i64 [ %indvars.iv.next5, %30 ], [ 0, %5 ]
  %exitcond6 = icmp eq i64 %indvars.iv4, 1024
  br i1 %exitcond6, label %31, label %.preheader

.preheader:                                       ; preds = %6, %29
  %indvars.iv1 = phi i64 [ %indvars.iv.next2, %29 ], [ 0, %6 ]
  %exitcond3 = icmp eq i64 %indvars.iv1, 1024
  br i1 %exitcond3, label %30, label %7

7:                                                ; preds = %.preheader
  %8 = getelementptr inbounds [1024 x double], [1024 x double]* %2, i64 %indvars.iv4, i64 %indvars.iv1
...
11:                                               ; preds = %12, %7
  %indvars.iv = phi i64 [ 0, %7 ], [ %indvars.iv.next.1, %12 ]
  %exitcond = icmp eq i64 %indvars.iv, 1024
  br i1 %exitcond, label %29, label %12

12:                                               ; preds = %11
  %13 = getelementptr inbounds [1024 x double], [1024 x double]* %3, i64 %indvars.iv4, i64 %indvars.iv
  %14 = load double, double* %13, align 8
  %15 = fmul double %14, %0
  %16 = getelementptr inbounds [1024 x double], [1024 x double]* %4, i64 %indvars.iv, i64 %indvars.iv1
  ...
  %indvars.iv.next = or i64 %indvars.iv, 1
  %21 = getelementptr inbounds [1024 x double], [1024 x double]* %3, i64 %indvars.iv4, i64 %indvars.iv.next
  %22 = load double, double* %21, align 8
  %23 = fmul double %22, %0
  %24 = getelementptr inbounds [1024 x double], [1024 x double]* %4, i64 %indvars.iv.next, i64 %indvars.iv1
...
; Function Attrs: nofree noinline norecurse nounwind uwtable
define internal fastcc void @kernel_gemm_StrictFP(double %0, double %1, [1024 x double]* nocapture %2, [1024 x double]* nocapture readonly %3, [1024 x double]* nocapture readonly %4) unnamed_addr #6 {
  br label %6
