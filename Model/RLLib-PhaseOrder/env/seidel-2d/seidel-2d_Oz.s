...
.LBB9_7:                                #   Parent Loop BB9_1 Depth=1
	...
	movsd	-8032(%rdx,%rsi,8), %xmm1 # xmm1 = mem[0],zero
	addsd	-8024(%rdx,%rsi,8), %xmm1
	addsd	-8016(%rdx,%rsi,8), %xmm1
	addsd	-32(%rdx,%rsi,8), %xmm1
	addsd	-24(%rdx,%rsi,8), %xmm1
	addsd	-16(%rdx,%rsi,8), %xmm1
	addsd	7968(%rdx,%rsi,8), %xmm1
	addsd	7976(%rdx,%rsi,8), %xmm1
	addsd	7984(%rdx,%rsi,8), %xmm1
	divsd	%xmm0, %xmm1
	movsd	%xmm1, -24(%rdx,%rsi,8)
	addq	$1, %rsi
	testq	%rsi, %rsi
	jne	.LBB9_7
	jmp	.LBB9_3
