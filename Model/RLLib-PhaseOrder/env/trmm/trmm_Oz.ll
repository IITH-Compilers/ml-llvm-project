; ModuleID = '/home/cs20btech11037/ml-llvm-project/Model/RLLib-PhaseOrder/env/trmm/trmm.ll'
...
define dso_local i32 @main(i32 %0, i8** nocapture readnone %1) local_unnamed_addr #0 {
  ...
  %4 = tail call i8* @polybench_alloc_data(i64 1048576, i32 8)
  %5 = tail call i8* @polybench_alloc_data(i64 1048576, i32 8)
  %6 = tail call i8* @polybench_alloc_data(i64 1048576, i32 8)
  %7 = bitcast i8* %4 to [1024 x double]*
  %8 = bitcast i8* %5 to [1024 x double]*
  %9 = bitcast i8* %6 to [1024 x double]*
  call fastcc void @init_array(double* nonnull %3, [1024 x double]* %7, [1024 x double]* %8, [1024 x double]* %9)
  %10 = load double, double* %3, align 8
  tail call fastcc void @kernel_trmm(double %10, [1024 x double]* %7, [1024 x double]* %8)
  tail call fastcc void @kernel_trmm_StrictFP(double %10, [1024 x double]* %7, [1024 x double]* %9)
  %11 = tail call fastcc i32 @check_FP([1024 x double]* %8, [1024 x double]* %9)
  %12 = icmp eq i32 %11, 0
...
; Function Attrs: nofree noinline norecurse nounwind uwtable writeonly
define internal fastcc void @init_array(double* nocapture %0, [1024 x double]* nocapture %1, [1024 x double]* nocapture %2, [1024 x double]* nocapture %3) unnamed_addr #4 {
  store double 3.241200e+04, double* %0, align 8
  br label %5

5:                                                ; preds = %17, %4
  %indvars.iv1 = phi i64 [ %indvars.iv.next2, %17 ], [ 0, %4 ]
...
8:                                                ; preds = %.preheader, %9
  ...
  br i1 %exitcond, label %17, label %9
...
9:                                                ; preds = %8
  ...
  %14 = getelementptr inbounds [1024 x double], [1024 x double]* %1, i64 %indvars.iv1, i64 %indvars.iv
  store double %13, double* %14, align 8
  %15 = getelementptr inbounds [1024 x double], [1024 x double]* %2, i64 %indvars.iv1, i64 %indvars.iv
  store double %13, double* %15, align 8
  %16 = getelementptr inbounds [1024 x double], [1024 x double]* %3, i64 %indvars.iv1, i64 %indvars.iv
...
define internal fastcc void @kernel_trmm(double %0, [1024 x double]* nocapture readonly %1, [1024 x double]* nocapture %2) unnamed_addr #6 {
  br label %4

4:                                                ; preds = %17, %3
  %indvars.iv5 = phi i64 [ %indvars.iv.next6, %17 ], [ 1, %3 ]
  %exitcond7 = icmp eq i64 %indvars.iv5, 1024
  br i1 %exitcond7, label %18, label %.preheader1

.preheader1:                                      ; preds = %4, %16
  %indvars.iv2 = phi i64 [ %indvars.iv.next3, %16 ], [ 0, %4 ]
  %exitcond4 = icmp eq i64 %indvars.iv2, 1024
  br i1 %exitcond4, label %17, label %.preheader

.preheader:                                       ; preds = %.preheader1
  %5 = getelementptr inbounds [1024 x double], [1024 x double]* %2, i64 %indvars.iv5, i64 %indvars.iv2
  br label %6

6:                                                ; preds = %.preheader, %7
  %indvars.iv = phi i64 [ 0, %.preheader ], [ %indvars.iv.next, %7 ]
  %exitcond = icmp eq i64 %indvars.iv, %indvars.iv5
  br i1 %exitcond, label %16, label %7

7:                                                ; preds = %6
  %8 = getelementptr inbounds [1024 x double], [1024 x double]* %1, i64 %indvars.iv5, i64 %indvars.iv
  %9 = load double, double* %8, align 8
  %10 = fmul double %9, %0
  %11 = getelementptr inbounds [1024 x double], [1024 x double]* %2, i64 %indvars.iv2, i64 %indvars.iv
...
; Function Attrs: nofree noinline norecurse nounwind uwtable
define internal fastcc void @kernel_trmm_StrictFP(double %0, [1024 x double]* nocapture readonly %1, [1024 x double]* nocapture %2) unnamed_addr #6 {
  br label %4
