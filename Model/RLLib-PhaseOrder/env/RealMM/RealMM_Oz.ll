; ModuleID = '/home/cs20btech11037/ml-llvm-project/Model/RLLib-PhaseOrder/env/RealMM/RealMM.ll'
...
@value = common dso_local local_unnamed_addr global double 0.000000e+00, align 8
@fixed = common dso_local local_unnamed_addr global double 0.000000e+00, align 8
@floated = common dso_local local_unnamed_addr global double 0.000000e+00, align 8
...
@zr = common dso_local local_unnamed_addr global double 0.000000e+00, align 8
@zi = common dso_local local_unnamed_addr global double 0.000000e+00, align 8
...
; Function Attrs: nofree noinline norecurse nounwind uwtable
define dso_local void @rInitmatrix([41 x double]* nocapture %0) local_unnamed_addr #1 {
  br label %2
...
3:                                                ; preds = %.preheader
  ...
  %9 = getelementptr inbounds [41 x double], [41 x double]* %0, i64 %indvars.iv9, i64 %indvars.iv
...
; Function Attrs: nofree noinline norecurse nounwind uwtable
define dso_local void @rInnerproduct(double* nocapture %0, [41 x double]* nocapture readonly %1, [41 x double]* nocapture readonly %2, i32 %3, i32 %4) local_unnamed_addr #1 {
...
9:                                                ; preds = %8
  ...
  %11 = getelementptr inbounds [41 x double], [41 x double]* %1, i64 %6, i64 %indvars.iv
  %12 = load double, double* %11, align 8
  %13 = getelementptr inbounds [41 x double], [41 x double]* %2, i64 %indvars.iv, i64 %7
  ...
  %18 = getelementptr inbounds [41 x double], [41 x double]* %1, i64 %6, i64 %indvars.iv.next
  %19 = load double, double* %18, align 8
  %20 = getelementptr inbounds [41 x double], [41 x double]* %2, i64 %indvars.iv.next, i64 %7
...
define dso_local void @Mm(i32 %0) local_unnamed_addr #2 {
  ...
  tail call void @rInitmatrix([41 x double]* getelementptr inbounds ([41 x [41 x double]], [41 x [41 x double]]* @rma, i64 0, i64 0))
  tail call void @rInitmatrix([41 x double]* getelementptr inbounds ([41 x [41 x double]], [41 x [41 x double]]* @rmb, i64 0, i64 0))
  br label %2

2:                                                ; preds = %8, %1
  %indvars.iv10 = phi i64 [ %indvars.iv.next11, %8 ], [ 1, %1 ]
  %exitcond12 = icmp eq i64 %indvars.iv10, 41
  br i1 %exitcond12, label %9, label %.preheader
...
5:                                                ; preds = %4
  %6 = getelementptr inbounds [41 x [41 x double]], [41 x [41 x double]]* @rmr, i64 0, i64 %indvars.iv10, i64 %indvars.iv
  %7 = trunc i64 %indvars.iv to i32
  tail call void @rInnerproduct(double* nonnull %6, [41 x double]* getelementptr inbounds ([41 x [41 x double]], [41 x [41 x double]]* @rma, i64 0, i64 0), [41 x double]* getelementptr inbounds ([41 x [41 x double]], [41 x [41 x double]]* @rmb, i64 0, i64 0), i32 %3, i32 %7)
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  br label %4
...
9:                                                ; preds = %2
  ...
  %12 = getelementptr inbounds [41 x [41 x double]], [41 x [41 x double]]* @rmr, i64 0, i64 %11, i64 %11
  %13 = load double, double* %12, align 8
  %14 = tail call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), double %13)
  ret void
}
...
define dso_local i32 @main() local_unnamed_addr #2 {
  ...
  tail call void @Mm(i32 1)
  tail call void @Mm(i32 2)
  tail call void @Mm(i32 3)
  tail call void @Mm(i32 4)
  tail call void @Mm(i32 5)
  tail call void @Mm(i32 6)
  tail call void @Mm(i32 7)
  tail call void @Mm(i32 8)
  tail call void @Mm(i32 9)
  ret i32 0
}
