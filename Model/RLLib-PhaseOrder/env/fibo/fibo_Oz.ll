; ModuleID = '/home/cs20btech11037/ml-llvm-project/Model/RLLib-PhaseOrder/env/fibo/fibo.ll'
...
define dso_local i64 @_Z3fibm(i64 %0) local_unnamed_addr #4 {
  br label %tailrecurse

tailrecurse:                                      ; preds = %3, %1
  %accumulator.tr = phi i64 [ 1, %1 ], [ %7, %3 ]
  %.tr = phi i64 [ %0, %1 ], [ %6, %3 ]
  %2 = icmp ult i64 %.tr, 2
...
3:                                                ; preds = %tailrecurse
  %4 = add i64 %.tr, -2
  %5 = tail call i64 @_Z3fibm(i64 %4)
  %6 = add i64 %.tr, -1
  %7 = add i64 %5, %accumulator.tr
  br label %tailrecurse
...
8:                                                ; preds = %2, %4
  %9 = phi i64 [ %phitmp, %4 ], [ 43, %2 ]
  %10 = tail call i64 @_Z3fibm(i64 %9)
  %11 = tail call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEm(%"class.std::basic_ostream"* nonnull @_ZSt4cout, i64 %10)
