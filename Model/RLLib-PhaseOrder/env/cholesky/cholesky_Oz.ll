; ModuleID = '/home/cs20btech11037/ml-llvm-project/Model/RLLib-PhaseOrder/env/cholesky/cholesky.ll'
source_filename = "/home/es17btech11025/llvm-test-suite/SingleSource/Benchmarks/Polybench/linear-algebra/kernels/cholesky/cholesky.c"
...
define dso_local void @polybench_flush_cache() local_unnamed_addr #0 {
  %1 = tail call noalias dereferenceable_or_null(33556480) i8* @calloc(i64 4194560, i64 8) #8
...
12:                                               ; preds = %10
  tail call void @__assert_fail(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([93 x i8], [93 x i8]* @.str.1, i64 0, i64 0), i32 301, i8* getelementptr inbounds ([29 x i8], [29 x i8]* @__PRETTY_FUNCTION__.polybench_flush_cache, i64 0, i64 0)) #9
  unreachable
...
define internal fastcc i8* @xmalloc(i64 %0) unnamed_addr #0 {
  ...
  %3 = call i32 @posix_memalign(i8** nonnull %2, i64 32, i64 %0) #8
...
7:                                                ; preds = %1
  ...
  %9 = call i64 @fwrite(i8* getelementptr inbounds ([51 x i8], [51 x i8]* @.str.3, i64 0, i64 0), i64 50, i64 1, %struct._IO_FILE* %8) #10
...
define dso_local i32 @main(i32 %0, i8** nocapture readnone %1) local_unnamed_addr #0 {
  %3 = tail call i8* @polybench_alloc_data(i64 1048576, i32 8)
  %4 = tail call i8* @polybench_alloc_data(i64 1024, i32 8)
  %5 = tail call i8* @polybench_alloc_data(i64 1048576, i32 8)
  %6 = bitcast i8* %4 to double*
  %7 = bitcast i8* %3 to [1024 x double]*
  %8 = bitcast i8* %5 to [1024 x double]*
  tail call fastcc void @init_array(double* %6, [1024 x double]* %7, [1024 x double]* %8)
  tail call fastcc void @kernel_cholesky(double* %6, [1024 x double]* %7)
  tail call fastcc void @kernel_cholesky_StrictFP(double* %6, [1024 x double]* %8)
  %9 = tail call fastcc i32 @check_FP([1024 x double]* %7, [1024 x double]* %8)
  %10 = icmp eq i32 %9, 0
  br i1 %10, label %12, label %11

11:                                               ; preds = %2
  tail call fastcc void @print_array([1024 x double]* %8)
...
; Function Attrs: nofree noinline norecurse nounwind uwtable writeonly
define internal fastcc void @init_array(double* nocapture %0, [1024 x double]* nocapture %1, [1024 x double]* nocapture %2) unnamed_addr #4 {
  br label %4

4:                                                ; preds = %22, %3
  %indvars.iv1 = phi i64 [ %indvars.iv.next2, %22 ], [ 0, %3 ]
  %exitcond3 = icmp eq i64 %indvars.iv1, 1024
  br i1 %exitcond3, label %23, label %5
...
10:                                               ; preds = %11, %5
  %indvars.iv = phi i64 [ 0, %5 ], [ %indvars.iv.next.1, %11 ]
  %exitcond = icmp eq i64 %indvars.iv, 1024
  br i1 %exitcond, label %22, label %11

11:                                               ; preds = %10
  %12 = trunc i64 %indvars.iv to i32
  %13 = add nuw nsw i32 %12, 1024
  %14 = sitofp i32 %13 to double
  %15 = getelementptr inbounds [1024 x double], [1024 x double]* %1, i64 %indvars.iv1, i64 %indvars.iv
  store double %14, double* %15, align 8
  %16 = getelementptr inbounds [1024 x double], [1024 x double]* %2, i64 %indvars.iv1, i64 %indvars.iv
  store double %14, double* %16, align 8
  %indvars.iv.next = or i64 %indvars.iv, 1
  %17 = trunc i64 %indvars.iv.next to i32
  %18 = add nuw nsw i32 %17, 1024
  %19 = sitofp i32 %18 to double
  %20 = getelementptr inbounds [1024 x double], [1024 x double]* %1, i64 %indvars.iv1, i64 %indvars.iv.next
  store double %19, double* %20, align 8
  %21 = getelementptr inbounds [1024 x double], [1024 x double]* %2, i64 %indvars.iv1, i64 %indvars.iv.next
...
; Function Attrs: nofree noinline nounwind uwtable
define internal fastcc void @kernel_cholesky(double* nocapture %0, [1024 x double]* nocapture %1) unnamed_addr #5 {
  br label %.loopexit
...
.loopexit:                                        ; preds = %.loopexit.loopexit, %2
  %indvars.iv10 = phi i64 [ %indvars.iv.next11, %.loopexit.loopexit ], [ 0, %2 ]
  %indvars.iv5 = phi i64 [ %indvars.iv.next6, %.loopexit.loopexit ], [ 1, %2 ]
  %exitcond12 = icmp eq i64 %indvars.iv10, 1024
  br i1 %exitcond12, label %33, label %3

3:                                                ; preds = %.loopexit
  %4 = getelementptr inbounds [1024 x double], [1024 x double]* %1, i64 %indvars.iv10, i64 %indvars.iv10
  %5 = load double, double* %4, align 8
...
7:                                                ; preds = %8, %3
  ...
  %.0 = phi double [ %12, %8 ], [ %6, %3 ]
  %exitcond = icmp eq i64 %indvars.iv, %indvars.iv10
  br i1 %exitcond, label %13, label %8

8:                                                ; preds = %7
  %9 = getelementptr inbounds [1024 x double], [1024 x double]* %1, i64 %indvars.iv10, i64 %indvars.iv
...
13:                                               ; preds = %7
  %14 = tail call double @sqrt(double %.0) #8
  %15 = fdiv double 1.000000e+00, %14
  %16 = getelementptr inbounds double, double* %0, i64 %indvars.iv10
  store double %15, double* %16, align 8
  %indvars.iv.next11 = add nuw nsw i64 %indvars.iv10, 1
  br label %17

17:                                               ; preds = %29, %13
  %indvars.iv7 = phi i64 [ %indvars.iv.next8, %29 ], [ %indvars.iv5, %13 ]
  %exitcond9 = icmp eq i64 %indvars.iv7, 1024
  br i1 %exitcond9, label %.loopexit.loopexit, label %18

18:                                               ; preds = %17
  %19 = getelementptr inbounds [1024 x double], [1024 x double]* %1, i64 %indvars.iv10, i64 %indvars.iv7
  %20 = load double, double* %19, align 8
  br label %21

21:                                               ; preds = %22, %18
  %indvars.iv1 = phi i64 [ %indvars.iv.next2, %22 ], [ 0, %18 ]
  %.1 = phi double [ %28, %22 ], [ %20, %18 ]
  %exitcond4 = icmp eq i64 %indvars.iv1, %indvars.iv10
  br i1 %exitcond4, label %29, label %22

22:                                               ; preds = %21
  %23 = getelementptr inbounds [1024 x double], [1024 x double]* %1, i64 %indvars.iv7, i64 %indvars.iv1
  %24 = load double, double* %23, align 8
  %25 = getelementptr inbounds [1024 x double], [1024 x double]* %1, i64 %indvars.iv10, i64 %indvars.iv1
...
29:                                               ; preds = %21
  ...
  %31 = fmul double %.1, %30
  %32 = getelementptr inbounds [1024 x double], [1024 x double]* %1, i64 %indvars.iv7, i64 %indvars.iv10
...
; Function Attrs: nofree noinline nounwind uwtable
define internal fastcc void @kernel_cholesky_StrictFP(double* nocapture %0, [1024 x double]* nocapture %1) unnamed_addr #5 {
  br label %.loopexit
...
12:                                               ; preds = %4
  ...
  %16 = tail call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %15, i8* getelementptr inbounds ([76 x i8], [76 x i8]* @.str.4, i64 0, i64 0), i32 %13, i32 %14, double %6, i32 %13, i32 %14, double %8, double 1.000000e-05) #10
  br label %.loopexit
...
define internal fastcc void @print_array([1024 x double]* nocapture readonly %0) unnamed_addr #0 {
  %2 = tail call noalias dereferenceable_or_null(16385) i8* @malloc(i64 16385) #8
...
9:                                                ; preds = %.preheader
  ...
  %11 = tail call i32 @fputs(i8* %2, %struct._IO_FILE* %10) #10
  %indvars.iv.next2 = add nuw nsw i64 %indvars.iv1, 1
  br label %4
