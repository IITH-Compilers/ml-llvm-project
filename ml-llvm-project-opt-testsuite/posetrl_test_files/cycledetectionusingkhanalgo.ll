; ModuleID = '/home/intern24006/codebase/cycledetectionusingkhanalgo.cpp'
source_filename = "/home/intern24006/codebase/cycledetectionusingkhanalgo.cpp"
...
@.str = private unnamed_addr constant [3 x i8] c"N0\00", align 1
@.str.1 = private unnamed_addr constant [4 x i8] c"Yes\00", align 1
@.str.2 = private unnamed_addr constant [26 x i8] c"vector::_M_realloc_insert\00", align 1
@.str.3 = private unnamed_addr constant [48 x i8] c"cannot create std::deque larger than max_size()\00", align 1
@.str.4 = private unnamed_addr constant [49 x i8] c"cannot create std::vector larger than max_size()\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_cycledetectionusingkhanalgo.cpp, i8* null }]
...
; Function Attrs: noinline optnone uwtable
define dso_local void @_Z7isCyclePSt6vectorIiSaIiEERS1_i(%"class.std::vector"* %adj, %"class.std::vector"* dereferenceable(24) %indegree, i32 %V) #4 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
  %adj.addr = alloca %"class.std::vector"*, align 8
  %indegree.addr = alloca %"class.std::vector"*, align 8
  %V.addr = alloca i32, align 4
...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  %1 = load %"class.std::vector"*, %"class.std::vector"** %indegree.addr, align 8
...
for.body:                                         ; preds = %for.cond
  ...
  %call2 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %2, i64 %conv1) #3
...
lpad:                                             ; preds = %invoke.cont34, %if.else, %invoke.cont30, %if.then29, %if.then22, %invoke.cont6, %while.body, %while.cond, %if.then
  %5 = landingpad { i8*, i32 }
          cleanup
...
while.cond:                                       ; preds = %for.end27, %for.end
  %call5 = invoke zeroext i1 @_ZNKSt5queueIiSt5dequeIiSaIiEEE5emptyEv(%"class.std::queue"* %q)
...
while.body:                                       ; preds = %invoke.cont4
  %call7 = invoke dereferenceable(4) i32* @_ZNSt5queueIiSt5dequeIiSaIiEEE5frontEv(%"class.std::queue"* %q)
...
invoke.cont8:                                     ; preds = %invoke.cont6
  ...
  %11 = load %"class.std::vector"*, %"class.std::vector"** %adj.addr, align 8
  %12 = load i32, i32* %x, align 4
  %idxprom = sext i32 %12 to i64
  %arrayidx = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %11, i64 %idxprom
  store %"class.std::vector"* %arrayidx, %"class.std::vector"** %__range2, align 8
  %13 = load %"class.std::vector"*, %"class.std::vector"** %__range2, align 8
  %call10 = call i32* @_ZNSt6vectorIiSaIiEE5beginEv(%"class.std::vector"* %13) #3
  ...
  store i32* %call10, i32** %coerce.dive, align 8
  %14 = load %"class.std::vector"*, %"class.std::vector"** %__range2, align 8
  %call11 = call i32* @_ZNSt6vectorIiSaIiEE3endEv(%"class.std::vector"* %14) #3
  %coerce.dive12 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator", %"class.__gnu_cxx::__normal_iterator"* %__end2, i32 0, i32 0
  store i32* %call11, i32** %coerce.dive12, align 8
  br label %for.cond13

for.cond13:                                       ; preds = %for.inc25, %invoke.cont8
  %call14 = call zeroext i1 @_ZN9__gnu_cxxneIPiSt6vectorIiSaIiEEEEbRKNS_17__normal_iteratorIT_T0_EESA_(%"class.__gnu_cxx::__normal_iterator"* dereferenceable(8) %__begin2, %"class.__gnu_cxx::__normal_iterator"* dereferenceable(8) %__end2) #3
  br i1 %call14, label %for.body15, label %for.end27
...
for.body15:                                       ; preds = %for.cond13
  ...
  %16 = load %"class.std::vector"*, %"class.std::vector"** %indegree.addr, align 8
  %17 = load i32, i32* %u, align 4
  %conv17 = sext i32 %17 to i64
  %call18 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %16, i64 %conv17) #3
  %18 = load i32, i32* %call18, align 4
  %dec = add nsw i32 %18, -1
  store i32 %dec, i32* %call18, align 4
...
if.end24:                                         ; preds = %invoke.cont23, %for.body15
  br label %for.inc25

for.inc25:                                        ; preds = %if.end24
  %call26 = call dereferenceable(8) %"class.__gnu_cxx::__normal_iterator"* @_ZN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEppEv(%"class.__gnu_cxx::__normal_iterator"* %__begin2) #3
  br label %for.cond13
...
if.then29:                                        ; preds = %while.end
  %call31 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0))
...
if.else:                                          ; preds = %while.end
  %call35 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0))
          to label %invoke.cont34 unwind label %lpad

invoke.cont34:                                    ; preds = %if.else
  %call37 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEPFRSoS_E(%"class.std::basic_ostream"* %call35, %"class.std::basic_ostream"* (%"class.std::basic_ostream"*)* @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
...
entry:
  ...
  %indegree2 = alloca %"class.std::vector", align 8
...
invoke.cont:                                      ; preds = %arrayctor.cont
  ...
  invoke void @_Z7addEdgePSt6vectorIiSaIiEEiiRS1_(%"class.std::vector"* %vla, i32 0, i32 1, %"class.std::vector"* dereferenceable(24) %indegree)
          to label %invoke.cont3 unwind label %lpad2

invoke.cont3:                                     ; preds = %invoke.cont
  invoke void @_Z7addEdgePSt6vectorIiSaIiEEiiRS1_(%"class.std::vector"* %vla, i32 1, i32 2, %"class.std::vector"* dereferenceable(24) %indegree)
          to label %invoke.cont4 unwind label %lpad2

invoke.cont4:                                     ; preds = %invoke.cont3
  invoke void @_Z7addEdgePSt6vectorIiSaIiEEiiRS1_(%"class.std::vector"* %vla, i32 2, i32 0, %"class.std::vector"* dereferenceable(24) %indegree)
          to label %invoke.cont5 unwind label %lpad2

invoke.cont5:                                     ; preds = %invoke.cont4
  invoke void @_Z7addEdgePSt6vectorIiSaIiEEiiRS1_(%"class.std::vector"* %vla, i32 2, i32 3, %"class.std::vector"* dereferenceable(24) %indegree)
          to label %invoke.cont6 unwind label %lpad2

invoke.cont6:                                     ; preds = %invoke.cont5
  %4 = load i32, i32* %V, align 4
  invoke void @_Z7isCyclePSt6vectorIiSaIiEERS1_i(%"class.std::vector"* %vla, %"class.std::vector"* dereferenceable(24) %indegree, i32 %4)
          to label %invoke.cont7 unwind label %lpad2

invoke.cont7:                                     ; preds = %invoke.cont6
  %5 = load i32, i32* %V, align 4
  %6 = zext i32 %5 to i64
  %vla8 = alloca %"class.std::vector", i64 %6, align 16
  store i64 %6, i64* %__vla_expr1, align 8
  %isempty9 = icmp eq i64 %6, 0
  br i1 %isempty9, label %arrayctor.cont16, label %new.ctorloop10

new.ctorloop10:                                   ; preds = %invoke.cont7
  %arrayctor.end11 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %vla8, i64 %6
  br label %arrayctor.loop12

arrayctor.loop12:                                 ; preds = %arrayctor.loop12, %new.ctorloop10
  %arrayctor.cur13 = phi %"class.std::vector"* [ %vla8, %new.ctorloop10 ], [ %arrayctor.next14, %arrayctor.loop12 ]
  call void @_ZNSt6vectorIiSaIiEEC2Ev(%"class.std::vector"* %arrayctor.cur13) #3
  %arrayctor.next14 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %arrayctor.cur13, i64 1
  %arrayctor.done15 = icmp eq %"class.std::vector"* %arrayctor.next14, %arrayctor.end11
  br i1 %arrayctor.done15, label %arrayctor.cont16, label %arrayctor.loop12

arrayctor.cont16:                                 ; preds = %invoke.cont7, %arrayctor.loop12
  ...
  invoke void @_ZNSt6vectorIiSaIiEEC2EmRKiRKS0_(%"class.std::vector"* %indegree2, i64 %conv17, i32* dereferenceable(4) %ref.tmp18, %"class.std::allocator"* dereferenceable(1) %ref.tmp19)
          to label %invoke.cont21 unwind label %lpad20

invoke.cont21:                                    ; preds = %arrayctor.cont16
  call void @_ZNSaIiED2Ev(%"class.std::allocator"* %ref.tmp19) #3
  invoke void @_Z7addEdgePSt6vectorIiSaIiEEiiRS1_(%"class.std::vector"* %vla8, i32 0, i32 1, %"class.std::vector"* dereferenceable(24) %indegree2)
          to label %invoke.cont23 unwind label %lpad22

invoke.cont23:                                    ; preds = %invoke.cont21
  invoke void @_Z7addEdgePSt6vectorIiSaIiEEiiRS1_(%"class.std::vector"* %vla8, i32 1, i32 2, %"class.std::vector"* dereferenceable(24) %indegree2)
          to label %invoke.cont24 unwind label %lpad22

invoke.cont24:                                    ; preds = %invoke.cont23
  invoke void @_Z7addEdgePSt6vectorIiSaIiEEiiRS1_(%"class.std::vector"* %vla8, i32 0, i32 2, %"class.std::vector"* dereferenceable(24) %indegree2)
          to label %invoke.cont25 unwind label %lpad22

invoke.cont25:                                    ; preds = %invoke.cont24
  invoke void @_Z7addEdgePSt6vectorIiSaIiEEiiRS1_(%"class.std::vector"* %vla8, i32 2, i32 3, %"class.std::vector"* dereferenceable(24) %indegree2)
          to label %invoke.cont26 unwind label %lpad22

invoke.cont26:                                    ; preds = %invoke.cont25
  %8 = load i32, i32* %V, align 4
  invoke void @_Z7isCyclePSt6vectorIiSaIiEERS1_i(%"class.std::vector"* %vla8, %"class.std::vector"* dereferenceable(24) %indegree2, i32 %8)
          to label %invoke.cont27 unwind label %lpad22

invoke.cont27:                                    ; preds = %invoke.cont26
  store i32 0, i32* %retval, align 4
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %indegree2) #3
  %9 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %vla8, i64 %6
  %arraydestroy.isempty = icmp eq %"class.std::vector"* %vla8, %9
...
lpad22:                                           ; preds = %invoke.cont26, %invoke.cont25, %invoke.cont24, %invoke.cont23, %invoke.cont21
...
arraydestroy.body:                                ; preds = %arraydestroy.body, %invoke.cont27
  %arraydestroy.elementPast = phi %"class.std::vector"* [ %9, %invoke.cont27 ], [ %arraydestroy.element, %arraydestroy.body ]
  ...
  %arraydestroy.done = icmp eq %"class.std::vector"* %arraydestroy.element, %vla8
  br i1 %arraydestroy.done, label %arraydestroy.done28, label %arraydestroy.body

arraydestroy.done28:                              ; preds = %arraydestroy.body, %invoke.cont27
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %indegree) #3
  %22 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %vla, i64 %1
  %arraydestroy.isempty36 = icmp eq %"class.std::vector"* %vla, %22
  br i1 %arraydestroy.isempty36, label %arraydestroy.done41, label %arraydestroy.body37

ehcleanup:                                        ; preds = %lpad22, %lpad20
  %23 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %vla8, i64 %6
  %arraydestroy.isempty29 = icmp eq %"class.std::vector"* %vla8, %23
...
arraydestroy.body30:                              ; preds = %arraydestroy.body30, %ehcleanup
  %arraydestroy.elementPast31 = phi %"class.std::vector"* [ %23, %ehcleanup ], [ %arraydestroy.element32, %arraydestroy.body30 ]
  ...
  %arraydestroy.done33 = icmp eq %"class.std::vector"* %arraydestroy.element32, %vla8
  br i1 %arraydestroy.done33, label %arraydestroy.done34, label %arraydestroy.body30

arraydestroy.done34:                              ; preds = %arraydestroy.body30, %ehcleanup
  br label %ehcleanup35

ehcleanup35:                                      ; preds = %arraydestroy.done34, %lpad2
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %indegree) #3
  br label %ehcleanup42

arraydestroy.body37:                              ; preds = %arraydestroy.body37, %arraydestroy.done28
  %arraydestroy.elementPast38 = phi %"class.std::vector"* [ %22, %arraydestroy.done28 ], [ %arraydestroy.element39, %arraydestroy.body37 ]
  %arraydestroy.element39 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %arraydestroy.elementPast38, i64 -1
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %arraydestroy.element39) #3
  %arraydestroy.done40 = icmp eq %"class.std::vector"* %arraydestroy.element39, %vla
  br i1 %arraydestroy.done40, label %arraydestroy.done41, label %arraydestroy.body37

arraydestroy.done41:                              ; preds = %arraydestroy.body37, %arraydestroy.done28
  %24 = load i8*, i8** %saved_stack, align 8
  call void @llvm.stackrestore(i8* %24)
  %25 = load i32, i32* %retval, align 4
  ret i32 %25

ehcleanup42:                                      ; preds = %ehcleanup35, %lpad
  %26 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %vla, i64 %1
  %arraydestroy.isempty43 = icmp eq %"class.std::vector"* %vla, %26
  br i1 %arraydestroy.isempty43, label %arraydestroy.done48, label %arraydestroy.body44

arraydestroy.body44:                              ; preds = %arraydestroy.body44, %ehcleanup42
  %arraydestroy.elementPast45 = phi %"class.std::vector"* [ %26, %ehcleanup42 ], [ %arraydestroy.element46, %arraydestroy.body44 ]
  %arraydestroy.element46 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %arraydestroy.elementPast45, i64 -1
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %arraydestroy.element46) #3
  %arraydestroy.done47 = icmp eq %"class.std::vector"* %arraydestroy.element46, %vla
  br i1 %arraydestroy.done47, label %arraydestroy.done48, label %arraydestroy.body44

arraydestroy.done48:                              ; preds = %arraydestroy.body44, %ehcleanup42
  br label %eh.resume

eh.resume:                                        ; preds = %arraydestroy.done48
  %exn = load i8*, i8** %exn.slot, align 8
  %sel = load i32, i32* %ehselector.slot, align 4
  %lpad.val = insertvalue { i8*, i32 } undef, i8* %exn, 0
...
if.then:                                          ; preds = %entry
  call void @_ZSt20__throw_length_errorPKc(i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str.3, i64 0, i64 0)) #13
  unreachable
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_cycledetectionusingkhanalgo.cpp() #0 section ".text.startup" {
entry:
