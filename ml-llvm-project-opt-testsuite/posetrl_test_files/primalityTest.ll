; ModuleID = '/home/intern24006/codebase/primalityTest.cpp'
source_filename = "/home/intern24006/codebase/primalityTest.cpp"
...
$_ZN8Solution7isPrimeEi = comdat any
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_primalityTest.cpp, i8* null }]
...
while.body:                                       ; preds = %while.cond
  ...
  %call2 = call zeroext i1 @_ZN8Solution7isPrimeEi(%class.Solution* %ob, i32 %1)
  br i1 %call2, label %if.then, label %if.else

if.then:                                          ; preds = %while.body
  %call3 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0))
  br label %if.end

if.else:                                          ; preds = %while.body
  %call4 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0))
  br label %if.end
...
define linkonce_odr dso_local zeroext i1 @_ZN8Solution7isPrimeEi(%class.Solution* %this, i32 %N) #5 comdat align 2 {
entry:
...
if.end4:                                          ; preds = %if.end
  ...
  %3 = call double @llvm.ceil.f64(double %call)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_primalityTest.cpp() #0 section ".text.startup" {
entry:
