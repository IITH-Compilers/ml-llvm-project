; ModuleID = '/home/intern24006/codebase/maxSubArrayEvenOdd.cpp'
source_filename = "/home/intern24006/codebase/maxSubArrayEvenOdd.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_maxSubArrayEvenOdd.cpp, i8* null }]
...
define dso_local i32 @_Z10maxEvenOddPii(i32* %arr, i32 %n) #4 {
entry:
...
if.then:                                          ; preds = %land.lhs.true10, %land.lhs.true
  ...
  %call = call dereferenceable(4) i32* @_ZSt3maxIiERKT_S2_S2_(i32* dereferenceable(4) %count, i32* dereferenceable(4) %res)
...
for.end:                                          ; preds = %for.cond
  ...
  %call2 = call i32 @_Z10maxEvenOddPii(i32* %vla, i32 %7)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_maxSubArrayEvenOdd.cpp() #0 section ".text.startup" {
entry:
