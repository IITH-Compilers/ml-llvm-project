; ModuleID = '/home/intern24006/codebase/LongestCommonSubsequence.cpp'
source_filename = "/home/intern24006/codebase/LongestCommonSubsequence.cpp"
...
@__const.main.X = private unnamed_addr constant [3 x i8] c"BD\00", align 1
@__const.main.Y = private unnamed_addr constant [5 x i8] c"ABCD\00", align 1
@_ZSt4cout = external dso_local global %"class.std::basic_ostream", align 8
@.str = private unnamed_addr constant [18 x i8] c"Length of LCS is \00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_LongestCommonSubsequence.cpp, i8* null }]
...
define dso_local i32 @_Z3lcsPcS_ii(i8* %X, i8* %Y, i32 %m, i32 %n) #4 {
entry:
...
if.then7:                                         ; preds = %if.end
  ...
  %9 = load i8*, i8** %Y.addr, align 8
  %10 = load i32, i32* %m.addr, align 4
  %sub8 = sub nsw i32 %10, 1
  %11 = load i32, i32* %n.addr, align 4
  %sub9 = sub nsw i32 %11, 1
  %call = call i32 @_Z3lcsPcS_ii(i8* %8, i8* %9, i32 %sub8, i32 %sub9)
...
if.else:                                          ; preds = %if.end
  ...
  %call11 = call i32 @_Z3lcsPcS_ii(i8* %12, i8* %13, i32 %14, i32 %sub10)
  %16 = load i8*, i8** %X.addr, align 8
  %17 = load i8*, i8** %Y.addr, align 8
  %18 = load i32, i32* %m.addr, align 4
  %sub12 = sub nsw i32 %18, 1
  %19 = load i32, i32* %n.addr, align 4
  %call13 = call i32 @_Z3lcsPcS_ii(i8* %16, i8* %17, i32 %sub12, i32 %19)
  %call14 = call i32 @_Z3maxii(i32 %call11, i32 %call13)
...
define dso_local i32 @_Z3maxii(i32 %a, i32 %b) #5 {
entry:
...
entry:
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 %0, i8* align 1 getelementptr inbounds ([3 x i8], [3 x i8]* @__const.main.X, i32 0, i32 0), i64 3, i1 false)
  %1 = bitcast [5 x i8]* %Y to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 %1, i8* align 1 getelementptr inbounds ([5 x i8], [5 x i8]* @__const.main.Y, i32 0, i32 0), i64 5, i1 false)
  %arraydecay = getelementptr inbounds [3 x i8], [3 x i8]* %X, i64 0, i64 0
  %call = call i64 @strlen(i8* %arraydecay) #9
  %conv = trunc i64 %call to i32
  store i32 %conv, i32* %m, align 4
  %arraydecay1 = getelementptr inbounds [5 x i8], [5 x i8]* %Y, i64 0, i64 0
  %call2 = call i64 @strlen(i8* %arraydecay1) #9
  %conv3 = trunc i64 %call2 to i32
  store i32 %conv3, i32* %n, align 4
  %call4 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str, i64 0, i64 0))
  %arraydecay5 = getelementptr inbounds [3 x i8], [3 x i8]* %X, i64 0, i64 0
  %arraydecay6 = getelementptr inbounds [5 x i8], [5 x i8]* %Y, i64 0, i64 0
  %2 = load i32, i32* %m, align 4
  %3 = load i32, i32* %n, align 4
  %call7 = call i32 @_Z3lcsPcS_ii(i8* %arraydecay5, i8* %arraydecay6, i32 %2, i32 %3)
  %call8 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* %call4, i32 %call7)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_LongestCommonSubsequence.cpp() #0 section ".text.startup" {
entry:
