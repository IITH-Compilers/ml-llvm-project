; ModuleID = '/home/intern24006/codebase/Q1.cpp'
source_filename = "/home/intern24006/codebase/Q1.cpp"
...
$_ZN8Solution7setBitsEi = comdat any

@_ZStL8__ioinit = internal global %"class.std::ios_base::Init" zeroinitializer, align 1
@__dso_handle = external hidden global i8
@_ZSt3cin = external dso_local global %"class.std::basic_istream", align 8
@_ZSt4cout = external dso_local global %"class.std::basic_ostream", align 8
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_Q1.cpp, i8* null }]
...
while.body:                                       ; preds = %while.cond
  ...
  %call2 = call i32 @_ZN8Solution7setBitsEi(%class.Solution* %ob, i32 %1)
...
define linkonce_odr dso_local i32 @_ZN8Solution7setBitsEi(%class.Solution* %this, i32 %N) #5 comdat align 2 {
entry:
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_Q1.cpp() #0 section ".text.startup" {
entry:
