; ModuleID = '/home/intern24006/codebase/ClimbingStairs.cpp'
source_filename = "/home/intern24006/codebase/ClimbingStairs.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_ClimbingStairs.cpp, i8* null }]
...
define dso_local i32 @_Z11climbStairsi(i32 %n) #4 {
entry:
...
entry:
  ...
  %call1 = call i32 @_Z11climbStairsi(i32 %0)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_ClimbingStairs.cpp() #0 section ".text.startup" {
entry:
