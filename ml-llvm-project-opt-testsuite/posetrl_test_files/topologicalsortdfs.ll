; ModuleID = '/home/intern24006/codebase/topologicalsortdfs.cpp'
source_filename = "/home/intern24006/codebase/topologicalsortdfs.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_topologicalsortdfs.cpp, i8* null }]
...
; Function Attrs: noinline optnone uwtable
define dso_local void @_Z7toporecPSt6vectorIiSaIiEEiRS_IbSaIbEERSt5stackIiSt5dequeIiS0_EE(%"class.std::vector"* %adj, i32 %s, %"class.std::vector.0"* dereferenceable(40) %visited, %"class.std::stack"* dereferenceable(80) %st) #4 {
entry:
  %adj.addr = alloca %"class.std::vector"*, align 8
  ...
  %7 = load %"class.std::vector"*, %"class.std::vector"** %adj.addr, align 8
  %8 = load i32, i32* %s.addr, align 4
  %idxprom = sext i32 %8 to i64
  %arrayidx = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %7, i64 %idxprom
  store %"class.std::vector"* %arrayidx, %"class.std::vector"** %__range1, align 8
  %9 = load %"class.std::vector"*, %"class.std::vector"** %__range1, align 8
  %call2 = call i32* @_ZNSt6vectorIiSaIiEE5beginEv(%"class.std::vector"* %9) #3
  ...
  store i32* %call2, i32** %coerce.dive, align 8
  %10 = load %"class.std::vector"*, %"class.std::vector"** %__range1, align 8
  %call3 = call i32* @_ZNSt6vectorIiSaIiEE3endEv(%"class.std::vector"* %10) #3
...
for.cond:                                         ; preds = %for.inc, %entry
  %call5 = call zeroext i1 @_ZN9__gnu_cxxneIPiSt6vectorIiSaIiEEEEbRKNS_17__normal_iteratorIT_T0_EESA_(%"class.__gnu_cxx::__normal_iterator"* dereferenceable(8) %__begin1, %"class.__gnu_cxx::__normal_iterator"* dereferenceable(8) %__end1) #3
  br i1 %call5, label %for.body, label %for.end

for.body:                                         ; preds = %for.cond
  %call6 = call dereferenceable(4) i32* @_ZNK9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEdeEv(%"class.__gnu_cxx::__normal_iterator"* %__begin1) #3
  %11 = load i32, i32* %call6, align 4
  store i32 %11, i32* %x, align 4
  %12 = load %"class.std::vector.0"*, %"class.std::vector.0"** %visited.addr, align 8
  %13 = load i32, i32* %x, align 4
  %conv8 = sext i32 %13 to i64
  %call9 = call { i64*, i64 } @_ZNSt6vectorIbSaIbEEixEm(%"class.std::vector.0"* %12, i64 %conv8)
  %14 = bitcast %"struct.std::_Bit_reference"* %ref.tmp7 to { i64*, i64 }*
  ...
  %call10 = call zeroext i1 @_ZNKSt14_Bit_referencecvbEv(%"struct.std::_Bit_reference"* %ref.tmp7) #3
  %conv11 = zext i1 %call10 to i32
  %cmp = icmp eq i32 %conv11, 0
  br i1 %cmp, label %if.then, label %if.end

if.then:                                          ; preds = %for.body
  %19 = load %"class.std::vector"*, %"class.std::vector"** %adj.addr, align 8
  %20 = load i32, i32* %x, align 4
  %21 = load %"class.std::vector.0"*, %"class.std::vector.0"** %visited.addr, align 8
  %22 = load %"class.std::stack"*, %"class.std::stack"** %st.addr, align 8
  call void @_Z7toporecPSt6vectorIiSaIiEEiRS_IbSaIbEERSt5stackIiSt5dequeIiS0_EE(%"class.std::vector"* %19, i32 %20, %"class.std::vector.0"* dereferenceable(40) %21, %"class.std::stack"* dereferenceable(80) %22)
  br label %if.end
...
for.end:                                          ; preds = %for.cond
  %23 = load %"class.std::stack"*, %"class.std::stack"** %st.addr, align 8
  call void @_ZNSt5stackIiSt5dequeIiSaIiEEE4pushERKi(%"class.std::stack"* %23, i32* dereferenceable(4) %s.addr)
  ret void
}
...
; Function Attrs: noinline optnone uwtable
define dso_local void @_Z8toposortPSt6vectorIiSaIiEEi(%"class.std::vector"* noalias sret %agg.result, %"class.std::vector"* %adj, i32 %V) #4 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
  ...
  store %"class.std::vector"* %adj, %"class.std::vector"** %adj.addr, align 8
  store i32 %V, i32* %V.addr, align 4
  call void @_ZNSt5stackIiSt5dequeIiSaIiEEEC2IS2_vEEv(%"class.std::stack"* %st)
...
for.body:                                         ; preds = %for.cond
  ...
  %call = invoke { i64*, i64 } @_ZNSt6vectorIbSaIbEEixEm(%"class.std::vector.0"* %visited, i64 %conv3)
          to label %invoke.cont5 unwind label %lpad4

invoke.cont5:                                     ; preds = %for.body
  %5 = bitcast %"struct.std::_Bit_reference"* %ref.tmp2 to { i64*, i64 }*
  ...
  %call6 = call zeroext i1 @_ZNKSt14_Bit_referencecvbEv(%"struct.std::_Bit_reference"* %ref.tmp2) #3
  %conv7 = zext i1 %call6 to i32
  %cmp8 = icmp eq i32 %conv7, 0
  br i1 %cmp8, label %if.then, label %if.end

if.then:                                          ; preds = %invoke.cont5
  %10 = load %"class.std::vector"*, %"class.std::vector"** %adj.addr, align 8
  %11 = load i32, i32* %i, align 4
  invoke void @_Z7toporecPSt6vectorIiSaIiEEiRS_IbSaIbEERSt5stackIiSt5dequeIiS0_EE(%"class.std::vector"* %10, i32 %11, %"class.std::vector.0"* dereferenceable(40) %visited, %"class.std::stack"* dereferenceable(80) %st)
...
while.cond:                                       ; preds = %invoke.cont16, %for.end
  %call12 = invoke zeroext i1 @_ZNKSt5stackIiSt5dequeIiSaIiEEE5emptyEv(%"class.std::stack"* %st)
...
while.body:                                       ; preds = %invoke.cont11
  %call14 = invoke dereferenceable(4) i32* @_ZNSt5stackIiSt5dequeIiSaIiEEE3topEv(%"class.std::stack"* %st)
          to label %invoke.cont13 unwind label %lpad10

invoke.cont13:                                    ; preds = %while.body
  invoke void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* %agg.result, i32* dereferenceable(4) %call14)
...
lpad10:                                           ; preds = %invoke.cont15, %invoke.cont13, %while.body, %while.cond
...
arrayctor.cont:                                   ; preds = %entry, %arrayctor.loop
  invoke void @_Z7addEdgePSt6vectorIiSaIiEEii(%"class.std::vector"* %vla, i32 5, i32 0)
          to label %invoke.cont unwind label %lpad

invoke.cont:                                      ; preds = %arrayctor.cont
  invoke void @_Z7addEdgePSt6vectorIiSaIiEEii(%"class.std::vector"* %vla, i32 5, i32 2)
          to label %invoke.cont1 unwind label %lpad

invoke.cont1:                                     ; preds = %invoke.cont
  invoke void @_Z7addEdgePSt6vectorIiSaIiEEii(%"class.std::vector"* %vla, i32 2, i32 3)
          to label %invoke.cont2 unwind label %lpad

invoke.cont2:                                     ; preds = %invoke.cont1
  invoke void @_Z7addEdgePSt6vectorIiSaIiEEii(%"class.std::vector"* %vla, i32 3, i32 1)
          to label %invoke.cont3 unwind label %lpad

invoke.cont3:                                     ; preds = %invoke.cont2
  invoke void @_Z7addEdgePSt6vectorIiSaIiEEii(%"class.std::vector"* %vla, i32 4, i32 1)
          to label %invoke.cont4 unwind label %lpad

invoke.cont4:                                     ; preds = %invoke.cont3
  invoke void @_Z7addEdgePSt6vectorIiSaIiEEii(%"class.std::vector"* %vla, i32 4, i32 0)
          to label %invoke.cont5 unwind label %lpad

invoke.cont5:                                     ; preds = %invoke.cont4
  call void @_ZNSt6vectorIiSaIiEEC2Ev(%"class.std::vector"* %v) #3
  %3 = load i32, i32* %V, align 4
  invoke void @_Z8toposortPSt6vectorIiSaIiEEi(%"class.std::vector"* sret %ref.tmp, %"class.std::vector"* %vla, i32 %3)
          to label %invoke.cont7 unwind label %lpad6

invoke.cont7:                                     ; preds = %invoke.cont5
  %call = call dereferenceable(24) %"class.std::vector"* @_ZNSt6vectorIiSaIiEEaSEOS1_(%"class.std::vector"* %v, %"class.std::vector"* dereferenceable(24) %ref.tmp) #3
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %ref.tmp) #3
  %call8 = call i32* @_ZNSt6vectorIiSaIiEE5beginEv(%"class.std::vector"* %v) #3
  %coerce.dive = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator", %"class.__gnu_cxx::__normal_iterator"* %it, i32 0, i32 0
  store i32* %call8, i32** %coerce.dive, align 8
  br label %for.cond

for.cond:                                         ; preds = %for.inc, %invoke.cont7
  %call10 = call i32* @_ZNSt6vectorIiSaIiEE3endEv(%"class.std::vector"* %v) #3
  %coerce.dive11 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator", %"class.__gnu_cxx::__normal_iterator"* %ref.tmp9, i32 0, i32 0
  store i32* %call10, i32** %coerce.dive11, align 8
  %call12 = call zeroext i1 @_ZN9__gnu_cxxneIPiSt6vectorIiSaIiEEEEbRKNS_17__normal_iteratorIT_T0_EESA_(%"class.__gnu_cxx::__normal_iterator"* dereferenceable(8) %it, %"class.__gnu_cxx::__normal_iterator"* dereferenceable(8) %ref.tmp9) #3
  br i1 %call12, label %for.body, label %for.end

for.body:                                         ; preds = %for.cond
  %call13 = call dereferenceable(4) i32* @_ZNK9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEdeEv(%"class.__gnu_cxx::__normal_iterator"* %it) #3
  %4 = load i32, i32* %call13, align 4
  %call15 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* @_ZSt4cout, i32 %4)
          to label %invoke.cont14 unwind label %lpad6

invoke.cont14:                                    ; preds = %for.body
  %call17 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) %call15, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0))
...
for.inc:                                          ; preds = %invoke.cont16
  %call18 = call i32* @_ZN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEppEi(%"class.__gnu_cxx::__normal_iterator"* %it, i32 0) #3
  ...
  store i32* %call18, i32** %coerce.dive19, align 8
  br label %for.cond
...
lpad6:                                            ; preds = %for.end, %invoke.cont14, %for.body, %invoke.cont5
  %8 = landingpad { i8*, i32 }
          cleanup
  %9 = extractvalue { i8*, i32 } %8, 0
  store i8* %9, i8** %exn.slot, align 8
...
for.end:                                          ; preds = %for.cond
  %call21 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEPFRSoS_E(%"class.std::basic_ostream"* @_ZSt4cout, %"class.std::basic_ostream"* (%"class.std::basic_ostream"*)* @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
          to label %invoke.cont20 unwind label %lpad6

invoke.cont20:                                    ; preds = %for.end
  store i32 0, i32* %retval, align 4
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %v) #3
  %11 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %vla, i64 %1
...
arraydestroy.body:                                ; preds = %arraydestroy.body, %invoke.cont20
  %arraydestroy.elementPast = phi %"class.std::vector"* [ %11, %invoke.cont20 ], [ %arraydestroy.element, %arraydestroy.body ]
...
arraydestroy.done22:                              ; preds = %arraydestroy.body, %invoke.cont20
...
ehcleanup:                                        ; preds = %lpad6, %lpad
  %14 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %vla, i64 %1
  %arraydestroy.isempty23 = icmp eq %"class.std::vector"* %vla, %14
...
arraydestroy.body24:                              ; preds = %arraydestroy.body24, %ehcleanup
  %arraydestroy.elementPast25 = phi %"class.std::vector"* [ %14, %ehcleanup ], [ %arraydestroy.element26, %arraydestroy.body24 ]
  %arraydestroy.element26 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %arraydestroy.elementPast25, i64 -1
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %arraydestroy.element26) #3
  %arraydestroy.done27 = icmp eq %"class.std::vector"* %arraydestroy.element26, %vla
  br i1 %arraydestroy.done27, label %arraydestroy.done28, label %arraydestroy.body24

arraydestroy.done28:                              ; preds = %arraydestroy.body24, %ehcleanup
  br label %eh.resume
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local i32* @_ZN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEppEi(%"class.__gnu_cxx::__normal_iterator"* %this, i32 %0) #5 comdat align 2 {
entry:
  %retval = alloca %"class.__gnu_cxx::__normal_iterator", align 8
  %this.addr = alloca %"class.__gnu_cxx::__normal_iterator"*, align 8
  ...
  %this1 = load %"class.__gnu_cxx::__normal_iterator"*, %"class.__gnu_cxx::__normal_iterator"** %this.addr, align 8
  %_M_current = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator", %"class.__gnu_cxx::__normal_iterator"* %this1, i32 0, i32 0
  %1 = load i32*, i32** %_M_current, align 8
...
entry:
  ...
  store i64 %__n, i64* %__n.addr, align 8
  %this1 = load %"class.std::_Deque_base"*, %"class.std::_Deque_base"** %this.addr, align 8
  call void @_ZNKSt11_Deque_baseIiSaIiEE20_M_get_map_allocatorEv(%"class.std::allocator.7"* sret %__map_alloc, %"class.std::_Deque_base"* %this1) #3
  %0 = load i32**, i32*** %__p.addr, align 8
  %1 = load i64, i64* %__n.addr, align 8
  invoke void @_ZNSt16allocator_traitsISaIPiEE10deallocateERS1_PS0_m(%"class.std::allocator.7"* dereferenceable(1) %__map_alloc, i32** %0, i64 %1)
          to label %invoke.cont unwind label %lpad

invoke.cont:                                      ; preds = %entry
  call void @_ZNSaIPiED2Ev(%"class.std::allocator.7"* %__map_alloc) #3
  ret void
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNKSt11_Deque_baseIiSaIiEE20_M_get_map_allocatorEv(%"class.std::allocator.7"* noalias sret %agg.result, %"class.std::_Deque_base"* %this) #5 comdat align 2 {
entry:
  %result.ptr = alloca i8*, align 8
  %this.addr = alloca %"class.std::_Deque_base"*, align 8
  ...
  call void @_ZNSaIPiEC2IiEERKSaIT_E(%"class.std::allocator.7"* %agg.result, %"class.std::allocator"* dereferenceable(1) %call) #3
  ret void
}

; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local void @_ZNSt16allocator_traitsISaIPiEE10deallocateERS1_PS0_m(%"class.std::allocator.7"* dereferenceable(1) %__a, i32** %__p, i64 %__n) #4 comdat align 2 {
entry:
  ...
  %2 = load i32**, i32*** %__p.addr, align 8
  %3 = load i64, i64* %__n.addr, align 8
  call void @_ZN9__gnu_cxx13new_allocatorIPiE10deallocateEPS1_m(%"class.__gnu_cxx::new_allocator.8"* %1, i32** %2, i64 %3)
  ret void
}

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSaIPiED2Ev(%"class.std::allocator.7"* %this) unnamed_addr #5 comdat align 2 {
entry:
  ...
  call void @_ZN9__gnu_cxx13new_allocatorIPiED2Ev(%"class.__gnu_cxx::new_allocator.8"* %0) #3
  ret void
}
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZNSaIPiEC2IiEERKSaIT_E(%"class.std::allocator.7"* %this, %"class.std::allocator"* dereferenceable(1) %0) unnamed_addr #5 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::allocator.7"*, align 8
  %.addr = alloca %"class.std::allocator"*, align 8
  store %"class.std::allocator.7"* %this, %"class.std::allocator.7"** %this.addr, align 8
  ...
  call void @_ZN9__gnu_cxx13new_allocatorIPiEC2Ev(%"class.__gnu_cxx::new_allocator.8"* %1) #3
  ret void
}

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZN9__gnu_cxx13new_allocatorIPiEC2Ev(%"class.__gnu_cxx::new_allocator.8"* %this) unnamed_addr #5 comdat align 2 {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZN9__gnu_cxx13new_allocatorIPiE10deallocateEPS1_m(%"class.__gnu_cxx::new_allocator.8"* %this, i32** %__p, i64 %__t) #5 comdat align 2 {
entry:
  %this.addr = alloca %"class.__gnu_cxx::new_allocator.8"*, align 8
  %__p.addr = alloca i32**, align 8
  %__t.addr = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @_ZN9__gnu_cxx13new_allocatorIPiED2Ev(%"class.__gnu_cxx::new_allocator.8"* %this) unnamed_addr #5 comdat align 2 {
entry:
  %this.addr = alloca %"class.__gnu_cxx::new_allocator.8"*, align 8
  store %"class.__gnu_cxx::new_allocator.8"* %this, %"class.__gnu_cxx::new_allocator.8"** %this.addr, align 8
  %this1 = load %"class.__gnu_cxx::new_allocator.8"*, %"class.__gnu_cxx::new_allocator.8"** %this.addr, align 8
...
entry:
  ...
  call void @_ZNKSt11_Deque_baseIiSaIiEE20_M_get_map_allocatorEv(%"class.std::allocator.7"* sret %__map_alloc, %"class.std::_Deque_base"* %this1) #3
  %0 = load i64, i64* %__n.addr, align 8
  %call = invoke i32** @_ZNSt16allocator_traitsISaIPiEE8allocateERS1_m(%"class.std::allocator.7"* dereferenceable(1) %__map_alloc, i64 %0)
          to label %invoke.cont unwind label %lpad
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local i32** @_ZNSt16allocator_traitsISaIPiEE8allocateERS1_m(%"class.std::allocator.7"* dereferenceable(1) %__a, i64 %__n) #4 comdat align 2 {
entry:
  %__a.addr = alloca %"class.std::allocator.7"*, align 8
  %__n.addr = alloca i64, align 8
  store %"class.std::allocator.7"* %__a, %"class.std::allocator.7"** %__a.addr, align 8
  ...
  %1 = bitcast %"class.std::allocator.7"* %0 to %"class.__gnu_cxx::new_allocator.8"*
  %2 = load i64, i64* %__n.addr, align 8
  %call = call i32** @_ZN9__gnu_cxx13new_allocatorIPiE8allocateEmPKv(%"class.__gnu_cxx::new_allocator.8"* %1, i64 %2, i8* null)
  ret i32** %call
}

; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local i32** @_ZN9__gnu_cxx13new_allocatorIPiE8allocateEmPKv(%"class.__gnu_cxx::new_allocator.8"* %this, i64 %__n, i8* %0) #4 comdat align 2 {
entry:
  %this.addr = alloca %"class.__gnu_cxx::new_allocator.8"*, align 8
  %__n.addr = alloca i64, align 8
  %.addr = alloca i8*, align 8
  ...
  %this1 = load %"class.__gnu_cxx::new_allocator.8"*, %"class.__gnu_cxx::new_allocator.8"** %this.addr, align 8
  %1 = load i64, i64* %__n.addr, align 8
  %call = call i64 @_ZNK9__gnu_cxx13new_allocatorIPiE11_M_max_sizeEv(%"class.__gnu_cxx::new_allocator.8"* %this1) #3
  %cmp = icmp ugt i64 %1, %call
  br i1 %cmp, label %if.then, label %if.end4
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local i64 @_ZNK9__gnu_cxx13new_allocatorIPiE11_M_max_sizeEv(%"class.__gnu_cxx::new_allocator.8"* %this) #5 comdat align 2 {
entry:
  %this.addr = alloca %"class.__gnu_cxx::new_allocator.8"*, align 8
  store %"class.__gnu_cxx::new_allocator.8"* %this, %"class.__gnu_cxx::new_allocator.8"** %this.addr, align 8
  %this1 = load %"class.__gnu_cxx::new_allocator.8"*, %"class.__gnu_cxx::new_allocator.8"** %this.addr, align 8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_topologicalsortdfs.cpp() #0 section ".text.startup" {
entry:
