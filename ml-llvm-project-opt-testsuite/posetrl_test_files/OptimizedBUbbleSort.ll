; ModuleID = '/home/intern24006/codebase/OptimizedBUbbleSort.cpp'
source_filename = "/home/intern24006/codebase/OptimizedBUbbleSort.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_OptimizedBUbbleSort.cpp, i8* null }]
...
define dso_local void @_Z19optimizedBubbleSortSt6vectorIiSaIiEE(%"class.std::vector"* noalias sret %agg.result, %"class.std::vector"* %v) #4 {
entry:
...
for.cond1:                                        ; preds = %for.inc, %for.body
  ...
  %call3 = call i64 @_ZNKSt6vectorIiSaIiEE4sizeEv(%"class.std::vector"* %v) #3
  %sub4 = sub i64 %call3, 1
  %3 = load i32, i32* %i, align 4
  %conv5 = sext i32 %3 to i64
  %sub6 = sub i64 %sub4, %conv5
  %cmp7 = icmp ult i64 %conv2, %sub6
  br i1 %cmp7, label %for.body8, label %for.end

for.body8:                                        ; preds = %for.cond1
  %4 = load i32, i32* %j, align 4
  %conv9 = sext i32 %4 to i64
  %call10 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %v, i64 %conv9) #3
  %5 = load i32, i32* %call10, align 4
  %6 = load i32, i32* %j, align 4
  %add = add nsw i32 %6, 1
  %conv11 = sext i32 %add to i64
  %call12 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %v, i64 %conv11) #3
  %7 = load i32, i32* %call12, align 4
  %cmp13 = icmp sgt i32 %5, %7
  br i1 %cmp13, label %if.then, label %if.end

if.then:                                          ; preds = %for.body8
  %8 = load i32, i32* %j, align 4
  %conv14 = sext i32 %8 to i64
  %call15 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %v, i64 %conv14) #3
  %9 = load i32, i32* %j, align 4
  %add16 = add nsw i32 %9, 1
  %conv17 = sext i32 %add16 to i64
  %call18 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %v, i64 %conv17) #3
  call void @_ZSt4swapIiENSt9enable_ifIXsr6__and_ISt6__not_ISt15__is_tuple_likeIT_EESt21is_move_constructibleIS3_ESt18is_move_assignableIS3_EEE5valueEvE4typeERS3_SC_(i32* dereferenceable(4) %call15, i32* dereferenceable(4) %call18) #3
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_OptimizedBUbbleSort.cpp() #0 section ".text.startup" {
entry:
