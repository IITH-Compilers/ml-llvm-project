; ModuleID = '/home/intern24006/codebase/MaxCircularSubarraySum.cpp'
source_filename = "/home/intern24006/codebase/MaxCircularSubarraySum.cpp"
...
$_ZN8Solution19circularSubarraySumEPii = comdat any

$_ZN8Solution6kadaneEPii = comdat any
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_MaxCircularSubarraySum.cpp, i8* null }]
...
for.end:                                          ; preds = %for.cond
  ...
  %call3 = call i32 @_ZN8Solution19circularSubarraySumEPii(%class.Solution* %ob, i32* %vla, i32 %8)
...
define linkonce_odr dso_local i32 @_ZN8Solution19circularSubarraySumEPii(%class.Solution* %this, i32* %arr, i32 %num) #5 comdat align 2 {
entry:
  %this.addr = alloca %class.Solution*, align 8
  %arr.addr = alloca i32*, align 8
  %num.addr = alloca i32, align 4
  %wrapsum = alloca i32, align 4
  %nonWrapsum = alloca i32, align 4
  ...
  %call = call i32 @_ZN8Solution6kadaneEPii(%class.Solution* %this1, i32* %0, i32 %1)
  store i32 %call, i32* %nonWrapsum, align 4
...
for.body:                                         ; preds = %for.cond
  ...
  %7 = load i32, i32* %totalSum, align 4
  %add = add nsw i32 %7, %6
  store i32 %add, i32* %totalSum, align 4
...
for.end:                                          ; preds = %for.cond
  %14 = load i32, i32* %totalSum, align 4
  %15 = load i32*, i32** %arr.addr, align 8
  %16 = load i32, i32* %num.addr, align 4
  %call6 = call i32 @_ZN8Solution6kadaneEPii(%class.Solution* %this1, i32* %15, i32 %16)
  %add7 = add nsw i32 %14, %call6
  store i32 %add7, i32* %wrapsum, align 4
  %17 = load i32, i32* %wrapsum, align 4
  %cmp8 = icmp eq i32 %17, 0
  br i1 %cmp8, label %if.then, label %if.end

if.then:                                          ; preds = %for.end
  store i32 -2147483648, i32* %wrapsum, align 4
  br label %if.end

if.end:                                           ; preds = %if.then, %for.end
  %call9 = call dereferenceable(4) i32* @_ZSt3maxIiERKT_S2_S2_(i32* dereferenceable(4) %wrapsum, i32* dereferenceable(4) %nonWrapsum)
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local i32 @_ZN8Solution6kadaneEPii(%class.Solution* %this, i32* %arr, i32 %num) #5 comdat align 2 {
entry:
  %this.addr = alloca %class.Solution*, align 8
  %arr.addr = alloca i32*, align 8
  %num.addr = alloca i32, align 4
  %currentSum = alloca i32, align 4
...
for.body:                                         ; preds = %for.cond
  ...
  %8 = load i32, i32* %currentSum, align 4
  ...
  %call = call dereferenceable(4) i32* @_ZSt3maxIiERKT_S2_S2_(i32* dereferenceable(4) %arrayidx3, i32* dereferenceable(4) %ref.tmp)
  %12 = load i32, i32* %call, align 4
  store i32 %12, i32* %currentSum, align 4
  %call6 = call dereferenceable(4) i32* @_ZSt3maxIiERKT_S2_S2_(i32* dereferenceable(4) %maxSum, i32* dereferenceable(4) %currentSum)
  %13 = load i32, i32* %call6, align 4
  store i32 %13, i32* %maxSum, align 4
  br label %for.inc
...
for.end:                                          ; preds = %for.cond
  %15 = load i32, i32* %maxSum, align 4
  ret i32 %15
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_MaxCircularSubarraySum.cpp() #0 section ".text.startup" {
entry:
