; ModuleID = '/home/intern24006/codebase/InfinityTable.cpp'
source_filename = "/home/intern24006/codebase/InfinityTable.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_InfinityTable.cpp, i8* null }]
...
while.body:                                       ; preds = %while.cond
  ...
  %call2 = call double @_ZSt4sqrtIxEN9__gnu_cxx11__enable_ifIXsr12__is_integerIT_EE7__valueEdE6__typeES2_(i64 %1)
  %2 = call double @llvm.ceil.f64(double %call2)
...
if.then:                                          ; preds = %while.body
  ...
  %call3 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEx(%"class.std::basic_ostream"* @_ZSt4cout, i64 %7)
  ...
  %mul5 = mul nsw i64 %8, %9
  %10 = load i64, i64* %n, align 8
  %sub6 = sub nsw i64 %mul5, %10
  %add7 = add nsw i64 %sub6, 1
  %call8 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEx(%"class.std::basic_ostream"* %call4, i64 %add7)
...
if.else:                                          ; preds = %while.body
  ...
  %sub11 = sub nsw i64 %mul10, %14
  %add12 = add nsw i64 %sub11, 1
  %15 = load i64, i64* %size, align 8
  %sub13 = sub nsw i64 %15, 1
  %sub14 = sub nsw i64 %add12, %sub13
  %sub15 = sub nsw i64 %11, %sub14
  %add16 = add nsw i64 %sub15, 1
  %call17 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEx(%"class.std::basic_ostream"* @_ZSt4cout, i64 %add16)
  %call18 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) %call17, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0))
  %16 = load i64, i64* %size, align 8
  %call19 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEx(%"class.std::basic_ostream"* %call18, i64 %16)
...
define linkonce_odr dso_local double @_ZSt4sqrtIxEN9__gnu_cxx11__enable_ifIXsr12__is_integerIT_EE7__valueEdE6__typeES2_(i64 %__x) #5 comdat {
entry:
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_InfinityTable.cpp() #0 section ".text.startup" {
entry:
