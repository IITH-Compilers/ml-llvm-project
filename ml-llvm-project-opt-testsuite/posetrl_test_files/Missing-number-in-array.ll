; ModuleID = '/home/intern24006/codebase/Missing-number-in-array.cpp'
source_filename = "/home/intern24006/codebase/Missing-number-in-array.cpp"
...
$_ZN8Solution13MissingNumberERSt6vectorIiSaIiEEi = comdat any
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_Missing_number_in_array.cpp, i8* null }]
...
while.body:                                       ; preds = %while.cond
  ...
  invoke void @_ZNSt6vectorIiSaIiEEC2EmRKS0_(%"class.std::vector"* %array, i64 %conv, %"class.std::allocator"* dereferenceable(1) %ref.tmp)
...
for.body:                                         ; preds = %for.cond
  ...
  %call4 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %array, i64 %conv3) #3
  %call7 = invoke dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERi(%"class.std::basic_istream"* @_ZSt3cin, i32* dereferenceable(4) %call4)
...
lpad5:                                            ; preds = %invoke.cont10, %invoke.cont8, %for.end, %for.body
  %9 = landingpad { i8*, i32 }
          cleanup
  ...
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %array) #3
  br label %eh.resume

for.end:                                          ; preds = %for.cond
  %12 = load i32, i32* %n, align 4
  %call9 = invoke i32 @_ZN8Solution13MissingNumberERSt6vectorIiSaIiEEi(%class.Solution* %obj, %"class.std::vector"* dereferenceable(24) %array, i32 %12)
          to label %invoke.cont8 unwind label %lpad5

invoke.cont8:                                     ; preds = %for.end
  %call11 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* @_ZSt4cout, i32 %call9)
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local i32 @_ZN8Solution13MissingNumberERSt6vectorIiSaIiEEi(%class.Solution* %this, %"class.std::vector"* dereferenceable(24) %array, i32 %n) #5 comdat align 2 {
entry:
  %this.addr = alloca %class.Solution*, align 8
  %array.addr = alloca %"class.std::vector"*, align 8
  %n.addr = alloca i32, align 4
  %sum = alloca i32, align 4
  %i = alloca i32, align 4
  store %class.Solution* %this, %class.Solution** %this.addr, align 8
  store %"class.std::vector"* %array, %"class.std::vector"** %array.addr, align 8
...
for.body:                                         ; preds = %for.cond
  %2 = load %"class.std::vector"*, %"class.std::vector"** %array.addr, align 8
...
for.end:                                          ; preds = %for.cond
  ...
  %mul = mul nsw i32 %7, %add2
  %div = sdiv i32 %mul, 2
  %9 = load i32, i32* %sum, align 4
  %sub3 = sub nsw i32 %div, %9
  ret i32 %sub3
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_Missing_number_in_array.cpp() #0 section ".text.startup" {
entry:
