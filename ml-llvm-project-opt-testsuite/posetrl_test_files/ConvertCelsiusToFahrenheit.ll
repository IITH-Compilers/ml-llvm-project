; ModuleID = '/home/intern24006/codebase/ConvertCelsiusToFahrenheit.cpp'
source_filename = "/home/intern24006/codebase/ConvertCelsiusToFahrenheit.cpp"
...
$_ZN8Solution4cToFEi = comdat any

@_ZStL8__ioinit = internal global %"class.std::ios_base::Init" zeroinitializer, align 1
@__dso_handle = external hidden global i8
@_ZSt3cin = external dso_local global %"class.std::basic_istream", align 8
@_ZSt4cout = external dso_local global %"class.std::basic_ostream", align 8
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_ConvertCelsiusToFahrenheit.cpp, i8* null }]
...
while.body:                                       ; preds = %while.cond
  ...
  %call2 = call double @_ZN8Solution4cToFEi(%class.Solution* %ob, i32 %1)
  %2 = call double @llvm.floor.f64(double %call2)
  %call3 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEd(%"class.std::basic_ostream"* @_ZSt4cout, double %2)
...
define linkonce_odr dso_local double @_ZN8Solution4cToFEi(%class.Solution* %this, i32 %C) #5 comdat align 2 {
entry:
  ...
  %mul = fmul double %conv, 1.800000e+00
  %add = fadd double %mul, 3.200000e+01
  ret double %add
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_ConvertCelsiusToFahrenheit.cpp() #0 section ".text.startup" {
entry:
