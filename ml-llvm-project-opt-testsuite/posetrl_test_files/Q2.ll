; ModuleID = '/home/intern24006/codebase/Q2.cpp'
source_filename = "/home/intern24006/codebase/Q2.cpp"
...
$_ZN8Solution3sumEii = comdat any
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_Q2.cpp, i8* null }]
...
while.body:                                       ; preds = %while.cond
  ...
  %call3 = call i32 @_ZN8Solution3sumEii(%class.Solution* %ob, i32 %1, i32 %2)
...
define linkonce_odr dso_local i32 @_ZN8Solution3sumEii(%class.Solution* %this, i32 %a, i32 %b) #5 comdat align 2 {
entry:
...
while.body:                                       ; preds = %while.cond
  ...
  %mul = mul nsw i32 %rem5, %9
  %10 = load i32, i32* %r, align 4
  %add6 = add nsw i32 %10, %mul
  store i32 %add6, i32* %r, align 4
  ...
  %div8 = sdiv i32 %13, 10
  store i32 %div8, i32* %b.addr, align 4
  %14 = load i32, i32* %k, align 4
  %mul9 = mul nsw i32 %14, 10
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_Q2.cpp() #0 section ".text.startup" {
entry:
