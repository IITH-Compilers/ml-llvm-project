; ModuleID = '/home/intern24006/codebase/ModularMultiplicativeInverse.cpp'
source_filename = "/home/intern24006/codebase/ModularMultiplicativeInverse.cpp"
...
$_ZN8Solution10modInverseEii = comdat any

@_ZStL8__ioinit = internal global %"class.std::ios_base::Init" zeroinitializer, align 1
@__dso_handle = external hidden global i8
@_ZSt3cin = external dso_local global %"class.std::basic_istream", align 8
@_ZSt4cout = external dso_local global %"class.std::basic_ostream", align 8
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_ModularMultiplicativeInverse.cpp, i8* null }]
...
while.body:                                       ; preds = %while.cond
  ...
  %call3 = call i32 @_ZN8Solution10modInverseEii(%class.Solution* %ob, i32 %1, i32 %2)
...
define linkonce_odr dso_local i32 @_ZN8Solution10modInverseEii(%class.Solution* %this, i32 %a, i32 %m) #5 comdat align 2 {
entry:
  %retval = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_ModularMultiplicativeInverse.cpp() #0 section ".text.startup" {
entry:
