; ModuleID = '/home/intern24006/codebase/longest_prefix_suffix.cpp'
source_filename = "/home/intern24006/codebase/longest_prefix_suffix.cpp"
...
@.str = private unnamed_addr constant [5 x i8] c"abab\00", align 1
@_ZSt4cout = external dso_local global %"class.std::basic_ostream", align 8
@.str.1 = private unnamed_addr constant [49 x i8] c"cannot create std::vector larger than max_size()\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_longest_prefix_suffix.cpp, i8* null }]
...
define dso_local void @_Z15prefix_functionNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE(%"class.std::vector"* noalias sret %agg.result, %"class.std::__cxx11::basic_string"* %s) #4 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
  ...
  invoke void @_ZNSt6vectorIiSaIiEEC2EmRKS0_(%"class.std::vector"* %agg.result, i64 %conv1, %"class.std::allocator"* dereferenceable(1) %ref.tmp)
...
for.body:                                         ; preds = %for.cond
  ...
  %call3 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %agg.result, i64 %conv2) #3
...
land.rhs:                                         ; preds = %while.cond
  ...
  %call8 = invoke dereferenceable(1) i8* @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEixEm(%"class.std::__cxx11::basic_string"* %s, i64 %conv5)
          to label %invoke.cont7 unwind label %lpad6

invoke.cont7:                                     ; preds = %land.rhs
  %8 = load i8, i8* %call8, align 1
  %conv9 = sext i8 %8 to i32
  %9 = load i32, i32* %j, align 4
  %conv10 = sext i32 %9 to i64
  %call12 = invoke dereferenceable(1) i8* @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEixEm(%"class.std::__cxx11::basic_string"* %s, i64 %conv10)
          to label %invoke.cont11 unwind label %lpad6

invoke.cont11:                                    ; preds = %invoke.cont7
  %10 = load i8, i8* %call12, align 1
  %conv13 = sext i8 %10 to i32
  %cmp14 = icmp ne i32 %conv9, %conv13
  br label %land.end

land.end:                                         ; preds = %invoke.cont11, %while.cond
  %11 = phi i1 [ false, %while.cond ], [ %cmp14, %invoke.cont11 ]
...
while.body:                                       ; preds = %land.end
  ...
  %call17 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %agg.result, i64 %conv16) #3
  %13 = load i32, i32* %call17, align 4
...
lpad6:                                            ; preds = %invoke.cont19, %while.end, %invoke.cont7, %land.rhs
...
while.end:                                        ; preds = %land.end
  ...
  %call20 = invoke dereferenceable(1) i8* @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEixEm(%"class.std::__cxx11::basic_string"* %s, i64 %conv18)
          to label %invoke.cont19 unwind label %lpad6

invoke.cont19:                                    ; preds = %while.end
  %21 = load i8, i8* %call20, align 1
  %conv21 = sext i8 %21 to i32
  %22 = load i32, i32* %j, align 4
  %conv22 = sext i32 %22 to i64
  %call24 = invoke dereferenceable(1) i8* @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEixEm(%"class.std::__cxx11::basic_string"* %s, i64 %conv22)
          to label %invoke.cont23 unwind label %lpad6

invoke.cont23:                                    ; preds = %invoke.cont19
  %23 = load i8, i8* %call24, align 1
...
if.end:                                           ; preds = %if.then, %invoke.cont23
  ...
  %call28 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %agg.result, i64 %conv27) #3
  store i32 %25, i32* %call28, align 4
  br label %for.inc
...
entry:
  ...
  invoke void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC1EPKcRKS3_(%"class.std::__cxx11::basic_string"* %s, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), %"class.std::allocator.0"* dereferenceable(1) %ref.tmp)
          to label %invoke.cont unwind label %lpad
...
invoke.cont4:                                     ; preds = %invoke.cont
  invoke void @_Z15prefix_functionNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE(%"class.std::vector"* sret %ref.tmp2, %"class.std::__cxx11::basic_string"* %agg.tmp)
          to label %invoke.cont6 unwind label %lpad5

invoke.cont6:                                     ; preds = %invoke.cont4
  %call7 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEE4backEv(%"class.std::vector"* %ref.tmp2) #3
  %2 = load i32, i32* %call7, align 4
  %call10 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* @_ZSt4cout, i32 %2)
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEE4backEv(%"class.std::vector"* %this) #5 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::vector"*, align 8
  ...
  %call3 = call i32* @_ZNK9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEmiEl(%"class.__gnu_cxx::__normal_iterator"* %ref.tmp2, i64 1) #3
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_longest_prefix_suffix.cpp() #0 section ".text.startup" {
entry:
