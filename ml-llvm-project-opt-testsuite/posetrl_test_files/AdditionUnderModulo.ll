; ModuleID = '/home/intern24006/codebase/AdditionUnderModulo.cpp'
source_filename = "/home/intern24006/codebase/AdditionUnderModulo.cpp"
...
$_ZN8Solution14sumUnderModuloExx = comdat any

@_ZStL8__ioinit = internal global %"class.std::ios_base::Init" zeroinitializer, align 1
@__dso_handle = external hidden global i8
@_ZSt3cin = external dso_local global %"class.std::basic_istream", align 8
@_ZSt4cout = external dso_local global %"class.std::basic_ostream", align 8
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_AdditionUnderModulo.cpp, i8* null }]
...
while.body:                                       ; preds = %while.cond
  ...
  %call3 = call i64 @_ZN8Solution14sumUnderModuloExx(%class.Solution* %ob, i64 %1, i64 %2)
...
define linkonce_odr dso_local i64 @_ZN8Solution14sumUnderModuloExx(%class.Solution* %this, i64 %a, i64 %b) #5 comdat align 2 {
entry:
  ...
  %rem2 = srem i64 %1, 1000000007
  %add = add nsw i64 %rem, %rem2
  %rem3 = srem i64 %add, 1000000007
  ret i64 %rem3
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_AdditionUnderModulo.cpp() #0 section ".text.startup" {
entry:
