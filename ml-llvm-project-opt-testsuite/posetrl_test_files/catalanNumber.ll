; ModuleID = '/home/intern24006/codebase/catalanNumber.cpp'
source_filename = "/home/intern24006/codebase/catalanNumber.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_catalanNumber.cpp, i8* null }]
...
define dso_local i32 @_Z7catalani(i32 %n) #4 {
entry:
...
for.body:                                         ; preds = %for.cond
  ...
  %call = call i32 @_Z7catalani(i32 %3)
  %4 = load i32, i32* %n.addr, align 4
  %5 = load i32, i32* %i, align 4
  %sub = sub nsw i32 %4, %5
  %sub2 = sub nsw i32 %sub, 1
  %call3 = call i32 @_Z7catalani(i32 %sub2)
  %mul = mul nsw i32 %call, %call3
...
for.body:                                         ; preds = %for.cond
  %1 = load i32, i32* %i, align 4
  %call = call i32 @_Z7catalani(i32 %1)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_catalanNumber.cpp() #0 section ".text.startup" {
entry:
