; ModuleID = '/home/intern24006/codebase/kaden's_algorithm.cpp'
source_filename = "/home/intern24006/codebase/kaden's_algorithm.cpp"
...
@.str.1 = private unnamed_addr constant [17 x i8] c"Enter elements: \00", align 1
@.str.2 = private unnamed_addr constant [27 x i8] c"Maximum contiguous sum is \00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_kaden_s_algorithm.cpp, i8* null }]
...
define dso_local i32 @_Z14maxSubArraySumPii(i32* %a, i32 %size) #4 {
entry:
...
for.body:                                         ; preds = %for.cond
  %2 = load i32, i32* %max_ending_here, align 4
...
if.end:                                           ; preds = %if.then, %for.body
  %9 = load i32, i32* %max_ending_here, align 4
...
for.end:                                          ; preds = %for.cond
  %11 = load i32, i32* %max_so_far, align 4
  ret i32 %11
}
...
for.end:                                          ; preds = %for.cond
  ...
  %call4 = call i32 @_Z14maxSubArraySumPii(i32* %vla, i32 %7)
  store i32 %call4, i32* %max_sum, align 4
  %call5 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([27 x i8], [27 x i8]* @.str.2, i64 0, i64 0))
  %8 = load i32, i32* %max_sum, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_kaden_s_algorithm.cpp() #0 section ".text.startup" {
entry:
