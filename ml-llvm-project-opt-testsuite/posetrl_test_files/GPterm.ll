; ModuleID = '/home/intern24006/codebase/GPterm.cpp'
source_filename = "/home/intern24006/codebase/GPterm.cpp"
...
$_ZN8Solution8termOfGPEiii = comdat any
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_GPterm.cpp, i8* null }]
...
for.body:                                         ; preds = %for.cond
  ...
  %call4 = call double @_ZN8Solution8termOfGPEiii(%class.Solution* %ob, i32 %2, i32 %3, i32 %4)
  %5 = call double @llvm.floor.f64(double %call4)
  %call5 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEd(%"class.std::basic_ostream"* @_ZSt4cout, double %5)
...
define linkonce_odr dso_local double @_ZN8Solution8termOfGPEiii(%class.Solution* %this, i32 %A, i32 %B, i32 %N) #5 comdat align 2 {
entry:
  ...
  %sub = sub nsw i32 %4, 1
  %call = call double @_ZSt3powIdiEN9__gnu_cxx11__promote_2IT_T0_NS0_9__promoteIS2_Xsr3std12__is_integerIS2_EE7__valueEE6__typeENS4_IS3_Xsr3std12__is_integerIS3_EE7__valueEE6__typeEE6__typeES2_S3_(double %3, i32 %sub)
  %mul5 = fmul double %conv4, %call
  ret double %mul5
}
...
define linkonce_odr dso_local double @_ZSt3powIdiEN9__gnu_cxx11__promote_2IT_T0_NS0_9__promoteIS2_Xsr3std12__is_integerIS2_EE7__valueEE6__typeENS4_IS3_Xsr3std12__is_integerIS3_EE7__valueEE6__typeEE6__typeES2_S3_(double %__x, i32 %__y) #7 comdat {
entry:
  ...
  %call = call double @pow(double %0, double %conv) #3
  ret double %call
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_GPterm.cpp() #0 section ".text.startup" {
entry:
