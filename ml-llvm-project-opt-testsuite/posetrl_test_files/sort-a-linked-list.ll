; ModuleID = '/home/intern24006/codebase/sort-a-linked-list.cpp'
source_filename = "/home/intern24006/codebase/sort-a-linked-list.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_sort_a_linked_list.cpp, i8* null }]
...
define dso_local void @_Z9MergeSortPP4Node(%class.Node** %headRef) #4 {
entry:
...
define dso_local void @_Z14FrontBackSplitP4NodePS0_S1_(%class.Node* %source, %class.Node** %frontRef, %class.Node** %backRef) #5 {
entry:
...
; Function Attrs: noinline optnone uwtable
define dso_local %class.Node* @_Z11SortedMergeP4NodeS0_(%class.Node* %a, %class.Node* %b) #4 {
entry:
...
; Function Attrs: noinline optnone uwtable
define dso_local void @_Z9printListP4Node(%class.Node* %node) #4 {
entry:
...
; Function Attrs: noinline optnone uwtable
define dso_local void @_Z4pushPP4Nodei(%class.Node** %head_ref, i32 %new_data) #4 {
entry:
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_sort_a_linked_list.cpp() #0 section ".text.startup" {
entry:
