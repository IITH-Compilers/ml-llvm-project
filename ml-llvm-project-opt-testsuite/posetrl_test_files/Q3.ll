; ModuleID = '/home/intern24006/codebase/Q3.cpp'
source_filename = "/home/intern24006/codebase/Q3.cpp"
...
$_ZN8Solution11checkKthBitEii = comdat any
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_Q3.cpp, i8* null }]
...
while.body:                                       ; preds = %while.cond
  %call1 = call dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERx(%"class.std::basic_istream"* @_ZSt3cin, i64* dereferenceable(8) %n)
  %call2 = call dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERi(%"class.std::basic_istream"* @_ZSt3cin, i32* dereferenceable(4) %k)
  %1 = load i64, i64* %n, align 8
  %conv = trunc i64 %1 to i32
  %2 = load i32, i32* %k, align 4
  %call3 = call zeroext i1 @_ZN8Solution11checkKthBitEii(%class.Solution* %obj, i32 %conv, i32 %2)
  br i1 %call3, label %if.then, label %if.else

if.then:                                          ; preds = %while.body
  %call4 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0))
  %call5 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEPFRSoS_E(%"class.std::basic_ostream"* %call4, %"class.std::basic_ostream"* (%"class.std::basic_ostream"*)* @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
  br label %if.end

if.else:                                          ; preds = %while.body
  %call6 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0))
...
define linkonce_odr dso_local zeroext i1 @_ZN8Solution11checkKthBitEii(%class.Solution* %this, i32 %n, i32 %k) #5 comdat align 2 {
entry:
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_Q3.cpp() #0 section ".text.startup" {
entry:
