; ModuleID = '/home/intern24006/codebase/minimum_coins.cpp'
source_filename = "/home/intern24006/codebase/minimum_coins.cpp"
...
@notes = dso_local global [10 x i32] [i32 1, i32 2, i32 5, i32 10, i32 20, i32 50, i32 100, i32 200, i32 500, i32 2000], align 16
@n = dso_local global i32 10, align 4
@_ZSt4cout = external dso_local global %"class.std::basic_ostream", align 8
@.str = private unnamed_addr constant [2 x i8] c"\09\00", align 1
@.str.1 = private unnamed_addr constant [47 x i8] c"The minimum number of coins/notes that sum up \00", align 1
@.str.2 = private unnamed_addr constant [7 x i8] c" is \09 \00", align 1
@.str.3 = private unnamed_addr constant [26 x i8] c"vector::_M_realloc_insert\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_minimum_coins.cpp, i8* null }]
...
define dso_local void @_Z9minchangei(i32 %sum) #4 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
  %sum.addr = alloca i32, align 4
  %coins = alloca %"class.std::vector", align 8
  %i = alloca i32, align 4
  %exn.slot = alloca i8*
  %ehselector.slot = alloca i32
  %i7 = alloca i32, align 4
  store i32 %sum, i32* %sum.addr, align 4
  call void @_ZNSt6vectorIiSaIiEEC2Ev(%"class.std::vector"* %coins) #3
...
while.cond:                                       ; preds = %invoke.cont, %for.body
  ...
  %arrayidx = getelementptr inbounds [10 x i32], [10 x i32]* @notes, i64 0, i64 %idxprom
...
while.body:                                       ; preds = %while.cond
  ...
  %arrayidx3 = getelementptr inbounds [10 x i32], [10 x i32]* @notes, i64 0, i64 %idxprom2
  %6 = load i32, i32* %arrayidx3, align 4
  %7 = load i32, i32* %sum.addr, align 4
  %sub4 = sub nsw i32 %7, %6
  store i32 %sub4, i32* %sum.addr, align 4
  %8 = load i32, i32* %i, align 4
  %idxprom5 = sext i32 %8 to i64
  %arrayidx6 = getelementptr inbounds [10 x i32], [10 x i32]* @notes, i64 0, i64 %idxprom5
  invoke void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* %coins, i32* dereferenceable(4) %arrayidx6)
          to label %invoke.cont unwind label %lpad

invoke.cont:                                      ; preds = %while.body
  br label %while.cond

lpad:                                             ; preds = %invoke.cont13, %for.body10, %while.body
  %9 = landingpad { i8*, i32 }
          cleanup
  ...
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %coins) #3
  br label %eh.resume
...
for.cond8:                                        ; preds = %for.inc17, %for.end
  ...
  %call = call i64 @_ZNKSt6vectorIiSaIiEE4sizeEv(%"class.std::vector"* %coins) #3
...
for.body10:                                       ; preds = %for.cond8
  ...
  %call12 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %coins, i64 %conv11) #3
  %15 = load i32, i32* %call12, align 4
  %call14 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* @_ZSt4cout, i32 %15)
          to label %invoke.cont13 unwind label %lpad

invoke.cont13:                                    ; preds = %for.body10
  %call16 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) %call14, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0))
...
entry:
  ...
  store i32 3253, i32* %n, align 4
  %call = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([47 x i8], [47 x i8]* @.str.1, i64 0, i64 0))
  %0 = load i32, i32* %n, align 4
  %call1 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* %call, i32 %0)
  %call2 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) %call1, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.2, i64 0, i64 0))
  %1 = load i32, i32* %n, align 4
  call void @_Z9minchangei(i32 %1)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_minimum_coins.cpp() #0 section ".text.startup" {
entry:
