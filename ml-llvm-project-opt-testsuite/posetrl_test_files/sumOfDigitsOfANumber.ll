; ModuleID = '/home/intern24006/codebase/sumOfDigitsOfANumber.cpp'
source_filename = "/home/intern24006/codebase/sumOfDigitsOfANumber.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_sumOfDigitsOfANumber.cpp, i8* null }]
...
define dso_local i32 @_Z11sumOfDigitsi(i32 %n) #4 {
entry:
...
if.end:                                           ; preds = %entry
  ...
  %div = sdiv i32 %3, 10
  %call = call i32 @_Z11sumOfDigitsi(i32 %div)
...
while.body:                                       ; preds = %while.cond
  ...
  %call2 = call i32 @_Z11sumOfDigitsi(i32 %1)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_sumOfDigitsOfANumber.cpp() #0 section ".text.startup" {
entry:
