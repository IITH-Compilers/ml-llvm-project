; ModuleID = '/home/intern24006/codebase/Q13.cpp'
source_filename = "/home/intern24006/codebase/Q13.cpp"
...
$_ZN8Solution6maxANDEPii = comdat any

@_ZStL8__ioinit = internal global %"class.std::ios_base::Init" zeroinitializer, align 1
@__dso_handle = external hidden global i8
@_ZSt3cin = external dso_local global %"class.std::basic_istream", align 8
@_ZSt4cout = external dso_local global %"class.std::basic_ostream", align 8
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_Q13.cpp, i8* null }]
...
for.end:                                          ; preds = %for.cond
  ...
  %call3 = call i32 @_ZN8Solution6maxANDEPii(%class.Solution* %ob, i32* %vla, i32 %8)
...
define linkonce_odr dso_local i32 @_ZN8Solution6maxANDEPii(%class.Solution* %this, i32* %arr, i32 %N) #5 comdat align 2 {
entry:
  ...
  store i32 0, i32* %pattern, align 4
...
for.body:                                         ; preds = %for.cond
  ...
  %or = or i32 %2, %3
  store i32 %or, i32* %pattern, align 4
  store i32 0, i32* %cnt, align 4
...
for.body4:                                        ; preds = %for.cond2
  %6 = load i32, i32* %pattern, align 4
  ...
  %and = and i32 %6, %9
  %10 = load i32, i32* %pattern, align 4
  %cmp5 = icmp eq i32 %and, %10
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_Q13.cpp() #0 section ".text.startup" {
entry:
