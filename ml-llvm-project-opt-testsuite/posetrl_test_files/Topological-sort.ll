; ModuleID = '/home/intern24006/codebase/Topological-sort.cpp'
source_filename = "/home/intern24006/codebase/Topological-sort.cpp"
...
$_ZN8Solution8topoSortEiPSt6vectorIiSaIiEE = comdat any
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_Topological_sort.cpp, i8* null }]
...
define dso_local i32 @_Z5checkiRSt6vectorIiSaIiEEPS1_(i32 %V, %"class.std::vector"* dereferenceable(24) %res, %"class.std::vector"* %adj) #4 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
  %retval = alloca i32, align 4
  %V.addr = alloca i32, align 4
  %res.addr = alloca %"class.std::vector"*, align 8
  %adj.addr = alloca %"class.std::vector"*, align 8
  %map = alloca %"class.std::vector", align 8
  ...
  store %"class.std::vector"* %res, %"class.std::vector"** %res.addr, align 8
  store %"class.std::vector"* %adj, %"class.std::vector"** %adj.addr, align 8
  %0 = load i32, i32* %V.addr, align 4
  %conv = sext i32 %0 to i64
  %1 = load %"class.std::vector"*, %"class.std::vector"** %res.addr, align 8
...
if.end:                                           ; preds = %entry
  ...
  invoke void @_ZNSt6vectorIiSaIiEEC2EmRKiRKS0_(%"class.std::vector"* %map, i64 %conv1, i32* dereferenceable(4) %ref.tmp, %"class.std::allocator"* dereferenceable(1) %ref.tmp2)
...
for.body:                                         ; preds = %for.cond
  ...
  %6 = load %"class.std::vector"*, %"class.std::vector"** %res.addr, align 8
  %7 = load i32, i32* %i, align 4
  %conv4 = sext i32 %7 to i64
  %call5 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %6, i64 %conv4) #3
  %8 = load i32, i32* %call5, align 4
  %conv6 = sext i32 %8 to i64
  %call7 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %map, i64 %conv6) #3
...
for.body11:                                       ; preds = %for.cond9
  ...
  %call12 = call i32* @_ZNSt6vectorIiSaIiEE5beginEv(%"class.std::vector"* %17) #3
  ...
  %call13 = call i32* @_ZNSt6vectorIiSaIiEE3endEv(%"class.std::vector"* %18) #3
...
for.cond15:                                       ; preds = %for.inc26, %for.body11
  ...
  br i1 %call16, label %for.body17, label %for.end28
...
for.body17:                                       ; preds = %for.cond15
  ...
  %call20 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %map, i64 %conv19) #3
  %21 = load i32, i32* %call20, align 4
  %22 = load i32, i32* %v, align 4
  %conv21 = sext i32 %22 to i64
  %call22 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %map, i64 %conv21) #3
  %23 = load i32, i32* %call22, align 4
  %cmp23 = icmp sgt i32 %21, %23
...
for.inc26:                                        ; preds = %if.end25
  %call27 = call dereferenceable(8) %"class.__gnu_cxx::__normal_iterator"* @_ZN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEppEv(%"class.__gnu_cxx::__normal_iterator"* %__begin2) #3
  br label %for.cond15
...
for.inc29:                                        ; preds = %for.end28
  ...
  store i32 %inc30, i32* %i8, align 4
  br label %for.cond9
...
cleanup:                                          ; preds = %for.end31, %if.then24
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %map) #3
  br label %return
...
while.cond:                                       ; preds = %arraydestroy.done15, %entry
...
while.body:                                       ; preds = %while.cond
  %call1 = call dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERi(%"class.std::basic_istream"* @_ZSt3cin, i32* dereferenceable(4) %E)
  %call2 = call dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERi(%"class.std::basic_istream"* %call1, i32* dereferenceable(4) %N)
  %1 = load i32, i32* %N, align 4
  %2 = zext i32 %1 to i64
  %3 = call i8* @llvm.stacksave()
  store i8* %3, i8** %saved_stack, align 8
  %vla = alloca %"class.std::vector", i64 %2, align 16
  store i64 %2, i64* %__vla_expr0, align 8
  %isempty = icmp eq i64 %2, 0
  br i1 %isempty, label %arrayctor.cont, label %new.ctorloop

new.ctorloop:                                     ; preds = %while.body
  %arrayctor.end = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %vla, i64 %2
...
arrayctor.cont:                                   ; preds = %while.body, %arrayctor.loop
  store i32 0, i32* %i, align 4
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  %call3 = invoke dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERi(%"class.std::basic_istream"* @_ZSt3cin, i32* dereferenceable(4) %u)
          to label %invoke.cont unwind label %lpad

invoke.cont:                                      ; preds = %for.body
  %call5 = invoke dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERi(%"class.std::basic_istream"* %call3, i32* dereferenceable(4) %v)
...
for.end:                                          ; preds = %for.cond
  ...
  invoke void @_ZN8Solution8topoSortEiPSt6vectorIiSaIiEE(%"class.std::vector"* sret %res, %class.Solution* %obj, i32 %11, %"class.std::vector"* %vla)
          to label %invoke.cont7 unwind label %lpad

invoke.cont7:                                     ; preds = %for.end
  %12 = load i32, i32* %N, align 4
  %call10 = invoke i32 @_Z5checkiRSt6vectorIiSaIiEEPS1_(i32 %12, %"class.std::vector"* dereferenceable(24) %res, %"class.std::vector"* %vla)
          to label %invoke.cont9 unwind label %lpad8

invoke.cont9:                                     ; preds = %invoke.cont7
  %call12 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* @_ZSt4cout, i32 %call10)
...
invoke.cont13:                                    ; preds = %invoke.cont11
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %res) #3
  %13 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %vla, i64 %2
  %arraydestroy.isempty = icmp eq %"class.std::vector"* %vla, %13
...
arraydestroy.body:                                ; preds = %arraydestroy.body, %invoke.cont13
  %arraydestroy.elementPast = phi %"class.std::vector"* [ %13, %invoke.cont13 ], [ %arraydestroy.element, %arraydestroy.body ]
...
arraydestroy.done15:                              ; preds = %arraydestroy.body, %invoke.cont13
...
ehcleanup:                                        ; preds = %lpad8, %lpad
  %18 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %vla, i64 %2
  %arraydestroy.isempty16 = icmp eq %"class.std::vector"* %vla, %18
  br i1 %arraydestroy.isempty16, label %arraydestroy.done21, label %arraydestroy.body17

arraydestroy.body17:                              ; preds = %arraydestroy.body17, %ehcleanup
  %arraydestroy.elementPast18 = phi %"class.std::vector"* [ %18, %ehcleanup ], [ %arraydestroy.element19, %arraydestroy.body17 ]
  %arraydestroy.element19 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %arraydestroy.elementPast18, i64 -1
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %arraydestroy.element19) #3
  %arraydestroy.done20 = icmp eq %"class.std::vector"* %arraydestroy.element19, %vla
  br i1 %arraydestroy.done20, label %arraydestroy.done21, label %arraydestroy.body17

arraydestroy.done21:                              ; preds = %arraydestroy.body17, %ehcleanup
  br label %eh.resume

while.end:                                        ; preds = %while.cond
  ret i32 0

eh.resume:                                        ; preds = %arraydestroy.done21
  %exn = load i8*, i8** %exn.slot, align 8
  %sel = load i32, i32* %ehselector.slot, align 4
  %lpad.val = insertvalue { i8*, i32 } undef, i8* %exn, 0
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local void @_ZN8Solution8topoSortEiPSt6vectorIiSaIiEE(%"class.std::vector"* noalias sret %agg.result, %class.Solution* %this, i32 %V, %"class.std::vector"* %adj) #4 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
  ...
  %qu = alloca %"class.std::queue", align 8
  %i19 = alloca i32, align 4
  %nrvo = alloca i1, align 1
  %node34 = alloca i32, align 4
  ...
  call void @_ZNSaIiEC2Ev(%"class.std::allocator"* %ref.tmp2) #3
  invoke void @_ZNSt6vectorIiSaIiEEC2EmRKiRKS0_(%"class.std::vector"* %indegree, i64 %conv, i32* dereferenceable(4) %ref.tmp, %"class.std::allocator"* dereferenceable(1) %ref.tmp2)
          to label %invoke.cont unwind label %lpad
...
for.cond3:                                        ; preds = %for.inc, %for.body
  ...
  %5 = load %"class.std::vector"*, %"class.std::vector"** %adj.addr, align 8
  %6 = load i32, i32* %i, align 4
  %idxprom = sext i32 %6 to i64
  %arrayidx = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %5, i64 %idxprom
  %call = call i64 @_ZNKSt6vectorIiSaIiEE4sizeEv(%"class.std::vector"* %arrayidx) #3
...
for.body6:                                        ; preds = %for.cond3
  ...
  %arrayidx8 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %7, i64 %idxprom7
  %9 = load i32, i32* %j, align 4
  %conv9 = sext i32 %9 to i64
  %call10 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %arrayidx8, i64 %conv9) #3
  %10 = load i32, i32* %call10, align 4
  store i32 %10, i32* %node, align 4
  %11 = load i32, i32* %node, align 4
  %conv11 = sext i32 %11 to i64
  %call12 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %indegree, i64 %conv11) #3
  %12 = load i32, i32* %call12, align 4
  %inc = add nsw i32 %12, 1
  store i32 %inc, i32* %call12, align 4
  br label %for.inc
...
for.end16:                                        ; preds = %for.cond
  invoke void @_ZNSt5queueIiSt5dequeIiSaIiEEEC2IS2_vEEv(%"class.std::queue"* %qu)
...
for.cond20:                                       ; preds = %for.inc28, %invoke.cont18
...
for.body22:                                       ; preds = %for.cond20
  ...
  %call24 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %indegree, i64 %conv23) #3
  %21 = load i32, i32* %call24, align 4
  %cmp25 = icmp eq i32 %21, 0
  br i1 %cmp25, label %if.then, label %if.end

if.then:                                          ; preds = %for.body22
  invoke void @_ZNSt5queueIiSt5dequeIiSaIiEEE4pushERKi(%"class.std::queue"* %qu, i32* dereferenceable(4) %i19)
...
if.end:                                           ; preds = %invoke.cont27, %for.body22
  br label %for.inc28
...
while.cond:                                       ; preds = %for.end59, %for.end30
  %call33 = invoke zeroext i1 @_ZNKSt5queueIiSt5dequeIiSaIiEEE5emptyEv(%"class.std::queue"* %qu)
...
while.body:                                       ; preds = %invoke.cont32
  %call36 = invoke dereferenceable(4) i32* @_ZNSt5queueIiSt5dequeIiSaIiEEE5frontEv(%"class.std::queue"* %qu)
          to label %invoke.cont35 unwind label %lpad31

invoke.cont35:                                    ; preds = %while.body
  %29 = load i32, i32* %call36, align 4
  store i32 %29, i32* %node34, align 4
  invoke void @_ZNSt5queueIiSt5dequeIiSaIiEEE3popEv(%"class.std::queue"* %qu)
          to label %invoke.cont37 unwind label %lpad31

invoke.cont37:                                    ; preds = %invoke.cont35
  invoke void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* %agg.result, i32* dereferenceable(4) %node34)
...
for.cond40:                                       ; preds = %for.inc57, %invoke.cont38
  %30 = load i32, i32* %j39, align 4
  %conv41 = sext i32 %30 to i64
  %31 = load %"class.std::vector"*, %"class.std::vector"** %adj.addr, align 8
  %32 = load i32, i32* %node34, align 4
  %idxprom42 = sext i32 %32 to i64
  %arrayidx43 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %31, i64 %idxprom42
  %call44 = call i64 @_ZNKSt6vectorIiSaIiEE4sizeEv(%"class.std::vector"* %arrayidx43) #3
  %cmp45 = icmp ult i64 %conv41, %call44
  br i1 %cmp45, label %for.body46, label %for.end59

for.body46:                                       ; preds = %for.cond40
  %33 = load %"class.std::vector"*, %"class.std::vector"** %adj.addr, align 8
  %34 = load i32, i32* %node34, align 4
  %idxprom47 = sext i32 %34 to i64
  %arrayidx48 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %33, i64 %idxprom47
  %35 = load i32, i32* %j39, align 4
  %conv49 = sext i32 %35 to i64
  %call50 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %arrayidx48, i64 %conv49) #3
  %36 = load i32, i32* %call50, align 4
  store i32 %36, i32* %nbr, align 4
  %37 = load i32, i32* %nbr, align 4
  %conv51 = sext i32 %37 to i64
  %call52 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %indegree, i64 %conv51) #3
  %38 = load i32, i32* %call52, align 4
  %dec = add nsw i32 %38, -1
  store i32 %dec, i32* %call52, align 4
  %cmp53 = icmp eq i32 %dec, 0
  br i1 %cmp53, label %if.then54, label %if.end56

if.then54:                                        ; preds = %for.body46
  invoke void @_ZNSt5queueIiSt5dequeIiSaIiEEE4pushERKi(%"class.std::queue"* %qu, i32* dereferenceable(4) %nbr)
          to label %invoke.cont55 unwind label %lpad31

invoke.cont55:                                    ; preds = %if.then54
  br label %if.end56

lpad31:                                           ; preds = %if.then54, %invoke.cont37, %invoke.cont35, %while.body, %while.cond
...
if.end56:                                         ; preds = %invoke.cont55, %for.body46
  br label %for.inc57

for.inc57:                                        ; preds = %if.end56
  %42 = load i32, i32* %j39, align 4
  %inc58 = add nsw i32 %42, 1
  store i32 %inc58, i32* %j39, align 4
  br label %for.cond40
...
nrvo.skipdtor:                                    ; preds = %nrvo.unused, %while.end
  call void @_ZNSt5queueIiSt5dequeIiSaIiEEED2Ev(%"class.std::queue"* %qu) #3
