; ModuleID = '/home/intern24006/codebase/palindromeString.cpp'
source_filename = "/home/intern24006/codebase/palindromeString.cpp"
...
@.str = private unnamed_addr constant [15 x i8] c"Not palindrome\00", align 1
@.str.1 = private unnamed_addr constant [11 x i8] c"Palindrome\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_palindromeString.cpp, i8* null }]
...
invoke.cont:                                      ; preds = %entry
  ...
  %call1 = call i64 @_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6lengthEv(%"class.std::__cxx11::basic_string"* %s) #3
  %sub = sub i64 %call1, 1
...
for.cond:                                         ; preds = %for.inc, %invoke.cont
  ...
  %call3 = call i64 @_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6lengthEv(%"class.std::__cxx11::basic_string"* %s) #3
...
for.body:                                         ; preds = %for.cond
  ...
  %call6 = invoke dereferenceable(1) i8* @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEixEm(%"class.std::__cxx11::basic_string"* %s, i64 %conv4)
          to label %invoke.cont5 unwind label %lpad

invoke.cont5:                                     ; preds = %for.body
  %2 = load i8, i8* %call6, align 1
...
if.then:                                          ; preds = %invoke.cont9
  %call14 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str, i64 0, i64 0))
...
lpad:                                             ; preds = %for.end, %if.then, %invoke.cont5, %for.body, %entry
  %5 = landingpad { i8*, i32 }
          cleanup
...
for.end:                                          ; preds = %for.cond
  %call16 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.1, i64 0, i64 0))
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_palindromeString.cpp() #0 section ".text.startup" {
entry:
