; ModuleID = '/home/intern24006/codebase/L20_kosarajuAlgo.cpp'
source_filename = "/home/intern24006/codebase/L20_kosarajuAlgo.cpp"
...
@.str.1 = private unnamed_addr constant [6 x i8] c"SCC: \00", align 1
@.str.2 = private unnamed_addr constant [48 x i8] c"cannot create std::deque larger than max_size()\00", align 1
@.str.3 = private unnamed_addr constant [26 x i8] c"vector::_M_realloc_insert\00", align 1
@.str.4 = private unnamed_addr constant [49 x i8] c"cannot create std::vector larger than max_size()\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_L20_kosarajuAlgo.cpp, i8* null }]
...
define dso_local void @_Z3dfsiRSt5stackIiSt5dequeIiSaIiEEERSt6vectorIiS1_EPS6_(i32 %node, %"class.std::stack"* dereferenceable(80) %st, %"class.std::vector"* dereferenceable(24) %vis, %"class.std::vector"* %adj) #4 {
entry:
  ...
  %arrayidx = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %2, i64 %idxprom
  store %"class.std::vector"* %arrayidx, %"class.std::vector"** %__range1, align 8
  %4 = load %"class.std::vector"*, %"class.std::vector"** %__range1, align 8
  %call1 = call i32* @_ZNSt6vectorIiSaIiEE5beginEv(%"class.std::vector"* %4) #3
  ...
  %5 = load %"class.std::vector"*, %"class.std::vector"** %__range1, align 8
  %call2 = call i32* @_ZNSt6vectorIiSaIiEE3endEv(%"class.std::vector"* %5) #3
...
for.cond:                                         ; preds = %for.inc, %entry
  %call4 = call zeroext i1 @_ZN9__gnu_cxxneIPiSt6vectorIiSaIiEEEEbRKNS_17__normal_iteratorIT_T0_EESA_(%"class.__gnu_cxx::__normal_iterator"* dereferenceable(8) %__begin1, %"class.__gnu_cxx::__normal_iterator"* dereferenceable(8) %__end1) #3
  br i1 %call4, label %for.body, label %for.end

for.body:                                         ; preds = %for.cond
  %call5 = call dereferenceable(4) i32* @_ZNK9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEdeEv(%"class.__gnu_cxx::__normal_iterator"* %__begin1) #3
  %6 = load i32, i32* %call5, align 4
  store i32 %6, i32* %it, align 4
  %7 = load %"class.std::vector"*, %"class.std::vector"** %vis.addr, align 8
  %8 = load i32, i32* %it, align 4
  %conv6 = sext i32 %8 to i64
  %call7 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %7, i64 %conv6) #3
  %9 = load i32, i32* %call7, align 4
  %tobool = icmp ne i32 %9, 0
  br i1 %tobool, label %if.end, label %if.then

if.then:                                          ; preds = %for.body
  %10 = load i32, i32* %it, align 4
  %11 = load %"class.std::stack"*, %"class.std::stack"** %st.addr, align 8
  %12 = load %"class.std::vector"*, %"class.std::vector"** %vis.addr, align 8
  %13 = load %"class.std::vector"*, %"class.std::vector"** %adj.addr, align 8
  call void @_Z3dfsiRSt5stackIiSt5dequeIiSaIiEEERSt6vectorIiS1_EPS6_(i32 %10, %"class.std::stack"* dereferenceable(80) %11, %"class.std::vector"* dereferenceable(24) %12, %"class.std::vector"* %13)
  br label %if.end
...
for.inc:                                          ; preds = %if.end
  %call8 = call dereferenceable(8) %"class.__gnu_cxx::__normal_iterator"* @_ZN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEppEv(%"class.__gnu_cxx::__normal_iterator"* %__begin1) #3
  br label %for.cond

for.end:                                          ; preds = %for.cond
  %14 = load %"class.std::stack"*, %"class.std::stack"** %st.addr, align 8
  call void @_ZNSt5stackIiSt5dequeIiSaIiEEE4pushERKi(%"class.std::stack"* %14, i32* dereferenceable(4) %node.addr)
  ret void
}
...
; Function Attrs: noinline optnone uwtable
define dso_local void @_Z6revDfsiRSt6vectorIiSaIiEEPS1_(i32 %node, %"class.std::vector"* dereferenceable(24) %vis, %"class.std::vector"* %transpose) #4 {
entry:
  %node.addr = alloca i32, align 4
  %vis.addr = alloca %"class.std::vector"*, align 8
  %transpose.addr = alloca %"class.std::vector"*, align 8
  %__range1 = alloca %"class.std::vector"*, align 8
  %__begin1 = alloca %"class.__gnu_cxx::__normal_iterator", align 8
  %__end1 = alloca %"class.__gnu_cxx::__normal_iterator", align 8
  %it = alloca i32, align 4
  store i32 %node, i32* %node.addr, align 4
  store %"class.std::vector"* %vis, %"class.std::vector"** %vis.addr, align 8
  store %"class.std::vector"* %transpose, %"class.std::vector"** %transpose.addr, align 8
  ...
  %1 = load %"class.std::vector"*, %"class.std::vector"** %vis.addr, align 8
  %2 = load i32, i32* %node.addr, align 4
  %conv = sext i32 %2 to i64
  %call2 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %1, i64 %conv) #3
  store i32 1, i32* %call2, align 4
  %3 = load %"class.std::vector"*, %"class.std::vector"** %transpose.addr, align 8
  %4 = load i32, i32* %node.addr, align 4
  %idxprom = sext i32 %4 to i64
  %arrayidx = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %3, i64 %idxprom
  store %"class.std::vector"* %arrayidx, %"class.std::vector"** %__range1, align 8
  %5 = load %"class.std::vector"*, %"class.std::vector"** %__range1, align 8
  %call3 = call i32* @_ZNSt6vectorIiSaIiEE5beginEv(%"class.std::vector"* %5) #3
  %coerce.dive = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator", %"class.__gnu_cxx::__normal_iterator"* %__begin1, i32 0, i32 0
  store i32* %call3, i32** %coerce.dive, align 8
  %6 = load %"class.std::vector"*, %"class.std::vector"** %__range1, align 8
  %call4 = call i32* @_ZNSt6vectorIiSaIiEE3endEv(%"class.std::vector"* %6) #3
...
for.body:                                         ; preds = %for.cond
  ...
  %8 = load %"class.std::vector"*, %"class.std::vector"** %vis.addr, align 8
  %9 = load i32, i32* %it, align 4
  %conv8 = sext i32 %9 to i64
  %call9 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %8, i64 %conv8) #3
...
if.then:                                          ; preds = %for.body
  ...
  %12 = load %"class.std::vector"*, %"class.std::vector"** %vis.addr, align 8
  %13 = load %"class.std::vector"*, %"class.std::vector"** %transpose.addr, align 8
  call void @_Z6revDfsiRSt6vectorIiSaIiEEPS1_(i32 %11, %"class.std::vector"* dereferenceable(24) %12, %"class.std::vector"* %13)
  br label %if.end
...
for.inc:                                          ; preds = %if.end
  %call10 = call dereferenceable(8) %"class.__gnu_cxx::__normal_iterator"* @_ZN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEppEv(%"class.__gnu_cxx::__normal_iterator"* %__begin1) #3
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  %call2 = invoke dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERi(%"class.std::basic_istream"* @_ZSt3cin, i32* dereferenceable(4) %a)
          to label %invoke.cont unwind label %lpad

invoke.cont:                                      ; preds = %for.body
  %call4 = invoke dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERi(%"class.std::basic_istream"* %call2, i32* dereferenceable(4) %b)
...
invoke.cont3:                                     ; preds = %invoke.cont
  ...
  invoke void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* %arrayidx, i32* dereferenceable(4) %b)
...
lpad:                                             ; preds = %for.end, %invoke.cont3, %invoke.cont, %for.body
  %7 = landingpad { i8*, i32 }
          cleanup
...
for.end:                                          ; preds = %for.cond
  invoke void @_ZNSt5stackIiSt5dequeIiSaIiEEEC2IS2_vEEv(%"class.std::stack"* %st)
...
invoke.cont6:                                     ; preds = %for.end
  ...
  call void @_ZNSaIiEC2Ev(%"class.std::allocator"* %ref.tmp7) #3
  invoke void @_ZNSt6vectorIiSaIiEEC2EmRKiRKS0_(%"class.std::vector"* %vis, i64 %conv, i32* dereferenceable(4) %ref.tmp, %"class.std::allocator"* dereferenceable(1) %ref.tmp7)
          to label %invoke.cont9 unwind label %lpad8

invoke.cont9:                                     ; preds = %invoke.cont6
  call void @_ZNSaIiED2Ev(%"class.std::allocator"* %ref.tmp7) #3
  store i32 0, i32* %i10, align 4
  br label %for.cond11

for.cond11:                                       ; preds = %for.inc18, %invoke.cont9
...
for.body13:                                       ; preds = %for.cond11
  ...
  %call15 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %vis, i64 %conv14) #3
...
if.then:                                          ; preds = %for.body13
  ...
  invoke void @_Z3dfsiRSt5stackIiSt5dequeIiSaIiEEERSt6vectorIiS1_EPS6_(i32 %15, %"class.std::stack"* dereferenceable(80) %st, %"class.std::vector"* dereferenceable(24) %vis, %"class.std::vector"* %vla)
...
if.end:                                           ; preds = %invoke.cont17, %for.body13
  br label %for.inc18

for.inc18:                                        ; preds = %if.end
  %22 = load i32, i32* %i10, align 4
...
for.end20:                                        ; preds = %for.cond11
  ...
  %vla21 = alloca %"class.std::vector", i64 %24, align 16
  store i64 %24, i64* %__vla_expr1, align 8
  %isempty22 = icmp eq i64 %24, 0
  br i1 %isempty22, label %arrayctor.cont29, label %new.ctorloop23

new.ctorloop23:                                   ; preds = %for.end20
  %arrayctor.end24 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %vla21, i64 %24
  br label %arrayctor.loop25

arrayctor.loop25:                                 ; preds = %arrayctor.loop25, %new.ctorloop23
  %arrayctor.cur26 = phi %"class.std::vector"* [ %vla21, %new.ctorloop23 ], [ %arrayctor.next27, %arrayctor.loop25 ]
  call void @_ZNSt6vectorIiSaIiEEC2Ev(%"class.std::vector"* %arrayctor.cur26) #3
  %arrayctor.next27 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %arrayctor.cur26, i64 1
  %arrayctor.done28 = icmp eq %"class.std::vector"* %arrayctor.next27, %arrayctor.end24
  br i1 %arrayctor.done28, label %arrayctor.cont29, label %arrayctor.loop25

arrayctor.cont29:                                 ; preds = %for.end20, %arrayctor.loop25
  store i32 0, i32* %i30, align 4
  br label %for.cond31

for.cond31:                                       ; preds = %for.inc52, %arrayctor.cont29
...
for.body33:                                       ; preds = %for.cond31
  ...
  %call35 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %vis, i64 %conv34) #3
  store i32 0, i32* %call35, align 4
  %28 = load i32, i32* %i30, align 4
  %idxprom36 = sext i32 %28 to i64
  %arrayidx37 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %vla, i64 %idxprom36
  store %"class.std::vector"* %arrayidx37, %"class.std::vector"** %__range2, align 8
  %29 = load %"class.std::vector"*, %"class.std::vector"** %__range2, align 8
  %call38 = call i32* @_ZNSt6vectorIiSaIiEE5beginEv(%"class.std::vector"* %29) #3
  ...
  store i32* %call38, i32** %coerce.dive, align 8
  %30 = load %"class.std::vector"*, %"class.std::vector"** %__range2, align 8
  %call39 = call i32* @_ZNSt6vectorIiSaIiEE3endEv(%"class.std::vector"* %30) #3
  %coerce.dive40 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator", %"class.__gnu_cxx::__normal_iterator"* %__end2, i32 0, i32 0
  store i32* %call39, i32** %coerce.dive40, align 8
  br label %for.cond41

for.cond41:                                       ; preds = %for.inc49, %for.body33
  %call42 = call zeroext i1 @_ZN9__gnu_cxxneIPiSt6vectorIiSaIiEEEEbRKNS_17__normal_iteratorIT_T0_EESA_(%"class.__gnu_cxx::__normal_iterator"* dereferenceable(8) %__begin2, %"class.__gnu_cxx::__normal_iterator"* dereferenceable(8) %__end2) #3
  br i1 %call42, label %for.body43, label %for.end51

for.body43:                                       ; preds = %for.cond41
  %call44 = call dereferenceable(4) i32* @_ZNK9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEdeEv(%"class.__gnu_cxx::__normal_iterator"* %__begin2) #3
  %31 = load i32, i32* %call44, align 4
  store i32 %31, i32* %it, align 4
  %32 = load i32, i32* %it, align 4
  %idxprom45 = sext i32 %32 to i64
  %arrayidx46 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %vla21, i64 %idxprom45
  invoke void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* %arrayidx46, i32* dereferenceable(4) %i30)
          to label %invoke.cont48 unwind label %lpad47

invoke.cont48:                                    ; preds = %for.body43
  br label %for.inc49

for.inc49:                                        ; preds = %invoke.cont48
  %call50 = call dereferenceable(8) %"class.__gnu_cxx::__normal_iterator"* @_ZN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEppEv(%"class.__gnu_cxx::__normal_iterator"* %__begin2) #3
  br label %for.cond41

lpad47:                                           ; preds = %invoke.cont66, %invoke.cont64, %if.then63, %invoke.cont57, %while.body, %while.cond, %for.body43
  ...
  %36 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %vla21, i64 %24
  %arraydestroy.isempty71 = icmp eq %"class.std::vector"* %vla21, %36
  br i1 %arraydestroy.isempty71, label %arraydestroy.done76, label %arraydestroy.body72
...
for.inc52:                                        ; preds = %for.end51
  ...
  store i32 %inc53, i32* %i30, align 4
  br label %for.cond31

for.end54:                                        ; preds = %for.cond31
  br label %while.cond

while.cond:                                       ; preds = %if.end69, %for.end54
  %call56 = invoke zeroext i1 @_ZNKSt5stackIiSt5dequeIiSaIiEEE5emptyEv(%"class.std::stack"* %st)
...
while.body:                                       ; preds = %invoke.cont55
  %call58 = invoke dereferenceable(4) i32* @_ZNSt5stackIiSt5dequeIiSaIiEEE3topEv(%"class.std::stack"* %st)
          to label %invoke.cont57 unwind label %lpad47

invoke.cont57:                                    ; preds = %while.body
  %38 = load i32, i32* %call58, align 4
  store i32 %38, i32* %node, align 4
  invoke void @_ZNSt5stackIiSt5dequeIiSaIiEEE3popEv(%"class.std::stack"* %st)
          to label %invoke.cont59 unwind label %lpad47

invoke.cont59:                                    ; preds = %invoke.cont57
  %39 = load i32, i32* %node, align 4
  %conv60 = sext i32 %39 to i64
  %call61 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %vis, i64 %conv60) #3
  %40 = load i32, i32* %call61, align 4
  %tobool62 = icmp ne i32 %40, 0
  br i1 %tobool62, label %if.end69, label %if.then63

if.then63:                                        ; preds = %invoke.cont59
  %call65 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0))
          to label %invoke.cont64 unwind label %lpad47

invoke.cont64:                                    ; preds = %if.then63
  %41 = load i32, i32* %node, align 4
  invoke void @_Z6revDfsiRSt6vectorIiSaIiEEPS1_(i32 %41, %"class.std::vector"* dereferenceable(24) %vis, %"class.std::vector"* %vla21)
          to label %invoke.cont66 unwind label %lpad47

invoke.cont66:                                    ; preds = %invoke.cont64
  %call68 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEPFRSoS_E(%"class.std::basic_ostream"* @_ZSt4cout, %"class.std::basic_ostream"* (%"class.std::basic_ostream"*)* @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
...
while.end:                                        ; preds = %invoke.cont55
  store i32 0, i32* %retval, align 4
  %42 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %vla21, i64 %24
  %arraydestroy.isempty = icmp eq %"class.std::vector"* %vla21, %42
...
arraydestroy.body:                                ; preds = %arraydestroy.body, %while.end
  %arraydestroy.elementPast = phi %"class.std::vector"* [ %42, %while.end ], [ %arraydestroy.element, %arraydestroy.body ]
  ...
  %arraydestroy.done = icmp eq %"class.std::vector"* %arraydestroy.element, %vla21
  br i1 %arraydestroy.done, label %arraydestroy.done70, label %arraydestroy.body

arraydestroy.done70:                              ; preds = %arraydestroy.body, %while.end
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %vis) #3
  call void @_ZNSt5stackIiSt5dequeIiSaIiEEED2Ev(%"class.std::stack"* %st) #3
  %43 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %vla, i64 %1
  %arraydestroy.isempty78 = icmp eq %"class.std::vector"* %vla, %43
  br i1 %arraydestroy.isempty78, label %arraydestroy.done83, label %arraydestroy.body79

arraydestroy.body72:                              ; preds = %arraydestroy.body72, %lpad47
  %arraydestroy.elementPast73 = phi %"class.std::vector"* [ %36, %lpad47 ], [ %arraydestroy.element74, %arraydestroy.body72 ]
  %arraydestroy.element74 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %arraydestroy.elementPast73, i64 -1
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %arraydestroy.element74) #3
  %arraydestroy.done75 = icmp eq %"class.std::vector"* %arraydestroy.element74, %vla21
  br i1 %arraydestroy.done75, label %arraydestroy.done76, label %arraydestroy.body72

arraydestroy.done76:                              ; preds = %arraydestroy.body72, %lpad47
  br label %ehcleanup

ehcleanup:                                        ; preds = %arraydestroy.done76, %lpad16
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %vis) #3
  br label %ehcleanup77

ehcleanup77:                                      ; preds = %ehcleanup, %lpad8
  call void @_ZNSt5stackIiSt5dequeIiSaIiEEED2Ev(%"class.std::stack"* %st) #3
  br label %ehcleanup84

arraydestroy.body79:                              ; preds = %arraydestroy.body79, %arraydestroy.done70
  %arraydestroy.elementPast80 = phi %"class.std::vector"* [ %43, %arraydestroy.done70 ], [ %arraydestroy.element81, %arraydestroy.body79 ]
  %arraydestroy.element81 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %arraydestroy.elementPast80, i64 -1
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %arraydestroy.element81) #3
  %arraydestroy.done82 = icmp eq %"class.std::vector"* %arraydestroy.element81, %vla
  br i1 %arraydestroy.done82, label %arraydestroy.done83, label %arraydestroy.body79

arraydestroy.done83:                              ; preds = %arraydestroy.body79, %arraydestroy.done70
  %44 = load i8*, i8** %saved_stack, align 8
  call void @llvm.stackrestore(i8* %44)
  %45 = load i32, i32* %retval, align 4
  ret i32 %45

ehcleanup84:                                      ; preds = %ehcleanup77, %lpad
  %46 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %vla, i64 %1
  %arraydestroy.isempty85 = icmp eq %"class.std::vector"* %vla, %46
  br i1 %arraydestroy.isempty85, label %arraydestroy.done90, label %arraydestroy.body86

arraydestroy.body86:                              ; preds = %arraydestroy.body86, %ehcleanup84
  %arraydestroy.elementPast87 = phi %"class.std::vector"* [ %46, %ehcleanup84 ], [ %arraydestroy.element88, %arraydestroy.body86 ]
  %arraydestroy.element88 = getelementptr inbounds %"class.std::vector", %"class.std::vector"* %arraydestroy.elementPast87, i64 -1
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %arraydestroy.element88) #3
  %arraydestroy.done89 = icmp eq %"class.std::vector"* %arraydestroy.element88, %vla
  br i1 %arraydestroy.done89, label %arraydestroy.done90, label %arraydestroy.body86

arraydestroy.done90:                              ; preds = %arraydestroy.body86, %ehcleanup84
  br label %eh.resume

eh.resume:                                        ; preds = %arraydestroy.done90
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_L20_kosarajuAlgo.cpp() #0 section ".text.startup" {
entry:
