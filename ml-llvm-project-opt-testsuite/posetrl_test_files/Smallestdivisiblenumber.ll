; ModuleID = '/home/intern24006/codebase/Smallestdivisiblenumber.cpp'
source_filename = "/home/intern24006/codebase/Smallestdivisiblenumber.cpp"
...
$_ZN8Solution17getSmallestDivNumEx = comdat any

$_ZN8Solution3gcdExx = comdat any

@_ZStL8__ioinit = internal global %"class.std::ios_base::Init" zeroinitializer, align 1
@__dso_handle = external hidden global i8
@_ZSt3cin = external dso_local global %"class.std::basic_istream", align 8
@_ZSt4cout = external dso_local global %"class.std::basic_ostream", align 8
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_Smallestdivisiblenumber.cpp, i8* null }]
...
while.body:                                       ; preds = %while.cond
  ...
  %call2 = call i64 @_ZN8Solution17getSmallestDivNumEx(%class.Solution* %ob, i64 %conv)
  %call3 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEx(%"class.std::basic_ostream"* @_ZSt4cout, i64 %call2)
...
define linkonce_odr dso_local i64 @_ZN8Solution17getSmallestDivNumEx(%class.Solution* %this, i64 %n) #5 comdat align 2 {
entry:
...
for.body:                                         ; preds = %for.cond
  %2 = load i64, i64* %LCM, align 8
  %3 = load i64, i64* %i, align 8
  %mul = mul nsw i64 %2, %3
  %4 = load i64, i64* %i, align 8
  %5 = load i64, i64* %LCM, align 8
  %call = call i64 @_ZN8Solution3gcdExx(%class.Solution* %this1, i64 %4, i64 %5)
  %div = sdiv i64 %mul, %call
  store i64 %div, i64* %LCM, align 8
  br label %for.inc
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local i64 @_ZN8Solution3gcdExx(%class.Solution* %this, i64 %a, i64 %b) #5 comdat align 2 {
entry:
...
if.end:                                           ; preds = %entry
  ...
  %rem = srem i64 %3, %4
  %call = call i64 @_ZN8Solution3gcdExx(%class.Solution* %this1, i64 %2, i64 %rem)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_Smallestdivisiblenumber.cpp() #0 section ".text.startup" {
entry:
