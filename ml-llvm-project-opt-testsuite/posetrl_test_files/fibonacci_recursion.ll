; ModuleID = '/home/intern24006/codebase/fibonacci_recursion.cpp'
source_filename = "/home/intern24006/codebase/fibonacci_recursion.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_fibonacci_recursion.cpp, i8* null }]
...
define dso_local i64 @_Z9fibonaccix(i64 %n) #4 {
entry:
...
if.end:                                           ; preds = %entry
  ...
  %sub = sub nsw i64 %2, 1
  %call = call i64 @_Z9fibonaccix(i64 %sub)
  %3 = load i64, i64* %n.addr, align 8
  %sub1 = sub nsw i64 %3, 2
  %call2 = call i64 @_Z9fibonaccix(i64 %sub1)
...
entry:
  ...
  %call = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str, i64 0, i64 0))
  %call1 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEPFRSoS_E(%"class.std::basic_ostream"* %call, %"class.std::basic_ostream"* (%"class.std::basic_ostream"*)* @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
  %call2 = call dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERx(%"class.std::basic_istream"* @_ZSt3cin, i64* dereferenceable(8) %n)
  %0 = load i64, i64* %n, align 8
  %call3 = call i64 @_Z9fibonaccix(i64 %0)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_fibonacci_recursion.cpp() #0 section ".text.startup" {
entry:
