; ModuleID = '/home/intern24006/codebase/Fibonacci_Series_recursive_DP.cpp'
source_filename = "/home/intern24006/codebase/Fibonacci_Series_recursive_DP.cpp"
...
@dp = dso_local global [1000001 x i32] zeroinitializer, align 16
@_ZSt3cin = external dso_local global %"class.std::basic_istream", align 8
@_ZSt4cout = external dso_local global %"class.std::basic_ostream", align 8
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_Fibonacci_Series_recursive_DP.cpp, i8* null }]
...
define dso_local i32 @_Z3fibi(i32 %n) #4 {
entry:
...
if.end:                                           ; preds = %lor.lhs.false
  ...
  %arrayidx = getelementptr inbounds [1000001 x i32], [1000001 x i32]* @dp, i64 0, i64 %idxprom
...
if.then3:                                         ; preds = %if.end
  ...
  %arrayidx5 = getelementptr inbounds [1000001 x i32], [1000001 x i32]* @dp, i64 0, i64 %idxprom4
...
if.end6:                                          ; preds = %if.end
  ...
  %call8 = call i32 @_Z3fibi(i32 %sub7)
  %add = add nsw i32 %call, %call8
  store i32 %add, i32* %res, align 4
  %9 = load i32, i32* %res, align 4
  %10 = load i32, i32* %n.addr, align 4
  %idxprom9 = sext i32 %10 to i64
  %arrayidx10 = getelementptr inbounds [1000001 x i32], [1000001 x i32]* @dp, i64 0, i64 %idxprom9
  store i32 %9, i32* %arrayidx10, align 4
  %11 = load i32, i32* %n.addr, align 4
  %idxprom11 = sext i32 %11 to i64
  %arrayidx12 = getelementptr inbounds [1000001 x i32], [1000001 x i32]* @dp, i64 0, i64 %idxprom11
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_Fibonacci_Series_recursive_DP.cpp() #0 section ".text.startup" {
entry:
