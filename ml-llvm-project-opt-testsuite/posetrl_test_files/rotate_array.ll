; ModuleID = '/home/intern24006/codebase/rotate_array.cpp'
source_filename = "/home/intern24006/codebase/rotate_array.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_rotate_array.cpp, i8* null }]
...
define dso_local void @_Z14rotateFunctionPii(i32* %a, i32 %n) #4 {
entry:
...
for.end:                                          ; preds = %for.cond
  ...
  call void @_Z14rotateFunctionPii(i32* %vla, i32 %7)
...
for.end11:                                        ; preds = %for.cond3
  %call12 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0))
  store i32 0, i32* %retval, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_rotate_array.cpp() #0 section ".text.startup" {
entry:
