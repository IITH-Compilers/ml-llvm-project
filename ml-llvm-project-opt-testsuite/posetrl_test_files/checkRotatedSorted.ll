; ModuleID = '/home/intern24006/codebase/checkRotatedSorted.cpp'
source_filename = "/home/intern24006/codebase/checkRotatedSorted.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_checkRotatedSorted.cpp, i8* null }]
...
define dso_local zeroext i1 @_Z18checkSortedRotatedSt6vectorIiSaIiEE(%"class.std::vector"* %v) #4 {
entry:
...
for.body:                                         ; preds = %for.cond
  ...
  %call2 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %v, i64 %conv1) #3
  %2 = load i32, i32* %call2, align 4
  %3 = load i32, i32* %i, align 4
  %add = add nsw i32 %3, 1
  %conv3 = sext i32 %add to i64
  %call4 = call i64 @_ZNKSt6vectorIiSaIiEE4sizeEv(%"class.std::vector"* %v) #3
  %rem = urem i64 %conv3, %call4
  %call5 = call dereferenceable(4) i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %v, i64 %rem) #3
...
for.body:                                         ; preds = %for.cond
  %call2 = invoke dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERi(%"class.std::basic_istream"* @_ZSt3cin, i32* dereferenceable(4) %x)
          to label %invoke.cont1 unwind label %lpad

invoke.cont1:                                     ; preds = %for.body
  invoke void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* %v, i32* dereferenceable(4) %x)
...
lpad:                                             ; preds = %if.else, %if.then, %for.end, %invoke.cont1, %for.body, %entry
  %3 = landingpad { i8*, i32 }
          cleanup
...
invoke.cont4:                                     ; preds = %for.end
  %call7 = invoke zeroext i1 @_Z18checkSortedRotatedSt6vectorIiSaIiEE(%"class.std::vector"* %agg.tmp)
          to label %invoke.cont6 unwind label %lpad5

invoke.cont6:                                     ; preds = %invoke.cont4
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %agg.tmp) #3
  %frombool = zext i1 %call7 to i8
  store i8 %frombool, i8* %check, align 1
  %6 = load i8, i8* %check, align 1
...
if.then:                                          ; preds = %invoke.cont6
  %call10 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0))
...
if.else:                                          ; preds = %invoke.cont6
  %call12 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0))
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local i32* @_ZSt13__copy_move_aILb0EN9__gnu_cxx17__normal_iteratorIPKiSt6vectorIiSaIiEEEEPiET1_T0_SA_S9_(i32* %__first.coerce, i32* %__last.coerce, i32* %__result) #6 comdat {
entry:
  %__first = alloca %"class.__gnu_cxx::__normal_iterator.0", align 8
  %__last = alloca %"class.__gnu_cxx::__normal_iterator.0", align 8
  %__result.addr = alloca i32*, align 8
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local i32* @_ZSt14__copy_move_a1ILb0EPKiPiET1_T0_S4_S3_(i32* %__first, i32* %__last, i32* %__result) #6 comdat {
entry:
  %__first.addr = alloca i32*, align 8
  %__last.addr = alloca i32*, align 8
  %__result.addr = alloca i32*, align 8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_checkRotatedSorted.cpp() #0 section ".text.startup" {
entry:
