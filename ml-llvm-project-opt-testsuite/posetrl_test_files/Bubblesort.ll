; ModuleID = '/home/intern24006/codebase/Bubblesort.cpp'
source_filename = "/home/intern24006/codebase/Bubblesort.cpp"
...
define dso_local void @_Z4swapPiS_(i32* %xp, i32* %yp) #4 {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @_Z10bubbleSortPii(i32* %arr, i32 %n) #4 {
entry:
...
define dso_local void @_Z10printArrayPii(i32* %arr, i32 %size) #5 {
entry:
  %arr.addr = alloca i32*, align 8
