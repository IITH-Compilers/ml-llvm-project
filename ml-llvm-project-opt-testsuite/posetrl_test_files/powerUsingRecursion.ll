; ModuleID = '/home/intern24006/codebase/powerUsingRecursion.cpp'
source_filename = "/home/intern24006/codebase/powerUsingRecursion.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_powerUsingRecursion.cpp, i8* null }]
...
define dso_local i32 @_Z14RecursivePowerii(i32 %n, i32 %p) #4 {
entry:
...
if.end:                                           ; preds = %entry
  ...
  %sub = sub nsw i32 %3, 1
  %call = call i32 @_Z14RecursivePowerii(i32 %2, i32 %sub)
...
while.body:                                       ; preds = %while.cond
  ...
  %call3 = call i32 @_Z14RecursivePowerii(i32 %1, i32 %2)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_powerUsingRecursion.cpp() #0 section ".text.startup" {
entry:
