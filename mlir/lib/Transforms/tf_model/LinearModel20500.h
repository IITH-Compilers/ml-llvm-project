...
#ifndef TFCOMPILE_GENERATED__xla_home_cs20mtech12003_ml_llvm_project_mlir_lib_Transforms_tf_model_LinearModel20500_LinearModel20500_H_  // NOLINT(build/header_guard)
#define TFCOMPILE_GENERATED__xla_home_cs20mtech12003_ml_llvm_project_mlir_lib_Transforms_tf_model_LinearModel20500_LinearModel20500_H_  // NOLINT(build/header_guard)
...
extern "C" void _xla_home_cs20mtech12003_ml_llvm_project_mlir_lib_Transforms_tf_model_LinearModel20500_LinearModel20500(
...
// LinearModel20500 represents a computation previously specified in a
...
//
// Memory stats:
//   arg bytes total:    164000
//   arg bytes aligned:  164032
//   temp bytes total:   5320
//   temp bytes aligned: 5440
class LinearModel20500 final : public tensorflow::XlaCompiledCpuFunction {
 public:
  ...
  static const tensorflow::XlaCompiledCpuFunction::StaticData& StaticData() {
    static XlaCompiledCpuFunction::StaticData* kStaticData = [](){
      ...
      set_static_data_raw_function(data, _xla_home_cs20mtech12003_ml_llvm_project_mlir_lib_Transforms_tf_model_LinearModel20500_LinearModel20500);
  ...
  LinearModel20500(AllocMode alloc_mode =
            AllocMode::ARGS_VARIABLES_RESULTS_PROFILES_AND_TEMPS)
      : XlaCompiledCpuFunction(StaticData(), alloc_mode) {}

  LinearModel20500(const LinearModel20500&) = delete;
  LinearModel20500& operator=(const LinearModel20500&) = delete;
  ...
  double& arg0(size_t dim0) {
    return (*static_cast<double(*)[20500]>(
        arg_data(0)))[dim0];
  }
  ...
  const double& arg0(size_t dim0) const {
    return (*static_cast<const double(*)[20500]>(
        arg_data(0)))[dim0];
  }
  int arg0_size() const {
    return 20500 * sizeof(double);
  }
...
::xla::cpu_function_runtime::BufferInfo(::xla::cpu_function_runtime::EncodedBufferInfo{656002ULL, 0U, ~0U}),
...
::xla::cpu_function_runtime::BufferInfo(::xla::cpu_function_runtime::EncodedBufferInfo{35ULL, ~0U, ~0U}),
::xla::cpu_function_runtime::BufferInfo(::xla::cpu_function_runtime::EncodedBufferInfo{35ULL, ~0U, ~0U}),
::xla::cpu_function_runtime::BufferInfo(::xla::cpu_function_runtime::EncodedBufferInfo{21217ULL, ~0U, ~0U})
      };
    return kBufferInfos;
  }
...
#endif  // TFCOMPILE_GENERATED__xla_home_cs20mtech12003_ml_llvm_project_mlir_lib_Transforms_tf_model_LinearModel20500_LinearModel20500_H_
