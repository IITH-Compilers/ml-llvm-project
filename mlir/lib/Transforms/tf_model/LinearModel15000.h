...
#ifndef TFCOMPILE_GENERATED__xla_home_cs20mtech12003_ml_llvm_project_mlir_lib_Transforms_tf_model_LinearModel15000_LinearModel15000_H_  // NOLINT(build/header_guard)
#define TFCOMPILE_GENERATED__xla_home_cs20mtech12003_ml_llvm_project_mlir_lib_Transforms_tf_model_LinearModel15000_LinearModel15000_H_  // NOLINT(build/header_guard)
...
extern "C" void _xla_home_cs20mtech12003_ml_llvm_project_mlir_lib_Transforms_tf_model_LinearModel15000_LinearModel15000(
...
// LinearModel15000 represents a computation previously specified in a
...
//
// Memory stats:
//   arg bytes total:    120000
//   arg bytes aligned:  120000
//   temp bytes total:   3896
//   temp bytes aligned: 4032
class LinearModel15000 final : public tensorflow::XlaCompiledCpuFunction {
 public:
  ...
  static const tensorflow::XlaCompiledCpuFunction::StaticData& StaticData() {
    static XlaCompiledCpuFunction::StaticData* kStaticData = [](){
      ...
      set_static_data_raw_function(data, _xla_home_cs20mtech12003_ml_llvm_project_mlir_lib_Transforms_tf_model_LinearModel15000_LinearModel15000);
  ...
  LinearModel15000(AllocMode alloc_mode =
            AllocMode::ARGS_VARIABLES_RESULTS_PROFILES_AND_TEMPS)
      : XlaCompiledCpuFunction(StaticData(), alloc_mode) {}

  LinearModel15000(const LinearModel15000&) = delete;
  LinearModel15000& operator=(const LinearModel15000&) = delete;
  ...
  double& arg0(size_t dim0) {
    return (*static_cast<double(*)[15000]>(
        arg_data(0)))[dim0];
  }
  ...
  const double& arg0(size_t dim0) const {
    return (*static_cast<const double(*)[15000]>(
        arg_data(0)))[dim0];
  }
  int arg0_size() const {
    return 15000 * sizeof(double);
  }
...
::xla::cpu_function_runtime::BufferInfo(::xla::cpu_function_runtime::EncodedBufferInfo{480002ULL, 0U, ~0U}),
...
::xla::cpu_function_runtime::BufferInfo(::xla::cpu_function_runtime::EncodedBufferInfo{35ULL, ~0U, ~0U}),
::xla::cpu_function_runtime::BufferInfo(::xla::cpu_function_runtime::EncodedBufferInfo{35ULL, ~0U, ~0U}),
::xla::cpu_function_runtime::BufferInfo(::xla::cpu_function_runtime::EncodedBufferInfo{15521ULL, ~0U, ~0U})
      };
    return kBufferInfos;
  }
...
#endif  // TFCOMPILE_GENERATED__xla_home_cs20mtech12003_ml_llvm_project_mlir_lib_Transforms_tf_model_LinearModel15000_LinearModel15000_H_
